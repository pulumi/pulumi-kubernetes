...
/**
 * CustomResourcePatchArgsBase is the base class for a user-defined
 * CustomResourcePatchArgs.
 */
public abstract class CustomResourcePatchArgsBase extends com.pulumi.resources.ResourceArgs {
    ...
    @Nullable Output<ObjectMetaPatchArgs> metadata;
    ...
    protected CustomResourcePatchArgsBase() {
    }
    ...
    public static class Builder<T extends CustomResourcePatchArgsBase, U extends Builder<T, U>> {
         ...
         * 
         */
        public U metadata(@Nullable Output<ObjectMetaPatchArgs> metadata) {
            $.metadata = metadata;
            return (U) this;
        }
         ...
         * 
         */
        public U metadata(ObjectMetaPatchArgs metadata) {
