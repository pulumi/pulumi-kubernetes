...
namespace Pulumi.Kubernetes.Helm.V3
{
	...
	public sealed class Chart : CollectionComponentResource
	{
		...
		internal ImmutableDictionary<string, object> SkipAwait(ImmutableDictionary<string, object> obj, CustomResourceOptions opts)
		{
			...
			{
				metadata = metadata.SetItem("annotations", ((ImmutableDictionary<string, object>)metadata["annotations"]).SetItem("pulumi.com/skipAwait", "true"));
                obj = obj.SetItem("metadata", metadata);
			}
			else
			{
				obj = obj.SetItem("metadata", metadata.SetItem("annotations", new Dictionary<string, string> { { "pulumi.com/skipAwait", "true" } }.ToImmutableDictionary()));
			}
