...
// pulumi_gen.go just slightly modifies some methods in
// https://github.com/pulumi/pulumi/blob/master/pkg/codegen/nodejs/gen.go
...
// Changed "return root + modName + title(name)" to "return modName + title(name"
...
// Removes imports from input/output
