...
require (
	github.com/pulumi/pulumi-kubernetes-gateway-pulumi-test/sdk/v4/go v0.0.0-00010101000000-000000000000
	github.com/pulumi/pulumi/sdk/v3 v3.228.0
)

replace github.com/pulumi/pulumi-kubernetes-gateway-pulumi-test/sdk/v4/go => ./sdks/go
