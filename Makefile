...
# Test everything except the Go SDK
	cd tests && $(GO_TEST_FAST) $(go list ./... | grep -v integration/go)
# Test the Go SDK separately due to high memory usage
# TODO: re-enable Go tests
#	cd tests/integration/go && $(GO_TEST_FAST) ./...
