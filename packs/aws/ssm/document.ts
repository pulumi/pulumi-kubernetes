...
export class Document extends lumi.NamedResource implements DocumentArgs {
    ...
    public readonly parameter?: { defaultValue?: string, description?: string, name?: string, type?: string }[];
...
export interface DocumentArgs {
    ...
    readonly parameter?: { defaultValue?: string, description?: string, name?: string, type?: string }[];
