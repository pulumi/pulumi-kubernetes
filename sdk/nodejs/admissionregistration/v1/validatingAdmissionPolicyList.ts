...
export class ValidatingAdmissionPolicyList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.admissionregistration.v1.ValidatingAdmissionPolicy[]>;
    /**
