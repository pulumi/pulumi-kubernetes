...
export class ValidatingAdmissionPolicyBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBinding';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec>;
