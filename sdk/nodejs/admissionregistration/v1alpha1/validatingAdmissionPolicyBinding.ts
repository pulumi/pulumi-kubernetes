...
export class ValidatingAdmissionPolicyBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyBinding';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.admissionregistration.v1alpha1.ValidatingAdmissionPolicyBindingSpec>;
    ...
    constructor(name: string, args?: ValidatingAdmissionPolicyBindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyBinding" }] };
