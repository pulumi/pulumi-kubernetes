...
export class ValidatingWebhookConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly webhooks!: pulumi.Output<outputs.admissionregistration.k8s.io.v1beta1.ValidatingWebhook[] | undefined>;
...
export interface ValidatingWebhookConfigurationArgs {
     ...
     * Webhooks is a list of webhooks and the affected resources and operations.
     */
    readonly webhooks?: pulumi.Input<pulumi.Input<inputs.admissionregistration.k8s.io.v1beta1.ValidatingWebhook>[]>;
}
