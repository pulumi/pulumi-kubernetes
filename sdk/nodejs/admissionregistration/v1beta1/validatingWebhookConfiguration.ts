...
export class ValidatingWebhookConfiguration extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"ValidatingWebhookConfiguration">;
    /**
     ...
     */
    declare public readonly webhooks: pulumi.Output<outputs.admissionregistration.v1beta1.ValidatingWebhook[]>;
