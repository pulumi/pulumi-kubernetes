...
export class ValidatingWebhookConfigurationList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.admissionregistration.k8s.io.v1beta1.ValidatingWebhookConfiguration[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ValidatingWebhookConfigurationListArgs | ValidatingWebhookConfigurationListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ValidatingWebhookConfigurationListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as ValidatingWebhookConfigurationListArgs | undefined;
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "ValidatingWebhookConfigurationList";
...
export interface ValidatingWebhookConfigurationListArgs {
     ...
     * List of ValidatingWebhookConfiguration.
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.admissionregistration.k8s.io.v1beta1.ValidatingWebhookConfiguration>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
