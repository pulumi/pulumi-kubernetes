...
export class PriorityLevelConfigurationList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfigurationList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.flowcontrol.apiserver.k8s.io.v1alpha1.PriorityLevelConfiguration[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PriorityLevelConfigurationListArgs | PriorityLevelConfigurationListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as PriorityLevelConfigurationListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as PriorityLevelConfigurationListArgs | undefined;
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "PriorityLevelConfigurationList";
...
export interface PriorityLevelConfigurationListArgs {
     ...
     * `items` is a list of request-priorities.
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.flowcontrol.apiserver.k8s.io.v1alpha1.PriorityLevelConfiguration>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
