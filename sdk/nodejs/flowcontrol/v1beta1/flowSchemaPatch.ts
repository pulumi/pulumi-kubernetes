...
export class FlowSchemaPatch extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: FlowSchemaPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:FlowSchemaPatch" }, { type: "kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaPatch" }] };
