...
export class PriorityLevelConfigurationPatch extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: PriorityLevelConfigurationPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfigurationPatch" }, { type: "kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfigurationPatch" }] };
