...
export class PriorityLevelConfigurationPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:flowcontrol.apiserver.k8s.io/v1beta3:PriorityLevelConfigurationPatch';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.flowcontrol.v1beta3.PriorityLevelConfigurationSpecPatch>;
    /**
     * `status` is the current status of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.flowcontrol.v1beta3.PriorityLevelConfigurationStatusPatch>;
