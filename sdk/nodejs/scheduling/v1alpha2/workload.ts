...
export class Workload extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:scheduling.k8s.io/v1alpha2:Workload';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.scheduling.v1alpha2.WorkloadSpec>;
...
export interface WorkloadArgs {
     ...
     * Spec defines the desired behavior of a Workload.
     */
    spec: pulumi.Input<inputs.scheduling.v1alpha2.WorkloadSpec>;
}
