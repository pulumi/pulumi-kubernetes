...
export class PriorityClassList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.scheduling.v1alpha1.PriorityClass[]>;
    /**
    ...
    constructor(name: string, argsOrState?: PriorityClassListArgs, opts?: pulumi.CustomResourceOptions) {
