...
export class Workload extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:scheduling.k8s.io/v1beta1:Workload';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.scheduling.v1beta1.WorkloadSpec>;
    ...
    constructor(name: string, args?: WorkloadArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:scheduling.k8s.io/v1alpha1:Workload" }, { type: "kubernetes:scheduling.k8s.io/v1alpha2:Workload" }, { type: "kubernetes:scheduling.k8s.io/v1alpha3:Workload" }] };
