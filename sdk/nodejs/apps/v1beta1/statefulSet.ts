...
export class StatefulSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:apps/v1beta1:StatefulSet';
     ...
     */
    declare public readonly kind: pulumi.Output<"StatefulSet">;
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMeta>;
    /**
     * Spec defines the desired identities of pods in this set.
     */
    declare public readonly spec: pulumi.Output<outputs.apps.v1beta1.StatefulSetSpec>;
    /**
     * Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.apps.v1beta1.StatefulSetStatus>;
