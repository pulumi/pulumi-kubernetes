...
export class ControllerRevisionList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:apps/v1beta1:ControllerRevisionList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.apps.v1beta1.ControllerRevision[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ControllerRevisionListArgs | ControllerRevisionListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ControllerRevisionListState | undefined;
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "ControllerRevisionList";
