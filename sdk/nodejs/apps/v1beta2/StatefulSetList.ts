...
export class StatefulSetList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:apps/v1beta2:StatefulSetList';
    ...
    public readonly items!: pulumi.Output<outputs.apps.v1beta2.StatefulSet[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: StatefulSetListArgs | StatefulSetListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as StatefulSetListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as StatefulSetListArgs | undefined;
