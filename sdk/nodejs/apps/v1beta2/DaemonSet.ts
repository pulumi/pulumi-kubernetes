...
export class DaemonSet extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.apps.v1beta2.DaemonSetSpec | undefined>;
    /**
     * The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.apps.v1beta2.DaemonSetStatus | undefined>;
    ...
    /** @deprecated apps/v1beta2/DaemonSet is deprecated by apps/v1/DaemonSet and not supported by Kubernetes v1.16+ clusters. */
    constructor(name: string, argsOrState?: DaemonSetArgs | DaemonSetState, opts?: pulumi.CustomResourceOptions) {
        pulumi.log.warn("DaemonSet is deprecated: apps/v1beta2/DaemonSet is deprecated by apps/v1/DaemonSet and not supported by Kubernetes v1.16+ clusters.")
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as DaemonSetState | undefined;
...
export interface DaemonSetArgs {
     ...
     * The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    readonly spec?: pulumi.Input<inputs.apps.v1beta2.DaemonSetSpec>;
}
