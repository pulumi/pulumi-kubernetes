...
export class Lease extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:coordination.k8s.io/v1:Lease';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.coordination.v1.LeaseSpec>;
