...
export class Lease extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.coordination.k8s.io.v1beta1.LeaseSpec | undefined>;
...
export interface LeaseArgs {
     ...
     * Specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    readonly spec?: pulumi.Input<inputs.coordination.k8s.io.v1beta1.LeaseSpec>;
}
