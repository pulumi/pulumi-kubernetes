...
export class LeaseList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.coordination.k8s.io.v1.Lease[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LeaseListArgs | LeaseListState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            inputs["apiVersion"] = (args ? args.apiVersion : undefined) || "coordination.k8s.io/v1";
...
export interface LeaseListArgs {
     ...
     * Items is a list of schema objects.
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.coordination.k8s.io.v1.Lease>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
