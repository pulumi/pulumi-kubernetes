...
export class SelfSubjectAccessReview extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.authorization.k8s.io.v1beta1.SelfSubjectAccessReviewSpec | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SelfSubjectAccessReviewArgs | SelfSubjectAccessReviewState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as SelfSubjectAccessReviewState | undefined;
            ...
            const args = argsOrState as SelfSubjectAccessReviewArgs | undefined;
...
export interface SelfSubjectAccessReviewArgs {
     ...
     * Spec holds information about the request being evaluated.  user and groups must be empty
     */
    readonly spec: pulumi.Input<inputs.authorization.k8s.io.v1beta1.SelfSubjectAccessReviewSpec>;
}
