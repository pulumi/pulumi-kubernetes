...
export class SubjectAccessReview extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.authorization.k8s.io.v1beta1.SubjectAccessReviewSpec | undefined>;
    /**
     * Status is filled in by the server and indicates whether the request is allowed or not
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.authorization.k8s.io.v1beta1.SubjectAccessReviewStatus | undefined>;
    ...
    constructor(name: string, argsOrState?: SubjectAccessReviewArgs | SubjectAccessReviewState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as SubjectAccessReviewState | undefined;
            ...
            const args = argsOrState as SubjectAccessReviewArgs | undefined;
            if (!args || args.spec === undefined) {
                throw new Error("Missing required property 'spec'");
            }
            inputs["apiVersion"] = (args ? args.apiVersion : undefined) || "authorization.k8s.io/v1beta1";
            inputs["kind"] = (args ? args.kind : undefined) || "SubjectAccessReview";
...
export interface SubjectAccessReviewArgs {
     ...
     * Spec holds information about the request being evaluated
     */
    readonly spec: pulumi.Input<inputs.authorization.k8s.io.v1beta1.SubjectAccessReviewSpec>;
}
