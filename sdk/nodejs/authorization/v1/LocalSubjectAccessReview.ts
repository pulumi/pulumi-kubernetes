...
export class LocalSubjectAccessReview extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:authorization.k8s.io/v1:LocalSubjectAccessReview';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.authorization.k8s.io.v1.SubjectAccessReviewSpec | undefined>;
    /**
...
export interface LocalSubjectAccessReviewArgs {
     ...
     * Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.
     */
    readonly spec: pulumi.Input<inputs.authorization.k8s.io.v1.SubjectAccessReviewSpec>;
}
