...
export class ServiceCIDRList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.k8s.io/v1:ServiceCIDRList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.networking.v1.ServiceCIDR[]>;
    /**
