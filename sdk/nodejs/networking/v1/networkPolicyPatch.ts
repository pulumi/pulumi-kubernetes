...
export class NetworkPolicyPatch extends pulumi.CustomResource {
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.networking.v1.NetworkPolicySpecPatch>;
    /**
     * Status is the current state of the NetworkPolicy. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.networking.v1.NetworkPolicyStatusPatch>;
