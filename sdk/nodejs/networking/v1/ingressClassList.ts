...
export class IngressClassList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.k8s.io/v1:IngressClassList';
    ...
    constructor(name: string, argsOrState?: IngressClassListArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as IngressClassListArgs | undefined;
