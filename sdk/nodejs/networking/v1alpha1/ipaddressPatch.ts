...
export class IPAddressPatch extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.networking.v1alpha1.IPAddressSpecPatch>;
    ...
    constructor(name: string, args?: IPAddressPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.k8s.io/v1beta1:IPAddressPatch" }] };
