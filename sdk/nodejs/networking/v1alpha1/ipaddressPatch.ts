...
export class IPAddressPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.k8s.io/v1alpha1:IPAddressPatch';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.networking.v1alpha1.IPAddressSpecPatch>;
