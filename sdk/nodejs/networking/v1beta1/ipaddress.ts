...
export class IPAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.k8s.io/v1beta1:IPAddress';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.networking.v1beta1.IPAddressSpec>;
...
export interface IPAddressArgs {
     ...
     * spec is the desired state of the IPAddress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    spec?: pulumi.Input<inputs.networking.v1beta1.IPAddressSpec | undefined>;
}
