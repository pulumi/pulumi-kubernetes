...
export class StorageClassList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:storage.k8s.io/v1beta1:StorageClassList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.storage.k8s.io.v1beta1.StorageClass[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: StorageClassListArgs | StorageClassListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as StorageClassListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as StorageClassListArgs | undefined;
            if (!args || args.items === undefined) {
                throw new Error("Missing required property 'items'");
            }
            inputs["apiVersion"] = (args ? args.apiVersion : undefined) || "storage.k8s.io/v1beta1";
            inputs["items"] = args ? args.items : undefined;
            inputs["kind"] = (args ? args.kind : undefined) || "StorageClassList";
...
export interface StorageClassListArgs {
     ...
     * Items is the list of StorageClasses
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.storage.k8s.io.v1beta1.StorageClass>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
