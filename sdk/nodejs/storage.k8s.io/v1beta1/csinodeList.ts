...
export class CSINodeList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:storage.k8s.io/v1beta1:CSINodeList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.storage.k8s.io.v1beta1.CSINode[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CSINodeListArgs | CSINodeListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as CSINodeListState | undefined;
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "CSINodeList";
...
export interface CSINodeListArgs {
     ...
     * items is the list of CSINode
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.storage.k8s.io.v1beta1.CSINode>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
