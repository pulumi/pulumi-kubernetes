...
export class CSIDriverList extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CSIDriverListArgs | CSIDriverListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as CSIDriverListState | undefined;
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "CSIDriverList";
