...
export class CustomResourceDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.apiextensions.v1beta1.CustomResourceDefinitionSpec | undefined>;
    /**
     * status indicates the actual state of the CustomResourceDefinition
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.apiextensions.v1beta1.CustomResourceDefinitionStatus | undefined>;
...
export interface CustomResourceDefinitionArgs {
     ...
     * spec describes how the user wants the resources to appear
     */
    readonly spec: pulumi.Input<inputs.apiextensions.v1beta1.CustomResourceDefinitionSpec>;
}
