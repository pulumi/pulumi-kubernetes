...
export class IngressList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:extensions/v1beta1:IngressList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.extensions.v1beta1.Ingress[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: IngressListArgs | IngressListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as IngressListState | undefined;
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "IngressList";
...
export interface IngressListArgs {
     ...
     * Items is the list of Ingress.
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.extensions.v1beta1.Ingress>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
