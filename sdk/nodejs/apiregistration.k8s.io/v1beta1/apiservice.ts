...
export class APIService extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.apiregistration.k8s.io.v1beta1.APIServiceSpec | undefined>;
    /**
     * Status contains derived information about an API server
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.apiregistration.k8s.io.v1beta1.APIServiceStatus | undefined>;
    ...
    constructor(name: string, argsOrState?: APIServiceArgs | APIServiceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "APIService";
...
export interface APIServiceArgs {
     ...
     * Spec contains information for locating and communicating with a server
     */
    readonly spec?: pulumi.Input<inputs.apiregistration.k8s.io.v1beta1.APIServiceSpec>;
}
