...
export class PriorityLevelConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.flowcontrol.apiserver.k8s.io.v1alpha1.PriorityLevelConfigurationSpec | undefined>;
    /**
     * `status` is the current status of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.flowcontrol.apiserver.k8s.io.v1alpha1.PriorityLevelConfigurationStatus | undefined>;
    ...
    constructor(name: string, argsOrState?: PriorityLevelConfigurationArgs | PriorityLevelConfigurationState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as PriorityLevelConfigurationState | undefined;
            ...
            const args = argsOrState as PriorityLevelConfigurationArgs | undefined;
...
export interface PriorityLevelConfigurationArgs {
     ...
     * `spec` is the specification of the desired behavior of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    readonly spec?: pulumi.Input<inputs.flowcontrol.apiserver.k8s.io.v1alpha1.PriorityLevelConfigurationSpec>;
}
