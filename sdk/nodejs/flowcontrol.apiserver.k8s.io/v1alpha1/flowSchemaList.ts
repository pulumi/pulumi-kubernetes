...
export class FlowSchemaList extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: FlowSchemaListArgs | FlowSchemaListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as FlowSchemaListState | undefined;
