...
export class CustomResourceDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.apiextensions.k8s.io.v1beta1.CustomResourceDefinitionSpec | undefined>;
    /**
     * status indicates the actual state of the CustomResourceDefinition
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.apiextensions.k8s.io.v1beta1.CustomResourceDefinitionStatus | undefined>;
    ...
    constructor(name: string, argsOrState?: CustomResourceDefinitionArgs | CustomResourceDefinitionState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as CustomResourceDefinitionState | undefined;
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "CustomResourceDefinition";
...
export interface CustomResourceDefinitionArgs {
     ...
     * spec describes how the user wants the resources to appear
     */
    readonly spec: pulumi.Input<inputs.apiextensions.k8s.io.v1beta1.CustomResourceDefinitionSpec>;
}
