...
export class EndpointSlice extends pulumi.CustomResource {
     ...
     */
    declare public readonly endpoints: pulumi.Output<outputs.discovery.v1beta1.Endpoint[]>;
    /**
     ...
     */
    declare public readonly ports: pulumi.Output<outputs.discovery.v1beta1.EndpointPort[]>;
