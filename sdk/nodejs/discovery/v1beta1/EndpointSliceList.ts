...
export class EndpointSliceList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.discovery.k8s.io.v1beta1.EndpointSlice[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EndpointSliceListArgs | EndpointSliceListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as EndpointSliceListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as EndpointSliceListArgs | undefined;
            if (!args || args.items === undefined) {
                throw new Error("Missing required property 'items'");
            }
            inputs["apiVersion"] = (args ? args.apiVersion : undefined) || "discovery.k8s.io/v1beta1";
            inputs["items"] = args ? args.items : undefined;
            inputs["kind"] = (args ? args.kind : undefined) || "EndpointSliceList";
...
export interface EndpointSliceListArgs {
     ...
     * List of endpoint slices
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.discovery.k8s.io.v1beta1.EndpointSlice>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
