...
export class EndpointSlicePatch extends pulumi.CustomResource {
     ...
     */
    declare public readonly endpoints: pulumi.Output<outputs.discovery.v1beta1.EndpointPatch[]>;
    /**
     ...
     */
    declare public readonly ports: pulumi.Output<outputs.discovery.v1beta1.EndpointPortPatch[]>;
