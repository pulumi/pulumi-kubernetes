...
export class CertificateSigningRequestList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:certificates.k8s.io/v1:CertificateSigningRequestList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.certificates.v1.CertificateSigningRequest[]>;
    /**
