...
export class CertificateSigningRequestList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.certificates.v1.CertificateSigningRequest[]>;
    /**
    ...
    constructor(name: string, argsOrState?: CertificateSigningRequestListArgs, opts?: pulumi.CustomResourceOptions) {
