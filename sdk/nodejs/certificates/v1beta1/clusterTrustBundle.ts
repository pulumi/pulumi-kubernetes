...
export class ClusterTrustBundle extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundle';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.certificates.v1beta1.ClusterTrustBundleSpec>;
    ...
    constructor(name: string, args?: ClusterTrustBundleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:certificates.k8s.io/v1:ClusterTrustBundle" }, { type: "kubernetes:certificates.k8s.io/v1alpha1:ClusterTrustBundle" }] };
