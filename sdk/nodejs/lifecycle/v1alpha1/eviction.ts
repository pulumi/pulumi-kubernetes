...
export class Eviction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:lifecycle.k8s.io/v1alpha1:Eviction';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.lifecycle.v1alpha1.EvictionSpec>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.lifecycle.v1alpha1.EvictionStatus>;
    ...
    constructor(name: string, args?: EvictionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Eviction.__pulumiType, name, resourceInputs, opts);
    }
}
