...
export class RuntimeClassPatch extends pulumi.CustomResource {
     ...
     */
    declare public readonly overhead: pulumi.Output<outputs.node.v1.OverheadPatch>;
    /**
     * scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.
     */
    declare public readonly scheduling: pulumi.Output<outputs.node.v1.SchedulingPatch>;
