...
export class RuntimeClassList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:node.k8s.io/v1beta1:RuntimeClassList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.node.v1beta1.RuntimeClass[]>;
    /**
