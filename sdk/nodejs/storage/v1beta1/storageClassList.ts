...
export class StorageClassList extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageClassList {
        return new StorageClassList(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.storage.v1beta1.StorageClass[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"StorageClassList">;
    /**
