...
export class VolumeAttachment extends pulumi.CustomResource {
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.storage.v1.VolumeAttachmentSpec>;
    /**
     * status represents status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.storage.v1.VolumeAttachmentStatus>;
