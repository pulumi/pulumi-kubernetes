...
export class VolumeAttachmentList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:storage.k8s.io/v1alpha1:VolumeAttachmentList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.storage.k8s.io.v1alpha1.VolumeAttachment[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VolumeAttachmentListArgs | VolumeAttachmentListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as VolumeAttachmentListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as VolumeAttachmentListArgs | undefined;
            if (!args || args.items === undefined) {
                throw new Error("Missing required property 'items'");
            }
            inputs["apiVersion"] = (args ? args.apiVersion : undefined) || "storage.k8s.io/v1alpha1";
            inputs["items"] = args ? args.items : undefined;
            inputs["kind"] = (args ? args.kind : undefined) || "VolumeAttachmentList";
...
export interface VolumeAttachmentListArgs {
     ...
     * Items is the list of VolumeAttachments
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.storage.k8s.io.v1alpha1.VolumeAttachment>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
