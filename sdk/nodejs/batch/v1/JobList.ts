...
export class JobList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.batch.v1.Job[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: JobListArgs | JobListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as JobListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as JobListArgs | undefined;
