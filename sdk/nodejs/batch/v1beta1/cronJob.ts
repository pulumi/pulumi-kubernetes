...
export class CronJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:batch/v1beta1:CronJob';
     ...
     */
    declare public readonly kind: pulumi.Output<"CronJob">;
    /**
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.batch.v1beta1.CronJobSpec>;
    /**
     * Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.batch.v1beta1.CronJobStatus>;
