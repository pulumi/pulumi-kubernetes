...
export class CronJobList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:batch/v2alpha1:CronJobList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.batch.v2alpha1.CronJob[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CronJobListArgs | CronJobListState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            inputs["apiVersion"] = (args ? args.apiVersion : undefined) || "batch/v2alpha1";
