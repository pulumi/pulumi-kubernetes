...
export interface ContainerResourceMetricSourcePatch {
     ...
     * target specifies the target value for the given metric
     */
    target?: pulumi.Input<inputs.autoscaling.v2.MetricTargetPatch>;
}
...
export interface ExternalMetricSourcePatch {
     ...
     * metric identifies the target metric by name and selector
     */
    metric?: pulumi.Input<inputs.autoscaling.v2.MetricIdentifierPatch>;
    /**
     * target specifies the target value for the given metric
     */
    target?: pulumi.Input<inputs.autoscaling.v2.MetricTargetPatch>;
...
export interface HPAScalingRulesPatch {
     ...
     * policies is a list of potential scaling polices which can be used during scaling. At least one policy must be specified, otherwise the HPAScalingRules will be discarded as invalid
     */
    policies?: pulumi.Input<pulumi.Input<inputs.autoscaling.v2.HPAScalingPolicyPatch>[]>;
    /**
     * selectPolicy is used to specify which policy should be used. If not set, the default value Max is used.
     */
    selectPolicy?: pulumi.Input<string>;
...
export interface HorizontalPodAutoscalerBehaviorPatch {
     ...
     * scaleDown is scaling policy for scaling Down. If not set, the default value is to allow to scale down to minReplicas pods, with a 300 second stabilization window (i.e., the highest recommendation for the last 300sec is used).
     */
    scaleDown?: pulumi.Input<inputs.autoscaling.v2.HPAScalingRulesPatch>;
    /**
     * scaleUp is scaling policy for scaling Up. If not set, the default value is the higher of:
     *   * increase no more than 4 pods per 60 seconds
     *   * double the number of pods per 60 seconds
     * No stabilization is used.
     */
    scaleUp?: pulumi.Input<inputs.autoscaling.v2.HPAScalingRulesPatch>;
}
...
export interface HorizontalPodAutoscalerSpecPatch {
     ...
     * behavior configures the scaling behavior of the target in both Up and Down directions (scaleUp and scaleDown fields respectively). If not set, the default HPAScalingRules for scale up and scale down are used.
     */
    behavior?: pulumi.Input<inputs.autoscaling.v2.HorizontalPodAutoscalerBehaviorPatch>;
    /**
     * maxReplicas is the upper limit for the number of replicas to which the autoscaler can scale up. It cannot be less that minReplicas.
     */
    maxReplicas?: pulumi.Input<number>;
     ...
     * metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used).  The desired replica count is calculated multiplying the ratio between the target value and the current value by the current number of pods.  Ergo, metrics used must decrease as the pod count is increased, and vice-versa.  See the individual metric source types for more information about how each type of metric must respond. If not set, the default metric will be set to 80% average CPU utilization.
     */
    metrics?: pulumi.Input<pulumi.Input<inputs.autoscaling.v2.MetricSpecPatch>[]>;
    /**
     * minReplicas is the lower limit for the number of replicas to which the autoscaler can scale down.  It defaults to 1 pod.  minReplicas is allowed to be 0 if the alpha feature gate HPAScaleToZero is enabled and at least one Object or External metric is configured.  Scaling is active as long as at least one metric value is available.
     */
    minReplicas?: pulumi.Input<number>;
     ...
     * scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.
     */
    scaleTargetRef?: pulumi.Input<inputs.autoscaling.v2.CrossVersionObjectReferencePatch>;
}
...
export interface MetricSpecPatch {
     ...
     * containerResource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod of the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the "pods" source. This is an alpha feature and can be enabled by the HPAContainerMetrics feature flag.
     */
    containerResource?: pulumi.Input<inputs.autoscaling.v2.ContainerResourceMetricSourcePatch>;
    /**
     * external refers to a global metric that is not associated with any Kubernetes object. It allows autoscaling based on information coming from components running outside of cluster (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster).
     */
    external?: pulumi.Input<inputs.autoscaling.v2.ExternalMetricSourcePatch>;
    /**
     * object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).
     */
    object?: pulumi.Input<inputs.autoscaling.v2.ObjectMetricSourcePatch>;
    /**
     * pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.
     */
    pods?: pulumi.Input<inputs.autoscaling.v2.PodsMetricSourcePatch>;
    /**
     * resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the "pods" source.
     */
    resource?: pulumi.Input<inputs.autoscaling.v2.ResourceMetricSourcePatch>;
    /**
     * type is the type of metric source.  It should be one of "ContainerResource", "External", "Object", "Pods" or "Resource", each mapping to a matching field in the object. Note: "ContainerResource" type is available on when the feature-gate HPAContainerMetrics is enabled
     */
    type?: pulumi.Input<string>;
...
export interface ObjectMetricSourcePatch {
     ...
     * describedObject specifies the descriptions of a object,such as kind,name apiVersion
     */
    describedObject?: pulumi.Input<inputs.autoscaling.v2.CrossVersionObjectReferencePatch>;
    /**
     * metric identifies the target metric by name and selector
     */
    metric?: pulumi.Input<inputs.autoscaling.v2.MetricIdentifierPatch>;
