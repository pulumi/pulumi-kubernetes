...
export class ClusterRoleBindingList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.rbac.authorization.k8s.io.v1.ClusterRoleBinding[] | undefined>;
    /**
...
export interface ClusterRoleBindingListArgs {
     ...
     * Items is a list of ClusterRoleBindings
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.rbac.authorization.k8s.io.v1.ClusterRoleBinding>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
