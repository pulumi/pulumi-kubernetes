...
export class ClusterRoleBinding extends pulumi.CustomResource {
     ...
     */
    public readonly roleRef!: pulumi.Output<outputs.rbac.authorization.k8s.io.v1beta1.RoleRef | undefined>;
    /**
     * Subjects holds references to the objects the role applies to.
     */
    public readonly subjects!: pulumi.Output<outputs.rbac.authorization.k8s.io.v1beta1.Subject[] | undefined>;
    ...
    constructor(name: string, argsOrState?: ClusterRoleBindingArgs | ClusterRoleBindingState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ClusterRoleBindingState | undefined;
...
export interface ClusterRoleBindingArgs {
     ...
     * RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
     */
    readonly roleRef: pulumi.Input<inputs.rbac.authorization.k8s.io.v1beta1.RoleRef>;
    /**
     * Subjects holds references to the objects the role applies to.
     */
    readonly subjects?: pulumi.Input<pulumi.Input<inputs.rbac.authorization.k8s.io.v1beta1.Subject>[]>;
}
