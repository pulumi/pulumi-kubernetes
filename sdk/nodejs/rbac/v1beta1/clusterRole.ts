...
export class ClusterRole extends pulumi.CustomResource {
     ...
     */
    declare public readonly aggregationRule: pulumi.Output<outputs.rbac.v1beta1.AggregationRule>;
    /**
     ...
     */
    declare public readonly rules: pulumi.Output<outputs.rbac.v1beta1.PolicyRule[]>;
