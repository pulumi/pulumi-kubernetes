...
export class RoleList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:rbac.authorization.k8s.io/v1beta1:RoleList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.rbac.authorization.k8s.io.v1beta1.Role[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RoleListArgs | RoleListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as RoleListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as RoleListArgs | undefined;
...
export interface RoleListArgs {
     ...
     * Items is a list of Roles
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.rbac.authorization.k8s.io.v1beta1.Role>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
