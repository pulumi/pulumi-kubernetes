...
export class PriorityClassList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.scheduling.k8s.io.v1beta1.PriorityClass[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PriorityClassListArgs | PriorityClassListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as PriorityClassListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as PriorityClassListArgs | undefined;
...
export interface PriorityClassListArgs {
     ...
     * items is the list of PriorityClasses
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.scheduling.k8s.io.v1beta1.PriorityClass>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
