...
export class PodSchedulingContextList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContextList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.resource.v1alpha3.PodSchedulingContext[]>;
    /**
