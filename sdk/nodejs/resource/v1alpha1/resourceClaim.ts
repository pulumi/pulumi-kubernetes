...
export class ResourceClaim extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1alpha1:ResourceClaim';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.resource.v1alpha1.ResourceClaimSpec>;
    /**
     * Status describes whether the resource is available and with which attributes.
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.resource.v1alpha1.ResourceClaimStatus>;
    ...
    constructor(name: string, args?: ResourceClaimArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha2:ResourceClaim" }, { type: "kubernetes:resource.k8s.io/v1alpha3:ResourceClaim" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceClaim" }] };
