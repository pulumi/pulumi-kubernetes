...
export class ResourceClaimTemplatePatch extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: ResourceClaimTemplatePatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1alpha3:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplatePatch" }] };
