...
export class ResourceClaim extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1beta2:ResourceClaim';
...
export interface ResourceClaimArgs {
     ...
     * Spec describes what is being requested and how to configure it. The spec is immutable.
     */
    spec?: pulumi.Input<inputs.resource.v1beta2.ResourceClaimSpec | undefined>;
}
