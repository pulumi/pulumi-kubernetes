...
export class ResourceClaimTemplatePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplatePatch';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.resource.v1beta2.ResourceClaimTemplateSpecPatch>;
