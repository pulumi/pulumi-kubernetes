...
export class ResourceClaimPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1beta1:ResourceClaimPatch';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.resource.v1beta1.ResourceClaimSpecPatch>;
    /**
     * Status describes whether the claim is ready to use and what has been allocated.
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.resource.v1beta1.ResourceClaimStatusPatch>;
    ...
    constructor(name: string, args?: ResourceClaimPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha1:ResourceClaimPatch" }, { type: "kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch" }, { type: "kubernetes:resource.k8s.io/v1alpha3:ResourceClaimPatch" }] };
