...
export class DeviceClass extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.resource.v1beta1.DeviceClassSpec>;
    ...
    constructor(name: string, args?: DeviceClassArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha3:DeviceClass" }] };
