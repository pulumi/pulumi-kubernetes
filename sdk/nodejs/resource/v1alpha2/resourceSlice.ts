...
export class ResourceSlice extends pulumi.CustomResource {
     ...
     */
    public readonly namedResources!: pulumi.Output<outputs.resource.v1alpha2.NamedResourcesResources>;
    /**
    ...
    constructor(name: string, args?: ResourceSliceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha3:ResourceSlice" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceSlice" }] };
