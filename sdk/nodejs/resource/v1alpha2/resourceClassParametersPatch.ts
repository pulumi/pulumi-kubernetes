 ...
 */
export class ResourceClassParametersPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceClassParametersPatch {
        return new ResourceClassParametersPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1alpha2:ResourceClassParametersPatch';
     ...
     */
    public static isInstance(obj: any): obj is ResourceClassParametersPatch {
