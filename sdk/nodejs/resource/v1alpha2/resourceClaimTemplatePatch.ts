...
export class ResourceClaimTemplatePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplatePatch';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.resource.v1alpha2.ResourceClaimTemplateSpecPatch>;
    ...
    constructor(name: string, args?: ResourceClaimTemplatePatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha1:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1alpha3:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplatePatch" }] };
