...
export class ResourceClaimTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplate';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.resource.v1alpha2.ResourceClaimTemplateSpec>;
    ...
    constructor(name: string, args?: ResourceClaimTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha1:ResourceClaimTemplate" }, { type: "kubernetes:resource.k8s.io/v1alpha3:ResourceClaimTemplate" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate" }] };
