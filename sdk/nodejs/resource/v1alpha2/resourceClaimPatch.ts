...
export class ResourceClaimPatch extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: ResourceClaimPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha1:ResourceClaimPatch" }, { type: "kubernetes:resource.k8s.io/v1alpha3:ResourceClaimPatch" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceClaimPatch" }] };
