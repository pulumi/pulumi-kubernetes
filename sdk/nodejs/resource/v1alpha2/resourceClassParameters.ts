...
export class ResourceClassParameters extends pulumi.CustomResource {
     ...
     */
    declare public readonly filters: pulumi.Output<outputs.resource.v1alpha2.ResourceFilter[]>;
    /**
     ...
     */
    declare public readonly generatedFrom: pulumi.Output<outputs.resource.v1alpha2.ResourceClassParametersReference>;
    /**
     ...
     */
    declare public readonly vendorParameters: pulumi.Output<outputs.resource.v1alpha2.VendorParameters[]>;
