...
export class ResourceClass extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1alpha2:ResourceClass';
     ...
     */
    declare public readonly parametersRef: pulumi.Output<outputs.resource.v1alpha2.ResourceClassParametersReference>;
    /**
     ...
     */
    declare public readonly structuredParameters: pulumi.Output<boolean>;
    /**
     * Only nodes matching the selector will be considered by the scheduler when trying to find a Node that fits a Pod when that Pod uses a ResourceClaim that has not been allocated yet.
     *
     * Setting this field is optional. If null, all nodes are candidates.
     */
    declare public readonly suitableNodes: pulumi.Output<outputs.core.v1.NodeSelector>;
