...
export class ResourceClaimTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1:ResourceClaimTemplate';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.resource.v1.ResourceClaimTemplateSpec>;
