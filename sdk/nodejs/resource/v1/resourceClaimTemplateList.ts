...
export class ResourceClaimTemplateList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:resource.k8s.io/v1:ResourceClaimTemplateList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.resource.v1.ResourceClaimTemplate[]>;
    /**
