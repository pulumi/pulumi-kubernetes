...
export class APIServiceList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:apiregistration.k8s.io/v1beta1:APIServiceList';
    ...
    constructor(name: string, argsOrState?: APIServiceListArgs | APIServiceListState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            inputs["apiVersion"] = (args ? args.apiVersion : undefined) || "apiregistration.k8s.io/v1beta1";
