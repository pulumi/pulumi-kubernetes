...
export class ClusterRoleBindingList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.rbac.authorization.k8s.io.v1beta1.ClusterRoleBinding[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ClusterRoleBindingListArgs | ClusterRoleBindingListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ClusterRoleBindingListState | undefined;
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "ClusterRoleBindingList";
...
export interface ClusterRoleBindingListArgs {
     ...
     * Items is a list of ClusterRoleBindings
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.rbac.authorization.k8s.io.v1beta1.ClusterRoleBinding>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
