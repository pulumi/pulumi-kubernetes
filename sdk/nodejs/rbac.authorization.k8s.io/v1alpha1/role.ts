...
export class Role extends pulumi.CustomResource {
     ...
     */
    public readonly rules!: pulumi.Output<outputs.rbac.authorization.k8s.io.v1alpha1.PolicyRule[] | undefined>;
...
export interface RoleArgs {
     ...
     * Rules holds all the PolicyRules for this Role
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputs.rbac.authorization.k8s.io.v1alpha1.PolicyRule>[]>;
}
