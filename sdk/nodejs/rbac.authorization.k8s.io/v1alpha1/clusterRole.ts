...
export class ClusterRole extends pulumi.CustomResource {
     ...
     */
    public readonly aggregationRule!: pulumi.Output<outputs.rbac.authorization.k8s.io.v1alpha1.AggregationRule | undefined>;
    /**
...
export interface ClusterRoleArgs {
     ...
     * AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.
     */
    readonly aggregationRule?: pulumi.Input<inputs.rbac.authorization.k8s.io.v1alpha1.AggregationRule>;
    /**
     * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
     */
