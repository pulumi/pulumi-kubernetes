...
export class StorageVersionMigration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:storagemigration.k8s.io/v1beta1:StorageVersionMigration';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.storagemigration.v1beta1.StorageVersionMigrationSpec>;
    /**
     * Status of the migration.
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.storagemigration.v1beta1.StorageVersionMigrationStatus>;
    ...
    constructor(name: string, args?: StorageVersionMigrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:storagemigration.k8s.io/v1:StorageVersionMigration" }, { type: "kubernetes:storagemigration.k8s.io/v1alpha1:StorageVersionMigration" }] };
