...
export class PodDisruptionBudgetList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:policy/v1beta1:PodDisruptionBudgetList';
    ...
    public readonly items!: pulumi.Output<outputs.policy.v1beta1.PodDisruptionBudget[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PodDisruptionBudgetListArgs | PodDisruptionBudgetListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as PodDisruptionBudgetListState | undefined;
