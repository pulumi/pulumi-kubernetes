...
export class HorizontalPodAutoscalerList extends pulumi.CustomResource {
     ...
     */
    public readonly items!: pulumi.Output<outputs.autoscaling.v2beta1.HorizontalPodAutoscaler[] | undefined>;
    /**
...
export interface HorizontalPodAutoscalerListArgs {
     ...
     * items is the list of horizontal pod autoscaler objects.
     */
    readonly items: pulumi.Input<pulumi.Input<inputs.autoscaling.v2beta1.HorizontalPodAutoscaler>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
