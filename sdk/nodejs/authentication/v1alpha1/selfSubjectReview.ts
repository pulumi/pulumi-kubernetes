...
export class SelfSubjectReview extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SelfSubjectReview {
        return new SelfSubjectReview(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:authentication.k8s.io/v1alpha1:SelfSubjectReview';

    /**
     * Returns true if the given object is an instance of SelfSubjectReview.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SelfSubjectReview {
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.authentication.v1alpha1.SelfSubjectReviewStatus>;
