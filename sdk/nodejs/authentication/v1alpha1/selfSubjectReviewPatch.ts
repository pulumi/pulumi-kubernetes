...
export class SelfSubjectReviewPatch extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SelfSubjectReviewPatch {
        return new SelfSubjectReviewPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:authentication.k8s.io/v1alpha1:SelfSubjectReviewPatch';

    /**
     * Returns true if the given object is an instance of SelfSubjectReviewPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SelfSubjectReviewPatch {
     ...
     */
    public readonly apiVersion!: pulumi.Output<"authentication.k8s.io/v1alpha1">;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    public readonly kind!: pulumi.Output<"SelfSubjectReview">;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.authentication.v1alpha1.SelfSubjectReviewStatusPatch>;
