...
export class SelfSubjectReviewPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:authentication.k8s.io/v1beta1:SelfSubjectReviewPatch';
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.authentication.v1beta1.SelfSubjectReviewStatusPatch>;
