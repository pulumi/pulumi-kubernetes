...
export class TokenReview extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:authentication.k8s.io/v1beta1:TokenReview';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.authentication.k8s.io.v1beta1.TokenReviewSpec | undefined>;
    /**
     * Status is filled in by the server and indicates whether the request can be authenticated.
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.authentication.k8s.io.v1beta1.TokenReviewStatus | undefined>;
...
export interface TokenReviewArgs {
     ...
     * Spec holds information about the request being evaluated
     */
    readonly spec: pulumi.Input<inputs.authentication.k8s.io.v1beta1.TokenReviewSpec>;
}
