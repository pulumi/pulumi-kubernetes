...
export class SelfSubjectReview extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:authentication.k8s.io/v1:SelfSubjectReview';
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.authentication.v1.SelfSubjectReviewStatus>;
