...
export class ComponentStatusList extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ComponentStatusListArgs | ComponentStatusListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ComponentStatusListState | undefined;
            ...
            inputs["kind"] = (args ? args.kind : undefined) || "ComponentStatusList";
