...
export class LimitRange extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LimitRange {
        return new LimitRange(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    declare public readonly kind: pulumi.Output<"LimitRange">;
    /**
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.core.v1.LimitRangeSpec>;
