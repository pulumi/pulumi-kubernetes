...
export class ReplicationControllerList extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ReplicationControllerListArgs | ReplicationControllerListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as ReplicationControllerListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as ReplicationControllerListArgs | undefined;
