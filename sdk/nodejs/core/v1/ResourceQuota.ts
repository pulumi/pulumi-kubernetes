...
export class ResourceQuota extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.core.v1.ResourceQuotaSpec | undefined>;
    /**
     * Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.core.v1.ResourceQuotaStatus | undefined>;
...
export interface ResourceQuotaArgs {
     ...
     * Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    readonly spec?: pulumi.Input<inputs.core.v1.ResourceQuotaSpec>;
}
