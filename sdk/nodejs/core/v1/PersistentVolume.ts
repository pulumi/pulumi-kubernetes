...
export class PersistentVolume extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PersistentVolumeArgs | PersistentVolumeState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as PersistentVolumeState | undefined;
            ...
            const args = argsOrState as PersistentVolumeArgs | undefined;
