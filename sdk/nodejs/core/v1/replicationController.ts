...
export class ReplicationController extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationController {
        return new ReplicationController(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    declare public readonly kind: pulumi.Output<"ReplicationController">;
    /**
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.core.v1.ReplicationControllerSpec>;
    /**
     * Status is the most recently observed status of the replication controller. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.core.v1.ReplicationControllerStatus>;
