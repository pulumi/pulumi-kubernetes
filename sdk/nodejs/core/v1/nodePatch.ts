...
export class NodePatch extends pulumi.CustomResource {
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.core.v1.NodeSpecPatch>;
    /**
     * Most recently observed status of the node. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.core.v1.NodeStatusPatch>;
