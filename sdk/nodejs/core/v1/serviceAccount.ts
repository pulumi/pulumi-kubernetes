...
export class ServiceAccount extends pulumi.CustomResource {
     ...
     */
    declare public readonly imagePullSecrets: pulumi.Output<outputs.core.v1.LocalObjectReference[]>;
    /**
     ...
     */
    declare public readonly secrets: pulumi.Output<outputs.core.v1.ObjectReference[]>;
