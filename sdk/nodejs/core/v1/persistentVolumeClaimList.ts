...
export class PersistentVolumeClaimList extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PersistentVolumeClaimList {
        return new PersistentVolumeClaimList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:core/v1:PersistentVolumeClaimList';
     ...
     */
    public static isInstance(obj: any): obj is PersistentVolumeClaimList {
     ...
     */
    declare public readonly items: pulumi.Output<outputs.core.v1.PersistentVolumeClaim[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"PersistentVolumeClaimList">;
    /**
