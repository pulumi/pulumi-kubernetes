...
export class ComponentStatus extends pulumi.CustomResource {
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.core.v1.ComponentCondition[] | undefined>;
    /**
...
export interface ComponentStatusArgs {
     ...
     * List of component conditions observed
     */
    readonly conditions?: pulumi.Input<pulumi.Input<inputs.core.v1.ComponentCondition>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
