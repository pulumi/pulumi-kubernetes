...
export class Namespace extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"Namespace">;
    /**
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.core.v1.NamespaceSpec>;
    /**
     * Status describes the current status of a Namespace. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.core.v1.NamespaceStatus>;
