...
export class PersistentVolumeList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:core/v1:PersistentVolumeList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.core.v1.PersistentVolume[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PersistentVolumeListArgs | PersistentVolumeListState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as PersistentVolumeListState | undefined;
            inputs["apiVersion"] = state ? state.apiVersion : undefined;
            inputs["items"] = state ? state.items : undefined;
            inputs["kind"] = state ? state.kind : undefined;
            inputs["metadata"] = state ? state.metadata : undefined;
        } else {
            const args = argsOrState as PersistentVolumeListArgs | undefined;
