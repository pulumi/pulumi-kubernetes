...
namespace Pulumi.Kubernetes.ApiExtensions.V1 {
    ...
    public partial class CustomResourceDefinitionList : Pulumi.CustomResource {
        ...
        public CustomResourceDefinitionList(string name, Types.Inputs.ApiExtensions.V1.CustomResourceDefinitionList? args = null, CustomResourceOptions? options = null)
        ...
        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.ApiExtensions.V1.CustomResourceDefinitionList? args) {
            if (args != null) {
