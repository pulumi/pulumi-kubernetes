...
namespace Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1
{
    ...
    public class CustomResourceDefinitionStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinitionNamesArgs> AcceptedNames { get; set; } = null!;

        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinitionConditionArgs>? _conditions;

        /// <summary>
        /// conditions indicate state for particular aspects of a CustomResourceDefinition
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinitionConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinitionConditionArgs>());
