...
namespace Pulumi.Kubernetes.Apps.V1Beta1
{
    ...
    public partial class DeploymentList : KubernetesResource
    {
        ...
        internal DeploymentList(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta1:DeploymentList", name, dictionary, options)
        {
        }

        private static ResourceArgs SetAPIKindAndVersion(Types.Inputs.Apps.V1Beta1.DeploymentListArgs? args)
        {
            args ??= new Types.Inputs.Apps.V1Beta1.DeploymentListArgs();
