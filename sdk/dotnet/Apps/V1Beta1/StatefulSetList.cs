...
namespace Pulumi.Kubernetes.Apps.V1Beta1 {
    ...
    public partial class StatefulSetList : Pulumi.CustomResource {
        ...
        public StatefulSetList(string name, Types.Inputs.Apps.V1Beta1.StatefulSetList args, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta1:StatefulSetList", name, args, MakeResourceOptions(options, ""))
        {
        }
