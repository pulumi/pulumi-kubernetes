...
namespace Pulumi.Kubernetes.Apps.V1Beta1
{
    ...
    public partial class ControllerRevisionList : KubernetesResource
    {
        ...
        internal ControllerRevisionList(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta1:ControllerRevisionList", name, dictionary, options)
        {
        }

        private static ResourceArgs SetAPIKindAndVersion(Types.Inputs.Apps.V1Beta1.ControllerRevisionListArgs? args)
        {
            args ??= new Types.Inputs.Apps.V1Beta1.ControllerRevisionListArgs();
