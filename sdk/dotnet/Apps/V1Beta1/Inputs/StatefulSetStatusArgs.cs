...
namespace Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta1
{
    ...
    public class StatefulSetStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta1.StatefulSetConditionArgs>? _conditions;

        /// <summary>
        /// Represents the latest available observations of a statefulset's current state.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta1.StatefulSetConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta1.StatefulSetConditionArgs>());
