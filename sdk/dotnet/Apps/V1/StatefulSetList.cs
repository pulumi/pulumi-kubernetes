...
namespace Pulumi.Kubernetes.Apps.V1 {
    ...
    public partial class StatefulSetList : Pulumi.CustomResource {
        ...
        public StatefulSetList(string name, Types.Inputs.Apps.V1.StatefulSetList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:StatefulSetList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Apps.V1.StatefulSetList? args) {
            if (args != null) {
