...
namespace Pulumi.Kubernetes.Apps.V1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:apps/v1:StatefulSetList")]
    public partial class StatefulSetList : KubernetesResource
    {
        ...
        public StatefulSetList(string name, Pulumi.Kubernetes.Types.Inputs.Apps.V1.StatefulSetListArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:StatefulSetList", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal StatefulSetList(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:StatefulSetList", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private StatefulSetList(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:StatefulSetList", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Apps.V1.StatefulSetListArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Apps.V1.StatefulSetListArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Apps.V1.StatefulSetListArgs();
