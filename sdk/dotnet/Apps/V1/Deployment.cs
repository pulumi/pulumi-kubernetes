...
namespace Pulumi.Kubernetes.Apps.V1 {
    ...
    public partial class Deployment : Pulumi.CustomResource {
        ...
        public Deployment(string name, Types.Inputs.Apps.V1.Deployment? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:Deployment", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Apps.V1.Deployment? args) {
            if (args != null) {
