...
namespace Pulumi.Kubernetes.Apps.V1
{
    ...
    public partial class Deployment : KubernetesResource
    {
        ...
        public Deployment(string name, Pulumi.Kubernetes.Types.Inputs.Apps.V1.DeploymentArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:Deployment", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal Deployment(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:Deployment", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Apps.V1.DeploymentArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Apps.V1.DeploymentArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Apps.V1.DeploymentArgs();
