...
namespace Pulumi.Kubernetes.Apps.V1 {
    ...
    public partial class DaemonSetList : Pulumi.CustomResource {
        ...
        public DaemonSetList(string name, Types.Inputs.Apps.V1.DaemonSetList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:DaemonSetList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Apps.V1.DaemonSetList? args) {
            if (args != null) {
