...
namespace Pulumi.Kubernetes.Apps.V1 {
    ...
    public partial class StatefulSet : Pulumi.CustomResource {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Types.Outputs.Apps.V1.StatefulSetSpec> Spec { get; private set; } = null!;
        ...
        /// </summary>
        [Output("status")]
        public Output<Types.Outputs.Apps.V1.StatefulSetStatus> Status { get; private set; } = null!;
        ...
        public StatefulSet(string name, Types.Inputs.Apps.V1.StatefulSet? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:StatefulSet", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Apps.V1.StatefulSet? args) {
            if (args != null) {
