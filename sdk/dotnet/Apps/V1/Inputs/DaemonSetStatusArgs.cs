...
namespace Pulumi.Kubernetes.Types.Inputs.Apps.V1
{
    ...
    public class DaemonSetStatusArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1.DaemonSetConditionArgs>? _conditions;

        /// <summary>
        /// Represents the latest available observations of a DaemonSet's current state.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1.DaemonSetConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1.DaemonSetConditionArgs>());
