...
namespace Pulumi.Kubernetes.Types.Inputs.Apps.V1
{
    ...
    public class StatefulSetStatusPatchArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1.StatefulSetConditionPatchArgs>? _conditions;

        /// <summary>
        /// Represents the latest available observations of a statefulset's current state.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1.StatefulSetConditionPatchArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1.StatefulSetConditionPatchArgs>());
