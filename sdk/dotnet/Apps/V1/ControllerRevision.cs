...
namespace Pulumi.Kubernetes.Apps.V1 {
    ...
    public partial class ControllerRevision : Pulumi.CustomResource {
        ...
        public ControllerRevision(string name, Types.Inputs.Apps.V1.ControllerRevision? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:ControllerRevision", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Apps.V1.ControllerRevision? args) {
            if (args != null) {
