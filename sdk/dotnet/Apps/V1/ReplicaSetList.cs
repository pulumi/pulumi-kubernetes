...
namespace Pulumi.Kubernetes.Apps.V1 {
    ...
    public partial class ReplicaSetList : Pulumi.CustomResource {
        ...
        public ReplicaSetList(string name, Types.Inputs.Apps.V1.ReplicaSetList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1:ReplicaSetList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Apps.V1.ReplicaSetList? args) {
            if (args != null) {
