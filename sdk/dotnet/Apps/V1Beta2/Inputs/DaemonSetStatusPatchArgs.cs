...
namespace Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2
{
    ...
    public class DaemonSetStatusPatchArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.DaemonSetConditionPatchArgs>? _conditions;

        /// <summary>
        /// Represents the latest available observations of a DaemonSet's current state.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.DaemonSetConditionPatchArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.DaemonSetConditionPatchArgs>());
