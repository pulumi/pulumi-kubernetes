...
namespace Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2
{
    ...
    public class DeploymentStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.DeploymentConditionArgs>? _conditions;

        /// <summary>
        /// Represents the latest available observations of a deployment's current state.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.DeploymentConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.DeploymentConditionArgs>());
