...
namespace Pulumi.Kubernetes.Apps.V1Beta2 {
    ...
    public partial class ReplicaSetList : Pulumi.CustomResource {
        ...
        public ReplicaSetList(string name, Types.Inputs.Apps.V1Beta2.ReplicaSetList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta2:ReplicaSetList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Apps.V1Beta2.ReplicaSetList? args) {
            if (args != null) {
