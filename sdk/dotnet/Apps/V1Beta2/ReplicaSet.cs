...
namespace Pulumi.Kubernetes.Apps.V1Beta2
{
    ...
    public partial class ReplicaSet : KubernetesResource
    {
        ...
        public ReplicaSet(string name, Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.ReplicaSetArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta2:ReplicaSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal ReplicaSet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta2:ReplicaSet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ReplicaSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta2:ReplicaSet", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.ReplicaSetArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.ReplicaSetArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Apps.V1Beta2.ReplicaSetArgs();
