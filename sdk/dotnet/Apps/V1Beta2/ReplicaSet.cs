...
namespace Pulumi.Kubernetes.Apps.V1Beta2 {
    ...
    public partial class ReplicaSet : Pulumi.CustomResource {
        ...
        public ReplicaSet(string name, Types.Inputs.Apps.V1Beta2.ReplicaSet? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta2:ReplicaSet", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Apps.V1Beta2.ReplicaSet? args) {
            if (args != null) {
