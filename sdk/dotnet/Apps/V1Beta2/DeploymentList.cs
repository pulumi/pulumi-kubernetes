...
namespace Pulumi.Kubernetes.Apps.V1Beta2 {
    ...
    public partial class DeploymentList : Pulumi.CustomResource {
        ...
        public DeploymentList(string name, Types.Inputs.Apps.V1Beta2.DeploymentList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta2:DeploymentList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Apps.V1Beta2.DeploymentList? args) {
            if (args != null) {
