...
namespace Pulumi.Kubernetes.Networking.V1
{
    ...
    public partial class NetworkPolicy : KubernetesResource
    {
        ...
        public NetworkPolicy(string name, Pulumi.Kubernetes.Types.Inputs.Networking.V1.NetworkPolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:networking.k8s.io/v1:NetworkPolicy", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal NetworkPolicy(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:networking.k8s.io/v1:NetworkPolicy", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private NetworkPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:networking.k8s.io/v1:NetworkPolicy", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Networking.V1.NetworkPolicyArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Networking.V1.NetworkPolicyArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Networking.V1.NetworkPolicyArgs();
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "kubernetes:extensions/v1beta1:NetworkPolicy" },
                },
            };
