...
namespace Pulumi.Kubernetes.Types.Inputs.Networking.V1
{
    ...
    /// </summary>
    public class ServiceCIDRSpecArgs : global::Pulumi.ResourceArgs
    {
        [Input("cidrs")]
        ...
        public ServiceCIDRSpecArgs()
        {
        }
        public static new ServiceCIDRSpecArgs Empty => new ServiceCIDRSpecArgs();
    }
}
