...
namespace Pulumi.Kubernetes.Networking.V1 {
    ...
    public partial class NetworkPolicyList : Pulumi.CustomResource {
        ...
        public NetworkPolicyList(string name, Types.Inputs.Networking.V1.NetworkPolicyList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:networking.k8s.io/v1:NetworkPolicyList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Networking.V1.NetworkPolicyList? args) {
            if (args != null) {
