...
namespace Pulumi.Kubernetes.Networking.V1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:networking.k8s.io/v1:IPAddress")]
    public partial class IPAddress : KubernetesResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Networking.V1.IPAddressSpec> Spec { get; private set; } = null!;
        ...
        public IPAddress(string name, Pulumi.Kubernetes.Types.Inputs.Networking.V1.IPAddressArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:networking.k8s.io/v1:IPAddress", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal IPAddress(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:networking.k8s.io/v1:IPAddress", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private IPAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:networking.k8s.io/v1:IPAddress", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Networking.V1.IPAddressArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Networking.V1.IPAddressArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Networking.V1.IPAddressArgs();
...
namespace Pulumi.Kubernetes.Types.Inputs.Networking.V1
{
    ...
    public class IPAddressArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Networking.V1.IPAddressSpecArgs> Spec { get; set; } = null!;
