...
namespace Pulumi.Kubernetes.Networking.V1Beta1 {
    ...
    public partial class IngressList : Pulumi.CustomResource {
        ...
        public IngressList(string name, Types.Inputs.Networking.V1Beta1.IngressList args, CustomResourceOptions? options = null)
            : base("kubernetes:networking.k8s.io/v1beta1:IngressList", name, args, MakeResourceOptions(options, ""))
        {
        }
