...
namespace Pulumi.Kubernetes.Storage.V1Alpha1 {
    ...
    public partial class VolumeAttachment : Pulumi.CustomResource {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Types.Outputs.Storage.V1Alpha1.VolumeAttachmentSpec> Spec { get; private set; } = null!;
        ...
        /// </summary>
        [Output("status")]
        public Output<Types.Outputs.Storage.V1Alpha1.VolumeAttachmentStatus> Status { get; private set; } = null!;
        ...
        public VolumeAttachment(string name, Types.Inputs.Storage.V1Alpha1.VolumeAttachment? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1alpha1:VolumeAttachment", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Storage.V1Alpha1.VolumeAttachment? args) {
            if (args != null) {
