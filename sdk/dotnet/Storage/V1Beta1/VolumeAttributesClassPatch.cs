...
namespace Pulumi.Kubernetes.Storage.V1Beta1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch")]
    public partial class VolumeAttributesClassPatch : KubernetesResource
    {
        ...
        public VolumeAttributesClassPatch(string name, Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.VolumeAttributesClassPatchArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal VolumeAttributesClassPatch(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VolumeAttributesClassPatch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.VolumeAttributesClassPatchArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.VolumeAttributesClassPatchArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.VolumeAttributesClassPatchArgs();
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "kubernetes:storage.k8s.io/v1alpha1:VolumeAttributesClassPatch" },
                },
            };
