...
namespace Pulumi.Kubernetes.Storage.V1Beta1 {
    ...
    public partial class VolumeAttachment : Pulumi.CustomResource {
        ...
        public VolumeAttachment(string name, Types.Inputs.Storage.V1Beta1.VolumeAttachment? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:VolumeAttachment", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Storage.V1Beta1.VolumeAttachment? args) {
            if (args != null) {
