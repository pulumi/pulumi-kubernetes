...
namespace Pulumi.Kubernetes.Storage.V1Beta1
{
    ...
    public partial class StorageClass : KubernetesResource
    {
        ...
        public StorageClass(string name, Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.StorageClassArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:StorageClass", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal StorageClass(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:StorageClass", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private StorageClass(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:StorageClass", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.StorageClassArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.StorageClassArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.StorageClassArgs();
