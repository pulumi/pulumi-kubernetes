...
namespace Pulumi.Kubernetes.Storage.V1Beta1 {
    ...
    public partial class StorageClassList : Pulumi.CustomResource {
        ...
        public StorageClassList(string name, Types.Inputs.Storage.V1Beta1.StorageClassList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:StorageClassList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Storage.V1Beta1.StorageClassList? args) {
            if (args != null) {
