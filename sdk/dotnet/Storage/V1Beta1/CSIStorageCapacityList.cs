...
namespace Pulumi.Kubernetes.Storage.V1Beta1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:storage.k8s.io/v1beta1:CSIStorageCapacityList")]
    public partial class CSIStorageCapacityList : KubernetesResource
    {
        ...
        public CSIStorageCapacityList(string name, Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.CSIStorageCapacityListArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:CSIStorageCapacityList", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal CSIStorageCapacityList(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:CSIStorageCapacityList", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private CSIStorageCapacityList(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1beta1:CSIStorageCapacityList", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.CSIStorageCapacityListArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.CSIStorageCapacityListArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.CSIStorageCapacityListArgs();
...
namespace Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1
{
    ...
    public class CSIStorageCapacityListArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _items ?? (_items = new InputList<Pulumi.Kubernetes.Types.Inputs.Storage.V1Beta1.CSIStorageCapacityArgs>());
            set => _items = value;
        }
