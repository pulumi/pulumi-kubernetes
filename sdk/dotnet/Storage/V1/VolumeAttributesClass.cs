...
namespace Pulumi.Kubernetes.Storage.V1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:storage.k8s.io/v1:VolumeAttributesClass")]
    public partial class VolumeAttributesClass : KubernetesResource
    {
        ...
        public VolumeAttributesClass(string name, Pulumi.Kubernetes.Types.Inputs.Storage.V1.VolumeAttributesClassArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1:VolumeAttributesClass", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal VolumeAttributesClass(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1:VolumeAttributesClass", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VolumeAttributesClass(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1:VolumeAttributesClass", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Storage.V1.VolumeAttributesClassArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Storage.V1.VolumeAttributesClassArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Storage.V1.VolumeAttributesClassArgs();
