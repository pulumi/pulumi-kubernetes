...
namespace Pulumi.Kubernetes.Types.Inputs.Storage.V1
{
    ...
    public class VolumeAttachmentStatusPatchArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("attachError")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Storage.V1.VolumeErrorPatchArgs>? AttachError { get; set; }
        ...
        /// </summary>
        [Input("detachError")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Storage.V1.VolumeErrorPatchArgs>? DetachError { get; set; }
