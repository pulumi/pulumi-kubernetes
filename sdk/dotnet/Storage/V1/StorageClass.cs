...
namespace Pulumi.Kubernetes.Storage.V1 {
    ...
    public partial class StorageClass : Pulumi.CustomResource {
        ...
        public StorageClass(string name, Types.Inputs.Storage.V1.StorageClass? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1:StorageClass", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Storage.V1.StorageClass? args) {
            if (args != null) {
