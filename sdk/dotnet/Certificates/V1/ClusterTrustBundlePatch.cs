...
namespace Pulumi.Kubernetes.Certificates.V1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch")]
    public partial class ClusterTrustBundlePatch : KubernetesResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Certificates.V1.ClusterTrustBundleSpecPatch> Spec { get; private set; } = null!;
        ...
        public ClusterTrustBundlePatch(string name, Pulumi.Kubernetes.Types.Inputs.Certificates.V1.ClusterTrustBundlePatchArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal ClusterTrustBundlePatch(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ClusterTrustBundlePatch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Certificates.V1.ClusterTrustBundlePatchArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Certificates.V1.ClusterTrustBundlePatchArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Certificates.V1.ClusterTrustBundlePatchArgs();
...
namespace Pulumi.Kubernetes.Types.Inputs.Certificates.V1
{
    ...
    public class ClusterTrustBundlePatchArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("spec")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Certificates.V1.ClusterTrustBundleSpecPatchArgs>? Spec { get; set; }
