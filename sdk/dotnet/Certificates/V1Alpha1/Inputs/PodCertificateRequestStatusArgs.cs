...
namespace Pulumi.Kubernetes.Types.Inputs.Certificates.V1Alpha1
{
    ...
    /// </summary>
    public class PodCertificateRequestStatusArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("beginRefreshAt")]
        public Input<string>? BeginRefreshAt { get; set; }
        ...
        public PodCertificateRequestStatusArgs()
        {
        }
        public static new PodCertificateRequestStatusArgs Empty => new PodCertificateRequestStatusArgs();
    }
}
