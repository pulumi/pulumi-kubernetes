...
namespace Pulumi.Kubernetes.Types.Inputs.Discovery.V1
{
    ...
    public class EndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("conditions")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Discovery.V1.EndpointConditionsArgs>? Conditions { get; set; }
        ...
        /// </summary>
        [Input("hints")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Discovery.V1.EndpointHintsArgs>? Hints { get; set; }
