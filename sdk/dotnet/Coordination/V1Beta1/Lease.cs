...
namespace Pulumi.Kubernetes.Coordination.V1Beta1 {
    ...
    public partial class Lease : Pulumi.CustomResource {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Types.Outputs.Coordination.V1Beta1.LeaseSpec> Spec { get; private set; } = null!;
        ...
        public Lease(string name, Types.Inputs.Coordination.V1Beta1.Lease? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:coordination.k8s.io/v1beta1:Lease", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Coordination.V1Beta1.Lease? args) {
            if (args != null) {
