...
namespace Pulumi.Kubernetes.Coordination.V1Beta1 {
    ...
    public partial class LeaseList : Pulumi.CustomResource {
        ...
        public LeaseList(string name, Types.Inputs.Coordination.V1Beta1.LeaseList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:coordination.k8s.io/v1beta1:LeaseList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Coordination.V1Beta1.LeaseList? args) {
            if (args != null) {
