...
namespace Pulumi.Kubernetes.Rbac.V1 {
    ...
    public partial class RoleBindingList : Pulumi.CustomResource {
        ...
        public RoleBindingList(string name, Types.Inputs.Rbac.V1.RoleBindingList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1:RoleBindingList", name, args, MakeResourceOptions(options, ""))
        {
        }
