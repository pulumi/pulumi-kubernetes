...
namespace Pulumi.Kubernetes.Rbac.V1 {
    ...
    public partial class ClusterRoleBinding : Pulumi.CustomResource {
        ...
        public ClusterRoleBinding(string name, Types.Inputs.Rbac.V1.ClusterRoleBinding? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBinding", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Rbac.V1.ClusterRoleBinding? args) {
            if (args != null) {
