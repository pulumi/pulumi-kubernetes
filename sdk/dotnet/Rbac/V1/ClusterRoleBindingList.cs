...
namespace Pulumi.Kubernetes.Rbac.V1 {
    ...
    public partial class ClusterRoleBindingList : Pulumi.CustomResource {
        ...
        public ClusterRoleBindingList(string name, Types.Inputs.Rbac.V1.ClusterRoleBindingList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBindingList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Rbac.V1.ClusterRoleBindingList? args) {
            if (args != null) {
