...
namespace Pulumi.Kubernetes.Rbac.V1 {
    ...
    public partial class ClusterRoleList : Pulumi.CustomResource {
        ...
        public ClusterRoleList(string name, Types.Inputs.Rbac.V1.ClusterRoleList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleList", name, args, MakeResourceOptions(options, ""))
        {
        }
