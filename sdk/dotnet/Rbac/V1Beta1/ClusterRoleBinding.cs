...
namespace Pulumi.Kubernetes.Rbac.V1Beta1 {
    ...
    public partial class ClusterRoleBinding : Pulumi.CustomResource {
        ...
        public ClusterRoleBinding(string name, Types.Inputs.Rbac.V1Beta1.ClusterRoleBinding? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleBinding", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Rbac.V1Beta1.ClusterRoleBinding? args) {
            if (args != null) {
