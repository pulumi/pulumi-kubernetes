...
namespace Pulumi.Kubernetes.Rbac.V1Beta1 {
    ...
    public partial class Role : Pulumi.CustomResource {
        ...
        public Role(string name, Types.Inputs.Rbac.V1Beta1.Role? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:Role", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Rbac.V1Beta1.Role? args) {
            if (args != null) {
