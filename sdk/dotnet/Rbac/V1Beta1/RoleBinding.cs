...
namespace Pulumi.Kubernetes.Rbac.V1Beta1 {
    ...
    public partial class RoleBinding : Pulumi.CustomResource {
        ...
        public RoleBinding(string name, Types.Inputs.Rbac.V1Beta1.RoleBinding? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBinding", name, args, MakeResourceOptions(options, ""))
        {
        }
