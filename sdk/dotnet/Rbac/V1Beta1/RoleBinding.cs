...
namespace Pulumi.Kubernetes.Rbac.V1Beta1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBinding")]
    public partial class RoleBinding : KubernetesResource
    {
        ...
        public RoleBinding(string name, Pulumi.Kubernetes.Types.Inputs.Rbac.V1Beta1.RoleBindingArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBinding", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal RoleBinding(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBinding", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private RoleBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBinding", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Rbac.V1Beta1.RoleBindingArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Rbac.V1Beta1.RoleBindingArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Rbac.V1Beta1.RoleBindingArgs();
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBinding" },
                },
            };
