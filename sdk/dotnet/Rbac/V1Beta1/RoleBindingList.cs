...
namespace Pulumi.Kubernetes.Rbac.V1Beta1 {
    ...
    public partial class RoleBindingList : Pulumi.CustomResource {
        ...
        public RoleBindingList(string name, Types.Inputs.Rbac.V1Beta1.RoleBindingList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBindingList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Rbac.V1Beta1.RoleBindingList? args) {
            if (args != null) {
