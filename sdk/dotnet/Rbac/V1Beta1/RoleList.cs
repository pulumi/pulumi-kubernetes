...
namespace Pulumi.Kubernetes.Rbac.V1Beta1 {
    ...
    public partial class RoleList : Pulumi.CustomResource {
        ...
        public RoleList(string name, Types.Inputs.Rbac.V1Beta1.RoleList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Rbac.V1Beta1.RoleList? args) {
            if (args != null) {
