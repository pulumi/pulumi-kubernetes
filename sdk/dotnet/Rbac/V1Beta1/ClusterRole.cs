...
namespace Pulumi.Kubernetes.Rbac.V1Beta1 {
    ...
    public partial class ClusterRole : Pulumi.CustomResource {
        ...
        public Output<Types.Outputs.Rbac.V1Beta1.AggregationRule> AggregationRule { get; private set; } = null!;
        ...
        public ClusterRole(string name, Types.Inputs.Rbac.V1Beta1.ClusterRole? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRole", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Rbac.V1Beta1.ClusterRole? args) {
            if (args != null) {
