...
namespace Pulumi.Kubernetes.Rbac.V1Beta1
{
    ...
    public partial class ClusterRoleBindingList : Pulumi.CustomResource
    {
        ...
        public ClusterRoleBindingList(string name, Types.Inputs.Rbac.V1Beta1.ClusterRoleBindingListArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleBindingList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options))
        {
        }

        private static ResourceArgs SetAPIKindAndVersion(Types.Inputs.Rbac.V1Beta1.ClusterRoleBindingListArgs? args)
        {
            args ??= new Types.Inputs.Rbac.V1Beta1.ClusterRoleBindingListArgs();
