...
namespace Pulumi.Kubernetes.Rbac.V1Alpha1 {
    ...
    public partial class ClusterRoleList : Pulumi.CustomResource {
        ...
        public ClusterRoleList(string name, Types.Inputs.Rbac.V1Alpha1.ClusterRoleList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleList", name, args, MakeResourceOptions(options, ""))
        {
        }
