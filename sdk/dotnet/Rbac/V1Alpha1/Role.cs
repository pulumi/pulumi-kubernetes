...
namespace Pulumi.Kubernetes.Rbac.V1Alpha1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:rbac.authorization.k8s.io/v1alpha1:Role")]
    public partial class Role : KubernetesResource
    {
        ...
        public Role(string name, Pulumi.Kubernetes.Types.Inputs.Rbac.V1Alpha1.RoleArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1alpha1:Role", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal Role(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1alpha1:Role", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1alpha1:Role", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Rbac.V1Alpha1.RoleArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Rbac.V1Alpha1.RoleArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Rbac.V1Alpha1.RoleArgs();
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "kubernetes:rbac.authorization.k8s.io/v1beta1:Role" },
                },
            };
