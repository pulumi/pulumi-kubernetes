...
namespace Pulumi.Kubernetes.Rbac.V1Alpha1 {
    ...
    public partial class RoleBinding : Pulumi.CustomResource {
        ...
        public RoleBinding(string name, Types.Inputs.Rbac.V1Alpha1.RoleBinding args, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBinding", name, args, MakeResourceOptions(options, ""))
        {
        }
