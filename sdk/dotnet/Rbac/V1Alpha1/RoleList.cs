...
namespace Pulumi.Kubernetes.Rbac.V1Alpha1 {
    ...
    public partial class RoleList : Pulumi.CustomResource {
        ...
        public RoleList(string name, Types.Inputs.Rbac.V1Alpha1.RoleList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Rbac.V1Alpha1.RoleList? args) {
            if (args != null) {
