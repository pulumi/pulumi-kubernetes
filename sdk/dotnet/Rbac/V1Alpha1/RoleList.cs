...
namespace Pulumi.Kubernetes.Rbac.V1Alpha1
{
    ...
    public partial class RoleList : KubernetesResource
    {
        ...
        internal RoleList(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleList", name, dictionary, options)
        {
        }

        private static ResourceArgs SetAPIKindAndVersion(Types.Inputs.Rbac.V1Alpha1.RoleListArgs? args)
        {
            args ??= new Types.Inputs.Rbac.V1Alpha1.RoleListArgs();
