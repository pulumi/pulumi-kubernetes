...
namespace Pulumi.Kubernetes.Rbac.V1Alpha1 {
    ...
    public partial class ClusterRole : Pulumi.CustomResource {
        ...
        public ClusterRole(string name, Types.Inputs.Rbac.V1Alpha1.ClusterRole? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRole", name, args, MakeResourceOptions(options, ""))
        {
        }
