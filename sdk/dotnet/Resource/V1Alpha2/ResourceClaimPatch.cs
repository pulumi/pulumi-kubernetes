...
namespace Pulumi.Kubernetes.Resource.V1Alpha2
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch")]
    public partial class ResourceClaimPatch : KubernetesResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Resource.V1Alpha2.ResourceClaimSpecPatch> Spec { get; private set; } = null!;

        /// <summary>
        /// Status describes whether the resource is available and with which attributes.
        /// </summary>
        [Output("status")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Resource.V1Alpha2.ResourceClaimStatusPatch> Status { get; private set; } = null!;
        ...
        public ResourceClaimPatch(string name, Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha2.ResourceClaimPatchArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal ResourceClaimPatch(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ResourceClaimPatch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha2.ResourceClaimPatchArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha2.ResourceClaimPatchArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha2.ResourceClaimPatchArgs();
