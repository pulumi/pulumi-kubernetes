...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha2
{
    ...
    public class ResourceClaimStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("allocation")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha2.AllocationResultArgs>? Allocation { get; set; }
        ...
        [Input("reservedFor")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha2.ResourceClaimConsumerReferenceArgs>? _reservedFor;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha2.ResourceClaimConsumerReferenceArgs> ReservedFor
        {
            get => _reservedFor ?? (_reservedFor = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha2.ResourceClaimConsumerReferenceArgs>());
