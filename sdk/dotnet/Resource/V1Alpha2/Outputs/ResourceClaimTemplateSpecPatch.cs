...
namespace Pulumi.Kubernetes.Types.Outputs.Resource.V1Alpha2
{
    ...
    public sealed class ResourceClaimTemplateSpecPatch
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Resource.V1Alpha2.ResourceClaimSpecPatch Spec;

        [OutputConstructor]
        private ResourceClaimTemplateSpecPatch(
            Pulumi.Kubernetes.Types.Outputs.Meta.V1.ObjectMetaPatch metadata,

            Pulumi.Kubernetes.Types.Outputs.Resource.V1Alpha2.ResourceClaimSpecPatch spec)
        {
            Metadata = metadata;
            Spec = spec;
        }
