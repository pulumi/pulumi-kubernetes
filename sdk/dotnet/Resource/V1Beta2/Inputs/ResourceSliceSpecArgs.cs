...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2
{
    ...
    public class ResourceSliceSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("devices")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceArgs>? _devices;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceArgs> Devices
        {
            get => _devices ?? (_devices = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceArgs>());
            set => _devices = value;
        }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.ResourcePoolArgs> Pool { get; set; } = null!;

        [Input("sharedCounters")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.CounterSetArgs>? _sharedCounters;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.CounterSetArgs> SharedCounters
        {
            get => _sharedCounters ?? (_sharedCounters = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.CounterSetArgs>());
