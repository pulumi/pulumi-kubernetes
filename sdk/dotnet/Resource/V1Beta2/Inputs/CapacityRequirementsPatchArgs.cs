...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2
{
    ...
    /// </summary>
    public class CapacityRequirementsPatchArgs : global::Pulumi.ResourceArgs
    {
        [Input("requests")]
        ...
        public CapacityRequirementsPatchArgs()
        {
        }
        public static new CapacityRequirementsPatchArgs Empty => new CapacityRequirementsPatchArgs();
    }
}
