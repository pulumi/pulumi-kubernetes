...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2
{
    ...
    public class DeviceRequestPatchArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("exactly")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.ExactDeviceRequestPatchArgs>? Exactly { get; set; }

        [Input("firstAvailable")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceSubRequestPatchArgs>? _firstAvailable;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceSubRequestPatchArgs> FirstAvailable
        {
            get => _firstAvailable ?? (_firstAvailable = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceSubRequestPatchArgs>());
