...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2
{
    ...
    /// </summary>
    public class NodeAllocatableResourceMappingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("allocationMultiplier")]
        public Input<string>? AllocationMultiplier { get; set; }
        ...
        public NodeAllocatableResourceMappingArgs()
        {
        }
        public static new NodeAllocatableResourceMappingArgs Empty => new NodeAllocatableResourceMappingArgs();
    }
}
