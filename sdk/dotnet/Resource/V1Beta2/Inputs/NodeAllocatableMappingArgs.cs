...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2
{
    ...
    /// </summary>
    public class NodeAllocatableMappingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capacityKey")]
        public Input<string>? CapacityKey { get; set; }
        ...
        /// </summary>
        [Input("capacityMultiplier")]
        public Input<string>? CapacityMultiplier { get; set; }
        ...
        /// </summary>
        [Input("deviceMultiplier")]
        public Input<string>? DeviceMultiplier { get; set; }

        public NodeAllocatableMappingArgs()
        {
        }
        public static new NodeAllocatableMappingArgs Empty => new NodeAllocatableMappingArgs();
    }
}
