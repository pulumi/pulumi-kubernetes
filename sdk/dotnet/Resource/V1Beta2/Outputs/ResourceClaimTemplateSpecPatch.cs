...
namespace Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta2
{
    ...
    public sealed class ResourceClaimTemplateSpecPatch
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta2.ResourceClaimSpecPatch Spec;

        [OutputConstructor]
        private ResourceClaimTemplateSpecPatch(
            Pulumi.Kubernetes.Types.Outputs.Meta.V1.ObjectMetaPatch metadata,

            Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta2.ResourceClaimSpecPatch spec)
        {
            Metadata = metadata;
            Spec = spec;
        }
