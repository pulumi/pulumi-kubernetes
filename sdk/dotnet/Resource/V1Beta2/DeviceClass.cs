...
namespace Pulumi.Kubernetes.Resource.V1Beta2
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:resource.k8s.io/v1beta2:DeviceClass")]
    public partial class DeviceClass : KubernetesResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta2.DeviceClassSpec> Spec { get; private set; } = null!;
        ...
        public DeviceClass(string name, Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceClassArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1beta2:DeviceClass", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal DeviceClass(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1beta2:DeviceClass", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DeviceClass(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1beta2:DeviceClass", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceClassArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceClassArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta2.DeviceClassArgs();
