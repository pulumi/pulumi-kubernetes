...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha3
{
    ...
    public class ResourceClaimStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("allocation")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha3.AllocationResultArgs>? Allocation { get; set; }
        ...
        {
            get => _reservedFor ?? (_reservedFor = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha3.ResourceClaimConsumerReferenceArgs>());
