...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha3
{
    ...
    {
        [Input("config")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha3.DeviceClassConfigurationArgs>? _config;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha3.DeviceClassConfigurationArgs> Config
        {
            get => _config ?? (_config = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha3.DeviceClassConfigurationArgs>());
            set => _config = value;
        }
