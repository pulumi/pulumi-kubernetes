...
namespace Pulumi.Kubernetes.Types.Outputs.Resource.V1Alpha3
{
    ...
    public sealed class ResourceClaimSpecPatch
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Resource.V1Alpha3.DeviceClaimPatch Devices;

        [OutputConstructor]
        private ResourceClaimSpecPatch(
            string controller,

            Pulumi.Kubernetes.Types.Outputs.Resource.V1Alpha3.DeviceClaimPatch devices)
        {
