...
namespace Pulumi.Kubernetes.Resource.V1
{
    ...
    public partial class DeviceClass : KubernetesResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Resource.V1.DeviceClassSpec> Spec { get; private set; } = null!;
        ...
        public DeviceClass(string name, Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceClassArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1:DeviceClass", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal DeviceClass(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1:DeviceClass", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DeviceClass(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1:DeviceClass", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceClassArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceClassArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceClassArgs();
...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1
{
    ...
    public class DeviceClassArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceClassSpecArgs> Spec { get; set; } = null!;
