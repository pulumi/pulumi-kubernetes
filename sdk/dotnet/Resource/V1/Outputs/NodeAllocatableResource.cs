...
namespace Pulumi.Kubernetes.Types.Outputs.Resource.V1
{
    ...
    public sealed class NodeAllocatableResource
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Resource.V1.NodeAllocatableMapping Mapping;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Resource.V1.NodeAllocatableOverhead Overhead;

        [OutputConstructor]
        private NodeAllocatableResource(
            Pulumi.Kubernetes.Types.Outputs.Resource.V1.NodeAllocatableMapping mapping,

            Pulumi.Kubernetes.Types.Outputs.Resource.V1.NodeAllocatableOverhead overhead)
        {
            Mapping = mapping;
            Overhead = overhead;
        }
