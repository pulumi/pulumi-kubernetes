...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1
{
    ...
    public class ExactDeviceRequestArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("capacity")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1.CapacityRequirementsArgs>? Capacity { get; set; }
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceDerivedAttributeArgs>? _derivedAttributes;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceDerivedAttributeArgs> DerivedAttributes
        {
            get => _derivedAttributes ?? (_derivedAttributes = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceDerivedAttributeArgs>());
        ...
        [Input("selectors")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceSelectorArgs>? _selectors;

        /// <summary>
        /// Selectors define criteria which must be satisfied by a specific device in order for that device to be considered for this request. All selectors must be satisfied for a device to be considered.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceSelectorArgs> Selectors
        {
            get => _selectors ?? (_selectors = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceSelectorArgs>());
