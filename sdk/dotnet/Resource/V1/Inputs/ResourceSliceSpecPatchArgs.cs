...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1
{
    ...
    public class ResourceSliceSpecPatchArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("devices")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DevicePatchArgs>? _devices;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DevicePatchArgs> Devices
        {
            get => _devices ?? (_devices = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DevicePatchArgs>());
            set => _devices = value;
        }
        ...
        /// </summary>
        [Input("pool")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1.ResourcePoolPatchArgs>? Pool { get; set; }

        [Input("sharedCounters")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.CounterSetPatchArgs>? _sharedCounters;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.CounterSetPatchArgs> SharedCounters
        {
            get => _sharedCounters ?? (_sharedCounters = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.CounterSetPatchArgs>());
