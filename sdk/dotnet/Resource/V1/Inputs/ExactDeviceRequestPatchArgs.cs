...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1
{
    ...
    /// </summary>
    public class ExactDeviceRequestPatchArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("capacity")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1.CapacityRequirementsPatchArgs>? Capacity { get; set; }
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceDerivedAttributePatchArgs>? _derivedAttributes;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceDerivedAttributePatchArgs> DerivedAttributes
        {
            get => _derivedAttributes ?? (_derivedAttributes = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceDerivedAttributePatchArgs>());
        ...
        [Input("selectors")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceSelectorPatchArgs>? _selectors;

        /// <summary>
        /// Selectors define criteria which must be satisfied by a specific device in order for that device to be considered for this request. All selectors must be satisfied for a device to be considered.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceSelectorPatchArgs> Selectors
        {
            get => _selectors ?? (_selectors = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceSelectorPatchArgs>());
            set => _selectors = value;
        }

        [Input("tolerations")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceTolerationPatchArgs>? _tolerations;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceTolerationPatchArgs> Tolerations
        {
            get => _tolerations ?? (_tolerations = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1.DeviceTolerationPatchArgs>());
            set => _tolerations = value;
        }

        public ExactDeviceRequestPatchArgs()
        {
        }
        public static new ExactDeviceRequestPatchArgs Empty => new ExactDeviceRequestPatchArgs();
    }
}
