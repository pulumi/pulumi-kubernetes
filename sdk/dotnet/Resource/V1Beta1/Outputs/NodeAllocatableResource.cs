...
namespace Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta1
{
    ...
    public sealed class NodeAllocatableResource
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta1.NodeAllocatableMapping Mapping;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta1.NodeAllocatableOverhead Overhead;

        [OutputConstructor]
        private NodeAllocatableResource(
            Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta1.NodeAllocatableMapping mapping,

            Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta1.NodeAllocatableOverhead overhead)
        {
            Mapping = mapping;
            Overhead = overhead;
        }
