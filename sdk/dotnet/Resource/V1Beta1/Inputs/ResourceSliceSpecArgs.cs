...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1
{
    ...
    public class ResourceSliceSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("devices")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1.DeviceArgs>? _devices;
        ...
        {
            get => _devices ?? (_devices = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1.DeviceArgs>());
            set => _devices = value;
        }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1.ResourcePoolArgs> Pool { get; set; } = null!;

        [Input("sharedCounters")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1.CounterSetArgs>? _sharedCounters;
        ...
        {
            get => _sharedCounters ?? (_sharedCounters = new InputList<Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1.CounterSetArgs>());
