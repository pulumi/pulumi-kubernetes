...
namespace Pulumi.Kubernetes.Resource.V1Beta1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate")]
    public partial class ResourceClaimTemplate : KubernetesResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Resource.V1Beta1.ResourceClaimTemplateSpec> Spec { get; private set; } = null!;
        ...
        public ResourceClaimTemplate(string name, Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1.ResourceClaimTemplateArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal ResourceClaimTemplate(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ResourceClaimTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1.ResourceClaimTemplateArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1.ResourceClaimTemplateArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Resource.V1Beta1.ResourceClaimTemplateArgs();
