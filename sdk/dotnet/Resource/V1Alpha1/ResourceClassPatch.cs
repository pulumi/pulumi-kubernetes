...
namespace Pulumi.Kubernetes.Resource.V1Alpha1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:resource.k8s.io/v1alpha1:ResourceClassPatch")]
    public partial class ResourceClassPatch : KubernetesResource
    {
        ...
        public Output<Pulumi.Kubernetes.Types.Outputs.Resource.V1Alpha1.ResourceClassParametersReferencePatch> ParametersRef { get; private set; } = null!;
        ...
        public ResourceClassPatch(string name, Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha1.ResourceClassPatchArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1alpha1:ResourceClassPatch", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal ResourceClassPatch(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1alpha1:ResourceClassPatch", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ResourceClassPatch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:resource.k8s.io/v1alpha1:ResourceClassPatch", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha1.ResourceClassPatchArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha1.ResourceClassPatchArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha1.ResourceClassPatchArgs();
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "kubernetes:resource.k8s.io/v1alpha2:ResourceClassPatch" },
                },
            };
...
namespace Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha1
{
    ...
    public class ResourceClassPatchArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("parametersRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Resource.V1Alpha1.ResourceClassParametersReferencePatchArgs>? ParametersRef { get; set; }
