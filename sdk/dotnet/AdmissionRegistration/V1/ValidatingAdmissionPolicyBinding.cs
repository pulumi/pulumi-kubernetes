...
namespace Pulumi.Kubernetes.AdmissionRegistration.V1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBinding")]
    public partial class ValidatingAdmissionPolicyBinding : KubernetesResource
    {
        ...
        public ValidatingAdmissionPolicyBinding(string name, Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1.ValidatingAdmissionPolicyBindingArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBinding", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal ValidatingAdmissionPolicyBinding(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBinding", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ValidatingAdmissionPolicyBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBinding", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1.ValidatingAdmissionPolicyBindingArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1.ValidatingAdmissionPolicyBindingArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1.ValidatingAdmissionPolicyBindingArgs();
