...
namespace Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1
{
    ...
    public class MutationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1.ApplyConfigurationArgs>? ApplyConfiguration { get; set; }
        ...
        /// </summary>
        [Input("jsonPatch")]
        public Input<Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1.JSONPatchArgs>? JsonPatch { get; set; }
