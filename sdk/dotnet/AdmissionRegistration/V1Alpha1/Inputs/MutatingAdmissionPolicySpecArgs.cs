...
namespace Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Alpha1
{
    ...
    public class MutatingAdmissionPolicySpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Alpha1.MatchResourcesArgs>? MatchConstraints { get; set; }

        [Input("mutations")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Alpha1.MutationArgs>? _mutations;

        /// <summary>
        /// mutations contain operations to perform on matching objects. mutations may not be empty; a minimum of one mutation is required. mutations are evaluated in order, and are reinvoked according to the reinvocationPolicy. The mutations of a policy are invoked for each binding of this policy and reinvocation of mutations occurs on a per binding basis.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Alpha1.MutationArgs> Mutations
        {
            get => _mutations ?? (_mutations = new InputList<Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Alpha1.MutationArgs>());
