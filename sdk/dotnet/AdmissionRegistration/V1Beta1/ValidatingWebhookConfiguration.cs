...
namespace Pulumi.Kubernetes.AdmissionRegistration.V1Beta1 {
    ...
    public partial class ValidatingWebhookConfiguration : Pulumi.CustomResource {
        ...
        public ValidatingWebhookConfiguration(string name, Types.Inputs.AdmissionRegistration.V1Beta1.ValidatingWebhookConfiguration? args = null, CustomResourceOptions? options = null)
        ...
        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.AdmissionRegistration.V1Beta1.ValidatingWebhookConfiguration? args) {
            if (args != null) {
