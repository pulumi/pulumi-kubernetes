...
namespace Pulumi.Kubernetes.AdmissionRegistration.V1Beta1 {
    ...
    public partial class MutatingWebhookConfigurationList : Pulumi.CustomResource {
        ...
        public MutatingWebhookConfigurationList(string name, Types.Inputs.AdmissionRegistration.V1Beta1.MutatingWebhookConfigurationList args, CustomResourceOptions? options = null)
            : base("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingWebhookConfigurationList", name, args, MakeResourceOptions(options, ""))
        {
        }
