...
namespace Pulumi.Kubernetes.AdmissionRegistration.V1Beta1 {
    ...
    public partial class MutatingWebhookConfiguration : Pulumi.CustomResource {
        ...
        public MutatingWebhookConfiguration(string name, Types.Inputs.AdmissionRegistration.V1Beta1.MutatingWebhookConfiguration? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingWebhookConfiguration", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.AdmissionRegistration.V1Beta1.MutatingWebhookConfiguration? args) {
            if (args != null) {
