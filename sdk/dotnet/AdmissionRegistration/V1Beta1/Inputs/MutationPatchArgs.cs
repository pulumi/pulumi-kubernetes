...
namespace Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Beta1
{
    ...
    public class MutationPatchArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Beta1.ApplyConfigurationPatchArgs>? ApplyConfiguration { get; set; }
        ...
        /// </summary>
        [Input("jsonPatch")]
        public Input<Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Beta1.JSONPatchPatchArgs>? JsonPatch { get; set; }
