...
namespace Pulumi.Kubernetes.Meta.V1
{
    ...
    public partial class Status : KubernetesResource
    {
        ...
        public Status(string name, Pulumi.Kubernetes.Types.Inputs.Meta.V1.StatusArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:meta/v1:Status", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal Status(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:meta/v1:Status", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Status(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:meta/v1:Status", name, null, MakeResourceOptions(options, id))
        {
        }
