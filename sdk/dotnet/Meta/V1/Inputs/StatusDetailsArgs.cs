...
namespace Pulumi.Kubernetes.Types.Inputs.Meta.V1
{
    ...
    public class StatusDetailsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Meta.V1.StatusCauseArgs> Causes
        {
            get => _causes ?? (_causes = new InputList<Pulumi.Kubernetes.Types.Inputs.Meta.V1.StatusCauseArgs>());
            set => _causes = value;
        }
