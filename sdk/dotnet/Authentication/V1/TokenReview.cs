...
namespace Pulumi.Kubernetes.Authentication.V1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:authentication.k8s.io/v1:TokenReview")]
    public partial class TokenReview : KubernetesResource
    {
        ...
        public TokenReview(string name, Pulumi.Kubernetes.Types.Inputs.Authentication.V1.TokenReviewArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:authentication.k8s.io/v1:TokenReview", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal TokenReview(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:authentication.k8s.io/v1:TokenReview", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private TokenReview(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:authentication.k8s.io/v1:TokenReview", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Authentication.V1.TokenReviewArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Authentication.V1.TokenReviewArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Authentication.V1.TokenReviewArgs();
...
namespace Pulumi.Kubernetes.Types.Inputs.Authentication.V1
{
    ...
    public class TokenReviewArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Authentication.V1.TokenReviewSpecArgs> Spec { get; set; } = null!;
