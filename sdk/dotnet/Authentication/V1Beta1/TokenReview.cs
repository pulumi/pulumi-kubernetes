...
namespace Pulumi.Kubernetes.Authentication.V1Beta1 {
    ...
    public partial class TokenReview : Pulumi.CustomResource {
        ...
        public TokenReview(string name, Types.Inputs.Authentication.V1Beta1.TokenReview? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:authentication.k8s.io/v1beta1:TokenReview", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Authentication.V1Beta1.TokenReview? args) {
            if (args != null) {
