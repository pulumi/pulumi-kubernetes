...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1
{
    ...
    /// </summary>
    public class WorkloadReferenceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("podGroup", required: true)]
        public Input<string> PodGroup { get; set; } = null!;
        ...
        /// </summary>
        [Input("podGroupReplicaKey")]
        public Input<string>? PodGroupReplicaKey { get; set; }

        public WorkloadReferenceArgs()
        {
        }
        public static new WorkloadReferenceArgs Empty => new WorkloadReferenceArgs();
    }
}
