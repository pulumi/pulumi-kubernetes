...
namespace Pulumi.Kubernetes.Core.V1
{
    ...
    public partial class Pod : KubernetesResource
    {
        ...
        public Pod(string name, Pulumi.Kubernetes.Types.Inputs.Core.V1.PodArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:Pod", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal Pod(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:Pod", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Pod(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:Pod", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Core.V1.PodArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Core.V1.PodArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Core.V1.PodArgs();
            args.ApiVersion = "v1";
            args.Kind = "Pod";
            return args;
        }
