...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class Binding : Pulumi.CustomResource {
        ...
        public Binding(string name, Types.Inputs.Core.V1.Binding? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:Binding", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.Binding? args) {
            if (args != null) {
                args.ApiVersion = "v1";
                args.Kind = "Binding";
            }
        ...
        {
            return new Binding(name, null, CustomResourceOptions.Merge(options, new CustomResourceOptions
            {
                Id = id,
            }));
        }
