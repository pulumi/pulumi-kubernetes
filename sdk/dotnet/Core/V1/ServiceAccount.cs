...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class ServiceAccount : Pulumi.CustomResource {
        ...
        public ServiceAccount(string name, Types.Inputs.Core.V1.ServiceAccount? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:ServiceAccount", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.ServiceAccount? args) {
            if (args != null) {
                args.ApiVersion = "v1";
