...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class PodList : Pulumi.CustomResource {
        ...
        public PodList(string name, Types.Inputs.Core.V1.PodList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:PodList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.PodList? args) {
            if (args != null) {
                args.ApiVersion = "v1";
                args.Kind = "PodList";
            }
