...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class ResourceQuota : Pulumi.CustomResource {
        ...
        public ResourceQuota(string name, Types.Inputs.Core.V1.ResourceQuota args, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:ResourceQuota", name, args, MakeResourceOptions(options, ""))
        {
        }
