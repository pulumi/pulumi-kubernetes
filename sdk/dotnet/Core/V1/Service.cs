...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class Service : Pulumi.CustomResource {
        ...
        public Service(string name, Types.Inputs.Core.V1.Service? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:Service", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.Service? args) {
            if (args != null) {
                args.ApiVersion = "v1";
                args.Kind = "Service";
            }
