...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class PersistentVolumeClaim : Pulumi.CustomResource {
        ...
        public PersistentVolumeClaim(string name, Types.Inputs.Core.V1.PersistentVolumeClaim? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:PersistentVolumeClaim", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.PersistentVolumeClaim? args) {
            if (args != null) {
                args.ApiVersion = "v1";
