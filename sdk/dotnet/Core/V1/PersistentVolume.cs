...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class PersistentVolume : Pulumi.CustomResource {
        ...
        public PersistentVolume(string name, Types.Inputs.Core.V1.PersistentVolume? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:PersistentVolume", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.PersistentVolume? args) {
            if (args != null) {
                args.ApiVersion = "v1";
