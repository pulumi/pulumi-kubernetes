...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    /// </summary>
    public partial class ServiceList : Pulumi.CustomResource {
        /// <summary>
        ...
        public ServiceList(string name, Types.Inputs.Core.V1.ServiceList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:ServiceList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.ServiceList? args) {
            if (args != null) {
                args.ApiVersion = "v1";
        ...
        {
            return new ServiceList(name, null, CustomResourceOptions.Merge(options, new CustomResourceOptions
            {
                Id = id,
            }));
        }
