...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class EventList : Pulumi.CustomResource {
        ...
        public EventList(string name, Types.Inputs.Core.V1.EventList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:EventList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.EventList? args) {
            if (args != null) {
                args.ApiVersion = "v1";
                args.Kind = "EventList";
            }
