...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class NamespaceList : Pulumi.CustomResource {
        ...
        public NamespaceList(string name, Types.Inputs.Core.V1.NamespaceList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:NamespaceList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.NamespaceList? args) {
            if (args != null) {
                args.ApiVersion = "v1";
