...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class ServiceAccountList : Pulumi.CustomResource {
        ...
        public ServiceAccountList(string name, Types.Inputs.Core.V1.ServiceAccountList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:ServiceAccountList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.ServiceAccountList? args) {
            if (args != null) {
                args.ApiVersion = "v1";
        ...
        {
            return new ServiceAccountList(name, null, CustomResourceOptions.Merge(options, new CustomResourceOptions
            {
                Id = id,
            }));
        }
