...
namespace Pulumi.Kubernetes.Core.V1
{
    ...
    public partial class ComponentStatusList : KubernetesResource
    {
        ...
        /// </summary>
        [Output("items")]
        public Output<ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Core.V1.ComponentStatus>> Items { get; private set; } = null!;
        ...
        private ComponentStatusList(string name, Input<string> id, CustomResourceOptions? options = null)
...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1
{
    ...
    public class ComponentStatusListArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.ComponentStatusArgs>? _items;

        /// <summary>
        /// List of ComponentStatus objects.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.ComponentStatusArgs> Items
        {
            get => _items ?? (_items = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.ComponentStatusArgs>());
            set => _items = value;
        }
