...
namespace Pulumi.Kubernetes.Core.V1 {
    ...
    public partial class ComponentStatusList : Pulumi.CustomResource {
        ...
        public ComponentStatusList(string name, Types.Inputs.Core.V1.ComponentStatusList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:ComponentStatusList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Core.V1.ComponentStatusList? args) {
            if (args != null) {
                args.ApiVersion = "v1";
