...
namespace Pulumi.Kubernetes.Core.V1
{
    ...
    public partial class ComponentStatus : KubernetesResource
    {
        ...
        /// </summary>
        [Output("conditions")]
        public Output<ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Core.V1.ComponentCondition>> Conditions { get; private set; } = null!;
        ...
        internal ComponentStatus(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:core/v1:ComponentStatus", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ComponentStatus(string name, Input<string> id, CustomResourceOptions? options = null)
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ComponentStatus Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
...
namespace Pulumi.Kubernetes.Types.Inputs.Core.V1
{
    ...
    public class ComponentStatusArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.ComponentConditionArgs>? _conditions;

        /// <summary>
        /// List of component conditions observed
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.ComponentConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Core.V1.ComponentConditionArgs>());
