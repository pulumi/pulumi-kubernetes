...
namespace Pulumi.Kubernetes.Settings.V1Alpha1
{
    ...
    public partial class PodPreset : KubernetesResource
    {
        ...
        public PodPreset(string name, Pulumi.Kubernetes.Types.Inputs.Settings.V1Alpha1.PodPresetArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:settings.k8s.io/v1alpha1:PodPreset", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal PodPreset(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:settings.k8s.io/v1alpha1:PodPreset", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private PodPreset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:settings.k8s.io/v1alpha1:PodPreset", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Settings.V1Alpha1.PodPresetArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Settings.V1Alpha1.PodPresetArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Settings.V1Alpha1.PodPresetArgs();
