...
namespace Pulumi.Kubernetes.Batch.V1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:batch/v1:CronJob")]
    public partial class CronJob : KubernetesResource
    {
        ...
        public CronJob(string name, Pulumi.Kubernetes.Types.Inputs.Batch.V1.CronJobArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:batch/v1:CronJob", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal CronJob(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:batch/v1:CronJob", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private CronJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:batch/v1:CronJob", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Batch.V1.CronJobArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Batch.V1.CronJobArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Batch.V1.CronJobArgs();
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "kubernetes:batch/v2alpha1:CronJob" },
                },
            };
