...
namespace Pulumi.Kubernetes.Types.Outputs.Batch.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class SuccessPolicyPatch
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Batch.V1.SuccessPolicyRulePatch> Rules;

        [OutputConstructor]
        private SuccessPolicyPatch(ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Batch.V1.SuccessPolicyRulePatch> rules)
        {
            Rules = rules;
        }
    }
