...
namespace Pulumi.Kubernetes.Types.Inputs.Batch.V1
{
    ...
    /// </summary>
    public class JobSchedulingConfigurationPatchArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.WorkloadPodGroupDisruptionModePatchArgs>? DisruptionMode { get; set; }

        [Input("resourceClaims")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.WorkloadPodGroupResourceClaimPatchArgs>? _resourceClaims;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.WorkloadPodGroupResourceClaimPatchArgs> ResourceClaims
        {
            get => _resourceClaims ?? (_resourceClaims = new InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.WorkloadPodGroupResourceClaimPatchArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.WorkloadPodGroupSchedulingConstraintsPatchArgs>? SchedulingConstraints { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.WorkloadPodGroupSchedulingPolicyPatchArgs>? SchedulingPolicy { get; set; }

        public JobSchedulingConfigurationPatchArgs()
        {
        }
        public static new JobSchedulingConfigurationPatchArgs Empty => new JobSchedulingConfigurationPatchArgs();
    }
}
