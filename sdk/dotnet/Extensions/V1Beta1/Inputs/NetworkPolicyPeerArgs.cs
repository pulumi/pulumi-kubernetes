...
namespace Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1
{
    ...
    public class NetworkPolicyPeerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ipBlock")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.IPBlockArgs>? IpBlock { get; set; }
        ...
        /// </summary>
        [Input("podSelector")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Meta.V1.LabelSelectorArgs>? PodSelector { get; set; }
