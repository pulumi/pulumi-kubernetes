...
namespace Pulumi.Kubernetes.Extensions.V1Beta1 {
    ...
    public partial class ReplicaSet : Pulumi.CustomResource {
        ...
        public ReplicaSet(string name, Types.Inputs.Extensions.V1Beta1.ReplicaSet? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:extensions/v1beta1:ReplicaSet", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Extensions.V1Beta1.ReplicaSet? args) {
            if (args != null) {
