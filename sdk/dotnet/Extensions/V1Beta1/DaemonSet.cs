...
namespace Pulumi.Kubernetes.Extensions.V1Beta1
{
    ...
    public partial class DaemonSet : KubernetesResource
    {
        ...
        public DaemonSet(string name, Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.DaemonSetArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:extensions/v1beta1:DaemonSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal DaemonSet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:extensions/v1beta1:DaemonSet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DaemonSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:extensions/v1beta1:DaemonSet", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.DaemonSetArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.DaemonSetArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.DaemonSetArgs();
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "kubernetes:apps/v1beta2:DaemonSet" },
                },
            };
