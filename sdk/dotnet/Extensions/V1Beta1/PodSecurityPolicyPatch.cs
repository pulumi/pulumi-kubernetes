...
namespace Pulumi.Kubernetes.Extensions.V1Beta1
{
    ...
    public partial class PodSecurityPolicyPatch : KubernetesResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Kubernetes.Types.Outputs.Extensions.V1Beta1.PodSecurityPolicySpecPatch> Spec { get; private set; } = null!;
...
namespace Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1
{
    ...
    public class PodSecurityPolicyPatchArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("spec")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.PodSecurityPolicySpecPatchArgs>? Spec { get; set; }
