...
namespace Pulumi.Kubernetes.Extensions.V1Beta1 {
    ...
    public partial class DaemonSetList : Pulumi.CustomResource {
        ...
        public DaemonSetList(string name, Types.Inputs.Extensions.V1Beta1.DaemonSetList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:extensions/v1beta1:DaemonSetList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Extensions.V1Beta1.DaemonSetList? args) {
            if (args != null) {
