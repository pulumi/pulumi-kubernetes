...
namespace Pulumi.Kubernetes.Extensions.V1Beta1
{
    ...
    public partial class Deployment : KubernetesResource
    {
        ...
        public Deployment(string name, Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.DeploymentArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:extensions/v1beta1:Deployment", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal Deployment(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:extensions/v1beta1:Deployment", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:extensions/v1beta1:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.DeploymentArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.DeploymentArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Extensions.V1Beta1.DeploymentArgs();
