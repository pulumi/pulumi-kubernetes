...
namespace Pulumi.Kubernetes.ApiExtensions.V1Beta1 {
    ...
    public partial class CustomResourceDefinition : Pulumi.CustomResource {
        ...
        public CustomResourceDefinition(string name, Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinition args, CustomResourceOptions? options = null)
            : base("kubernetes:apiextensions.k8s.io/v1beta1:CustomResourceDefinition", name, args, MakeResourceOptions(options, ""))
        {
        }
