...
namespace Pulumi.Kubernetes.Scheduling.V1 {
    ...
    public partial class PriorityClassList : Pulumi.CustomResource {
        ...
        public PriorityClassList(string name, Types.Inputs.Scheduling.V1.PriorityClassList args, CustomResourceOptions? options = null)
            : base("kubernetes:scheduling.k8s.io/v1:PriorityClassList", name, args, MakeResourceOptions(options, ""))
        {
        }
