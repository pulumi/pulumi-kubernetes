...
namespace Pulumi.Kubernetes.Apps.V1Beta1 {
    ...
    public partial class Deployment : Pulumi.CustomResource {
        ...
        public Deployment(string name, Types.Inputs.Apps.V1Beta1.Deployment args, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta1:Deployment", name, args, MakeResourceOptions(options, ""))
        {
        }
