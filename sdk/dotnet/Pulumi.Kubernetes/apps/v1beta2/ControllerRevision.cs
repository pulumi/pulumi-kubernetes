...
namespace Pulumi.Kubernetes.Apps.V1Beta2 {
    ...
    public partial class ControllerRevision : Pulumi.CustomResource {
        ...
        public ControllerRevision(string name, Types.Inputs.Apps.V1Beta2.ControllerRevision args, CustomResourceOptions? options = null)
            : base("kubernetes:apps/v1beta2:ControllerRevision", name, args, MakeResourceOptions(options, ""))
        {
        }
