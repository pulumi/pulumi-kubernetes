...
namespace Pulumi.Kubernetes.Authorization.V1 {
    ...
    public partial class SelfSubjectRulesReview : Pulumi.CustomResource {
        ...
        public SelfSubjectRulesReview(string name, Types.Inputs.Authorization.V1.SelfSubjectRulesReview args, CustomResourceOptions? options = null)
            : base("kubernetes:authorization.k8s.io/v1:SelfSubjectRulesReview", name, args, MakeResourceOptions(options, ""))
        {
        }
