...
namespace Pulumi.Kubernetes.Coordination.V1 {
    ...
    public partial class LeaseList : Pulumi.CustomResource {
        ...
        public LeaseList(string name, Types.Inputs.Coordination.V1.LeaseList args, CustomResourceOptions? options = null)
            : base("kubernetes:coordination.k8s.io/v1:LeaseList", name, args, MakeResourceOptions(options, ""))
        {
        }
