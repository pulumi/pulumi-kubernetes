...
namespace Pulumi.Kubernetes.Storage.V1 {
    ...
    public partial class VolumeAttachment : Pulumi.CustomResource {
        ...
        public VolumeAttachment(string name, Types.Inputs.Storage.V1.VolumeAttachment args, CustomResourceOptions? options = null)
            : base("kubernetes:storage.k8s.io/v1:VolumeAttachment", name, args, MakeResourceOptions(options, ""))
        {
        }
