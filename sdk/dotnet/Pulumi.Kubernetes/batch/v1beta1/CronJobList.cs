...
namespace Pulumi.Kubernetes.Batch.V1Beta1 {
    ...
    public partial class CronJobList : Pulumi.CustomResource {
        ...
        public CronJobList(string name, Types.Inputs.Batch.V1Beta1.CronJobList args, CustomResourceOptions? options = null)
            : base("kubernetes:batch/v1beta1:CronJobList", name, args, MakeResourceOptions(options, ""))
        {
        }
