...
namespace Pulumi.Kubernetes.Rbac.V1Alpha1 {
    ...
    public partial class ClusterRoleBinding : Pulumi.CustomResource {
        ...
        public ClusterRoleBinding(string name, Types.Inputs.Rbac.V1Alpha1.ClusterRoleBinding args, CustomResourceOptions? options = null)
            : base("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBinding", name, args, MakeResourceOptions(options, ""))
        {
        }
