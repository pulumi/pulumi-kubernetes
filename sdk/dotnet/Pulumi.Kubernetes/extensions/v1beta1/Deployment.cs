...
namespace Pulumi.Kubernetes.Extensions.V1Beta1 {
    ...
    public partial class Deployment : Pulumi.CustomResource {
        ...
        public Deployment(string name, Types.Inputs.Extensions.V1Beta1.Deployment args, CustomResourceOptions? options = null)
            : base("kubernetes:extensions/v1beta1:Deployment", name, args, MakeResourceOptions(options, ""))
        {
        }
