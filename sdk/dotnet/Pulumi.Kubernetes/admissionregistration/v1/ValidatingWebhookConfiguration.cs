...
namespace Pulumi.Kubernetes.AdmissionRegistration.V1 {
    ...
    public partial class ValidatingWebhookConfiguration : Pulumi.CustomResource {
        ...
        public ValidatingWebhookConfiguration(string name, Types.Inputs.AdmissionRegistration.V1.ValidatingWebhookConfiguration args, CustomResourceOptions? options = null)
            : base("kubernetes:admissionregistration.k8s.io/v1:ValidatingWebhookConfiguration", name, args, MakeResourceOptions(options, ""))
        {
        }
