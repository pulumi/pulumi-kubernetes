...
namespace Pulumi.Kubernetes.Autoscaling.V1 {
    ...
    public partial class HorizontalPodAutoscaler : Pulumi.CustomResource {
        ...
        public HorizontalPodAutoscaler(string name, Types.Inputs.Autoscaling.V1.HorizontalPodAutoscaler args, CustomResourceOptions? options = null)
            : base("kubernetes:autoscaling/v1:HorizontalPodAutoscaler", name, args, MakeResourceOptions(options, ""))
        {
        }
