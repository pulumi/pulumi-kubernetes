...
namespace Pulumi.Kubernetes.Events.V1Beta1 {
    ...
    public partial class EventList : Pulumi.CustomResource {
        ...
        public EventList(string name, Types.Inputs.Events.V1Beta1.EventList args, CustomResourceOptions? options = null)
            : base("kubernetes:events.k8s.io/v1beta1:EventList", name, args, MakeResourceOptions(options, ""))
        {
        }
