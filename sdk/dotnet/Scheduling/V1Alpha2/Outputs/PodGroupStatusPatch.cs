...
namespace Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha2
{
    ...
    public sealed class PodGroupStatusPatch
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha2.PodGroupResourceClaimStatusPatch> ResourceClaimStatuses;

        [OutputConstructor]
        private PodGroupStatusPatch(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Meta.V1.ConditionPatch> conditions,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha2.PodGroupResourceClaimStatusPatch> resourceClaimStatuses)
        {
