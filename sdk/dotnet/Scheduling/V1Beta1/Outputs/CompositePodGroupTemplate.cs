...
namespace Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1
{
    ...
    public sealed class CompositePodGroupTemplate
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.CompositePodGroupTemplate> CompositePodGroupTemplates;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.CompositeDisruptionMode DisruptionMode;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.PodGroupTemplate> PodGroupTemplates;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.CompositePodGroupSchedulingConstraints SchedulingConstraints;
        /// <summary>
        /// schedulingPolicy defines the scheduling policy for this template.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.CompositePodGroupSchedulingPolicy SchedulingPolicy;

        [OutputConstructor]
        private CompositePodGroupTemplate(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.CompositePodGroupTemplate> compositePodGroupTemplates,

            Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.CompositeDisruptionMode disruptionMode,

            string name,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.PodGroupTemplate> podGroupTemplates,
            ...
            Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.CompositePodGroupSchedulingConstraints schedulingConstraints,

            Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.CompositePodGroupSchedulingPolicy schedulingPolicy)
        {
