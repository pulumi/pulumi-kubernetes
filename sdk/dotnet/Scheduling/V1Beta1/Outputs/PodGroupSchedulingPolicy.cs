...
namespace Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1
{
    ...
    public sealed class PodGroupSchedulingPolicy
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.BasicSchedulingPolicy Basic;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.GangSchedulingPolicy Gang;

        [OutputConstructor]
        private PodGroupSchedulingPolicy(
            Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.BasicSchedulingPolicy basic,

            Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Beta1.GangSchedulingPolicy gang)
        {
            Basic = basic;
            Gang = gang;
        }
