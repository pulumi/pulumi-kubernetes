...
namespace Pulumi.Kubernetes.Scheduling.V1Beta1 {
    ...
    public partial class PriorityClassList : Pulumi.CustomResource {
        ...
        public PriorityClassList(string name, Types.Inputs.Scheduling.V1Beta1.PriorityClassList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:scheduling.k8s.io/v1beta1:PriorityClassList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Scheduling.V1Beta1.PriorityClassList? args) {
            if (args != null) {
