...
namespace Pulumi.Kubernetes.Scheduling.V1Beta1 {
    ...
    public partial class PriorityClass : Pulumi.CustomResource {
        ...
        public PriorityClass(string name, Types.Inputs.Scheduling.V1Beta1.PriorityClass? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:scheduling.k8s.io/v1beta1:PriorityClass", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Scheduling.V1Beta1.PriorityClass? args) {
            if (args != null) {
