...
namespace Pulumi.Kubernetes.Scheduling.V1Alpha1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:scheduling.k8s.io/v1alpha1:PriorityClass")]
    public partial class PriorityClass : KubernetesResource
    {
        ...
        public PriorityClass(string name, Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha1.PriorityClassArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:scheduling.k8s.io/v1alpha1:PriorityClass", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal PriorityClass(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:scheduling.k8s.io/v1alpha1:PriorityClass", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private PriorityClass(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:scheduling.k8s.io/v1alpha1:PriorityClass", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha1.PriorityClassArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha1.PriorityClassArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha1.PriorityClassArgs();
