...
namespace Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3
{
    ...
    /// </summary>
    [OutputType]
    public sealed class CompositePodGroupStatus
    {
        /// <summary>
        ...
        [OutputConstructor]
        private CompositePodGroupStatus(ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Meta.V1.Condition> conditions)
        {
