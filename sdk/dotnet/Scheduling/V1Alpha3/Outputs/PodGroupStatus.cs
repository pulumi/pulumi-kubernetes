...
namespace Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3
{
    ...
    public sealed class PodGroupStatus
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.PodGroupResourceClaimStatus> ResourceClaimStatuses;

        [OutputConstructor]
        private PodGroupStatus(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Meta.V1.Condition> conditions,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.PodGroupResourceClaimStatus> resourceClaimStatuses)
        {
