...
namespace Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3
{
    ...
    public sealed class PodGroupSchedulingPolicy
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.BasicSchedulingPolicy Basic;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.GangSchedulingPolicy Gang;

        [OutputConstructor]
        private PodGroupSchedulingPolicy(
            Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.BasicSchedulingPolicy basic,

            Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.GangSchedulingPolicy gang)
        {
            Basic = basic;
            Gang = gang;
        }
