...
namespace Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3
{
    ...
    /// </summary>
    [OutputType]
    public sealed class CompositePodGroupStatusPatch
    {
        /// <summary>
        ...
        [OutputConstructor]
        private CompositePodGroupStatusPatch(ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Meta.V1.ConditionPatch> conditions)
        {
