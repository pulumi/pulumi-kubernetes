...
namespace Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3
{
    ...
    public sealed class PodGroupSchedulingPolicyPatch
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.BasicSchedulingPolicyPatch Basic;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.GangSchedulingPolicyPatch Gang;

        [OutputConstructor]
        private PodGroupSchedulingPolicyPatch(
            Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.BasicSchedulingPolicyPatch basic,

            Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.GangSchedulingPolicyPatch gang)
        {
            Basic = basic;
            Gang = gang;
        }
