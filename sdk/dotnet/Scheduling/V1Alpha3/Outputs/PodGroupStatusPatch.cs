...
namespace Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3
{
    ...
    public sealed class PodGroupStatusPatch
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.PodGroupResourceClaimStatusPatch> ResourceClaimStatuses;

        [OutputConstructor]
        private PodGroupStatusPatch(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Meta.V1.ConditionPatch> conditions,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Scheduling.V1Alpha3.PodGroupResourceClaimStatusPatch> resourceClaimStatuses)
        {
