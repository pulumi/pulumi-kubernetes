...
namespace Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3
{
    ...
    /// </summary>
    public class CompositePodGroupTemplateArgs : global::Pulumi.ResourceArgs
    {
        [Input("compositePodGroupTemplates")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.CompositePodGroupTemplateArgs>? _compositePodGroupTemplates;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.CompositePodGroupTemplateArgs> CompositePodGroupTemplates
        {
            get => _compositePodGroupTemplates ?? (_compositePodGroupTemplates = new InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.CompositePodGroupTemplateArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.CompositeDisruptionModeArgs>? DisruptionMode { get; set; }
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupTemplateArgs>? _podGroupTemplates;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupTemplateArgs> PodGroupTemplates
        {
            get => _podGroupTemplates ?? (_podGroupTemplates = new InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupTemplateArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.CompositePodGroupSchedulingConstraintsArgs>? SchedulingConstraints { get; set; }

        /// <summary>
        /// schedulingPolicy defines the scheduling policy for this template.
        /// </summary>
        [Input("schedulingPolicy", required: true)]
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.CompositePodGroupSchedulingPolicyArgs> SchedulingPolicy { get; set; } = null!;

        public CompositePodGroupTemplateArgs()
        {
        }
        public static new CompositePodGroupTemplateArgs Empty => new CompositePodGroupTemplateArgs();
    }
}
