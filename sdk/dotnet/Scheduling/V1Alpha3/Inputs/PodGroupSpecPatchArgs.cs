...
namespace Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3
{
    ...
    /// </summary>
    public class PodGroupSpecPatchArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.DisruptionModePatchArgs>? DisruptionMode { get; set; }
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupResourceClaimPatchArgs>? _resourceClaims;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupResourceClaimPatchArgs> ResourceClaims
        {
            get => _resourceClaims ?? (_resourceClaims = new InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupResourceClaimPatchArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupSchedulingConstraintsPatchArgs>? SchedulingConstraints { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupSchedulingPolicyPatchArgs>? SchedulingPolicy { get; set; }
        ...
        public PodGroupSpecPatchArgs()
        {
        }
        public static new PodGroupSpecPatchArgs Empty => new PodGroupSpecPatchArgs();
    }
}
