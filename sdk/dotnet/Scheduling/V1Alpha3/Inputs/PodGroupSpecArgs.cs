...
namespace Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3
{
    ...
    public class PodGroupSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.DisruptionModeArgs>? DisruptionMode { get; set; }
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupResourceClaimArgs>? _resourceClaims;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupResourceClaimArgs> ResourceClaims
        {
            get => _resourceClaims ?? (_resourceClaims = new InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupResourceClaimArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupSchedulingConstraintsArgs>? SchedulingConstraints { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupSchedulingPolicyArgs> SchedulingPolicy { get; set; } = null!;
        ...
        /// </summary>
        [Input("workloadRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.WorkloadReferenceArgs>? WorkloadRef { get; set; }
