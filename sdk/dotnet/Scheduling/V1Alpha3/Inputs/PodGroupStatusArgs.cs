...
namespace Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3
{
    ...
    public class PodGroupStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupResourceClaimStatusArgs>? _resourceClaimStatuses;

        /// <summary>
        /// resourceClaimStatuses is status of resource claims.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupResourceClaimStatusArgs> ResourceClaimStatuses
        {
            get => _resourceClaimStatuses ?? (_resourceClaimStatuses = new InputList<Pulumi.Kubernetes.Types.Inputs.Scheduling.V1Alpha3.PodGroupResourceClaimStatusArgs>());
