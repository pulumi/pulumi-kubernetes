...
namespace Pulumi.Kubernetes.Authorization.V1 {
    ...
    public partial class LocalSubjectAccessReview : Pulumi.CustomResource {
        ...
        public LocalSubjectAccessReview(string name, Types.Inputs.Authorization.V1.LocalSubjectAccessReview? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:authorization.k8s.io/v1:LocalSubjectAccessReview", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Authorization.V1.LocalSubjectAccessReview? args) {
            if (args != null) {
