...
namespace Pulumi.Kubernetes.Authorization.V1 {
    ...
    public partial class SubjectAccessReview : Pulumi.CustomResource {
        ...
        public SubjectAccessReview(string name, Types.Inputs.Authorization.V1.SubjectAccessReview? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:authorization.k8s.io/v1:SubjectAccessReview", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Authorization.V1.SubjectAccessReview? args) {
            if (args != null) {
