...
namespace Pulumi.Kubernetes.Authorization.V1Beta1
{
    ...
    public partial class SubjectAccessReview : KubernetesResource
    {
        ...
        internal SubjectAccessReview(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:authorization.k8s.io/v1beta1:SubjectAccessReview", name, dictionary, options)
        {
        }

        private static ResourceArgs SetAPIKindAndVersion(Types.Inputs.Authorization.V1Beta1.SubjectAccessReviewArgs? args)
        {
            args ??= new Types.Inputs.Authorization.V1Beta1.SubjectAccessReviewArgs();
