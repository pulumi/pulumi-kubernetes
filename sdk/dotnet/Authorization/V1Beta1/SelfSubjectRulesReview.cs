...
namespace Pulumi.Kubernetes.Authorization.V1Beta1 {
    ...
    public partial class SelfSubjectRulesReview : Pulumi.CustomResource {
        ...
        public SelfSubjectRulesReview(string name, Types.Inputs.Authorization.V1Beta1.SelfSubjectRulesReview? args = null, CustomResourceOptions? options = null)
        ...
        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Authorization.V1Beta1.SelfSubjectRulesReview? args) {
            if (args != null) {
