...
namespace Pulumi.Kubernetes.Authorization.V1Beta1
{
    ...
    public partial class LocalSubjectAccessReview : Pulumi.CustomResource
    {
        ...
        private static ResourceArgs SetAPIKindAndVersion(Types.Inputs.Authorization.V1Beta1.LocalSubjectAccessReviewArgs? args)
        {
            args ??= new Types.Inputs.Authorization.V1Beta1.LocalSubjectAccessReviewArgs();
