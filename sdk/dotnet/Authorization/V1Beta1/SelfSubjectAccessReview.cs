...
namespace Pulumi.Kubernetes.Authorization.V1Beta1
{
    ...
    public partial class SelfSubjectAccessReview : KubernetesResource
    {
        ...
        private static ResourceArgs SetAPIKindAndVersion(Types.Inputs.Authorization.V1Beta1.SelfSubjectAccessReviewArgs? args)
        {
            args ??= new Types.Inputs.Authorization.V1Beta1.SelfSubjectAccessReviewArgs();
