...
namespace Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class EvictionStatus
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1.Requester> Requesters;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1.ResponderStatus> Responders;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1.TargetResponder> TargetResponders;
        ...
        private EvictionStatus(
            ...
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1.Requester> requesters,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1.ResponderStatus> responders,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1.TargetResponder> targetResponders)
        {
