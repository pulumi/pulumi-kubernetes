...
namespace Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class EvictionRequestSpecPatch
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1.EvictionRequestTargetPatch Target;
        ...
        private EvictionRequestSpecPatch(
            ...
            Pulumi.Kubernetes.Types.Outputs.Lifecycle.V1Alpha1.EvictionRequestTargetPatch target)
        {
            Intent = intent;
            Requester = requester;
            Target = target;
