...
namespace Pulumi.Kubernetes.Types.Inputs.Lifecycle.V1Alpha1
{
    ...
    /// </summary>
    public class EvictionRequestSpecArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("requester", required: true)]
        public Input<string> Requester { get; set; } = null!;

        /// <summary>
        /// target contains a reference to an object (e.g. a pod) that should be evicted. This field is required and immutable.
        /// </summary>
        [Input("target", required: true)]
        public Input<Pulumi.Kubernetes.Types.Inputs.Lifecycle.V1Alpha1.EvictionRequestTargetArgs> Target { get; set; } = null!;

        public EvictionRequestSpecArgs()
        {
        }
        public static new EvictionRequestSpecArgs Empty => new EvictionRequestSpecArgs();
    }
}
