...
namespace Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Beta3
{
    ...
    public class PriorityLevelConfigurationSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("exempt")]
        public Input<Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Beta3.ExemptPriorityLevelConfigurationArgs>? Exempt { get; set; }

        /// <summary>
        /// `limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `"Limited"`.
        /// </summary>
        [Input("limited")]
        public Input<Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Beta3.LimitedPriorityLevelConfigurationArgs>? Limited { get; set; }
