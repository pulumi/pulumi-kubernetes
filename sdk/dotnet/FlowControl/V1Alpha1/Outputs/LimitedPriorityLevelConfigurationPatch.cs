...
namespace Pulumi.Kubernetes.Types.Outputs.FlowControl.V1Alpha1
{
    ...
    public sealed class LimitedPriorityLevelConfigurationPatch
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.FlowControl.V1Alpha1.LimitResponsePatch LimitResponse;

        [OutputConstructor]
        private LimitedPriorityLevelConfigurationPatch(
            int assuredConcurrencyShares,

            Pulumi.Kubernetes.Types.Outputs.FlowControl.V1Alpha1.LimitResponsePatch limitResponse)
        {
