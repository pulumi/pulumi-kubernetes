...
namespace Pulumi.Kubernetes.FlowControl.V1Alpha1
{
    ...
    public partial class FlowSchema : KubernetesResource
    {
        ...
        public FlowSchema(string name, Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Alpha1.FlowSchemaArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:FlowSchema", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal FlowSchema(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:FlowSchema", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private FlowSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:FlowSchema", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Alpha1.FlowSchemaArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Alpha1.FlowSchemaArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.FlowControl.V1Alpha1.FlowSchemaArgs();
