...
namespace Pulumi.Kubernetes.ApiRegistration.V1
{
    ...
    public partial class APIService : KubernetesResource
    {
        ...
        public APIService(string name, Pulumi.Kubernetes.Types.Inputs.ApiRegistration.V1.APIServiceArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apiregistration.k8s.io/v1:APIService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal APIService(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:apiregistration.k8s.io/v1:APIService", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private APIService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:apiregistration.k8s.io/v1:APIService", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.ApiRegistration.V1.APIServiceArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.ApiRegistration.V1.APIServiceArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.ApiRegistration.V1.APIServiceArgs();
