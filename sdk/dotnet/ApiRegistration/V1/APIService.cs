...
namespace Pulumi.Kubernetes.ApiRegistration.V1 {
    ...
    public partial class APIService : Pulumi.CustomResource {
        ...
        public APIService(string name, Types.Inputs.ApiRegistration.V1.APIService? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apiregistration/v1:APIService", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.ApiRegistration.V1.APIService? args) {
            if (args != null) {
