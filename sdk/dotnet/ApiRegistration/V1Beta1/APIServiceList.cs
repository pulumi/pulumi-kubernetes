...
namespace Pulumi.Kubernetes.ApiRegistration.V1Beta1 {
    ...
    public partial class APIServiceList : Pulumi.CustomResource {
        ...
        public APIServiceList(string name, Types.Inputs.ApiRegistration.V1Beta1.APIServiceList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apiregistration/v1beta1:APIServiceList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.ApiRegistration.V1Beta1.APIServiceList? args) {
            if (args != null) {
