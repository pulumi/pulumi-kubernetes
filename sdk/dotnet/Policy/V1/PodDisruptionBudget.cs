...
namespace Pulumi.Kubernetes.Policy.V1
{
    ...
    /// </summary>
    [KubernetesResourceType("kubernetes:policy/v1:PodDisruptionBudget")]
    public partial class PodDisruptionBudget : KubernetesResource
    {
        ...
        public PodDisruptionBudget(string name, Pulumi.Kubernetes.Types.Inputs.Policy.V1.PodDisruptionBudgetArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:policy/v1:PodDisruptionBudget", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal PodDisruptionBudget(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:policy/v1:PodDisruptionBudget", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private PodDisruptionBudget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:policy/v1:PodDisruptionBudget", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Policy.V1.PodDisruptionBudgetArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Policy.V1.PodDisruptionBudgetArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Policy.V1.PodDisruptionBudgetArgs();
...
namespace Pulumi.Kubernetes.Types.Inputs.Policy.V1
{
    ...
    public class PodDisruptionBudgetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        /// </summary>
        ...
        public static new PodDisruptionBudgetArgs Empty => new PodDisruptionBudgetArgs();
    }
}
