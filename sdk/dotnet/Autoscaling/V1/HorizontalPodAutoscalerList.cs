...
namespace Pulumi.Kubernetes.Autoscaling.V1
{
    ...
    public partial class HorizontalPodAutoscalerList : KubernetesResource
    {
        ...
        public HorizontalPodAutoscalerList(string name, Pulumi.Kubernetes.Types.Inputs.Autoscaling.V1.HorizontalPodAutoscalerListArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:autoscaling/v1:HorizontalPodAutoscalerList", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal HorizontalPodAutoscalerList(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:autoscaling/v1:HorizontalPodAutoscalerList", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private HorizontalPodAutoscalerList(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:autoscaling/v1:HorizontalPodAutoscalerList", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Autoscaling.V1.HorizontalPodAutoscalerListArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Autoscaling.V1.HorizontalPodAutoscalerListArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Autoscaling.V1.HorizontalPodAutoscalerListArgs();
...
namespace Pulumi.Kubernetes.Types.Inputs.Autoscaling.V1
{
    ...
    public class HorizontalPodAutoscalerListArgs : Pulumi.ResourceArgs
    {
        ...
        {
            get => _items ?? (_items = new InputList<Pulumi.Kubernetes.Types.Inputs.Autoscaling.V1.HorizontalPodAutoscalerArgs>());
            set => _items = value;
        }
