...
namespace Pulumi.Kubernetes.Types.Inputs.Autoscaling.V2
{
    ...
    public class MetricSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("external")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Autoscaling.V2.ExternalMetricSourceArgs>? External { get; set; }

        /// <summary>
        /// object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).
        /// </summary>
        [Input("object")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Autoscaling.V2.ObjectMetricSourceArgs>? Object { get; set; }

        /// <summary>
        /// pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.
        /// </summary>
        [Input("pods")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Autoscaling.V2.PodsMetricSourceArgs>? Pods { get; set; }
