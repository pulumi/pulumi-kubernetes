...
namespace Pulumi.Kubernetes.Autoscaling.V2Beta1 {
    ...
    public partial class HorizontalPodAutoscaler : Pulumi.CustomResource {
        ...
        public HorizontalPodAutoscaler(string name, Types.Inputs.Autoscaling.V2Beta1.HorizontalPodAutoscaler? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:autoscaling/v2beta1:HorizontalPodAutoscaler", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Autoscaling.V2Beta1.HorizontalPodAutoscaler? args) {
            if (args != null) {
