...
namespace Pulumi.Kubernetes.Types.Inputs.Autoscaling.V2Beta1
{
    ...
    public class MetricStatusArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("external")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Autoscaling.V2Beta1.ExternalMetricStatusArgs>? External { get; set; }

        /// <summary>
        /// object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).
        /// </summary>
        [Input("object")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Autoscaling.V2Beta1.ObjectMetricStatusArgs>? Object { get; set; }

        /// <summary>
        /// pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.
        /// </summary>
        [Input("pods")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Autoscaling.V2Beta1.PodsMetricStatusArgs>? Pods { get; set; }
