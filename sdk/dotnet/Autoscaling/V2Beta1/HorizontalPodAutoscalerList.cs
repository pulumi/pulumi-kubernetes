...
namespace Pulumi.Kubernetes.Autoscaling.V2Beta1 {
    ...
    public partial class HorizontalPodAutoscalerList : Pulumi.CustomResource {
        ...
        public HorizontalPodAutoscalerList(string name, Types.Inputs.Autoscaling.V2Beta1.HorizontalPodAutoscalerList? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:autoscaling/v2beta1:HorizontalPodAutoscalerList", name, SetAPIKindAndVersion(args), MakeResourceOptions(options, ""))
        {
        }

        private static ResourceArgs? SetAPIKindAndVersion(Types.Inputs.Autoscaling.V2Beta1.HorizontalPodAutoscalerList? args) {
            if (args != null) {
