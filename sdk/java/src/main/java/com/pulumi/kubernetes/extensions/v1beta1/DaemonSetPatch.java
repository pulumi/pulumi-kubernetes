...
import com.pulumi.kubernetes.extensions.v1beta1.DaemonSetPatchArgs;
import com.pulumi.kubernetes.extensions.v1beta1.outputs.DaemonSetSpecPatch;
import com.pulumi.kubernetes.extensions.v1beta1.outputs.DaemonSetStatusPatch;
...
@ResourceType(type="kubernetes:extensions/v1beta1:DaemonSetPatch")
public class DaemonSetPatch extends com.pulumi.resources.CustomResource {
    ...
    public DaemonSetPatch(java.lang.String name, @Nullable DaemonSetPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DaemonSetPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DaemonSetPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DaemonSetPatch", name, null, makeResourceOptions(options, id), false);
    }
