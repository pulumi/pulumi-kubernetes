...
import com.pulumi.kubernetes.networking.v1alpha1.inputs.ClusterCIDRSpecPatchArgs;
...
public final class ClusterCIDRPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterCIDRPatchArgs Empty = new ClusterCIDRPatchArgs();
    ...
    private ClusterCIDRPatchArgs() {}

    private ClusterCIDRPatchArgs(ClusterCIDRPatchArgs $) {
    ...
    public static Builder builder(ClusterCIDRPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterCIDRPatchArgs();
        }

        public Builder(ClusterCIDRPatchArgs defaults) {
            $ = new ClusterCIDRPatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(@Nullable Output<ClusterCIDRSpecPatchArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(ClusterCIDRSpecPatchArgs spec) {
            return spec(Output.of(spec));
        }

        public ClusterCIDRPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("networking.k8s.io/v1alpha1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("ClusterCIDR").getNullable();
            return $;
        }
    }
