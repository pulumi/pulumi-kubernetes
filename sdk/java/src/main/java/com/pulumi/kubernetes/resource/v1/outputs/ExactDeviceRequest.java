...
import com.pulumi.kubernetes.resource.v1.outputs.CapacityRequirements;
import com.pulumi.kubernetes.resource.v1.outputs.DeviceDerivedAttribute;
import com.pulumi.kubernetes.resource.v1.outputs.DeviceSelector;
...
@CustomType
public final class ExactDeviceRequest {
    /**
    ...
    public static Builder builder(ExactDeviceRequest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<DeviceToleration> tolerations;
        public Builder() {}
        public Builder(ExactDeviceRequest defaults) {
        ...
        public Builder deviceClassName(String deviceClassName) {
            if (deviceClassName == null) {
              throw new MissingRequiredPropertyException("ExactDeviceRequest", "deviceClassName");
            }
        ...
        public ExactDeviceRequest build() {
            final var _resultValue = new ExactDeviceRequest();
