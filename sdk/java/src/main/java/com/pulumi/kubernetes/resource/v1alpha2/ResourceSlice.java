...
public class ResourceSlice extends com.pulumi.resources.CustomResource {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:resource.k8s.io/v1:ResourceSlice").build()),
                ...
                Output.of(Alias.builder().type("kubernetes:resource.k8s.io/v1beta2:ResourceSlice").build())
            ))
            .build();
