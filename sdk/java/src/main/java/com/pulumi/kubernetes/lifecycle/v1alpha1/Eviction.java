...
import com.pulumi.kubernetes.lifecycle.v1alpha1.EvictionArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes:lifecycle.k8s.io/v1alpha1:Eviction")
public class Eviction extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="spec", refs={EvictionSpec.class}, tree="[0]")
    private Output<EvictionSpec> spec;
     ...
     * 
     */
    public Output<EvictionSpec> spec() {
        return this.spec;
    }
    /**
     ...
     * 
     */
    @Export(name="status", refs={EvictionStatus.class}, tree="[0]")
    private Output</* @Nullable */ EvictionStatus> status;
     ...
     * 
     */
    public Output<Optional<EvictionStatus>> status() {
     ...
     */
    public Eviction(java.lang.String name) {
        this(name, EvictionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Eviction(java.lang.String name, EvictionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Eviction(java.lang.String name, EvictionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:lifecycle.k8s.io/v1alpha1:Eviction", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Eviction(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:lifecycle.k8s.io/v1alpha1:Eviction", name, null, makeResourceOptions(options, id), false);
    }

    private static EvictionArgs makeArgs(EvictionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        var builder = args == null ? EvictionArgs.builder() : EvictionArgs.builder(args);
        return builder
     ...
     */
    public static Eviction get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
