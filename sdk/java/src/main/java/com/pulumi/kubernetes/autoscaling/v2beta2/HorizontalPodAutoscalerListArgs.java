...
import com.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerArgs;
...
public final class HorizontalPodAutoscalerListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public HorizontalPodAutoscalerListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("HorizontalPodAutoscalerListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("HorizontalPodAutoscalerList").getNullable();
            return $;
        }
    }
