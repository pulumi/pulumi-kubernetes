...
public class CronJob extends com.pulumi.resources.CustomResource {
    ...
    public CronJob(java.lang.String name, @Nullable CronJobArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v1beta1:CronJob", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CronJob(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v1beta1:CronJob", name, null, makeResourceOptions(options, id), false);
    }
