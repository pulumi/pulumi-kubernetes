...
public final class PodPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final PodPatchArgs Empty = new PodPatchArgs();
    ...
    private PodPatchArgs() {}

    private PodPatchArgs(PodPatchArgs $) {
    ...
    public static Builder builder(PodPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PodPatchArgs defaults) {
            $ = new PodPatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PodPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("v1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("Pod").getNullable();
            return $;
        }
    }
