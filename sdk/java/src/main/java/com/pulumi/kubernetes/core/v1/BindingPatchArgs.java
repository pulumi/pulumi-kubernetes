...
public final class BindingPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final BindingPatchArgs Empty = new BindingPatchArgs();
     ...
     */
    @Import(name="target")
    private @Nullable Output<ObjectReferencePatchArgs> target;

    /**
     * @return The target object that you want to bind to the standard object.
     * 
     */
    public Optional<Output<ObjectReferencePatchArgs>> target() {
        return Optional.ofNullable(this.target);
    }

    private BindingPatchArgs() {}

    private BindingPatchArgs(BindingPatchArgs $) {
    ...
    public static Builder builder(BindingPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BindingPatchArgs();
        }

        public Builder(BindingPatchArgs defaults) {
            $ = new BindingPatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder target(@Nullable Output<ObjectReferencePatchArgs> target) {
            $.target = target;
            return this;
        }
         ...
         * 
         */
        public Builder target(ObjectReferencePatchArgs target) {
            return target(Output.of(target));
        }

        public BindingPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("v1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("Binding").getNullable();
            return $;
        }
    }
