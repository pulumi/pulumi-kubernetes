...
@CustomType
public final class FlockerVolumeSourcePatch {
    /**
    ...
    private FlockerVolumeSourcePatch() {}
    /**
     * @return datasetName is Name of the dataset stored as metadata -&gt; name on the dataset for Flocker should be considered as deprecated
     * 
     */
    ...
    public static Builder builder(FlockerVolumeSourcePatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String datasetUUID;
        public Builder() {}
        public Builder(FlockerVolumeSourcePatch defaults) {
        ...
        public FlockerVolumeSourcePatch build() {
            final var _resultValue = new FlockerVolumeSourcePatch();
