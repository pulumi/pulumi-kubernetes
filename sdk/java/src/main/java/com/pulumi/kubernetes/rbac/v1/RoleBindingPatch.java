...
public class RoleBindingPatch extends com.pulumi.resources.CustomResource {
    ...
    public RoleBindingPatch(String name, RoleBindingPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:RoleBindingPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private RoleBindingPatch(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:RoleBindingPatch", name, null, makeResourceOptions(options, id));
    }
