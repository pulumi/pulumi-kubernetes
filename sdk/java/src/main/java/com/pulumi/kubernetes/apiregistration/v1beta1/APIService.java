...
public class APIService extends com.pulumi.resources.CustomResource {
    ...
    public APIService(java.lang.String name, @Nullable APIServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apiregistration.k8s.io/v1beta1:APIService", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private APIService(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apiregistration.k8s.io/v1beta1:APIService", name, null, makeResourceOptions(options, id), false);
    }
