...
import com.pulumi.kubernetes.resource.v1alpha1.outputs.ResourceClaimSchedulingStatus;
...
public final class PodSchedulingStatus {
    ...
    public static Builder builder(PodSchedulingStatus defaults) {
    ...
    public static final class Builder {
        private @Nullable List<ResourceClaimSchedulingStatus> resourceClaims;
        public Builder() {}
        public Builder(PodSchedulingStatus defaults) {
