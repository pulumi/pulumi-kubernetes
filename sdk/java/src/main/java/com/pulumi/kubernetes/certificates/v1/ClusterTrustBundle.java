...
import com.pulumi.kubernetes.certificates.v1.ClusterTrustBundleArgs;
import com.pulumi.kubernetes.certificates.v1.outputs.ClusterTrustBundleSpec;
 ...
 * 
 */
@ResourceType(type="kubernetes:certificates.k8s.io/v1:ClusterTrustBundle")
public class ClusterTrustBundle extends com.pulumi.resources.CustomResource {
    ...
    public ClusterTrustBundle(java.lang.String name, ClusterTrustBundleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1:ClusterTrustBundle", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClusterTrustBundle(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1:ClusterTrustBundle", name, null, makeResourceOptions(options, id), false);
    }
