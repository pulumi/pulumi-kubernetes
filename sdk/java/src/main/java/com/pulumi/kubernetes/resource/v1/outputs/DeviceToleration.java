...
@CustomType
public final class DeviceToleration {
    /**
    ...
    public static Builder builder(DeviceToleration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(DeviceToleration defaults) {
        ...
        public DeviceToleration build() {
            final var _resultValue = new DeviceToleration();
