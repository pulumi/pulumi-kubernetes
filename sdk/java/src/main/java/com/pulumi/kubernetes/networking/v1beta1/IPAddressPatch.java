...
public class IPAddressPatch extends com.pulumi.resources.CustomResource {
    ...
    public IPAddressPatch(java.lang.String name, @Nullable IPAddressPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1beta1:IPAddressPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IPAddressPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1beta1:IPAddressPatch", name, null, makeResourceOptions(options, id), false);
    }
