...
public class LimitRange extends com.pulumi.resources.CustomResource {
     ...
     */
    public LimitRange(java.lang.String name) {
     ...
     */
    public LimitRange(java.lang.String name, @Nullable LimitRangeArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LimitRange(java.lang.String name, @Nullable LimitRangeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:LimitRange", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LimitRange(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:LimitRange", name, null, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LimitRange get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
