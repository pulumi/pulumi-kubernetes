...
@CustomType
public final class ImageVolumeSource {
    /**
    ...
    public static Builder builder(ImageVolumeSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String reference;
        public Builder() {}
        public Builder(ImageVolumeSource defaults) {
        ...
        public ImageVolumeSource build() {
            final var _resultValue = new ImageVolumeSource();
