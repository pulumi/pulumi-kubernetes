...
@CustomType
public final class StatefulSetConditionPatch {
    /**
    ...
    private StatefulSetConditionPatch() {}
    /**
     * @return Last time the condition transitioned from one status to another.
     * 
     */
    ...
    public static Builder builder(StatefulSetConditionPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(StatefulSetConditionPatch defaults) {
