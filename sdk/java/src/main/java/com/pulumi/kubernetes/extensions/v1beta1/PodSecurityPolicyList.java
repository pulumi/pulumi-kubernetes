...
public class PodSecurityPolicyList extends com.pulumi.resources.CustomResource {
    ...
    public PodSecurityPolicyList(java.lang.String name, PodSecurityPolicyListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:PodSecurityPolicyList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PodSecurityPolicyList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:PodSecurityPolicyList", name, null, makeResourceOptions(options, id), false);
    }
