...
import com.pulumi.kubernetes.scheduling.v1alpha1.inputs.WorkloadSpecArgs;
...
public final class WorkloadArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<WorkloadSpecArgs> spec;

    /**
     * @return Spec defines the desired behavior of a Workload.
     * 
     */
    public Output<WorkloadSpecArgs> spec() {
        return this.spec;
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder spec(Output<WorkloadSpecArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(WorkloadSpecArgs spec) {
        ...
        public WorkloadArgs build() {
            ...
            if ($.spec == null) {
                throw new MissingRequiredPropertyException("WorkloadArgs", "spec");
            }
            return $;
        }
    }
