...
import com.pulumi.kubernetes.autoscaling.v2.inputs.HorizontalPodAutoscalerSpecPatchArgs;
...
public final class HorizontalPodAutoscalerPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public HorizontalPodAutoscalerPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("autoscaling/v2").getNullable();
