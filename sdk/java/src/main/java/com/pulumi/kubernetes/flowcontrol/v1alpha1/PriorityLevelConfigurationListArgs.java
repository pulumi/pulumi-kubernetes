...
import com.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.PriorityLevelConfigurationArgs;
...
public final class PriorityLevelConfigurationListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PriorityLevelConfigurationListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("PriorityLevelConfigurationListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("PriorityLevelConfigurationList").getNullable();
            return $;
        }
    }
