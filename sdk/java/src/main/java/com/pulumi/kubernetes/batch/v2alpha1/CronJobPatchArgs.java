...
import com.pulumi.kubernetes.batch.v2alpha1.inputs.CronJobSpecPatchArgs;
...
public final class CronJobPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final CronJobPatchArgs Empty = new CronJobPatchArgs();
     ...
     */
    @Import(name="spec")
    private @Nullable Output<CronJobSpecPatchArgs> spec;
     ...
     * 
     */
    public Optional<Output<CronJobSpecPatchArgs>> spec() {
        return Optional.ofNullable(this.spec);
    }

    private CronJobPatchArgs() {}

    private CronJobPatchArgs(CronJobPatchArgs $) {
    ...
    public static Builder builder(CronJobPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CronJobPatchArgs();
        }

        public Builder(CronJobPatchArgs defaults) {
            $ = new CronJobPatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(@Nullable Output<CronJobSpecPatchArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(CronJobSpecPatchArgs spec) {
            return spec(Output.of(spec));
        }

        public CronJobPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("batch/v2alpha1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("CronJob").getNullable();
            return $;
        }
    }
