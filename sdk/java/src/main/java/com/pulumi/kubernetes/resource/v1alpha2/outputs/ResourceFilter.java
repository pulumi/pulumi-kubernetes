...
import com.pulumi.kubernetes.resource.v1alpha2.outputs.NamedResourcesFilter;
...
public final class ResourceFilter {
     ...
     * 
     */
    private @Nullable NamedResourcesFilter namedResources;
    ...
    public static Builder builder(ResourceFilter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable NamedResourcesFilter namedResources;
        public Builder() {}
        public Builder(ResourceFilter defaults) {
        ...
        @CustomType.Setter
        public Builder namedResources(@Nullable NamedResourcesFilter namedResources) {

            this.namedResources = namedResources;
            return this;
        }
        public ResourceFilter build() {
            final var _resultValue = new ResourceFilter();
