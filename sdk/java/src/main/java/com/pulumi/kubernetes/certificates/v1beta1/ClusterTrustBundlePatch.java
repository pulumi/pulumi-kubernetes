...
import com.pulumi.kubernetes.certificates.v1beta1.ClusterTrustBundlePatchArgs;
import com.pulumi.kubernetes.certificates.v1beta1.outputs.ClusterTrustBundleSpecPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundlePatch")
public class ClusterTrustBundlePatch extends com.pulumi.resources.CustomResource {
    ...
    public ClusterTrustBundlePatch(java.lang.String name, @Nullable ClusterTrustBundlePatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundlePatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClusterTrustBundlePatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundlePatch", name, null, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch").build()),
                Output.of(Alias.builder().type("kubernetes:certificates.k8s.io/v1alpha1:ClusterTrustBundlePatch").build())
            ))
            .build();
