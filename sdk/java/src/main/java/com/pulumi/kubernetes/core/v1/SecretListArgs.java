...
import com.pulumi.kubernetes.core.v1.inputs.SecretArgs;
...
public final class SecretListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SecretListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("SecretListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("SecretList").getNullable();
            return $;
        }
    }
