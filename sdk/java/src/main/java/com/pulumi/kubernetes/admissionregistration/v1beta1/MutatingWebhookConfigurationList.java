...
import com.pulumi.kubernetes.admissionregistration.v1beta1.MutatingWebhookConfigurationListArgs;
import com.pulumi.kubernetes.admissionregistration.v1beta1.outputs.MutatingWebhookConfiguration;
...
public class MutatingWebhookConfigurationList extends com.pulumi.resources.CustomResource {
    ...
    public MutatingWebhookConfigurationList(java.lang.String name, MutatingWebhookConfigurationListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingWebhookConfigurationList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private MutatingWebhookConfigurationList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingWebhookConfigurationList", name, null, makeResourceOptions(options, id), false);
    }
