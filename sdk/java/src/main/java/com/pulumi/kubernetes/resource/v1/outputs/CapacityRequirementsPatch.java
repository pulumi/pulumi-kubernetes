...
@CustomType
public final class CapacityRequirementsPatch {
    /**
    ...
    private CapacityRequirementsPatch() {}
    /**
     * @return Requests represent individual device resource requests for distinct resources, all of which must be provided by the device.
     * 
     * This value is used as an additional filtering condition against the available capacity on the device. This is semantically equivalent to a CEL selector with `device.capacity[&lt;domain&gt;].&lt;name&gt;.compareTo(quantity(&lt;request quantity&gt;)) &gt;= 0`. For example, device.capacity[&#39;test-driver.cdi.k8s.io&#39;].counters.compareTo(quantity(&#39;2&#39;)) &gt;= 0.
    ...
    public static Builder builder(CapacityRequirementsPatch defaults) {
    ...
    public static final class Builder {
        private @Nullable Map<String,String> requests;
        public Builder() {}
        public Builder(CapacityRequirementsPatch defaults) {
        ...
        public CapacityRequirementsPatch build() {
            final var _resultValue = new CapacityRequirementsPatch();
