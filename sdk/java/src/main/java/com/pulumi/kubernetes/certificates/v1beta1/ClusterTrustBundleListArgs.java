...
import com.pulumi.kubernetes.certificates.v1beta1.inputs.ClusterTrustBundleArgs;
...
public final class ClusterTrustBundleListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ClusterTrustBundleListArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("ClusterTrustBundleList").getNullable();
            return $;
        }
    }
