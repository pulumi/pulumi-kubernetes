...
public class ClusterRolePatch extends com.pulumi.resources.CustomResource {
    ...
    public ClusterRolePatch(java.lang.String name, @Nullable ClusterRolePatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRolePatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClusterRolePatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRolePatch", name, null, makeResourceOptions(options, id), false);
    }
