...
public class PodSchedulingList extends com.pulumi.resources.CustomResource {
     ...
     */
    public PodSchedulingList(java.lang.String name) {
     ...
     */
    public PodSchedulingList(java.lang.String name, PodSchedulingListArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PodSchedulingList(java.lang.String name, PodSchedulingListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha1:PodSchedulingList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PodSchedulingList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha1:PodSchedulingList", name, null, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static PodSchedulingList get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
