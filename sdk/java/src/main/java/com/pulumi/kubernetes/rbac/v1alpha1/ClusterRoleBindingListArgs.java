...
import com.pulumi.kubernetes.rbac.v1alpha1.inputs.ClusterRoleBindingArgs;
...
public final class ClusterRoleBindingListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ClusterRoleBindingListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("ClusterRoleBindingListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("ClusterRoleBindingList").getNullable();
            return $;
        }
    }
