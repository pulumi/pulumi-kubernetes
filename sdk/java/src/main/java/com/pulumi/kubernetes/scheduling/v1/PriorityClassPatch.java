...
public class PriorityClassPatch extends com.pulumi.resources.CustomResource {
    ...
    public PriorityClassPatch(java.lang.String name, @Nullable PriorityClassPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:scheduling.k8s.io/v1:PriorityClassPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PriorityClassPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:scheduling.k8s.io/v1:PriorityClassPatch", name, null, makeResourceOptions(options, id), false);
    }
