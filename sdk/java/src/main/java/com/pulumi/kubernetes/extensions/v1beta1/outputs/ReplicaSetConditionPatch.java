...
@CustomType
public final class ReplicaSetConditionPatch {
    /**
    ...
    public static Builder builder(ReplicaSetConditionPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(ReplicaSetConditionPatch defaults) {
        ...
        public ReplicaSetConditionPatch build() {
            final var _resultValue = new ReplicaSetConditionPatch();
