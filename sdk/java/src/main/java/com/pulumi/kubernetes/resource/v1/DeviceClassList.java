...
import com.pulumi.kubernetes.resource.v1.DeviceClassListArgs;
import com.pulumi.kubernetes.resource.v1.outputs.DeviceClass;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1:DeviceClassList")
public class DeviceClassList extends com.pulumi.resources.CustomResource {
    ...
    public DeviceClassList(java.lang.String name, DeviceClassListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1:DeviceClassList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DeviceClassList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1:DeviceClassList", name, null, makeResourceOptions(options, id), false);
    }
