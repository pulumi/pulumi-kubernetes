...
public class VolumeAttachmentList extends com.pulumi.resources.CustomResource {
    ...
    public VolumeAttachmentList(java.lang.String name, VolumeAttachmentListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1alpha1:VolumeAttachmentList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VolumeAttachmentList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1alpha1:VolumeAttachmentList", name, null, makeResourceOptions(options, id), false);
    }
