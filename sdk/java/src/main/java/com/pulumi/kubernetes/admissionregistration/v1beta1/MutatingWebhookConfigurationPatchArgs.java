...
import com.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MutatingWebhookPatchArgs;
...
public final class MutatingWebhookConfigurationPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public MutatingWebhookConfigurationPatchArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("MutatingWebhookConfiguration").getNullable();
            return $;
        }
    }
