...
public class ValidatingAdmissionPolicyList extends com.pulumi.resources.CustomResource {
    ...
    public ValidatingAdmissionPolicyList(String name, ValidatingAdmissionPolicyListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private ValidatingAdmissionPolicyList(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyList", name, null, makeResourceOptions(options, id));
    }
