...
public class CertificateSigningRequestPatch extends com.pulumi.resources.CustomResource {
    ...
    public CertificateSigningRequestPatch(java.lang.String name, @Nullable CertificateSigningRequestPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1:CertificateSigningRequestPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CertificateSigningRequestPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1:CertificateSigningRequestPatch", name, null, makeResourceOptions(options, id), false);
    }
