...
import com.pulumi.kubernetes.storage.v1beta1.inputs.StorageClassArgs;
...
public final class StorageClassListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private StorageClassListArgs(StorageClassListArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StorageClassListArgs();
        }

        public Builder(StorageClassListArgs defaults) {
            $ = new StorageClassListArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder items(Output<List<StorageClassArgs>> items) {
            $.items = items;
            return this;
        }
         ...
         * 
         */
        public Builder items(List<StorageClassArgs> items) {
         ...
         * 
         */
        public Builder items(StorageClassArgs... items) {
        ...
        public StorageClassListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("StorageClassListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("StorageClassList").getNullable();
            return $;
        }
    }
