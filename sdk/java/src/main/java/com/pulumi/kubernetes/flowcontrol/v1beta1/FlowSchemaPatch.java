...
import com.pulumi.kubernetes.flowcontrol.v1beta1.FlowSchemaPatchArgs;
import com.pulumi.kubernetes.flowcontrol.v1beta1.outputs.FlowSchemaSpecPatch;
import com.pulumi.kubernetes.flowcontrol.v1beta1.outputs.FlowSchemaStatusPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:FlowSchemaPatch")
public class FlowSchemaPatch extends com.pulumi.resources.CustomResource {
    ...
    public FlowSchemaPatch(java.lang.String name, @Nullable FlowSchemaPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:FlowSchemaPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private FlowSchemaPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:FlowSchemaPatch", name, null, makeResourceOptions(options, id), false);
    }
