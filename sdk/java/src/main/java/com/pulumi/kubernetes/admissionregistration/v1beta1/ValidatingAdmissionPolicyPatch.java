...
import com.pulumi.kubernetes.admissionregistration.v1beta1.ValidatingAdmissionPolicyPatchArgs;
import com.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingAdmissionPolicySpecPatch;
import com.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingAdmissionPolicyStatusPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyPatch")
public class ValidatingAdmissionPolicyPatch extends com.pulumi.resources.CustomResource {
    ...
    public ValidatingAdmissionPolicyPatch(String name, @Nullable ValidatingAdmissionPolicyPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
