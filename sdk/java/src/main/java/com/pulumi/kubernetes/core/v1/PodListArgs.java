...
import com.pulumi.kubernetes.core.v1.inputs.PodArgs;
...
public final class PodListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PodListArgs(PodListArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(PodListArgs defaults) {
            $ = new PodListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PodListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("PodListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("PodList").getNullable();
            return $;
        }
    }
