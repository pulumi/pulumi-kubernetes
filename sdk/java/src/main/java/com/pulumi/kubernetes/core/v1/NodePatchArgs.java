...
import com.pulumi.kubernetes.core.v1.inputs.NodeSpecPatchArgs;
...
public final class NodePatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final NodePatchArgs Empty = new NodePatchArgs();
     ...
     */
    @Import(name="spec")
    private @Nullable Output<NodeSpecPatchArgs> spec;
     ...
     * 
     */
    public Optional<Output<NodeSpecPatchArgs>> spec() {
        return Optional.ofNullable(this.spec);
    }

    private NodePatchArgs() {}

    private NodePatchArgs(NodePatchArgs $) {
    ...
    public static Builder builder(NodePatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(NodePatchArgs defaults) {
            $ = new NodePatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(@Nullable Output<NodeSpecPatchArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(NodeSpecPatchArgs spec) {
            return spec(Output.of(spec));
        }

        public NodePatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("v1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("Node").getNullable();
            return $;
        }
    }
