...
public final class PodTemplatePatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final PodTemplatePatchArgs Empty = new PodTemplatePatchArgs();
    ...
    private PodTemplatePatchArgs() {}

    private PodTemplatePatchArgs(PodTemplatePatchArgs $) {
    ...
    public static Builder builder(PodTemplatePatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PodTemplatePatchArgs();
        }

        public Builder(PodTemplatePatchArgs defaults) {
            $ = new PodTemplatePatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PodTemplatePatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("v1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("PodTemplate").getNullable();
            return $;
        }
    }
