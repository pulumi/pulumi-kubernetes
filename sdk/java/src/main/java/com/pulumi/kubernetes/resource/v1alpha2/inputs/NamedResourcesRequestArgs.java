 ...
 * 
 */
public final class NamedResourcesRequestArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NamedResourcesRequestArgs(NamedResourcesRequestArgs $) {
    ...
    public static Builder builder(NamedResourcesRequestArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NamedResourcesRequestArgs();
        }

        public Builder(NamedResourcesRequestArgs defaults) {
            $ = new NamedResourcesRequestArgs(Objects.requireNonNull(defaults));
        }
