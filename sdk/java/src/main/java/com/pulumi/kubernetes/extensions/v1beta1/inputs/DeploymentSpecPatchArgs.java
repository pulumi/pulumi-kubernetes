...
import com.pulumi.kubernetes.extensions.v1beta1.inputs.DeploymentStrategyPatchArgs;
import com.pulumi.kubernetes.extensions.v1beta1.inputs.RollbackConfigPatchArgs;
...
public final class DeploymentSpecPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<RollbackConfigPatchArgs> rollbackTo;

    /**
     * @return DEPRECATED. The config this deployment is rolling back to. Will be cleared after rollback is done.
     * 
     */
    public Optional<Output<RollbackConfigPatchArgs>> rollbackTo() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder rollbackTo(@Nullable Output<RollbackConfigPatchArgs> rollbackTo) {
         ...
         * 
         */
        public Builder rollbackTo(RollbackConfigPatchArgs rollbackTo) {
