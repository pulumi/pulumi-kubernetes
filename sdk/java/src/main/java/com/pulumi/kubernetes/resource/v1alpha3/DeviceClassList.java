...
public class DeviceClassList extends com.pulumi.resources.CustomResource {
    ...
    public DeviceClassList(String name, DeviceClassListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha3:DeviceClassList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private DeviceClassList(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha3:DeviceClassList", name, null, makeResourceOptions(options, id));
    }
