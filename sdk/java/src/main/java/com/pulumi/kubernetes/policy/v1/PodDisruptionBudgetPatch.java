...
public class PodDisruptionBudgetPatch extends com.pulumi.resources.CustomResource {
    ...
    public PodDisruptionBudgetPatch(String name, PodDisruptionBudgetPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:policy/v1:PodDisruptionBudgetPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PodDisruptionBudgetPatch(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:policy/v1:PodDisruptionBudgetPatch", name, null, makeResourceOptions(options, id));
    }
