...
import com.pulumi.kubernetes.storage.v1beta1.inputs.CSIStorageCapacityArgs;
...
public final class CSIStorageCapacityListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public CSIStorageCapacityListArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("CSIStorageCapacityList").getNullable();
            return $;
        }
    }
