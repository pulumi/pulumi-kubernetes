...
public class RuntimeClassList extends com.pulumi.resources.CustomResource {
    ...
    public RuntimeClassList(java.lang.String name, RuntimeClassListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:node.k8s.io/v1alpha1:RuntimeClassList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RuntimeClassList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:node.k8s.io/v1alpha1:RuntimeClassList", name, null, makeResourceOptions(options, id), false);
    }
