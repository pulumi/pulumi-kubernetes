...
public class JobPatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public JobPatch(java.lang.String name) {
     ...
     */
    public JobPatch(java.lang.String name, @Nullable JobPatchArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public JobPatch(java.lang.String name, @Nullable JobPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v1:JobPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private JobPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v1:JobPatch", name, null, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static JobPatch get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
