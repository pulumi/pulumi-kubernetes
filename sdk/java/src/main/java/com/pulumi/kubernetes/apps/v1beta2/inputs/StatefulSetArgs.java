...
import com.pulumi.kubernetes.apps.v1beta2.inputs.StatefulSetSpecArgs;
import com.pulumi.kubernetes.apps.v1beta2.inputs.StatefulSetStatusArgs;
...
public final class StatefulSetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public StatefulSetArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("StatefulSet").getNullable();
            return $;
        }
    }
