...
import com.pulumi.kubernetes.resource.v1alpha3.PodSchedulingContextPatchArgs;
import com.pulumi.kubernetes.resource.v1alpha3.outputs.PodSchedulingContextSpecPatch;
import com.pulumi.kubernetes.resource.v1alpha3.outputs.PodSchedulingContextStatusPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContextPatch")
public class PodSchedulingContextPatch extends com.pulumi.resources.CustomResource {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:resource.k8s.io/v1alpha2:PodSchedulingContextPatch").build())
            ))
            .build();
