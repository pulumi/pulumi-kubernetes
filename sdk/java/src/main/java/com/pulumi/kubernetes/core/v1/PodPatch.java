...
public class PodPatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public PodPatch(java.lang.String name) {
     ...
     */
    public PodPatch(java.lang.String name, @Nullable PodPatchArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PodPatch(java.lang.String name, @Nullable PodPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:PodPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PodPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:PodPatch", name, null, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static PodPatch get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
