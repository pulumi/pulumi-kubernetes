 ...
 * 
 */
public final class VendorParametersArgs extends com.pulumi.resources.ResourceArgs {

    public static final VendorParametersArgs Empty = new VendorParametersArgs();
    ...
    private VendorParametersArgs() {}

    private VendorParametersArgs(VendorParametersArgs $) {
    ...
    public static Builder builder(VendorParametersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VendorParametersArgs();
        }

        public Builder(VendorParametersArgs defaults) {
            $ = new VendorParametersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VendorParametersArgs build() {
            return $;
        }
    }
