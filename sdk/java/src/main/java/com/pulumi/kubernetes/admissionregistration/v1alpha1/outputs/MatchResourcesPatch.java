...
import com.pulumi.kubernetes.admissionregistration.v1alpha1.outputs.NamedRuleWithOperationsPatch;
...
public final class MatchResourcesPatch {
     ...
     * 
     */
    private @Nullable List<NamedRuleWithOperationsPatch> excludeResourceRules;
    /**
     ...
     * 
     */
    private @Nullable List<NamedRuleWithOperationsPatch> resourceRules;
    ...
    public static Builder builder(MatchResourcesPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<NamedRuleWithOperationsPatch> resourceRules;
        public Builder() {}
        public Builder(MatchResourcesPatch defaults) {
        ...
        public Builder excludeResourceRules(NamedRuleWithOperationsPatch... excludeResourceRules) {
        ...
        public Builder resourceRules(NamedRuleWithOperationsPatch... resourceRules) {
