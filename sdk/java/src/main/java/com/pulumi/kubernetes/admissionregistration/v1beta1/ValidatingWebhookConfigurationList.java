...
public class ValidatingWebhookConfigurationList extends com.pulumi.resources.CustomResource {
     ...
     */
    public ValidatingWebhookConfigurationList(java.lang.String name) {
     ...
     */
    public ValidatingWebhookConfigurationList(java.lang.String name, ValidatingWebhookConfigurationListArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ValidatingWebhookConfigurationList(java.lang.String name, ValidatingWebhookConfigurationListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingWebhookConfigurationList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ValidatingWebhookConfigurationList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingWebhookConfigurationList", name, null, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ValidatingWebhookConfigurationList get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
