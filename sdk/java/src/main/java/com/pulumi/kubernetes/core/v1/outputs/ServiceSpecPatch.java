...
import com.pulumi.kubernetes.core.v1.outputs.ServicePortPatch;
import com.pulumi.kubernetes.core.v1.outputs.SessionAffinityConfigPatch;
...
public final class ServiceSpecPatch {
     ...
     * 
     */
    private @Nullable List<ServicePortPatch> ports;
    /**
     ...
     * 
     */
    public List<ServicePortPatch> ports() {
     ...
     * 
     */
    public Optional<SessionAffinityConfigPatch> sessionAffinityConfig() {
    ...
    public static Builder builder(ServiceSpecPatch defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder ports(@Nullable List<ServicePortPatch> ports) {

            this.ports = ports;
            return this;
        }
        public Builder ports(ServicePortPatch... ports) {
        ...
        @CustomType.Setter
        public Builder sessionAffinityConfig(@Nullable SessionAffinityConfigPatch sessionAffinityConfig) {
        ...
        public ServiceSpecPatch build() {
            final var _resultValue = new ServiceSpecPatch();
