...
public class ValidatingAdmissionPolicyBindingList extends com.pulumi.resources.CustomResource {
    ...
    public ValidatingAdmissionPolicyBindingList(String name, @Nullable ValidatingAdmissionPolicyBindingListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyBindingList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
