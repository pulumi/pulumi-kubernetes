...
import com.pulumi.kubernetes.apps.v1beta2.ReplicaSetPatchArgs;
import com.pulumi.kubernetes.apps.v1beta2.outputs.ReplicaSetSpecPatch;
import com.pulumi.kubernetes.apps.v1beta2.outputs.ReplicaSetStatusPatch;
...
@ResourceType(type="kubernetes:apps/v1beta2:ReplicaSetPatch")
public class ReplicaSetPatch extends com.pulumi.resources.CustomResource {
    ...
    public ReplicaSetPatch(String name, @Nullable ReplicaSetPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:ReplicaSetPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
