...
import com.pulumi.kubernetes.resource.v1alpha1.ResourceClassPatchArgs;
import com.pulumi.kubernetes.resource.v1alpha1.outputs.ResourceClassParametersReferencePatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1alpha1:ResourceClassPatch")
public class ResourceClassPatch extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="parametersRef", type=ResourceClassParametersReferencePatch.class, parameters={})
     ...
     * 
     */
    @Export(name="suitableNodes", type=NodeSelectorPatch.class, parameters={})
    ...
    public ResourceClassPatch(String name, @Nullable ResourceClassPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha1:ResourceClassPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
