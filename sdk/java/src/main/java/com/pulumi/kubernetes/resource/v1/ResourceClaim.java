...
import com.pulumi.kubernetes.resource.v1.ResourceClaimArgs;
import com.pulumi.kubernetes.resource.v1.outputs.ResourceClaimSpec;
import com.pulumi.kubernetes.resource.v1.outputs.ResourceClaimStatus;
...
public class ResourceClaim extends com.pulumi.resources.CustomResource {
    ...
    public ResourceClaim(java.lang.String name, @Nullable ResourceClaimArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1:ResourceClaim", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ResourceClaim(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1:ResourceClaim", name, null, makeResourceOptions(options, id), false);
    }
