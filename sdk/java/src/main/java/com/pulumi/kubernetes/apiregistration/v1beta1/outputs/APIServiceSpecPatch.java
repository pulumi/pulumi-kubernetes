...
import com.pulumi.kubernetes.apiregistration.v1beta1.outputs.ServiceReferencePatch;
...
public final class APIServiceSpecPatch {
     ...
     * 
     */
    private @Nullable Integer groupPriorityMinimum;
    /**
     ...
     * 
     */
    private @Nullable Integer versionPriority;
    ...
    public static Builder builder(APIServiceSpecPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer versionPriority;
        public Builder() {}
        public Builder(APIServiceSpecPatch defaults) {
