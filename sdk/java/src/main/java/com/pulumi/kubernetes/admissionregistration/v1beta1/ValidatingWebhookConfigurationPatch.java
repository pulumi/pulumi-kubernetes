...
import com.pulumi.kubernetes.admissionregistration.v1beta1.ValidatingWebhookConfigurationPatchArgs;
import com.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingWebhookPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingWebhookConfigurationPatch")
public class ValidatingWebhookConfigurationPatch extends com.pulumi.resources.CustomResource {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:admissionregistration.k8s.io/v1:ValidatingWebhookConfigurationPatch").build())
            ))
            .build();
