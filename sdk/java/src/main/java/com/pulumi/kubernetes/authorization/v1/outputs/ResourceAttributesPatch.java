...
public final class ResourceAttributesPatch {
    ...
    private ResourceAttributesPatch() {}
    /**
     * @return Group is the API Group of the Resource.  &#34;*&#34; means all.
     * 
     */
    ...
    public static Builder builder(ResourceAttributesPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(ResourceAttributesPatch defaults) {
        ...
        public ResourceAttributesPatch build() {
            final var o = new ResourceAttributesPatch();
            o.group = group;
            o.name = name;
