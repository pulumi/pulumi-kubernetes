...
public class FlowSchemaList extends com.pulumi.resources.CustomResource {
    ...
    public FlowSchemaList(java.lang.String name, FlowSchemaListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private FlowSchemaList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaList", name, null, makeResourceOptions(options, id), false);
    }
