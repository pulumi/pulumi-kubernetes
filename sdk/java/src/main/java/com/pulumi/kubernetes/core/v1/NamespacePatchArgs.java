...
import com.pulumi.kubernetes.core.v1.inputs.NamespaceSpecPatchArgs;
...
public final class NamespacePatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final NamespacePatchArgs Empty = new NamespacePatchArgs();
     ...
     */
    @Import(name="spec")
    private @Nullable Output<NamespaceSpecPatchArgs> spec;
     ...
     * 
     */
    public Optional<Output<NamespaceSpecPatchArgs>> spec() {
        return Optional.ofNullable(this.spec);
    }

    private NamespacePatchArgs() {}

    private NamespacePatchArgs(NamespacePatchArgs $) {
    ...
    public static Builder builder(NamespacePatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NamespacePatchArgs();
        }

        public Builder(NamespacePatchArgs defaults) {
            $ = new NamespacePatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(@Nullable Output<NamespaceSpecPatchArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(NamespaceSpecPatchArgs spec) {
            return spec(Output.of(spec));
        }

        public NamespacePatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("v1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("Namespace").getNullable();
            return $;
        }
    }
