...
public final class CustomResourceDefinitionSpecPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<CustomResourceValidationPatchArgs> validation;
     ...
     * 
     */
    public Optional<Output<CustomResourceValidationPatchArgs>> validation() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder validation(@Nullable Output<CustomResourceValidationPatchArgs> validation) {
