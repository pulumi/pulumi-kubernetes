...
import com.pulumi.kubernetes.rbac.v1beta1.RoleArgs;
...
public class Role extends com.pulumi.resources.CustomResource {
    ...
    public Role(java.lang.String name, @Nullable RoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:Role", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Role(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:Role", name, null, makeResourceOptions(options, id), false);
    }
