...
public class ResourceClassParameters extends com.pulumi.resources.CustomResource {
     ...
     */
    public ResourceClassParameters(java.lang.String name) {
     ...
     */
    public ResourceClassParameters(java.lang.String name, @Nullable ResourceClassParametersArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ResourceClassParameters(java.lang.String name, @Nullable ResourceClassParametersArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha2:ResourceClassParameters", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ResourceClassParameters(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha2:ResourceClassParameters", name, null, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ResourceClassParameters get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
