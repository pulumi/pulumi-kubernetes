...
import com.pulumi.kubernetes.rbac.v1alpha1.inputs.ClusterRoleArgs;
...
public final class ClusterRoleListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ClusterRoleListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("ClusterRoleListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("ClusterRoleList").getNullable();
            return $;
        }
    }
