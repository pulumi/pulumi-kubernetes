...
import com.pulumi.kubernetes.rbac.v1beta1.ClusterRoleBindingArgs;
...
public class ClusterRoleBinding extends com.pulumi.resources.CustomResource {
    ...
    public ClusterRoleBinding(java.lang.String name, ClusterRoleBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClusterRoleBinding(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleBinding", name, null, makeResourceOptions(options, id), false);
    }
