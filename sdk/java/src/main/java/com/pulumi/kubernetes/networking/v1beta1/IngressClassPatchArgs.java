...
import com.pulumi.kubernetes.networking.v1beta1.inputs.IngressClassSpecPatchArgs;
...
public final class IngressClassPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final IngressClassPatchArgs Empty = new IngressClassPatchArgs();
     ...
     */
    @Import(name="spec")
    private @Nullable Output<IngressClassSpecPatchArgs> spec;
     ...
     * 
     */
    public Optional<Output<IngressClassSpecPatchArgs>> spec() {
        return Optional.ofNullable(this.spec);
    }

    private IngressClassPatchArgs() {}

    private IngressClassPatchArgs(IngressClassPatchArgs $) {
    ...
    public static Builder builder(IngressClassPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IngressClassPatchArgs();
        }

        public Builder(IngressClassPatchArgs defaults) {
            $ = new IngressClassPatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(@Nullable Output<IngressClassSpecPatchArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(IngressClassSpecPatchArgs spec) {
        ...
        public IngressClassPatchArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("IngressClass").getNullable();
            return $;
        }
    }
