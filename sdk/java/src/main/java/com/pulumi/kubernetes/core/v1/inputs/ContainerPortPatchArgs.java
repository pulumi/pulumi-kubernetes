 ...
 * 
 */
public final class ContainerPortPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final ContainerPortPatchArgs Empty = new ContainerPortPatchArgs();
    ...
    private ContainerPortPatchArgs() {}

    private ContainerPortPatchArgs(ContainerPortPatchArgs $) {
    ...
    public static Builder builder(ContainerPortPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ContainerPortPatchArgs();
        }

        public Builder(ContainerPortPatchArgs defaults) {
            $ = new ContainerPortPatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ContainerPortPatchArgs build() {
            return $;
        }
    }
