...
import com.pulumi.kubernetes.resource.v1beta2.ResourceClaimArgs;
import com.pulumi.kubernetes.resource.v1beta2.outputs.ResourceClaimSpec;
import com.pulumi.kubernetes.resource.v1beta2.outputs.ResourceClaimStatus;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1beta2:ResourceClaim")
public class ResourceClaim extends com.pulumi.resources.CustomResource {
     ...
     */
    public ResourceClaim(java.lang.String name, @Nullable ResourceClaimArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ResourceClaim(java.lang.String name, @Nullable ResourceClaimArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta2:ResourceClaim", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ResourceClaim(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta2:ResourceClaim", name, null, makeResourceOptions(options, id), false);
    }

    private static ResourceClaimArgs makeArgs(@Nullable ResourceClaimArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:resource.k8s.io/v1:ResourceClaim").build()),
