...
import com.pulumi.kubernetes.flowcontrol.v1beta2.PriorityLevelConfigurationPatchArgs;
import com.pulumi.kubernetes.flowcontrol.v1beta2.outputs.PriorityLevelConfigurationSpecPatch;
import com.pulumi.kubernetes.flowcontrol.v1beta2.outputs.PriorityLevelConfigurationStatusPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfigurationPatch")
public class PriorityLevelConfigurationPatch extends com.pulumi.resources.CustomResource {
    ...
    public PriorityLevelConfigurationPatch(java.lang.String name, @Nullable PriorityLevelConfigurationPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfigurationPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PriorityLevelConfigurationPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfigurationPatch", name, null, makeResourceOptions(options, id), false);
    }
