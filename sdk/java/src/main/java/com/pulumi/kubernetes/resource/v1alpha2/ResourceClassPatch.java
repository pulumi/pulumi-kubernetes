...
public class ResourceClassPatch extends com.pulumi.resources.CustomResource {
    ...
    public ResourceClassPatch(java.lang.String name, @Nullable ResourceClassPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha2:ResourceClassPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ResourceClassPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha2:ResourceClassPatch", name, null, makeResourceOptions(options, id), false);
    }
