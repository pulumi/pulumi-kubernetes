...
import com.pulumi.kubernetes.flowcontrol.v1alpha1.PriorityLevelConfigurationArgs;
import com.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.PriorityLevelConfigurationSpec;
import com.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.PriorityLevelConfigurationStatus;
...
public class PriorityLevelConfiguration extends com.pulumi.resources.CustomResource {
     ...
     */
    public PriorityLevelConfiguration(java.lang.String name) {
    ...
    public PriorityLevelConfiguration(java.lang.String name, @Nullable PriorityLevelConfigurationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfiguration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PriorityLevelConfiguration(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfiguration", name, null, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:flowcontrol.apiserver.k8s.io/v1:PriorityLevelConfiguration").build()),
     ...
     */
    public static PriorityLevelConfiguration get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
