...
public final class VolumeMountPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(VolumeMountPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(VolumeMountPatchArgs defaults) {
            $ = new VolumeMountPatchArgs(Objects.requireNonNull(defaults));
        }
