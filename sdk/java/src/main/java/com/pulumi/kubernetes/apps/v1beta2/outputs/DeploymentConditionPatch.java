...
@CustomType
public final class DeploymentConditionPatch {
    /**
    ...
    public static Builder builder(DeploymentConditionPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(DeploymentConditionPatch defaults) {
        ...
        public DeploymentConditionPatch build() {
            final var _resultValue = new DeploymentConditionPatch();
