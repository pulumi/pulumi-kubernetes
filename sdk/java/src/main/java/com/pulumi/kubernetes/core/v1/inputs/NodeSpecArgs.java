...
import com.pulumi.kubernetes.core.v1.inputs.NodePodPreemptionPolicyArgs;
...
public final class NodeSpecArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<NodePodPreemptionPolicyArgs> podPreemptionPolicy;
     ...
     * 
     */
    public Optional<Output<NodePodPreemptionPolicyArgs>> podPreemptionPolicy() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder podPreemptionPolicy(@Nullable Output<NodePodPreemptionPolicyArgs> podPreemptionPolicy) {
         ...
         * 
         */
        public Builder podPreemptionPolicy(NodePodPreemptionPolicyArgs podPreemptionPolicy) {
