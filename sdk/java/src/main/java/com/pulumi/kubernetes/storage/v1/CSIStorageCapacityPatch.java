...
public class CSIStorageCapacityPatch extends com.pulumi.resources.CustomResource {
    ...
    public CSIStorageCapacityPatch(java.lang.String name, @Nullable CSIStorageCapacityPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1:CSIStorageCapacityPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CSIStorageCapacityPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1:CSIStorageCapacityPatch", name, null, makeResourceOptions(options, id), false);
    }
