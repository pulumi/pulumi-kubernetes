...
public class ResourceClass extends com.pulumi.resources.CustomResource {
    ...
    public ResourceClass(java.lang.String name, ResourceClassArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha1:ResourceClass", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ResourceClass(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha1:ResourceClass", name, null, makeResourceOptions(options, id), false);
    }
