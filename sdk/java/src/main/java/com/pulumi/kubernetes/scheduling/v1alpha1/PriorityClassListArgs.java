...
import com.pulumi.kubernetes.scheduling.v1alpha1.inputs.PriorityClassArgs;
...
public final class PriorityClassListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PriorityClassListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("PriorityClassListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("PriorityClassList").getNullable();
            return $;
        }
    }
