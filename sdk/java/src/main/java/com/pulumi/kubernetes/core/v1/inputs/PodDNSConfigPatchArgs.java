...
import com.pulumi.kubernetes.core.v1.inputs.PodDNSConfigOptionPatchArgs;
 ...
 * 
 */
public final class PodDNSConfigPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final PodDNSConfigPatchArgs Empty = new PodDNSConfigPatchArgs();
     ...
     */
    @Import(name="options")
    private @Nullable Output<List<PodDNSConfigOptionPatchArgs>> options;
     ...
     * 
     */
    public Optional<Output<List<PodDNSConfigOptionPatchArgs>>> options() {
    ...
    private PodDNSConfigPatchArgs() {}

    private PodDNSConfigPatchArgs(PodDNSConfigPatchArgs $) {
    ...
    public static Builder builder(PodDNSConfigPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PodDNSConfigPatchArgs();
        }

        public Builder(PodDNSConfigPatchArgs defaults) {
            $ = new PodDNSConfigPatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder options(@Nullable Output<List<PodDNSConfigOptionPatchArgs>> options) {
            $.options = options;
            return this;
        }
         ...
         * 
         */
        public Builder options(List<PodDNSConfigOptionPatchArgs> options) {
         ...
         * 
         */
        public Builder options(PodDNSConfigOptionPatchArgs... options) {
        ...
        public PodDNSConfigPatchArgs build() {
            return $;
        }
    }
