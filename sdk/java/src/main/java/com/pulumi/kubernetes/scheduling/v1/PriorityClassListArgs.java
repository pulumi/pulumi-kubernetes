...
import com.pulumi.kubernetes.scheduling.v1.inputs.PriorityClassArgs;
...
public final class PriorityClassListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PriorityClassListArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("scheduling.k8s.io/v1").getNullable();
            if ($.items == null) {
