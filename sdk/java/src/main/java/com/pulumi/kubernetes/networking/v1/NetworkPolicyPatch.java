...
import com.pulumi.kubernetes.networking.v1.NetworkPolicyPatchArgs;
import com.pulumi.kubernetes.networking.v1.outputs.NetworkPolicySpecPatch;
import com.pulumi.kubernetes.networking.v1.outputs.NetworkPolicyStatusPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:networking.k8s.io/v1:NetworkPolicyPatch")
public class NetworkPolicyPatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public NetworkPolicyPatch(String name) {
    ...
    public NetworkPolicyPatch(String name, @Nullable NetworkPolicyPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:NetworkPolicyPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private NetworkPolicyPatch(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:NetworkPolicyPatch", name, null, makeResourceOptions(options, id));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:extensions/v1beta1:NetworkPolicyPatch").build())
            ))
            .build();
     ...
     */
    public static NetworkPolicyPatch get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
