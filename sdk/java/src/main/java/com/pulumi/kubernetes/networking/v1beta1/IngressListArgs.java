...
import com.pulumi.kubernetes.networking.v1beta1.inputs.IngressArgs;
...
public final class IngressListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public IngressListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("IngressListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("IngressList").getNullable();
            return $;
        }
    }
