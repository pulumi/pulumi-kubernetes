...
@CustomType
public final class PodCertificateProjectionPatch {
    /**
    ...
    private PodCertificateProjectionPatch() {}
    /**
     * @return Write the certificate chain at this path in the projected volume.
     * 
     * Most applications should use credentialBundlePath.  When using keyPath and certificateChainPath, your application needs to check that the key and leaf certificate are consistent, because it is possible to read the files mid-rotation.
    ...
    public static Builder builder(PodCertificateProjectionPatch defaults) {
    ...
    public static final class Builder {
        ...
        public PodCertificateProjectionPatch build() {
            final var _resultValue = new PodCertificateProjectionPatch();
