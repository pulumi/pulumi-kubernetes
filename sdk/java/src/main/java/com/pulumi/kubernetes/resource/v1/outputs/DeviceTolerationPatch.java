...
@CustomType
public final class DeviceTolerationPatch {
    /**
    ...
    public static Builder builder(DeviceTolerationPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(DeviceTolerationPatch defaults) {
        ...
        public DeviceTolerationPatch build() {
            final var _resultValue = new DeviceTolerationPatch();
