...
public final class IngressClassSpecPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<TypedLocalObjectReferencePatchArgs> parameters;
     ...
     * 
     */
    public Optional<Output<TypedLocalObjectReferencePatchArgs>> parameters() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder parameters(@Nullable Output<TypedLocalObjectReferencePatchArgs> parameters) {
