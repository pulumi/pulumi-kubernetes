...
@CustomType
public final class ObjectReferencePatch {
    /**
    ...
    public static Builder builder(ObjectReferencePatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uid;
        public Builder() {}
        public Builder(ObjectReferencePatch defaults) {
        ...
        public ObjectReferencePatch build() {
            final var _resultValue = new ObjectReferencePatch();
