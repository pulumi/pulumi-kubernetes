...
import com.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassSpecPatchArgs;
...
public final class RuntimeClassPatchArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="spec")
    private @Nullable Output<RuntimeClassSpecPatchArgs> spec;
     ...
     * 
     */
    public Optional<Output<RuntimeClassSpecPatchArgs>> spec() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder spec(@Nullable Output<RuntimeClassSpecPatchArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(RuntimeClassSpecPatchArgs spec) {
            return spec(Output.of(spec));
        }

        public RuntimeClassPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("node.k8s.io/v1alpha1").getNullable();
