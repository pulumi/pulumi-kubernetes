...
public final class EndpointSliceListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public EndpointSliceListArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("discovery.k8s.io/v1").getNullable();
            if ($.items == null) {
                throw new MissingRequiredPropertyException("EndpointSliceListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("EndpointSliceList").getNullable();
            return $;
        }
    }
