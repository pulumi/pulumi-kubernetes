...
public class ValidatingAdmissionPolicyBindingList extends com.pulumi.resources.CustomResource {
    ...
    public ValidatingAdmissionPolicyBindingList(java.lang.String name, ValidatingAdmissionPolicyBindingListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyBindingList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ValidatingAdmissionPolicyBindingList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyBindingList", name, null, makeResourceOptions(options, id), false);
    }
