...
import com.pulumi.kubernetes.extensions.v1beta1.inputs.DeploymentArgs;
...
public final class DeploymentListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DeploymentListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("DeploymentListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("DeploymentList").getNullable();
            return $;
        }
    }
