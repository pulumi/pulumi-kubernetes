...
public class LeaseCandidate extends com.pulumi.resources.CustomResource {
    ...
    public LeaseCandidate(String name, @Nullable LeaseCandidateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:coordination.k8s.io/v1alpha2:LeaseCandidate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private LeaseCandidate(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:coordination.k8s.io/v1alpha2:LeaseCandidate", name, null, makeResourceOptions(options, id));
    }
