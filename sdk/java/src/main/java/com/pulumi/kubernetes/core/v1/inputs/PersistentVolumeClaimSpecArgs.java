...
public final class PersistentVolumeClaimSpecArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<TypedObjectReferenceArgs> dataSourceRef;
     ...
     * 
     */
    public Optional<Output<TypedObjectReferenceArgs>> dataSourceRef() {
    ...
    /**
     * @return resources represents the minimum resources the volume should have. Users are allowed to specify resource requirements that are lower than previous value but must still be higher than capacity recorded in the status field of the claim. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources
     * 
     */
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder dataSourceRef(@Nullable Output<TypedObjectReferenceArgs> dataSourceRef) {
         ...
         * 
         */
        public Builder dataSourceRef(TypedObjectReferenceArgs dataSourceRef) {
            return dataSourceRef(Output.of(dataSourceRef));
        }

        /**
         * @param resources resources represents the minimum resources the volume should have. Users are allowed to specify resource requirements that are lower than previous value but must still be higher than capacity recorded in the status field of the claim. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources
         * 
         * @return builder
         * 
         */
