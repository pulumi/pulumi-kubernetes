...
public class NamespaceList extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="items", refs={List.class,Namespace.class}, tree="[0,1]")
     ...
     */
    public NamespaceList(java.lang.String name) {
     ...
     */
    public NamespaceList(java.lang.String name, NamespaceListArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NamespaceList(java.lang.String name, NamespaceListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:NamespaceList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NamespaceList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:NamespaceList", name, null, makeResourceOptions(options, id), false);
    }

    private static NamespaceListArgs makeArgs(NamespaceListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NamespaceList get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
