...
import com.pulumi.kubernetes.rbac.v1beta1.ClusterRoleArgs;
...
public class ClusterRole extends com.pulumi.resources.CustomResource {
    ...
    public ClusterRole(java.lang.String name, @Nullable ClusterRoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRole", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClusterRole(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRole", name, null, makeResourceOptions(options, id), false);
    }
