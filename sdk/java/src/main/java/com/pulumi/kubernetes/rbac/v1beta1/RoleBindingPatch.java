...
public class RoleBindingPatch extends com.pulumi.resources.CustomResource {
    ...
    public RoleBindingPatch(java.lang.String name, @Nullable RoleBindingPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBindingPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RoleBindingPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBindingPatch", name, null, makeResourceOptions(options, id), false);
    }
