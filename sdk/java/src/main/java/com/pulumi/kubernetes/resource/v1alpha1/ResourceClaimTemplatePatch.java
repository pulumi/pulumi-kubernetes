...
import com.pulumi.kubernetes.resource.v1alpha1.ResourceClaimTemplatePatchArgs;
import com.pulumi.kubernetes.resource.v1alpha1.outputs.ResourceClaimTemplateSpecPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1alpha1:ResourceClaimTemplatePatch")
public class ResourceClaimTemplatePatch extends com.pulumi.resources.CustomResource {
    ...
    public ResourceClaimTemplatePatch(String name, @Nullable ResourceClaimTemplatePatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha1:ResourceClaimTemplatePatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
