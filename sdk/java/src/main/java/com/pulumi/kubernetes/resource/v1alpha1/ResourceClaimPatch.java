...
public class ResourceClaimPatch extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", type=ResourceClaimSpecPatch.class, parameters={})
     ...
     * 
     */
    @Export(name="status", type=ResourceClaimStatusPatch.class, parameters={})
    ...
    public ResourceClaimPatch(String name, @Nullable ResourceClaimPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha1:ResourceClaimPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
