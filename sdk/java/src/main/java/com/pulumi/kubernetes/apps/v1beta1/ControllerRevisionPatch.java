...
import com.pulumi.kubernetes.apps.v1beta1.ControllerRevisionPatchArgs;
...
@ResourceType(type="kubernetes:apps/v1beta1:ControllerRevisionPatch")
public class ControllerRevisionPatch extends com.pulumi.resources.CustomResource {
    ...
    public ControllerRevisionPatch(java.lang.String name, @Nullable ControllerRevisionPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta1:ControllerRevisionPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ControllerRevisionPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta1:ControllerRevisionPatch", name, null, makeResourceOptions(options, id), false);
    }
