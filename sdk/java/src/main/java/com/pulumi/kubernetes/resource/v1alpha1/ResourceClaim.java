...
public class ResourceClaim extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", type=ResourceClaimSpec.class, parameters={})
     ...
     * 
     */
    @Export(name="status", type=ResourceClaimStatus.class, parameters={})
    ...
    public ResourceClaim(String name, ResourceClaimArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha1:ResourceClaim", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
