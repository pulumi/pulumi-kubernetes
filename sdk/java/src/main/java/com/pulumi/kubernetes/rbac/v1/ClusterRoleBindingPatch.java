...
public class ClusterRoleBindingPatch extends com.pulumi.resources.CustomResource {
    ...
    public ClusterRoleBindingPatch(java.lang.String name, @Nullable ClusterRoleBindingPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBindingPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClusterRoleBindingPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBindingPatch", name, null, makeResourceOptions(options, id), false);
    }
