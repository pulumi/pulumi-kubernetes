...
import com.pulumi.kubernetes.events.v1.inputs.EventArgs;
...
public final class EventListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public EventListArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("events.k8s.io/v1").getNullable();
            if ($.items == null) {
