...
import com.pulumi.kubernetes.resource.v1beta2.ResourceClaimTemplatePatchArgs;
import com.pulumi.kubernetes.resource.v1beta2.outputs.ResourceClaimTemplateSpecPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplatePatch")
public class ResourceClaimTemplatePatch extends com.pulumi.resources.CustomResource {
    ...
    public ResourceClaimTemplatePatch(java.lang.String name, @Nullable ResourceClaimTemplatePatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplatePatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ResourceClaimTemplatePatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplatePatch", name, null, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:resource.k8s.io/v1:ResourceClaimTemplatePatch").build()),
