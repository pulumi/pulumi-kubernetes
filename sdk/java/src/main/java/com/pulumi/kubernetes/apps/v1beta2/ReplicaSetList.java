...
import com.pulumi.kubernetes.apps.v1beta2.ReplicaSetListArgs;
import com.pulumi.kubernetes.apps.v1beta2.outputs.ReplicaSet;
...
public class ReplicaSetList extends com.pulumi.resources.CustomResource {
    ...
    public ReplicaSetList(java.lang.String name, ReplicaSetListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:ReplicaSetList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ReplicaSetList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:ReplicaSetList", name, null, makeResourceOptions(options, id), false);
    }
