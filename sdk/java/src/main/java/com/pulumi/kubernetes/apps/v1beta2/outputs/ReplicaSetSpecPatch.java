...
@CustomType
public final class ReplicaSetSpecPatch {
    /**
    ...
    public static Builder builder(ReplicaSetSpecPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable PodTemplateSpecPatch template;
        public Builder() {}
        public Builder(ReplicaSetSpecPatch defaults) {
        ...
        public ReplicaSetSpecPatch build() {
            final var _resultValue = new ReplicaSetSpecPatch();
