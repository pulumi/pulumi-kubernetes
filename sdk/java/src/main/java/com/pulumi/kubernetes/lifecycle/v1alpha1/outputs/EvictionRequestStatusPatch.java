...
@CustomType
public final class EvictionRequestStatusPatch {
    /**
    ...
    private EvictionRequestStatusPatch() {}
    /**
     * @return conditions contain information about the eviction request.
     * 
     * EvictionRequest specific conditions are: TargetEvicted or Failed (managed by evictionrequest-controller). - Failed means that the eviction request is no longer being processed
    ...
    public static Builder builder(EvictionRequestStatusPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer observedGeneration;
        public Builder() {}
        public Builder(EvictionRequestStatusPatch defaults) {
        ...
        public EvictionRequestStatusPatch build() {
            final var _resultValue = new EvictionRequestStatusPatch();
