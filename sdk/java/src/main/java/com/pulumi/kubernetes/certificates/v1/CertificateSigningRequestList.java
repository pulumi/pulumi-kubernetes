...
public class CertificateSigningRequestList extends com.pulumi.resources.CustomResource {
    ...
    public CertificateSigningRequestList(java.lang.String name, CertificateSigningRequestListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1:CertificateSigningRequestList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CertificateSigningRequestList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1:CertificateSigningRequestList", name, null, makeResourceOptions(options, id), false);
    }
