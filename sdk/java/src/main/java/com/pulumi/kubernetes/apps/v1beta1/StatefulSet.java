...
import com.pulumi.kubernetes.apps.v1beta1.StatefulSetArgs;
...
public class StatefulSet extends com.pulumi.resources.CustomResource {
    ...
    public StatefulSet(java.lang.String name, @Nullable StatefulSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta1:StatefulSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private StatefulSet(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta1:StatefulSet", name, null, makeResourceOptions(options, id), false);
    }
