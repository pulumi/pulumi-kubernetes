...
@CustomType
public final class PodSchedulingSpecPatch {
    /**
    ...
    public static Builder builder(PodSchedulingSpecPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String selectedNode;
        public Builder() {}
        public Builder(PodSchedulingSpecPatch defaults) {
        ...
        public PodSchedulingSpecPatch build() {
            final var _resultValue = new PodSchedulingSpecPatch();
