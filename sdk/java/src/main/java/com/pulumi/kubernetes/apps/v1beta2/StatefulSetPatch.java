...
public class StatefulSetPatch extends com.pulumi.resources.CustomResource {
    ...
    public StatefulSetPatch(java.lang.String name, @Nullable StatefulSetPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:StatefulSetPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private StatefulSetPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:StatefulSetPatch", name, null, makeResourceOptions(options, id), false);
    }
