...
import com.pulumi.kubernetes.apps.v1beta2.StatefulSetPatchArgs;
import com.pulumi.kubernetes.apps.v1beta2.outputs.StatefulSetSpecPatch;
import com.pulumi.kubernetes.apps.v1beta2.outputs.StatefulSetStatusPatch;
...
@ResourceType(type="kubernetes:apps/v1beta2:StatefulSetPatch")
public class StatefulSetPatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public StatefulSetPatch(String name, StatefulSetPatchArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public StatefulSetPatch(String name, StatefulSetPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:StatefulSetPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private StatefulSetPatch(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:StatefulSetPatch", name, null, makeResourceOptions(options, id));
    }

    private static StatefulSetPatchArgs makeArgs(StatefulSetPatchArgs args) {
