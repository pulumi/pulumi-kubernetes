...
import com.pulumi.kubernetes.policy.v1beta1.inputs.AllowedCSIDriverPatchArgs;
import com.pulumi.kubernetes.policy.v1beta1.inputs.AllowedFlexVolumePatchArgs;
import com.pulumi.kubernetes.policy.v1beta1.inputs.AllowedHostPathPatchArgs;
import com.pulumi.kubernetes.policy.v1beta1.inputs.FSGroupStrategyOptionsPatchArgs;
import com.pulumi.kubernetes.policy.v1beta1.inputs.HostPortRangePatchArgs;
import com.pulumi.kubernetes.policy.v1beta1.inputs.RunAsGroupStrategyOptionsPatchArgs;
import com.pulumi.kubernetes.policy.v1beta1.inputs.RunAsUserStrategyOptionsPatchArgs;
import com.pulumi.kubernetes.policy.v1beta1.inputs.RuntimeClassStrategyOptionsPatchArgs;
import com.pulumi.kubernetes.policy.v1beta1.inputs.SELinuxStrategyOptionsPatchArgs;
import com.pulumi.kubernetes.policy.v1beta1.inputs.SupplementalGroupsStrategyOptionsPatchArgs;
...
public final class PodSecurityPolicySpecPatchArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="fsGroup")
    private @Nullable Output<FSGroupStrategyOptionsPatchArgs> fsGroup;

    /**
     * @return fsGroup is the strategy that will dictate what fs group is used by the SecurityContext.
     * 
     */
    public Optional<Output<FSGroupStrategyOptionsPatchArgs>> fsGroup() {
    ...
    private @Nullable Output<List<HostPortRangePatchArgs>> hostPorts;

    /**
     * @return hostPorts determines which host port ranges are allowed to be exposed.
     * 
     */
    public Optional<Output<List<HostPortRangePatchArgs>>> hostPorts() {
    ...
    private @Nullable Output<RunAsGroupStrategyOptionsPatchArgs> runAsGroup;
     ...
     * 
     */
    public Optional<Output<RunAsGroupStrategyOptionsPatchArgs>> runAsGroup() {
    ...
    private @Nullable Output<RunAsUserStrategyOptionsPatchArgs> runAsUser;

    /**
     * @return runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
     * 
     */
    public Optional<Output<RunAsUserStrategyOptionsPatchArgs>> runAsUser() {
    ...
    private @Nullable Output<RuntimeClassStrategyOptionsPatchArgs> runtimeClass;
     ...
     * 
     */
    public Optional<Output<RuntimeClassStrategyOptionsPatchArgs>> runtimeClass() {
     ...
     */
    @Import(name="seLinux")
    private @Nullable Output<SELinuxStrategyOptionsPatchArgs> seLinux;

    /**
     * @return seLinux is the strategy that will dictate the allowable labels that may be set.
     * 
     */
    public Optional<Output<SELinuxStrategyOptionsPatchArgs>> seLinux() {
    ...
    private @Nullable Output<SupplementalGroupsStrategyOptionsPatchArgs> supplementalGroups;

    /**
     * @return supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
     * 
     */
    public Optional<Output<SupplementalGroupsStrategyOptionsPatchArgs>> supplementalGroups() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder allowedCSIDrivers(@Nullable Output<List<AllowedCSIDriverPatchArgs>> allowedCSIDrivers) {
         ...
         * 
         */
        public Builder allowedCSIDrivers(List<AllowedCSIDriverPatchArgs> allowedCSIDrivers) {
         ...
         * 
         */
        public Builder allowedFlexVolumes(@Nullable Output<List<AllowedFlexVolumePatchArgs>> allowedFlexVolumes) {
         ...
         * 
         */
        public Builder allowedFlexVolumes(List<AllowedFlexVolumePatchArgs> allowedFlexVolumes) {
         ...
         * 
         */
        public Builder allowedHostPaths(@Nullable Output<List<AllowedHostPathPatchArgs>> allowedHostPaths) {
         ...
         * 
         */
        public Builder allowedHostPaths(List<AllowedHostPathPatchArgs> allowedHostPaths) {
         ...
         * 
         */
        public Builder fsGroup(@Nullable Output<FSGroupStrategyOptionsPatchArgs> fsGroup) {
            $.fsGroup = fsGroup;
            return this;
        }
         ...
         * 
         */
        public Builder hostPorts(@Nullable Output<List<HostPortRangePatchArgs>> hostPorts) {
            $.hostPorts = hostPorts;
            return this;
        }
         ...
         * 
         */
        public Builder hostPorts(List<HostPortRangePatchArgs> hostPorts) {
         ...
         * 
         */
        public Builder runAsGroup(@Nullable Output<RunAsGroupStrategyOptionsPatchArgs> runAsGroup) {
         ...
         * 
         */
        public Builder runAsUser(@Nullable Output<RunAsUserStrategyOptionsPatchArgs> runAsUser) {
            $.runAsUser = runAsUser;
            return this;
        }
         ...
         * 
         */
        public Builder runtimeClass(@Nullable Output<RuntimeClassStrategyOptionsPatchArgs> runtimeClass) {
         ...
         * 
         */
        public Builder seLinux(@Nullable Output<SELinuxStrategyOptionsPatchArgs> seLinux) {
            $.seLinux = seLinux;
            return this;
        }
         ...
         * 
         */
        public Builder supplementalGroups(@Nullable Output<SupplementalGroupsStrategyOptionsPatchArgs> supplementalGroups) {
