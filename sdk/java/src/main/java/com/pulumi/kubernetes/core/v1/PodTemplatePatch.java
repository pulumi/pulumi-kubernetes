...
public class PodTemplatePatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public PodTemplatePatch(java.lang.String name) {
     ...
     */
    public PodTemplatePatch(java.lang.String name, @Nullable PodTemplatePatchArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PodTemplatePatch(java.lang.String name, @Nullable PodTemplatePatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:PodTemplatePatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PodTemplatePatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:PodTemplatePatch", name, null, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static PodTemplatePatch get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
