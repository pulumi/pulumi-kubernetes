...
@CustomType
public final class TokenReviewSpecPatch {
    /**
    ...
    public static Builder builder(TokenReviewSpecPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String token;
        public Builder() {}
        public Builder(TokenReviewSpecPatch defaults) {
        ...
        public TokenReviewSpecPatch build() {
            final var o = new TokenReviewSpecPatch();
