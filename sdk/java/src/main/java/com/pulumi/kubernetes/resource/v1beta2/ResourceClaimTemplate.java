...
import com.pulumi.kubernetes.resource.v1beta2.ResourceClaimTemplateArgs;
import com.pulumi.kubernetes.resource.v1beta2.outputs.ResourceClaimTemplateSpec;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplate")
