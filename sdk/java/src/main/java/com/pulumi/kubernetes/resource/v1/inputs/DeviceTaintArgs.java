 ...
 * 
 */
public final class DeviceTaintArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DeviceTaintArgs() {}

    private DeviceTaintArgs(DeviceTaintArgs $) {
        this.effect = $.effect;
        this.key = $.key;
    ...
    public static Builder builder(DeviceTaintArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DeviceTaintArgs defaults) {
            $ = new DeviceTaintArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeviceTaintArgs build() {
            if ($.effect == null) {
                throw new MissingRequiredPropertyException("DeviceTaintArgs", "effect");
            }
            if ($.key == null) {
                throw new MissingRequiredPropertyException("DeviceTaintArgs", "key");
            }
            return $;
        }
    }
