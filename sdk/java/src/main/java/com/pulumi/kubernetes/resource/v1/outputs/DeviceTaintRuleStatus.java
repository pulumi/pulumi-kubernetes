...
@CustomType
public final class DeviceTaintRuleStatus {
    /**
    ...
    public static Builder builder(DeviceTaintRuleStatus defaults) {
    ...
    public static final class Builder {
        private @Nullable List<Condition> conditions;
        public Builder() {}
        public Builder(DeviceTaintRuleStatus defaults) {
        ...
        public DeviceTaintRuleStatus build() {
            final var _resultValue = new DeviceTaintRuleStatus();
