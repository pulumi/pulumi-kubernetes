...
import com.pulumi.kubernetes.certificates.v1.ClusterTrustBundlePatchArgs;
import com.pulumi.kubernetes.certificates.v1.outputs.ClusterTrustBundleSpecPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch")
public class ClusterTrustBundlePatch extends com.pulumi.resources.CustomResource {
    ...
    public ClusterTrustBundlePatch(java.lang.String name, @Nullable ClusterTrustBundlePatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClusterTrustBundlePatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch", name, null, makeResourceOptions(options, id), false);
    }
