...
@CustomType
public final class PolicyRulePatch {
    /**
    ...
    public static Builder builder(PolicyRulePatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> verbs;
        public Builder() {}
        public Builder(PolicyRulePatch defaults) {
