...
public class DaemonSetList extends com.pulumi.resources.CustomResource {
    ...
    public DaemonSetList(java.lang.String name, DaemonSetListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DaemonSetList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DaemonSetList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DaemonSetList", name, null, makeResourceOptions(options, id), false);
    }
