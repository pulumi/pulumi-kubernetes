...
import com.pulumi.kubernetes.core.v1.NodeListArgs;
import com.pulumi.kubernetes.core.v1.outputs.Node;
...
public class NodeList extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="items", refs={List.class,Node.class}, tree="[0,1]")
