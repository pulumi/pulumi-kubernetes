...
public class CronJobPatch extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", type=CronJobSpecPatch.class, parameters={})
     ...
     * 
     */
    @Export(name="status", type=CronJobStatusPatch.class, parameters={})
    ...
    public CronJobPatch(String name, CronJobPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v1beta1:CronJobPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
