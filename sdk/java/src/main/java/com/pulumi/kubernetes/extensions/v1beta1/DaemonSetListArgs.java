...
import com.pulumi.kubernetes.extensions.v1beta1.inputs.DaemonSetArgs;
...
public final class DaemonSetListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DaemonSetListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("DaemonSetListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("DaemonSetList").getNullable();
            return $;
        }
    }
