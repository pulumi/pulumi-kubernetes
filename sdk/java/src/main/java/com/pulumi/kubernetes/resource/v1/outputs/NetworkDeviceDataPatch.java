...
public final class NetworkDeviceDataPatch {
    ...
    public static Builder builder(NetworkDeviceDataPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ips;
        public Builder() {}
        public Builder(NetworkDeviceDataPatch defaults) {
        ...
        public NetworkDeviceDataPatch build() {
            final var _resultValue = new NetworkDeviceDataPatch();
