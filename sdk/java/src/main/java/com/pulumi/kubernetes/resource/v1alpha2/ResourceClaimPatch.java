...
import com.pulumi.kubernetes.resource.v1alpha2.ResourceClaimPatchArgs;
import com.pulumi.kubernetes.resource.v1alpha2.outputs.ResourceClaimSpecPatch;
import com.pulumi.kubernetes.resource.v1alpha2.outputs.ResourceClaimStatusPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch")
public class ResourceClaimPatch extends com.pulumi.resources.CustomResource {
    ...
    public ResourceClaimPatch(String name, @Nullable ResourceClaimPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private static ResourceClaimPatchArgs makeArgs(@Nullable ResourceClaimPatchArgs args) {
