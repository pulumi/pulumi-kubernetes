...
public class RoleBindingList extends com.pulumi.resources.CustomResource {
    ...
    public RoleBindingList(java.lang.String name, RoleBindingListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBindingList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RoleBindingList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBindingList", name, null, makeResourceOptions(options, id), false);
    }
