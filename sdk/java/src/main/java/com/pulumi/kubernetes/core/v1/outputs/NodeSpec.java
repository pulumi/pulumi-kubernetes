...
import com.pulumi.kubernetes.core.v1.outputs.NodePodPreemptionPolicy;
...
public final class NodeSpec {
     ...
     * 
     */
    private @Nullable NodePodPreemptionPolicy podPreemptionPolicy;
    /**
     ...
     * 
     */
    public Optional<NodePodPreemptionPolicy> podPreemptionPolicy() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder podPreemptionPolicy(@Nullable NodePodPreemptionPolicy podPreemptionPolicy) {
        ...
        public NodeSpec build() {
            final var _resultValue = new NodeSpec();
