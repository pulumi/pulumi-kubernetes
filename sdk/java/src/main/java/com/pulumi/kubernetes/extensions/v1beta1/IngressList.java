...
import com.pulumi.kubernetes.extensions.v1beta1.IngressListArgs;
import com.pulumi.kubernetes.extensions.v1beta1.outputs.Ingress;
...
public class IngressList extends com.pulumi.resources.CustomResource {
    ...
    public IngressList(java.lang.String name, IngressListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:IngressList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IngressList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:IngressList", name, null, makeResourceOptions(options, id), false);
    }
