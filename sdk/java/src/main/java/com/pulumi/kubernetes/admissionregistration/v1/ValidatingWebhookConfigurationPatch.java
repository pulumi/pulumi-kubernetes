...
public class ValidatingWebhookConfigurationPatch extends com.pulumi.resources.CustomResource {
    ...
    public ValidatingWebhookConfigurationPatch(java.lang.String name, @Nullable ValidatingWebhookConfigurationPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1:ValidatingWebhookConfigurationPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ValidatingWebhookConfigurationPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1:ValidatingWebhookConfigurationPatch", name, null, makeResourceOptions(options, id), false);
    }
