...
import com.pulumi.kubernetes.events.v1beta1.inputs.EventSeriesPatchArgs;
...
public final class EventPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public EventPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("events.k8s.io/v1beta1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("Event").getNullable();
            return $;
        }
    }
