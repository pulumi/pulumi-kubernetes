...
import com.pulumi.kubernetes.coordination.v1beta1.LeaseCandidateArgs;
import com.pulumi.kubernetes.coordination.v1beta1.outputs.LeaseCandidateSpec;
 ...
 * 
 */
@ResourceType(type="kubernetes:coordination.k8s.io/v1beta1:LeaseCandidate")
