...
import com.pulumi.kubernetes.coordination.v1alpha2.inputs.LeaseCandidateSpecPatchArgs;
...
public final class LeaseCandidatePatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LeaseCandidatePatchArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("LeaseCandidate").getNullable();
            return $;
        }
    }
