...
import com.pulumi.kubernetes.policy.v1.inputs.PodDisruptionBudgetSpecPatchArgs;
...
public final class PodDisruptionBudgetPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PodDisruptionBudgetPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("policy/v1").getNullable();
