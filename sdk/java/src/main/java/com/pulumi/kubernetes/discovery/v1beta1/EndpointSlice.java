...
public class EndpointSlice extends com.pulumi.resources.CustomResource {
    ...
    public EndpointSlice(java.lang.String name, EndpointSliceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:discovery.k8s.io/v1beta1:EndpointSlice", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private EndpointSlice(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:discovery.k8s.io/v1beta1:EndpointSlice", name, null, makeResourceOptions(options, id), false);
    }
