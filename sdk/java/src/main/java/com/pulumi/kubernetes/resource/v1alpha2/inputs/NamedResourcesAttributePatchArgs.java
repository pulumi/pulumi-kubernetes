...
public final class NamedResourcesAttributePatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<NamedResourcesIntSlicePatchArgs> intSlice;

    /**
     * @return IntSliceValue is an array of 64-bit integers.
     * 
     */
    public Optional<Output<NamedResourcesIntSlicePatchArgs>> intSlice() {
    ...
    private @Nullable Output<NamedResourcesStringSlicePatchArgs> stringSlice;

    /**
     * @return StringSliceValue is an array of strings.
     * 
     */
    public Optional<Output<NamedResourcesStringSlicePatchArgs>> stringSlice() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder intSlice(@Nullable Output<NamedResourcesIntSlicePatchArgs> intSlice) {
            $.intSlice = intSlice;
            return this;
        }
         ...
         * 
         */
        public Builder stringSlice(@Nullable Output<NamedResourcesStringSlicePatchArgs> stringSlice) {
