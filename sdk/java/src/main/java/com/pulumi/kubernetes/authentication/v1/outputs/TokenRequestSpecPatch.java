...
import com.pulumi.kubernetes.authentication.v1.outputs.BoundObjectReferencePatch;
...
@CustomType
public final class TokenRequestSpecPatch {
    /**
     ...
     * 
     */
    private @Nullable BoundObjectReferencePatch boundObjectRef;
    /**
     ...
     * 
     */
    public Optional<BoundObjectReferencePatch> boundObjectRef() {
    ...
    public static Builder builder(TokenRequestSpecPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer expirationSeconds;
        public Builder() {}
        public Builder(TokenRequestSpecPatch defaults) {
        ...
        @CustomType.Setter
        public Builder boundObjectRef(@Nullable BoundObjectReferencePatch boundObjectRef) {
        ...
        public TokenRequestSpecPatch build() {
            final var o = new TokenRequestSpecPatch();
