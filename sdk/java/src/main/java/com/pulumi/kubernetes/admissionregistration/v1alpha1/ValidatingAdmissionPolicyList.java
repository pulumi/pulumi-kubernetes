...
public class ValidatingAdmissionPolicyList extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="items", type=List.class, parameters={ValidatingAdmissionPolicy.class})
    private Output</* @Nullable */ List<ValidatingAdmissionPolicy>> items;

    /**
     * @return List of ValidatingAdmissionPolicy.
     * 
     */
    public Output<Optional<List<ValidatingAdmissionPolicy>>> items() {
