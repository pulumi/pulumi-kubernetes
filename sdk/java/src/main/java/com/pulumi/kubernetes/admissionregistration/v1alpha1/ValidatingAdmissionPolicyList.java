...
public class ValidatingAdmissionPolicyList extends com.pulumi.resources.CustomResource {
    ...
    public ValidatingAdmissionPolicyList(java.lang.String name, ValidatingAdmissionPolicyListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ValidatingAdmissionPolicyList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyList", name, null, makeResourceOptions(options, id), false);
    }
