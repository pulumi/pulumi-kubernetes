...
import com.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassArgs;
...
public final class RuntimeClassListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RuntimeClassListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("RuntimeClassListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("RuntimeClassList").getNullable();
            return $;
        }
    }
