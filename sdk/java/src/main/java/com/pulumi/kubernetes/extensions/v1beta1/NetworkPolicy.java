...
import com.pulumi.kubernetes.extensions.v1beta1.NetworkPolicyArgs;
...
public class NetworkPolicy extends com.pulumi.resources.CustomResource {
    ...
    private Output<NetworkPolicySpec> spec;

    /**
     * @return Specification of the desired behavior for this NetworkPolicy.
     * 
     */
    public Output<NetworkPolicySpec> spec() {
        return this.spec;
    }
    ...
    public NetworkPolicy(java.lang.String name, @Nullable NetworkPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:NetworkPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NetworkPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:NetworkPolicy", name, null, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:networking.k8s.io/v1:NetworkPolicy").build())
            ))
            .build();
     ...
     */
    public static NetworkPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
