...
public final class PersistentVolumeListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PersistentVolumeListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("PersistentVolumeListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("PersistentVolumeList").getNullable();
            return $;
        }
    }
