 ...
 * 
 */
public final class PortworxVolumeSourcePatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PortworxVolumeSourcePatchArgs(PortworxVolumeSourcePatchArgs $) {
        this.fsType = $.fsType;
    ...
    public static Builder builder(PortworxVolumeSourcePatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PortworxVolumeSourcePatchArgs();
        }

        public Builder(PortworxVolumeSourcePatchArgs defaults) {
            $ = new PortworxVolumeSourcePatchArgs(Objects.requireNonNull(defaults));
        }
