...
import com.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetArgs;
...
public final class ReplicaSetListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ReplicaSetListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("ReplicaSetListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("ReplicaSetList").getNullable();
            return $;
        }
    }
