...
public final class JobPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobPatchArgs Empty = new JobPatchArgs();
    ...
    private JobPatchArgs() {}

    private JobPatchArgs(JobPatchArgs $) {
    ...
    public static Builder builder(JobPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(JobPatchArgs defaults) {
            $ = new JobPatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("batch/v1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("Job").getNullable();
            return $;
        }
    }
