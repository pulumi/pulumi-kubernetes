...
import com.pulumi.kubernetes.networking.v1.IPAddressArgs;
import com.pulumi.kubernetes.networking.v1.outputs.IPAddressSpec;
 ...
 * 
 */
@ResourceType(type="kubernetes:networking.k8s.io/v1:IPAddress")
public class IPAddress extends com.pulumi.resources.CustomResource {
    ...
    public IPAddress(java.lang.String name, @Nullable IPAddressArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:IPAddress", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IPAddress(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:IPAddress", name, null, makeResourceOptions(options, id), false);
    }
