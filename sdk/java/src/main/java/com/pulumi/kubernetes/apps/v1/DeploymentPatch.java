...
public class DeploymentPatch extends com.pulumi.resources.CustomResource {
    ...
    public DeploymentPatch(java.lang.String name, @Nullable DeploymentPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:DeploymentPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DeploymentPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:DeploymentPatch", name, null, makeResourceOptions(options, id), false);
    }
