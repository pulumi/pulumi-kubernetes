...
import com.pulumi.kubernetes.scheduling.v1beta1.PriorityClassArgs;
...
public class PriorityClass extends com.pulumi.resources.CustomResource {
    ...
    public PriorityClass(java.lang.String name, PriorityClassArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:scheduling.k8s.io/v1beta1:PriorityClass", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PriorityClass(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:scheduling.k8s.io/v1beta1:PriorityClass", name, null, makeResourceOptions(options, id), false);
    }
