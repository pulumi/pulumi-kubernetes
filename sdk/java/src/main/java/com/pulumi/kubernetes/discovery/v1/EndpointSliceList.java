...
public class EndpointSliceList extends com.pulumi.resources.CustomResource {
    ...
    public EndpointSliceList(java.lang.String name, EndpointSliceListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:discovery.k8s.io/v1:EndpointSliceList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private EndpointSliceList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:discovery.k8s.io/v1:EndpointSliceList", name, null, makeResourceOptions(options, id), false);
    }
