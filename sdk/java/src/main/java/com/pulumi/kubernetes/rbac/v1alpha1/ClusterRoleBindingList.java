...
public class ClusterRoleBindingList extends com.pulumi.resources.CustomResource {
    ...
    public ClusterRoleBindingList(java.lang.String name, ClusterRoleBindingListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClusterRoleBindingList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingList", name, null, makeResourceOptions(options, id), false);
    }
