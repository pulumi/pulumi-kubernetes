...
public class PodSchedulingContextList extends com.pulumi.resources.CustomResource {
    ...
    public PodSchedulingContextList(java.lang.String name, PodSchedulingContextListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha2:PodSchedulingContextList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PodSchedulingContextList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha2:PodSchedulingContextList", name, null, makeResourceOptions(options, id), false);
    }
