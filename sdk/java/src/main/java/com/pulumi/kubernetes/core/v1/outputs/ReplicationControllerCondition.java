...
public final class ReplicationControllerCondition {
    ...
    public static final class Builder {
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("ReplicationControllerCondition", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ReplicationControllerCondition", "type");
            }
            this.type = type;
            return this;
        }
        public ReplicationControllerCondition build() {
            final var _resultValue = new ReplicationControllerCondition();
