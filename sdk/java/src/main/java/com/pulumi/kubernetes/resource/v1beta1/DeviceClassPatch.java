...
import com.pulumi.kubernetes.resource.v1beta1.DeviceClassPatchArgs;
import com.pulumi.kubernetes.resource.v1beta1.outputs.DeviceClassSpecPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1beta1:DeviceClassPatch")
public class DeviceClassPatch extends com.pulumi.resources.CustomResource {
    ...
    public DeviceClassPatch(java.lang.String name, @Nullable DeviceClassPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta1:DeviceClassPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DeviceClassPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta1:DeviceClassPatch", name, null, makeResourceOptions(options, id), false);
    }
