...
public class IngressPatch extends com.pulumi.resources.CustomResource {
    ...
    public IngressPatch(java.lang.String name, @Nullable IngressPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:IngressPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IngressPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:IngressPatch", name, null, makeResourceOptions(options, id), false);
    }
