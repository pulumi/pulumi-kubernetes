...
import com.pulumi.kubernetes.authorization.v1.SelfSubjectAccessReviewPatchArgs;
import com.pulumi.kubernetes.authorization.v1.outputs.SelfSubjectAccessReviewSpecPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:authorization.k8s.io/v1:SelfSubjectAccessReviewPatch")
public class SelfSubjectAccessReviewPatch extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", refs={SelfSubjectAccessReviewSpecPatch.class}, tree="[0]")
    ...
    public SelfSubjectAccessReviewPatch(String name, @Nullable SelfSubjectAccessReviewPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:authorization.k8s.io/v1:SelfSubjectAccessReviewPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private SelfSubjectAccessReviewPatch(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:authorization.k8s.io/v1:SelfSubjectAccessReviewPatch", name, null, makeResourceOptions(options, id));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:authorization.k8s.io/v1beta1:SelfSubjectAccessReviewPatch").build())
            ))
            .build();
