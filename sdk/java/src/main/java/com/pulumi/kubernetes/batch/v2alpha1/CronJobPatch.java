...
public class CronJobPatch extends com.pulumi.resources.CustomResource {
    ...
    public CronJobPatch(java.lang.String name, @Nullable CronJobPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v2alpha1:CronJobPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CronJobPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v2alpha1:CronJobPatch", name, null, makeResourceOptions(options, id), false);
    }
