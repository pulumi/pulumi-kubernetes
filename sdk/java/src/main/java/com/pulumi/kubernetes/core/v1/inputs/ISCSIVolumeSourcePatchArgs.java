 ...
 * 
 */
public final class ISCSIVolumeSourcePatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ISCSIVolumeSourcePatchArgs(ISCSIVolumeSourcePatchArgs $) {
    ...
    public static Builder builder(ISCSIVolumeSourcePatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ISCSIVolumeSourcePatchArgs();
        }

        public Builder(ISCSIVolumeSourcePatchArgs defaults) {
            $ = new ISCSIVolumeSourcePatchArgs(Objects.requireNonNull(defaults));
        }
