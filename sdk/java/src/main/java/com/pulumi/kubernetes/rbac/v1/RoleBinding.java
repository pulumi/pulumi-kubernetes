...
import com.pulumi.kubernetes.rbac.v1.RoleBindingArgs;
...
public class RoleBinding extends com.pulumi.resources.CustomResource {
    ...
    public RoleBinding(java.lang.String name, RoleBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:RoleBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RoleBinding(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:RoleBinding", name, null, makeResourceOptions(options, id), false);
    }
