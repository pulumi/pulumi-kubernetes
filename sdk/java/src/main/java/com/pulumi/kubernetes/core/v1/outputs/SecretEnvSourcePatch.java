...
public final class SecretEnvSourcePatch {
    ...
    public static Builder builder(SecretEnvSourcePatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean optional;
        public Builder() {}
        public Builder(SecretEnvSourcePatch defaults) {
        ...
        public SecretEnvSourcePatch build() {
            final var _resultValue = new SecretEnvSourcePatch();
