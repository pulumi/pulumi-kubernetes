...
public class StatusPatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public StatusPatch(java.lang.String name) {
     ...
     */
    public StatusPatch(java.lang.String name, @Nullable StatusPatchArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public StatusPatch(java.lang.String name, @Nullable StatusPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:meta/v1:StatusPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private StatusPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:meta/v1:StatusPatch", name, null, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static StatusPatch get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
