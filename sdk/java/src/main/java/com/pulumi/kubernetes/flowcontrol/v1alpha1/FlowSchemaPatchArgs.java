...
import com.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaSpecPatchArgs;
...
public final class FlowSchemaPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final FlowSchemaPatchArgs Empty = new FlowSchemaPatchArgs();
     ...
     */
    @Import(name="spec")
    private @Nullable Output<FlowSchemaSpecPatchArgs> spec;
     ...
     * 
     */
    public Optional<Output<FlowSchemaSpecPatchArgs>> spec() {
        return Optional.ofNullable(this.spec);
    }

    private FlowSchemaPatchArgs() {}

    private FlowSchemaPatchArgs(FlowSchemaPatchArgs $) {
    ...
    public static Builder builder(FlowSchemaPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlowSchemaPatchArgs();
        }

        public Builder(FlowSchemaPatchArgs defaults) {
            $ = new FlowSchemaPatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(@Nullable Output<FlowSchemaSpecPatchArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(FlowSchemaSpecPatchArgs spec) {
            return spec(Output.of(spec));
        }

        public FlowSchemaPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("flowcontrol.apiserver.k8s.io/v1alpha1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("FlowSchema").getNullable();
            return $;
        }
    }
