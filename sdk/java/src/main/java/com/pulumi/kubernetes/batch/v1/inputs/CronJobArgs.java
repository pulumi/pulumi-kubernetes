...
import com.pulumi.kubernetes.batch.v1.inputs.CronJobStatusArgs;
...
public final class CronJobArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<CronJobSpecArgs> spec;
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder spec(Output<CronJobSpecArgs> spec) {
            $.spec = spec;
            return this;
        }
        ...
        public CronJobArgs build() {
            ...
            if ($.spec == null) {
                throw new MissingRequiredPropertyException("CronJobArgs", "spec");
            }
            return $;
        }
    }
