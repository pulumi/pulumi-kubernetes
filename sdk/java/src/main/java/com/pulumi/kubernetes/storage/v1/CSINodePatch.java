 ...
 * 
 */
@ResourceType(type="kubernetes:storage.k8s.io/v1:CSINodePatch")
public class CSINodePatch extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", type=CSINodeSpecPatch.class, parameters={})
     ...
     */
    public CSINodePatch(String name, CSINodePatchArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CSINodePatch(String name, CSINodePatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1:CSINodePatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private CSINodePatch(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1:CSINodePatch", name, null, makeResourceOptions(options, id));
    }

    private static CSINodePatchArgs makeArgs(CSINodePatchArgs args) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:storage.k8s.io/v1beta1:CSINodePatch").build())
            ))
            .build();
