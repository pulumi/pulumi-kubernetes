...
import com.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MatchConditionPatchArgs;
import com.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MatchResourcesPatchArgs;
import com.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MutationPatchArgs;
import com.pulumi.kubernetes.admissionregistration.v1beta1.inputs.ParamKindPatchArgs;
import com.pulumi.kubernetes.admissionregistration.v1beta1.inputs.VariablePatchArgs;
 ...
 * 
 */
public final class MutatingAdmissionPolicySpecPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final MutatingAdmissionPolicySpecPatchArgs Empty = new MutatingAdmissionPolicySpecPatchArgs();
    ...
    private @Nullable Output<List<MutationPatchArgs>> mutations;
     ...
     * 
     */
    public Optional<Output<List<MutationPatchArgs>>> mutations() {
    ...
    private MutatingAdmissionPolicySpecPatchArgs() {}

    private MutatingAdmissionPolicySpecPatchArgs(MutatingAdmissionPolicySpecPatchArgs $) {
    ...
    public static Builder builder(MutatingAdmissionPolicySpecPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MutatingAdmissionPolicySpecPatchArgs();
        }

        public Builder(MutatingAdmissionPolicySpecPatchArgs defaults) {
            $ = new MutatingAdmissionPolicySpecPatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder mutations(@Nullable Output<List<MutationPatchArgs>> mutations) {
            $.mutations = mutations;
            return this;
        }
         ...
         * 
         */
        public Builder mutations(List<MutationPatchArgs> mutations) {
         ...
         * 
         */
        public Builder mutations(MutationPatchArgs... mutations) {
        ...
        public MutatingAdmissionPolicySpecPatchArgs build() {
            return $;
        }
    }
