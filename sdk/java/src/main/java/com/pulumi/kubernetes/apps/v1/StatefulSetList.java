...
public class StatefulSetList extends com.pulumi.resources.CustomResource {
    ...
    public StatefulSetList(java.lang.String name, StatefulSetListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:StatefulSetList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private StatefulSetList(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:StatefulSetList", name, null, makeResourceOptions(options, id), false);
    }
