...
import com.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MutatingWebhookConfigurationArgs;
...
public final class MutatingWebhookConfigurationListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public MutatingWebhookConfigurationListArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("MutatingWebhookConfigurationList").getNullable();
            return $;
        }
    }
