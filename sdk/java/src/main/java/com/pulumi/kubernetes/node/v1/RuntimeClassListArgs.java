...
import com.pulumi.kubernetes.node.v1.inputs.RuntimeClassArgs;
...
public final class RuntimeClassListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RuntimeClassListArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("node.k8s.io/v1").getNullable();
            if ($.items == null) {
