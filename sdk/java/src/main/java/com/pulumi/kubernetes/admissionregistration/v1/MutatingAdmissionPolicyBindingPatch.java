...
import com.pulumi.kubernetes.admissionregistration.v1.MutatingAdmissionPolicyBindingPatchArgs;
import com.pulumi.kubernetes.admissionregistration.v1.outputs.MutatingAdmissionPolicyBindingSpecPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyBindingPatch")
public class MutatingAdmissionPolicyBindingPatch extends com.pulumi.resources.CustomResource {
    ...
    public MutatingAdmissionPolicyBindingPatch(java.lang.String name, @Nullable MutatingAdmissionPolicyBindingPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyBindingPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private MutatingAdmissionPolicyBindingPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyBindingPatch", name, null, makeResourceOptions(options, id), false);
    }
