...
import com.pulumi.kubernetes.core.v1.inputs.LimitRangeSpecPatchArgs;
...
public final class LimitRangePatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final LimitRangePatchArgs Empty = new LimitRangePatchArgs();
     ...
     */
    @Import(name="spec")
    private @Nullable Output<LimitRangeSpecPatchArgs> spec;
     ...
     * 
     */
    public Optional<Output<LimitRangeSpecPatchArgs>> spec() {
        return Optional.ofNullable(this.spec);
    }

    private LimitRangePatchArgs() {}

    private LimitRangePatchArgs(LimitRangePatchArgs $) {
    ...
    public static Builder builder(LimitRangePatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LimitRangePatchArgs();
        }

        public Builder(LimitRangePatchArgs defaults) {
            $ = new LimitRangePatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(@Nullable Output<LimitRangeSpecPatchArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(LimitRangeSpecPatchArgs spec) {
            return spec(Output.of(spec));
        }

        public LimitRangePatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("v1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("LimitRange").getNullable();
            return $;
        }
    }
