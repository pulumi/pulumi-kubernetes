...
import com.pulumi.kubernetes.resource.v1alpha2.ResourceClaimTemplatePatchArgs;
import com.pulumi.kubernetes.resource.v1alpha2.outputs.ResourceClaimTemplateSpecPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplatePatch")
public class ResourceClaimTemplatePatch extends com.pulumi.resources.CustomResource {
    ...
    public ResourceClaimTemplatePatch(java.lang.String name, @Nullable ResourceClaimTemplatePatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplatePatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ResourceClaimTemplatePatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplatePatch", name, null, makeResourceOptions(options, id), false);
    }
