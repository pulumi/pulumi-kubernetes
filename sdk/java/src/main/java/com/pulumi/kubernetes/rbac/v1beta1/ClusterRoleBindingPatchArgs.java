...
public final class ClusterRoleBindingPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterRoleBindingPatchArgs Empty = new ClusterRoleBindingPatchArgs();
    ...
    private ClusterRoleBindingPatchArgs() {}

    private ClusterRoleBindingPatchArgs(ClusterRoleBindingPatchArgs $) {
    ...
    public static Builder builder(ClusterRoleBindingPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterRoleBindingPatchArgs();
        }

        public Builder(ClusterRoleBindingPatchArgs defaults) {
            $ = new ClusterRoleBindingPatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterRoleBindingPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("rbac.authorization.k8s.io/v1beta1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("ClusterRoleBinding").getNullable();
            return $;
        }
    }
