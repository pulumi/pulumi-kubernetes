...
import com.pulumi.kubernetes.resource.v1alpha1.inputs.ResourceClassParametersReferencePatchArgs;
...
public final class ResourceClassPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ResourceClassPatchArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("ResourceClass").getNullable();
            return $;
        }
    }
