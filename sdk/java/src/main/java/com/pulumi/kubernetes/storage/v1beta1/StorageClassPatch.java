...
public class StorageClassPatch extends com.pulumi.resources.CustomResource {
    ...
    public StorageClassPatch(java.lang.String name, @Nullable StorageClassPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:StorageClassPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private StorageClassPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:StorageClassPatch", name, null, makeResourceOptions(options, id), false);
    }
