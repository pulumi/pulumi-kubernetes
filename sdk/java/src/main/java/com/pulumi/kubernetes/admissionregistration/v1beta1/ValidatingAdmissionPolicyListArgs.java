...
import com.pulumi.kubernetes.admissionregistration.v1beta1.inputs.ValidatingAdmissionPolicyArgs;
...
public final class ValidatingAdmissionPolicyListArgs extends com.pulumi.resources.ResourceArgs {

    public static final ValidatingAdmissionPolicyListArgs Empty = new ValidatingAdmissionPolicyListArgs();
    ...
    private ValidatingAdmissionPolicyListArgs() {}

    private ValidatingAdmissionPolicyListArgs(ValidatingAdmissionPolicyListArgs $) {
    ...
    public static Builder builder(ValidatingAdmissionPolicyListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ValidatingAdmissionPolicyListArgs();
        }

        public Builder(ValidatingAdmissionPolicyListArgs defaults) {
            $ = new ValidatingAdmissionPolicyListArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder items(List<ValidatingAdmissionPolicyArgs> items) {
         ...
         * 
         */
        public Builder items(ValidatingAdmissionPolicyArgs... items) {
        ...
        public ValidatingAdmissionPolicyListArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("ValidatingAdmissionPolicyList").getNullable();
            return $;
        }
    }
