 ...
 * 
 */
public final class PodCertificateProjectionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PodCertificateProjectionArgs Empty = new PodCertificateProjectionArgs();
     ...
     * 
     */
    @Import(name="userAnnotations")
    private @Nullable Output<Map<String,String>> userAnnotations;
     ...
     * 
     */
    public Optional<Output<Map<String,String>>> userAnnotations() {
        return Optional.ofNullable(this.userAnnotations);
    }

    private PodCertificateProjectionArgs() {}

    private PodCertificateProjectionArgs(PodCertificateProjectionArgs $) {
    ...
    public static Builder builder(PodCertificateProjectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PodCertificateProjectionArgs();
        }

        public Builder(PodCertificateProjectionArgs defaults) {
            $ = new PodCertificateProjectionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param userAnnotations userAnnotations allow pod authors to pass additional information to the signer implementation.  Kubernetes does not restrict or validate this metadata in any way.
         * 
         * These values are copied verbatim into the `spec.unverifiedUserAnnotations` field of the PodCertificateRequest objects that Kubelet creates.
         * 
         * Entries are subject to the same validation as object metadata annotations, with the addition that all keys must be domain-prefixed. No restrictions are placed on values, except an overall size limitation on the entire field.
         ...
         * 
         */
        public Builder userAnnotations(@Nullable Output<Map<String,String>> userAnnotations) {
         ...
         * 
         */
        public Builder userAnnotations(Map<String,String> userAnnotations) {
            return userAnnotations(Output.of(userAnnotations));
        }

        public PodCertificateProjectionArgs build() {
            if ($.keyType == null) {
                throw new MissingRequiredPropertyException("PodCertificateProjectionArgs", "keyType");
            }
            if ($.signerName == null) {
                throw new MissingRequiredPropertyException("PodCertificateProjectionArgs", "signerName");
            }
            return $;
        }
    }
