...
import com.pulumi.kubernetes.storage.v1beta1.CSIStorageCapacityArgs;
...
public class CSIStorageCapacity extends com.pulumi.resources.CustomResource {
    ...
    public CSIStorageCapacity(java.lang.String name, CSIStorageCapacityArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:CSIStorageCapacity", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CSIStorageCapacity(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:CSIStorageCapacity", name, null, makeResourceOptions(options, id), false);
    }
