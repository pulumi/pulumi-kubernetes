...
public class RuntimeClass extends com.pulumi.resources.CustomResource {
    ...
    public RuntimeClass(java.lang.String name, RuntimeClassArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:node.k8s.io/v1alpha1:RuntimeClass", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RuntimeClass(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:node.k8s.io/v1alpha1:RuntimeClass", name, null, makeResourceOptions(options, id), false);
    }
