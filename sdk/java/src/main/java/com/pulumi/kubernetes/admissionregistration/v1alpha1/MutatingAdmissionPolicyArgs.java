...
import com.pulumi.kubernetes.admissionregistration.v1alpha1.inputs.MutatingAdmissionPolicySpecArgs;
...
public final class MutatingAdmissionPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final MutatingAdmissionPolicyArgs Empty = new MutatingAdmissionPolicyArgs();
    ...
    private MutatingAdmissionPolicyArgs(MutatingAdmissionPolicyArgs $) {
    ...
    public static Builder builder(MutatingAdmissionPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MutatingAdmissionPolicyArgs();
        }

        public Builder(MutatingAdmissionPolicyArgs defaults) {
            $ = new MutatingAdmissionPolicyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(@Nullable Output<MutatingAdmissionPolicySpecArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(MutatingAdmissionPolicySpecArgs spec) {
