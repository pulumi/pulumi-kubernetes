...
@CustomType
public final class DeviceTaintRule {
    /**
    ...
    public static Builder builder(DeviceTaintRule defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder spec(DeviceTaintRuleSpec spec) {
            if (spec == null) {
              throw new MissingRequiredPropertyException("DeviceTaintRule", "spec");
            }
            this.spec = spec;
            return this;
        }
