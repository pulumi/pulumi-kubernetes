...
public class FlowSchema extends com.pulumi.resources.CustomResource {
    ...
    public FlowSchema(java.lang.String name, @Nullable FlowSchemaArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:FlowSchema", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private FlowSchema(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:FlowSchema", name, null, makeResourceOptions(options, id), false);
    }
