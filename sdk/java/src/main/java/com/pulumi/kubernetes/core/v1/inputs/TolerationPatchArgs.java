 ...
 * 
 */
public final class TolerationPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TolerationPatchArgs(TolerationPatchArgs $) {
        this.effect = $.effect;
        this.key = $.key;
    ...
    public static Builder builder(TolerationPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TolerationPatchArgs();
        }

        public Builder(TolerationPatchArgs defaults) {
            $ = new TolerationPatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param operator Operator represents a key&#39;s relationship to the value. Valid operators are Exists, Equal, Lt, and Gt. Defaults to Equal. Exists is equivalent to wildcard for value, so that a pod can tolerate all taints of a particular category. Lt and Gt perform numeric comparisons (requires feature gate TaintTolerationComparisonOperators).
         * 
         * @return builder
         * 
         */
