...
public final class EvictionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public EvictionArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("lifecycle.k8s.io/v1alpha1").getNullable();
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("Eviction").getNullable();
            if ($.spec == null) {
