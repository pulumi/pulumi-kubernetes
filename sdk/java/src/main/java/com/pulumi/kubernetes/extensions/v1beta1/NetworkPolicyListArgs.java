...
import com.pulumi.kubernetes.extensions.v1beta1.inputs.NetworkPolicyArgs;
...
public final class NetworkPolicyListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public NetworkPolicyListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("NetworkPolicyListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("NetworkPolicyList").getNullable();
            return $;
        }
    }
