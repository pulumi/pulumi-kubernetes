...
import com.pulumi.kubernetes.admissionregistration.v1alpha1.inputs.MutatingAdmissionPolicySpecPatchArgs;
...
public final class MutatingAdmissionPolicyPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final MutatingAdmissionPolicyPatchArgs Empty = new MutatingAdmissionPolicyPatchArgs();
     ...
     */
    @Import(name="spec")
    private @Nullable Output<MutatingAdmissionPolicySpecPatchArgs> spec;

    /**
     * @return spec defines the desired behavior of the MutatingAdmissionPolicy.
     * 
     */
    public Optional<Output<MutatingAdmissionPolicySpecPatchArgs>> spec() {
        return Optional.ofNullable(this.spec);
    }

    private MutatingAdmissionPolicyPatchArgs() {}

    private MutatingAdmissionPolicyPatchArgs(MutatingAdmissionPolicyPatchArgs $) {
    ...
    public static Builder builder(MutatingAdmissionPolicyPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MutatingAdmissionPolicyPatchArgs();
        }

        public Builder(MutatingAdmissionPolicyPatchArgs defaults) {
            $ = new MutatingAdmissionPolicyPatchArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(@Nullable Output<MutatingAdmissionPolicySpecPatchArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(MutatingAdmissionPolicySpecPatchArgs spec) {
            return spec(Output.of(spec));
        }

        public MutatingAdmissionPolicyPatchArgs build() {
