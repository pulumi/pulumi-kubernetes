...
public class PriorityLevelConfigurationPatch extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", type=PriorityLevelConfigurationSpecPatch.class, parameters={})
     ...
     * 
     */
    @Export(name="status", type=PriorityLevelConfigurationStatusPatch.class, parameters={})
     ...
     */
    public PriorityLevelConfigurationPatch(String name, PriorityLevelConfigurationPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfigurationPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private static PriorityLevelConfigurationPatchArgs makeArgs(PriorityLevelConfigurationPatchArgs args) {
