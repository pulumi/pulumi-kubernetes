...
import com.pulumi.kubernetes.extensions.v1beta1.DeploymentPatchArgs;
import com.pulumi.kubernetes.extensions.v1beta1.outputs.DeploymentSpecPatch;
import com.pulumi.kubernetes.extensions.v1beta1.outputs.DeploymentStatusPatch;
...
@ResourceType(type="kubernetes:extensions/v1beta1:DeploymentPatch")
public class DeploymentPatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public DeploymentPatch(java.lang.String name) {
     ...
     */
    public DeploymentPatch(java.lang.String name, @Nullable DeploymentPatchArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DeploymentPatch(java.lang.String name, @Nullable DeploymentPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DeploymentPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DeploymentPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DeploymentPatch", name, null, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:apps/v1:DeploymentPatch").build()),
     ...
     */
    public static DeploymentPatch get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
