...
public class DeploymentPatch extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", type=DeploymentSpecPatch.class, parameters={})
     ...
     * 
     */
    @Export(name="status", type=DeploymentStatusPatch.class, parameters={})
    ...
    public DeploymentPatch(String name, @Nullable DeploymentPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DeploymentPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private DeploymentPatch(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DeploymentPatch", name, null, makeResourceOptions(options, id));
    }
