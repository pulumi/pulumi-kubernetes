    ...
    public static final class Builder {
        ...
        public Builder pkixPublicKey(String pkixPublicKey) {
            if (pkixPublicKey == null) {
              throw new MissingRequiredPropertyException("PodCertificateRequestSpec", "pkixPublicKey");
            }
        ...
        public Builder proofOfPossession(String proofOfPossession) {
            if (proofOfPossession == null) {
              throw new MissingRequiredPropertyException("PodCertificateRequestSpec", "proofOfPossession");
            }
