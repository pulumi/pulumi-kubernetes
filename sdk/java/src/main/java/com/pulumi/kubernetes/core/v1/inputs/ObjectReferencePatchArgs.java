 ...
 * 
 */
public final class ObjectReferencePatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ObjectReferencePatchArgs(ObjectReferencePatchArgs $) {
    ...
    public static Builder builder(ObjectReferencePatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObjectReferencePatchArgs();
        }

        public Builder(ObjectReferencePatchArgs defaults) {
            $ = new ObjectReferencePatchArgs(Objects.requireNonNull(defaults));
        }
