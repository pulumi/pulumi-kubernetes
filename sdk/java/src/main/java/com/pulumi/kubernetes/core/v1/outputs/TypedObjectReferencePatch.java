...
@CustomType
public final class TypedObjectReferencePatch {
    /**
    ...
    private TypedObjectReferencePatch() {}
    /**
     * @return APIGroup is the group for the resource being referenced. If APIGroup is not specified, the specified Kind must be in the core API group. For any other third-party types, APIGroup is required.
     * 
     */
    ...
    public static Builder builder(TypedObjectReferencePatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String namespace;
        public Builder() {}
        public Builder(TypedObjectReferencePatch defaults) {
