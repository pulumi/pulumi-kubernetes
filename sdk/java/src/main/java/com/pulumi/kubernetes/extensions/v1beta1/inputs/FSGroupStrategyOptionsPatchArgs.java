 ...
 * 
 */
public final class FSGroupStrategyOptionsPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final FSGroupStrategyOptionsPatchArgs Empty = new FSGroupStrategyOptionsPatchArgs();
    ...
    private FSGroupStrategyOptionsPatchArgs() {}

    private FSGroupStrategyOptionsPatchArgs(FSGroupStrategyOptionsPatchArgs $) {
        this.ranges = $.ranges;
        this.rule = $.rule;
    }
    ...
    public static Builder builder(FSGroupStrategyOptionsPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FSGroupStrategyOptionsPatchArgs();
        }

        public Builder(FSGroupStrategyOptionsPatchArgs defaults) {
            $ = new FSGroupStrategyOptionsPatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FSGroupStrategyOptionsPatchArgs build() {
            return $;
        }
    }
