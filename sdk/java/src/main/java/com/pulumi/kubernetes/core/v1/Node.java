...
import com.pulumi.kubernetes.core.v1.NodeArgs;
...
public class Node extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", refs={NodeSpec.class}, tree="[0]")
    private Output<NodeSpec> spec;
    ...
    public Node(java.lang.String name, @Nullable NodeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:Node", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Node(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:Node", name, null, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static Node get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
