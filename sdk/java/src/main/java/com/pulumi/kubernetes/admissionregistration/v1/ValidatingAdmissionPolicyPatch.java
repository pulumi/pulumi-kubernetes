...
public class ValidatingAdmissionPolicyPatch extends com.pulumi.resources.CustomResource {
    ...
    public ValidatingAdmissionPolicyPatch(java.lang.String name, @Nullable ValidatingAdmissionPolicyPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ValidatingAdmissionPolicyPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyPatch", name, null, makeResourceOptions(options, id), false);
    }
