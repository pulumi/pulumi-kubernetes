...
@CustomType
public final class NamespaceConditionPatch {
    /**
    ...
    public static Builder builder(NamespaceConditionPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(NamespaceConditionPatch defaults) {
        ...
        public NamespaceConditionPatch build() {
            final var _resultValue = new NamespaceConditionPatch();
