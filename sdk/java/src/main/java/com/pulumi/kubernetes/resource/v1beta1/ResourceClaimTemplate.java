...
import com.pulumi.kubernetes.resource.v1beta1.ResourceClaimTemplateArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate")
public class ResourceClaimTemplate extends com.pulumi.resources.CustomResource {
    ...
    public ResourceClaimTemplate(String name, ResourceClaimTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private ResourceClaimTemplate(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate", name, null, makeResourceOptions(options, id));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("kubernetes:resource.k8s.io/v1alpha3:ResourceClaimTemplate").build())
            ))
            .build();
