...
public final class ParamRefPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(ParamRefPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ParamRefPatchArgs();
        }

        public Builder(ParamRefPatchArgs defaults) {
            $ = new ParamRefPatchArgs(Objects.requireNonNull(defaults));
        }
