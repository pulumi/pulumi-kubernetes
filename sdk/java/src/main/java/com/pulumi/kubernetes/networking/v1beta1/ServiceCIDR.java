...
import com.pulumi.kubernetes.networking.v1beta1.ServiceCIDRArgs;
import com.pulumi.kubernetes.networking.v1beta1.outputs.ServiceCIDRSpec;
import com.pulumi.kubernetes.networking.v1beta1.outputs.ServiceCIDRStatus;
 ...
 * 
 */
@ResourceType(type="kubernetes:networking.k8s.io/v1beta1:ServiceCIDR")
public class ServiceCIDR extends com.pulumi.resources.CustomResource {
    ...
    public ServiceCIDR(String name, @Nullable ServiceCIDRArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1beta1:ServiceCIDR", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceCIDR(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1beta1:ServiceCIDR", name, null, makeResourceOptions(options, id));
    }
