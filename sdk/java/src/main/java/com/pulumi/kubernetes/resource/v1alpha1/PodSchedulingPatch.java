...
public class PodSchedulingPatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public PodSchedulingPatch(String name) {
     ...
     */
    public PodSchedulingPatch(String name, @Nullable PodSchedulingPatchArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static PodSchedulingPatch get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
