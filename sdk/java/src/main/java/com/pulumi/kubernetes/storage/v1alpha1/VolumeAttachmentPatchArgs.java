...
import com.pulumi.kubernetes.storage.v1alpha1.inputs.VolumeAttachmentSpecPatchArgs;
...
public final class VolumeAttachmentPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public VolumeAttachmentPatchArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("VolumeAttachment").getNullable();
            return $;
        }
    }
