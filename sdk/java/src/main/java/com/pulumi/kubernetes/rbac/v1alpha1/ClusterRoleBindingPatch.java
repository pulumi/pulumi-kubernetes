...
public class ClusterRoleBindingPatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public ClusterRoleBindingPatch(String name, ClusterRoleBindingPatchArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ClusterRoleBindingPatch(String name, ClusterRoleBindingPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingPatch", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ClusterRoleBindingPatch(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingPatch", name, null, makeResourceOptions(options, id));
    }

    private static ClusterRoleBindingPatchArgs makeArgs(ClusterRoleBindingPatchArgs args) {
