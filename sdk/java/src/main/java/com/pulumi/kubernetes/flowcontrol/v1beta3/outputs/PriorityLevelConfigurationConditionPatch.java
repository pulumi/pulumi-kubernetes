...
@CustomType
public final class PriorityLevelConfigurationConditionPatch {
    /**
    ...
    private PriorityLevelConfigurationConditionPatch() {}
    /**
     * @return `lastTransitionTime` is the last time the condition transitioned from one status to another.
     * 
     */
    ...
    public static Builder builder(PriorityLevelConfigurationConditionPatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(PriorityLevelConfigurationConditionPatch defaults) {
        ...
        public PriorityLevelConfigurationConditionPatch build() {
            final var _resultValue = new PriorityLevelConfigurationConditionPatch();
