 ...
 * 
 */
public final class SupplementalGroupsStrategyOptionsPatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final SupplementalGroupsStrategyOptionsPatchArgs Empty = new SupplementalGroupsStrategyOptionsPatchArgs();
    ...
    private SupplementalGroupsStrategyOptionsPatchArgs() {}

    private SupplementalGroupsStrategyOptionsPatchArgs(SupplementalGroupsStrategyOptionsPatchArgs $) {
        this.ranges = $.ranges;
        this.rule = $.rule;
    }
    ...
    public static Builder builder(SupplementalGroupsStrategyOptionsPatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SupplementalGroupsStrategyOptionsPatchArgs();
        }

        public Builder(SupplementalGroupsStrategyOptionsPatchArgs defaults) {
            $ = new SupplementalGroupsStrategyOptionsPatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SupplementalGroupsStrategyOptionsPatchArgs build() {
            return $;
        }
    }
