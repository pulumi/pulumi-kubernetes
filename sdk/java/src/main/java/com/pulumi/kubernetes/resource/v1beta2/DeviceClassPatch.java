...
import com.pulumi.kubernetes.resource.v1beta2.DeviceClassPatchArgs;
import com.pulumi.kubernetes.resource.v1beta2.outputs.DeviceClassSpecPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1beta2:DeviceClassPatch")
public class DeviceClassPatch extends com.pulumi.resources.CustomResource {
    ...
    public DeviceClassPatch(java.lang.String name, @Nullable DeviceClassPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta2:DeviceClassPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DeviceClassPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta2:DeviceClassPatch", name, null, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("kubernetes:resource.k8s.io/v1alpha3:DeviceClassPatch").build()),
