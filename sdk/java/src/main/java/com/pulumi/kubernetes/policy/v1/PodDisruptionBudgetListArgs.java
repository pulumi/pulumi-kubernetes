...
import com.pulumi.kubernetes.policy.v1.inputs.PodDisruptionBudgetArgs;
...
public final class PodDisruptionBudgetListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PodDisruptionBudgetListArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("PodDisruptionBudgetList").getNullable();
            return $;
        }
    }
