...
import com.pulumi.kubernetes.resource.v1beta2.inputs.ResourceClaimSpecPatchArgs;
...
public final class ResourceClaimPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ResourceClaimPatchArgs build() {
            ...
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("ResourceClaim").getNullable();
            return $;
        }
    }
