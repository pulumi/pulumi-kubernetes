...
import com.pulumi.kubernetes.apps.v1.ReplicaSetPatchArgs;
import com.pulumi.kubernetes.apps.v1.outputs.ReplicaSetSpecPatch;
import com.pulumi.kubernetes.apps.v1.outputs.ReplicaSetStatusPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:apps/v1:ReplicaSetPatch")
public class ReplicaSetPatch extends com.pulumi.resources.CustomResource {
    ...
    public ReplicaSetPatch(java.lang.String name, @Nullable ReplicaSetPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:ReplicaSetPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ReplicaSetPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:ReplicaSetPatch", name, null, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("kubernetes:extensions/v1beta1:ReplicaSetPatch").build())
            ))
            .build();
