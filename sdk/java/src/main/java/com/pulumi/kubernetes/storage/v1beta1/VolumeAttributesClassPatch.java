...
public class VolumeAttributesClassPatch extends com.pulumi.resources.CustomResource {
    ...
    public VolumeAttributesClassPatch(String name, @Nullable VolumeAttributesClassPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private VolumeAttributesClassPatch(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch", name, null, makeResourceOptions(options, id));
    }
