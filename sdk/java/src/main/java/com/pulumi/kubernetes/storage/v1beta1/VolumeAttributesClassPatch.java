...
import com.pulumi.kubernetes.storage.v1beta1.VolumeAttributesClassPatchArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch")
public class VolumeAttributesClassPatch extends com.pulumi.resources.CustomResource {
    ...
    public VolumeAttributesClassPatch(java.lang.String name, @Nullable VolumeAttributesClassPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VolumeAttributesClassPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch", name, null, makeResourceOptions(options, id), false);
    }
