...
import com.pulumi.kubernetes.core.v1.inputs.NamespaceArgs;
...
public final class NamespaceListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NamespaceListArgs(NamespaceListArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NamespaceListArgs();
        }

        public Builder(NamespaceListArgs defaults) {
            $ = new NamespaceListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NamespaceListArgs build() {
            ...
            if ($.items == null) {
                throw new MissingRequiredPropertyException("NamespaceListArgs", "items");
            }
            $.kind = Codegen.stringProp("kind").output().arg($.kind).def("NamespaceList").getNullable();
            return $;
        }
    }
