...
import com.pulumi.kubernetes.batch.v1beta1.inputs.CronJobSpecPatchArgs;
...
public final class CronJobPatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public CronJobPatchArgs build() {
            $.apiVersion = Codegen.stringProp("apiVersion").output().arg($.apiVersion).def("batch/v1beta1").getNullable();
