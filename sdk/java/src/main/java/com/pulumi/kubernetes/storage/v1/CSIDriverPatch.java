...
public class CSIDriverPatch extends com.pulumi.resources.CustomResource {
    ...
    public CSIDriverPatch(java.lang.String name, @Nullable CSIDriverPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1:CSIDriverPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CSIDriverPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1:CSIDriverPatch", name, null, makeResourceOptions(options, id), false);
    }
