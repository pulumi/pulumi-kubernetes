...
import com.pulumi.kubernetes.storagemigration.v1.StorageVersionMigrationArgs;
import com.pulumi.kubernetes.storagemigration.v1.outputs.StorageVersionMigrationSpec;
import com.pulumi.kubernetes.storagemigration.v1.outputs.StorageVersionMigrationStatus;
 ...
 * 
 */
@ResourceType(type="kubernetes:storagemigration.k8s.io/v1:StorageVersionMigration")
public class StorageVersionMigration extends com.pulumi.resources.CustomResource {
    ...
    public StorageVersionMigration(java.lang.String name, @Nullable StorageVersionMigrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storagemigration.k8s.io/v1:StorageVersionMigration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private StorageVersionMigration(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storagemigration.k8s.io/v1:StorageVersionMigration", name, null, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("kubernetes:storagemigration.k8s.io/v1beta1:StorageVersionMigration").build())
            ))
            .build();
