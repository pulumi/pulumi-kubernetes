...
import com.pulumi.kubernetes.resource.v1beta2.ResourceClaimPatchArgs;
import com.pulumi.kubernetes.resource.v1beta2.outputs.ResourceClaimSpecPatch;
import com.pulumi.kubernetes.resource.v1beta2.outputs.ResourceClaimStatusPatch;
 ...
 * 
 */
@ResourceType(type="kubernetes:resource.k8s.io/v1beta2:ResourceClaimPatch")
public class ResourceClaimPatch extends com.pulumi.resources.CustomResource {
    ...
    public ResourceClaimPatch(java.lang.String name, @Nullable ResourceClaimPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta2:ResourceClaimPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ResourceClaimPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:resource.k8s.io/v1beta2:ResourceClaimPatch", name, null, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("kubernetes:resource.k8s.io/v1:ResourceClaimPatch").build()),
