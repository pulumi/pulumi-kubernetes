...
public class HorizontalPodAutoscalerPatch extends com.pulumi.resources.CustomResource {
    ...
    public HorizontalPodAutoscalerPatch(java.lang.String name, @Nullable HorizontalPodAutoscalerPatchArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:autoscaling/v1:HorizontalPodAutoscalerPatch", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private HorizontalPodAutoscalerPatch(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:autoscaling/v1:HorizontalPodAutoscalerPatch", name, null, makeResourceOptions(options, id), false);
    }
