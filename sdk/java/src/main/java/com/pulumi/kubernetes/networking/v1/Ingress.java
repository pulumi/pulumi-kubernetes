...
public class Ingress extends com.pulumi.resources.CustomResource {
    ...
    public Ingress(java.lang.String name, @Nullable IngressArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:Ingress", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Ingress(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:Ingress", name, null, makeResourceOptions(options, id), false);
    }
