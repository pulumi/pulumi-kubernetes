...
import (
	...
	apiextensionsv1beta1 "github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/apiextensions/v1beta1"
)
...
type CustomResourceConversion struct {
	...
	WebhookClientConfig *apiextensionsv1beta1.WebhookClientConfig `pulumi:"webhookClientConfig"`
}
...
type CustomResourceConversionArgs struct {
	...
	// webhookClientConfig is the instructions for how to call the webhook if strategy is `Webhook`. Required when `strategy` is set to `Webhook`.
	WebhookClientConfig apiextensionsv1beta1.WebhookClientConfigPtrInput `pulumi:"webhookClientConfig"`
}
...
// webhookClientConfig is the instructions for how to call the webhook if strategy is `Webhook`. Required when `strategy` is set to `Webhook`.
func (o CustomResourceConversionOutput) WebhookClientConfig() apiextensionsv1beta1.WebhookClientConfigPtrOutput {
	return o.ApplyT(func (v CustomResourceConversion) *apiextensionsv1beta1.WebhookClientConfig { return v.WebhookClientConfig }).(apiextensionsv1beta1.WebhookClientConfigPtrOutput)
}
...
type CustomResourceDefinitionSpec struct {
	...
	AdditionalPrinterColumns []apiextensionsv1beta1.CustomResourceColumnDefinition `pulumi:"additionalPrinterColumns"`
	// conversion defines conversion settings for the CRD.
	Conversion *apiextensionsv1beta1.CustomResourceConversion `pulumi:"conversion"`
	// group is the API group of the defined custom resource. The custom resources are served under `/apis/<group>/...`. Must match the name of the CustomResourceDefinition (in the form `<names.plural>.<group>`).
	Group *string `pulumi:"group"`
	// names specify the resource and kind names for the custom resource.
	Names *apiextensionsv1beta1.CustomResourceDefinitionNames `pulumi:"names"`
	...
	Subresources *apiextensionsv1beta1.CustomResourceSubresources `pulumi:"subresources"`
	// validation describes the schema used for validation and pruning of the custom resource. If present, this validation schema is used to validate all versions. Top-level and per-version schemas are mutually exclusive.
	Validation *apiextensionsv1beta1.CustomResourceValidation `pulumi:"validation"`
	...
	Versions []apiextensionsv1beta1.CustomResourceDefinitionVersion `pulumi:"versions"`
}
...
type CustomResourceDefinitionSpecArgs struct {
	// additionalPrinterColumns specifies additional columns returned in Table output. See https://kubernetes.io/docs/reference/using-api/api-concepts/#receiving-resources-as-tables for details. If present, this field configures columns for all versions. Top-level and per-version columns are mutually exclusive. If no top-level or per-version columns are specified, a single column displaying the age of the custom resource is used.
	AdditionalPrinterColumns apiextensionsv1beta1.CustomResourceColumnDefinitionArrayInput `pulumi:"additionalPrinterColumns"`
	// conversion defines conversion settings for the CRD.
	Conversion apiextensionsv1beta1.CustomResourceConversionPtrInput `pulumi:"conversion"`
	// group is the API group of the defined custom resource. The custom resources are served under `/apis/<group>/...`. Must match the name of the CustomResourceDefinition (in the form `<names.plural>.<group>`).
	Group pulumi.StringPtrInput `pulumi:"group"`
	// names specify the resource and kind names for the custom resource.
	Names apiextensionsv1beta1.CustomResourceDefinitionNamesPtrInput `pulumi:"names"`
	// preserveUnknownFields indicates that object fields which are not specified in the OpenAPI schema should be preserved when persisting to storage. apiVersion, kind, metadata and known fields inside metadata are always preserved. If false, schemas must be defined for all versions. Defaults to true in v1beta for backwards compatibility. Deprecated: will be required to be false in v1. Preservation of unknown fields can be specified in the validation schema using the `x-kubernetes-preserve-unknown-fields: true` extension. See https://kubernetes.io/docs/tasks/access-kubernetes-api/custom-resources/custom-resource-definitions/#pruning-versus-preserving-unknown-fields for details.
	PreserveUnknownFields pulumi.BoolPtrInput `pulumi:"preserveUnknownFields"`
	// scope indicates whether the defined custom resource is cluster- or namespace-scoped. Allowed values are `Cluster` and `Namespaced`. Default is `Namespaced`.
	Scope pulumi.StringPtrInput `pulumi:"scope"`
	// subresources specify what subresources the defined custom resource has. If present, this field configures subresources for all versions. Top-level and per-version subresources are mutually exclusive.
	Subresources apiextensionsv1beta1.CustomResourceSubresourcesPtrInput `pulumi:"subresources"`
	// validation describes the schema used for validation and pruning of the custom resource. If present, this validation schema is used to validate all versions. Top-level and per-version schemas are mutually exclusive.
	Validation apiextensionsv1beta1.CustomResourceValidationPtrInput `pulumi:"validation"`
	// version is the API version of the defined custom resource. The custom resources are served under `/apis/<group>/<version>/...`. Must match the name of the first item in the `versions` list if `version` and `versions` are both specified. Optional if `versions` is specified. Deprecated: use `versions` instead.
	Version pulumi.StringPtrInput `pulumi:"version"`
	// versions is the list of all API versions of the defined custom resource. Optional if `version` is specified. The name of the first item in the `versions` list must match the `version` field if `version` and `versions` are both specified. Version names are used to compute the order in which served versions are listed in API discovery. If the version string is "kube-like", it will sort above non "kube-like" version strings, which are ordered lexicographically. "Kube-like" versions start with a "v", then are followed by a number (the major version), then optionally the string "alpha" or "beta" and another number (the minor version). These are sorted first by GA > beta > alpha (where GA is a version with no suffix such as beta or alpha), and then by comparing major version, then minor version. An example sorted list of versions: v10, v2, v1, v11beta2, v10beta3, v3beta1, v12alpha1, v11alpha2, foo1, foo10.
	Versions apiextensionsv1beta1.CustomResourceDefinitionVersionArrayInput `pulumi:"versions"`
}
...
// additionalPrinterColumns specifies additional columns returned in Table output. See https://kubernetes.io/docs/reference/using-api/api-concepts/#receiving-resources-as-tables for details. If present, this field configures columns for all versions. Top-level and per-version columns are mutually exclusive. If no top-level or per-version columns are specified, a single column displaying the age of the custom resource is used.
func (o CustomResourceDefinitionSpecOutput) AdditionalPrinterColumns() apiextensionsv1beta1.CustomResourceColumnDefinitionArrayOutput {
	return o.ApplyT(func (v CustomResourceDefinitionSpec) []apiextensionsv1beta1.CustomResourceColumnDefinition { return v.AdditionalPrinterColumns }).(apiextensionsv1beta1.CustomResourceColumnDefinitionArrayOutput)
}

// conversion defines conversion settings for the CRD.
func (o CustomResourceDefinitionSpecOutput) Conversion() apiextensionsv1beta1.CustomResourceConversionPtrOutput {
	return o.ApplyT(func (v CustomResourceDefinitionSpec) *apiextensionsv1beta1.CustomResourceConversion { return v.Conversion }).(apiextensionsv1beta1.CustomResourceConversionPtrOutput)
}
...
// names specify the resource and kind names for the custom resource.
func (o CustomResourceDefinitionSpecOutput) Names() apiextensionsv1beta1.CustomResourceDefinitionNamesPtrOutput {
	return o.ApplyT(func (v CustomResourceDefinitionSpec) *apiextensionsv1beta1.CustomResourceDefinitionNames { return v.Names }).(apiextensionsv1beta1.CustomResourceDefinitionNamesPtrOutput)
}
...
// subresources specify what subresources the defined custom resource has. If present, this field configures subresources for all versions. Top-level and per-version subresources are mutually exclusive.
func (o CustomResourceDefinitionSpecOutput) Subresources() apiextensionsv1beta1.CustomResourceSubresourcesPtrOutput {
	return o.ApplyT(func (v CustomResourceDefinitionSpec) *apiextensionsv1beta1.CustomResourceSubresources { return v.Subresources }).(apiextensionsv1beta1.CustomResourceSubresourcesPtrOutput)
}

// validation describes the schema used for validation and pruning of the custom resource. If present, this validation schema is used to validate all versions. Top-level and per-version schemas are mutually exclusive.
func (o CustomResourceDefinitionSpecOutput) Validation() apiextensionsv1beta1.CustomResourceValidationPtrOutput {
	return o.ApplyT(func (v CustomResourceDefinitionSpec) *apiextensionsv1beta1.CustomResourceValidation { return v.Validation }).(apiextensionsv1beta1.CustomResourceValidationPtrOutput)
}
...
// versions is the list of all API versions of the defined custom resource. Optional if `version` is specified. The name of the first item in the `versions` list must match the `version` field if `version` and `versions` are both specified. Version names are used to compute the order in which served versions are listed in API discovery. If the version string is "kube-like", it will sort above non "kube-like" version strings, which are ordered lexicographically. "Kube-like" versions start with a "v", then are followed by a number (the major version), then optionally the string "alpha" or "beta" and another number (the minor version). These are sorted first by GA > beta > alpha (where GA is a version with no suffix such as beta or alpha), and then by comparing major version, then minor version. An example sorted list of versions: v10, v2, v1, v11beta2, v10beta3, v3beta1, v12alpha1, v11alpha2, foo1, foo10.
func (o CustomResourceDefinitionSpecOutput) Versions() apiextensionsv1beta1.CustomResourceDefinitionVersionArrayOutput {
	return o.ApplyT(func (v CustomResourceDefinitionSpec) []apiextensionsv1beta1.CustomResourceDefinitionVersion { return v.Versions }).(apiextensionsv1beta1.CustomResourceDefinitionVersionArrayOutput)
}

// CustomResourceDefinitionStatus indicates the state of the CustomResourceDefinition
type CustomResourceDefinitionStatus struct {
	// acceptedNames are the names that are actually being used to serve discovery. They may be different than the names in spec.
	AcceptedNames *apiextensionsv1beta1.CustomResourceDefinitionNames `pulumi:"acceptedNames"`
	// conditions indicate state for particular aspects of a CustomResourceDefinition
	Conditions []apiextensionsv1beta1.CustomResourceDefinitionCondition `pulumi:"conditions"`
...
type CustomResourceDefinitionStatusArgs struct {
	// acceptedNames are the names that are actually being used to serve discovery. They may be different than the names in spec.
	AcceptedNames apiextensionsv1beta1.CustomResourceDefinitionNamesPtrInput `pulumi:"acceptedNames"`
	// conditions indicate state for particular aspects of a CustomResourceDefinition
	Conditions apiextensionsv1beta1.CustomResourceDefinitionConditionArrayInput `pulumi:"conditions"`
	// storedVersions lists all versions of CustomResources that were ever persisted. Tracking these versions allows a migration path for stored versions in etcd. The field is mutable so a migration controller can finish a migration to another version (ensuring no old objects are left in storage), and then remove the rest of the versions from this list. Versions may not be removed from `spec.versions` while they exist in this list.
...
// acceptedNames are the names that are actually being used to serve discovery. They may be different than the names in spec.
func (o CustomResourceDefinitionStatusOutput) AcceptedNames() apiextensionsv1beta1.CustomResourceDefinitionNamesPtrOutput {
	return o.ApplyT(func (v CustomResourceDefinitionStatus) *apiextensionsv1beta1.CustomResourceDefinitionNames { return v.AcceptedNames }).(apiextensionsv1beta1.CustomResourceDefinitionNamesPtrOutput)
}

// conditions indicate state for particular aspects of a CustomResourceDefinition
func (o CustomResourceDefinitionStatusOutput) Conditions() apiextensionsv1beta1.CustomResourceDefinitionConditionArrayOutput {
	return o.ApplyT(func (v CustomResourceDefinitionStatus) []apiextensionsv1beta1.CustomResourceDefinitionCondition { return v.Conditions }).(apiextensionsv1beta1.CustomResourceDefinitionConditionArrayOutput)
}
...
type CustomResourceDefinitionVersion struct {
	...
	Schema *apiextensionsv1beta1.CustomResourceValidation `pulumi:"schema"`
...
type CustomResourceDefinitionVersionArgs struct {
	...
	Name pulumi.StringPtrInput `pulumi:"name"`
	// schema describes the schema used for validation and pruning of this version of the custom resource. Top-level and per-version schemas are mutually exclusive. Per-version schemas must not all be set to identical values (top-level validation schema should be used instead).
	Schema apiextensionsv1beta1.CustomResourceValidationPtrInput `pulumi:"schema"`
	// served is a flag enabling/disabling this version from being served via REST APIs
...
// additionalPrinterColumns specifies additional columns returned in Table output. See https://kubernetes.io/docs/reference/using-api/api-concepts/#receiving-resources-as-tables for details. Top-level and per-version columns are mutually exclusive. Per-version columns must not all be set to identical values (top-level columns should be used instead). If no top-level or per-version columns are specified, a single column displaying the age of the custom resource is used.
func (o CustomResourceDefinitionVersionOutput) AdditionalPrinterColumns() apiextensionsv1beta1.CustomResourceColumnDefinitionArrayOutput {
	return o.ApplyT(func (v CustomResourceDefinitionVersion) []apiextensionsv1beta1.CustomResourceColumnDefinition { return v.AdditionalPrinterColumns }).(apiextensionsv1beta1.CustomResourceColumnDefinitionArrayOutput)
}
...
// schema describes the schema used for validation and pruning of this version of the custom resource. Top-level and per-version schemas are mutually exclusive. Per-version schemas must not all be set to identical values (top-level validation schema should be used instead).
func (o CustomResourceDefinitionVersionOutput) Schema() apiextensionsv1beta1.CustomResourceValidationPtrOutput {
	return o.ApplyT(func (v CustomResourceDefinitionVersion) *apiextensionsv1beta1.CustomResourceValidation { return v.Schema }).(apiextensionsv1beta1.CustomResourceValidationPtrOutput)
}
...
// subresources specify what subresources this version of the defined custom resource have. Top-level and per-version subresources are mutually exclusive. Per-version subresources must not all be set to identical values (top-level subresources should be used instead).
func (o CustomResourceDefinitionVersionOutput) Subresources() apiextensionsv1beta1.CustomResourceSubresourcesPtrOutput {
	return o.ApplyT(func (v CustomResourceDefinitionVersion) *apiextensionsv1beta1.CustomResourceSubresources { return v.Subresources }).(apiextensionsv1beta1.CustomResourceSubresourcesPtrOutput)
}
...
type CustomResourceSubresources struct {
	...
	Scale *apiextensionsv1beta1.CustomResourceSubresourceScale `pulumi:"scale"`
...
type CustomResourceSubresourcesArgs struct {
	// scale indicates the custom resource should serve a `/scale` subresource that returns an `autoscaling/v1` Scale object.
	Scale apiextensionsv1beta1.CustomResourceSubresourceScalePtrInput `pulumi:"scale"`
	// status indicates the custom resource should serve a `/status` subresource. When enabled: 1. requests to the custom resource primary endpoint ignore changes to the `status` stanza of the object. 2. requests to the custom resource `/status` subresource ignore changes to anything other than the `status` stanza of the object.
...
// scale indicates the custom resource should serve a `/scale` subresource that returns an `autoscaling/v1` Scale object.
func (o CustomResourceSubresourcesOutput) Scale() apiextensionsv1beta1.CustomResourceSubresourceScalePtrOutput {
	return o.ApplyT(func (v CustomResourceSubresources) *apiextensionsv1beta1.CustomResourceSubresourceScale { return v.Scale }).(apiextensionsv1beta1.CustomResourceSubresourceScalePtrOutput)
}
...
type CustomResourceValidation struct {
	...
	OpenAPIV3Schema *apiextensionsv1beta1.JSONSchemaProps `pulumi:"openAPIV3Schema"`
}
...
type CustomResourceValidationArgs struct {
	// openAPIV3Schema is the OpenAPI v3 schema to use for validation and pruning.
	OpenAPIV3Schema apiextensionsv1beta1.JSONSchemaPropsPtrInput `pulumi:"openAPIV3Schema"`
}
...
// openAPIV3Schema is the OpenAPI v3 schema to use for validation and pruning.
func (o CustomResourceValidationOutput) OpenAPIV3Schema() apiextensionsv1beta1.JSONSchemaPropsPtrOutput {
	return o.ApplyT(func (v CustomResourceValidation) *apiextensionsv1beta1.JSONSchemaProps { return v.OpenAPIV3Schema }).(apiextensionsv1beta1.JSONSchemaPropsPtrOutput)
}
