...
type CertificateSigningRequestList struct {
	...
	Items certificatesv1beta1.CertificateSigningRequestArrayOutput `pulumi:"items"`
...
type certificateSigningRequestListState struct {
	...
	Items []certificatesv1beta1.CertificateSigningRequest `pulumi:"items"`
	// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
...
type CertificateSigningRequestListState struct {
	...
	Items certificatesv1beta1.CertificateSigningRequestArrayInput
	// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
