...
import (
	...
	authenticationv1beta1 "github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/authentication/v1beta1"
...
type TokenReview struct {
	...
	Spec authenticationv1beta1.TokenReviewSpecPtrOutput `pulumi:"spec"`
	// Status is filled in by the server and indicates whether the request can be authenticated.
	Status authenticationv1beta1.TokenReviewStatusPtrOutput `pulumi:"status"`
}
...
type tokenReviewState struct {
	...
	// Spec holds information about the request being evaluated
	Spec *authenticationv1beta1.TokenReviewSpec `pulumi:"spec"`
	// Status is filled in by the server and indicates whether the request can be authenticated.
	Status *authenticationv1beta1.TokenReviewStatus `pulumi:"status"`
}
...
type TokenReviewState struct {
	...
	// Spec holds information about the request being evaluated
	Spec authenticationv1beta1.TokenReviewSpecPtrInput
	// Status is filled in by the server and indicates whether the request can be authenticated.
	Status authenticationv1beta1.TokenReviewStatusPtrInput
}
...
type TokenReviewArgs struct {
	...
	Metadata metav1.ObjectMetaPtrInput
	// Spec holds information about the request being evaluated
	Spec authenticationv1beta1.TokenReviewSpecInput
}
