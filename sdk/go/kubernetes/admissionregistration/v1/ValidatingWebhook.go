...
type ValidatingWebhook struct {
	...
	// in the admission change and the side effects therefore need to be undone. Requests with the
	// dryRun attribute will be auto-rejected if they match a webhook with sideEffects == Unknown or
	// Some.
