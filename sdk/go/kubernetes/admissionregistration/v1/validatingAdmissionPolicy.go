...
func NewValidatingAdmissionPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetValidatingAdmissionPolicy(ctx *pulumi.Context,
	...
	var resource ValidatingAdmissionPolicy
	err := ctx.ReadResource("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
