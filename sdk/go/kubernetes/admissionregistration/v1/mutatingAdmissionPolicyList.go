...
func NewMutatingAdmissionPolicyList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMutatingAdmissionPolicyList(ctx *pulumi.Context,
	...
	var resource MutatingAdmissionPolicyList
	err := ctx.ReadResource("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
