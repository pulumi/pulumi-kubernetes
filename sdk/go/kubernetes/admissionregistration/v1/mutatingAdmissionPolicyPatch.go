...
func NewMutatingAdmissionPolicyPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMutatingAdmissionPolicyPatch(ctx *pulumi.Context,
	...
	var resource MutatingAdmissionPolicyPatch
	err := ctx.ReadResource("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
