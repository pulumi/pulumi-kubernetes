...
func NewValidatingAdmissionPolicyList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetValidatingAdmissionPolicyList(ctx *pulumi.Context,
	...
	var resource ValidatingAdmissionPolicyList
	err := ctx.ReadResource("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
