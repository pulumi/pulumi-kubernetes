...
func NewValidatingAdmissionPolicyBindingPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBindingPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetValidatingAdmissionPolicyBindingPatch(ctx *pulumi.Context,
	...
	var resource ValidatingAdmissionPolicyBindingPatch
	err := ctx.ReadResource("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBindingPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
