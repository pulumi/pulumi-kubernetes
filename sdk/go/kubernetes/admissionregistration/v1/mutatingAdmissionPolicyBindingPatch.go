...
func NewMutatingAdmissionPolicyBindingPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyBindingPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMutatingAdmissionPolicyBindingPatch(ctx *pulumi.Context,
	...
	var resource MutatingAdmissionPolicyBindingPatch
	err := ctx.ReadResource("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyBindingPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
