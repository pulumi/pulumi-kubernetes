...
func NewValidatingAdmissionPolicyBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetValidatingAdmissionPolicyBinding(ctx *pulumi.Context,
	...
	var resource ValidatingAdmissionPolicyBinding
	err := ctx.ReadResource("kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
