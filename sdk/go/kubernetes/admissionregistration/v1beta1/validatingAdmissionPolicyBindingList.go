...
func NewValidatingAdmissionPolicyBindingList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyBindingList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetValidatingAdmissionPolicyBindingList(ctx *pulumi.Context,
	...
	var resource ValidatingAdmissionPolicyBindingList
	err := ctx.ReadResource("kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyBindingList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
