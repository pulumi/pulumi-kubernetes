...
func NewMutatingAdmissionPolicyBindingPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyBindingPatch"),
		},
		{
			Type: pulumi.String("kubernetes:admissionregistration.k8s.io/v1alpha1:MutatingAdmissionPolicyBindingPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource MutatingAdmissionPolicyBindingPatch
	err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicyBindingPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMutatingAdmissionPolicyBindingPatch(ctx *pulumi.Context,
	...
	var resource MutatingAdmissionPolicyBindingPatch
	err := ctx.ReadResource("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicyBindingPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
