...
func NewServiceCIDRPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.k8s.io/v1beta1:ServiceCIDRPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceCIDRPatch(ctx *pulumi.Context,
	...
	var resource ServiceCIDRPatch
	err := ctx.ReadResource("kubernetes:networking.k8s.io/v1beta1:ServiceCIDRPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
