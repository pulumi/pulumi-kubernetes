...
func NewServiceCIDR(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.k8s.io/v1:ServiceCIDR", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceCIDR(ctx *pulumi.Context,
	...
	var resource ServiceCIDR
	err := ctx.ReadResource("kubernetes:networking.k8s.io/v1:ServiceCIDR", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
