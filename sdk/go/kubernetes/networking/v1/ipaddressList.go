...
func NewIPAddressList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.k8s.io/v1:IPAddressList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIPAddressList(ctx *pulumi.Context,
	...
	var resource IPAddressList
	err := ctx.ReadResource("kubernetes:networking.k8s.io/v1:IPAddressList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
