...
func NewIPAddressPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.k8s.io/v1beta1:IPAddressPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource IPAddressPatch
	err := ctx.RegisterResource("kubernetes:networking.k8s.io/v1:IPAddressPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIPAddressPatch(ctx *pulumi.Context,
	...
	var resource IPAddressPatch
	err := ctx.ReadResource("kubernetes:networking.k8s.io/v1:IPAddressPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
