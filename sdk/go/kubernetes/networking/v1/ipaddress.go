...
func NewIPAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.k8s.io/v1:IPAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIPAddress(ctx *pulumi.Context,
	...
	var resource IPAddress
	err := ctx.ReadResource("kubernetes:networking.k8s.io/v1:IPAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
