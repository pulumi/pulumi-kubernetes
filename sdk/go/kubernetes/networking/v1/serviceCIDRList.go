...
func NewServiceCIDRList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.k8s.io/v1:ServiceCIDRList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceCIDRList(ctx *pulumi.Context,
	...
	var resource ServiceCIDRList
	err := ctx.ReadResource("kubernetes:networking.k8s.io/v1:ServiceCIDRList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
