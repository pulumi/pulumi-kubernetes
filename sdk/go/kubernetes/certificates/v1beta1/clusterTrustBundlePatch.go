...
func NewClusterTrustBundlePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch"),
		},
		{
			Type: pulumi.String("kubernetes:certificates.k8s.io/v1alpha1:ClusterTrustBundlePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ClusterTrustBundlePatch
	err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundlePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterTrustBundlePatch(ctx *pulumi.Context,
	...
	var resource ClusterTrustBundlePatch
	err := ctx.ReadResource("kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundlePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
