...
func NewClusterTrustBundleList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundleList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterTrustBundleList(ctx *pulumi.Context,
	...
	var resource ClusterTrustBundleList
	err := ctx.ReadResource("kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundleList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
