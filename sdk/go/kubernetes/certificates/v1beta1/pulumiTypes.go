...
//
// Deprecated: This field is replaced by StubPKCS10Request. If StubPKCS10Request is set, this field must be empty.  Signer implementations should extract the public key from the StubPKCS10Request field.
func (o PodCertificateRequestSpecOutput) PkixPublicKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PodCertificateRequestSpec) *string { return v.PkixPublicKey }).(pulumi.StringPtrOutput)
}
...
//
// Deprecated: This field is replaced by StubPKCS10Request. If StubPKCS10Request is set, this field must be empty.
func (o PodCertificateRequestSpecOutput) ProofOfPossession() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PodCertificateRequestSpec) *string { return v.ProofOfPossession }).(pulumi.StringPtrOutput)
}
