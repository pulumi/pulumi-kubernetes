...
func NewClusterTrustBundle(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:certificates.k8s.io/v1alpha1:ClusterTrustBundle"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ClusterTrustBundle
	err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundle", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterTrustBundle(ctx *pulumi.Context,
	...
	var resource ClusterTrustBundle
	err := ctx.ReadResource("kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundle", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
