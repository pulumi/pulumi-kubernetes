...
func NewClusterTrustBundlePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterTrustBundlePatch(ctx *pulumi.Context,
	...
	var resource ClusterTrustBundlePatch
	err := ctx.ReadResource("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
