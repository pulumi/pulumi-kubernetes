...
func NewClusterTrustBundle(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1:ClusterTrustBundle", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterTrustBundle(ctx *pulumi.Context,
	...
	var resource ClusterTrustBundle
	err := ctx.ReadResource("kubernetes:certificates.k8s.io/v1:ClusterTrustBundle", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
