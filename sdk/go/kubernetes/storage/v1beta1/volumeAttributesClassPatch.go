...
func NewVolumeAttributesClassPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:storage.k8s.io/v1alpha1:VolumeAttributesClassPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VolumeAttributesClassPatch
	err := ctx.RegisterResource("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeAttributesClassPatch(ctx *pulumi.Context,
	...
	var resource VolumeAttributesClassPatch
	err := ctx.ReadResource("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
