...
func NewStorageClass(ctx *pulumi.Context, name string, args *StorageClassArgs, opts ...pulumi.ResourceOption) (*StorageClass, error) {
	...
	err := ctx.RegisterResource("kubernetes:storage.k8s.io/v1beta1:StorageClass", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageClass(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*StorageClass, error) {
	var resource StorageClass
	err := ctx.ReadResource("kubernetes:storage.k8s.io/v1beta1:StorageClass", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
