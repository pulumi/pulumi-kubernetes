...
func (o CSINodeListOutput) ApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *CSINodeList) pulumi.StringOutput { return v.ApiVersion }).(pulumi.StringOutput)
}
...
func (o CSINodeListOutput) Kind() pulumi.StringOutput {
	return o.ApplyT(func(v *CSINodeList) pulumi.StringOutput { return v.Kind }).(pulumi.StringOutput)
}

// Standard list metadata More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
func (o CSINodeListOutput) Metadata() metav1.ListMetaOutput {
	return o.ApplyT(func(v *CSINodeList) metav1.ListMetaOutput { return v.Metadata }).(metav1.ListMetaOutput)
}
