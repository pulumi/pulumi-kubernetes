...
func NewVolumeAttributesClass(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClass"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VolumeAttributesClass
	err := ctx.RegisterResource("kubernetes:storage.k8s.io/v1:VolumeAttributesClass", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeAttributesClass(ctx *pulumi.Context,
	...
	var resource VolumeAttributesClass
	err := ctx.ReadResource("kubernetes:storage.k8s.io/v1:VolumeAttributesClass", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
