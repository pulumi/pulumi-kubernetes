...
func NewVolumeAttributesClassPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:storage.k8s.io/v1:VolumeAttributesClassPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeAttributesClassPatch(ctx *pulumi.Context,
	...
	var resource VolumeAttributesClassPatch
	err := ctx.ReadResource("kubernetes:storage.k8s.io/v1:VolumeAttributesClassPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
