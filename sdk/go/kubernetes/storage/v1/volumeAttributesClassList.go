...
func NewVolumeAttributesClassList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:storage.k8s.io/v1:VolumeAttributesClassList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeAttributesClassList(ctx *pulumi.Context,
	...
	var resource VolumeAttributesClassList
	err := ctx.ReadResource("kubernetes:storage.k8s.io/v1:VolumeAttributesClassList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
