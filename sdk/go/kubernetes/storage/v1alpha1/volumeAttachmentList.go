...
func NewVolumeAttachmentList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:storage.k8s.io/v1alpha1:VolumeAttachmentList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolumeAttachmentList(ctx *pulumi.Context,
	...
	var resource VolumeAttachmentList
	err := ctx.ReadResource("kubernetes:storage.k8s.io/v1alpha1:VolumeAttachmentList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
