...
func NewStorageVersionMigrationPatch(ctx *pulumi.Context,
	...
	args.ApiVersion = pulumi.StringPtr("storagemigration.k8s.io/v1")
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:storagemigration.k8s.io/v1beta1:StorageVersionMigrationPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource StorageVersionMigrationPatch
	err := ctx.RegisterResource("kubernetes:storagemigration.k8s.io/v1:StorageVersionMigrationPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageVersionMigrationPatch(ctx *pulumi.Context,
	...
	var resource StorageVersionMigrationPatch
	err := ctx.ReadResource("kubernetes:storagemigration.k8s.io/v1:StorageVersionMigrationPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
