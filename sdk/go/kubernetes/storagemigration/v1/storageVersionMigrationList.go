...
func NewStorageVersionMigrationList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:storagemigration.k8s.io/v1:StorageVersionMigrationList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageVersionMigrationList(ctx *pulumi.Context,
	...
	var resource StorageVersionMigrationList
	err := ctx.ReadResource("kubernetes:storagemigration.k8s.io/v1:StorageVersionMigrationList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
