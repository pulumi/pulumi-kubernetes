...
func NewStorageVersionMigration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:storagemigration.k8s.io/v1:StorageVersionMigration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageVersionMigration(ctx *pulumi.Context,
	...
	var resource StorageVersionMigration
	err := ctx.ReadResource("kubernetes:storagemigration.k8s.io/v1:StorageVersionMigration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
