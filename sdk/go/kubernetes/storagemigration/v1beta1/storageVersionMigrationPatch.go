...
func NewStorageVersionMigrationPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:storagemigration.k8s.io/v1beta1:StorageVersionMigrationPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageVersionMigrationPatch(ctx *pulumi.Context,
	...
	var resource StorageVersionMigrationPatch
	err := ctx.ReadResource("kubernetes:storagemigration.k8s.io/v1beta1:StorageVersionMigrationPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
