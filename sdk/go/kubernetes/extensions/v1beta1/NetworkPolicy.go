...
func NewNetworkPolicy(ctx *pulumi.Context, name string, args *NetworkPolicyArgs, opts ...pulumi.ResourceOption) (*NetworkPolicy, error) {
	...
	err := ctx.RegisterResource("kubernetes:extensions/v1beta1:NetworkPolicy", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkPolicy(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*NetworkPolicy, error) {
	var resource NetworkPolicy
	err := ctx.ReadResource("kubernetes:extensions/v1beta1:NetworkPolicy", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
