...
func NewIngressList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:extensions/v1beta1:IngressList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIngressList(ctx *pulumi.Context,
	...
	var resource IngressList
	err := ctx.ReadResource("kubernetes:extensions/v1beta1:IngressList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o IngressListOutput) ToIngressListPtrOutputWithContext(ctx context.Context) IngressListPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v IngressList) *IngressList {
		return &v
	}).(IngressListPtrOutput)
}

type IngressListPtrOutput struct{ *pulumi.OutputState }
...
func (o IngressListPtrOutput) Elem() IngressListOutput {
