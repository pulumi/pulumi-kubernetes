...
func NewDeployment(ctx *pulumi.Context, name string, args *DeploymentArgs, opts ...pulumi.ResourceOption) (*Deployment, error) {
	...
	err := ctx.RegisterResource("kubernetes:extensions/v1beta1:Deployment", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeployment(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*Deployment, error) {
	var resource Deployment
	err := ctx.ReadResource("kubernetes:extensions/v1beta1:Deployment", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
