...
func NewIngress(ctx *pulumi.Context, name string, args *IngressArgs, opts ...pulumi.ResourceOption) (*Ingress, error) {
	...
	err := ctx.RegisterResource("kubernetes:extensions/v1beta1:Ingress", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIngress(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*Ingress, error) {
	var resource Ingress
	err := ctx.ReadResource("kubernetes:extensions/v1beta1:Ingress", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
