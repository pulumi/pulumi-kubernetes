...
func NewResourceClaimPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1:ResourceClaimPatch"),
		},
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1alpha1:ResourceClaimPatch"),
		},
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1alpha3:ResourceClaimPatch"),
		},
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1beta1:ResourceClaimPatch"),
		},
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1beta2:ResourceClaimPatch"),
		},
	})
