...
func NewResourceClaim(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1:ResourceClaim"),
		},
		{
		...
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1beta1:ResourceClaim"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ResourceClaim
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:ResourceClaim", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceClaim(ctx *pulumi.Context,
	...
	var resource ResourceClaim
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta2:ResourceClaim", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ResourceClaimArgs struct {
	...
	// Spec describes what is being requested and how to configure it. The spec is immutable.
	Spec ResourceClaimSpecPtrInput
}
