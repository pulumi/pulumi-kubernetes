...
func NewDeviceTaintRule(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1:DeviceTaintRule"),
		},
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1alpha3:DeviceTaintRule"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DeviceTaintRule
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:DeviceTaintRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceTaintRule(ctx *pulumi.Context,
	...
	var resource DeviceTaintRule
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta2:DeviceTaintRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
