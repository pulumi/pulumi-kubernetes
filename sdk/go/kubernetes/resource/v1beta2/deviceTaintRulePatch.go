...
func NewDeviceTaintRulePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:DeviceTaintRulePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceTaintRulePatch(ctx *pulumi.Context,
	...
	var resource DeviceTaintRulePatch
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta2:DeviceTaintRulePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
