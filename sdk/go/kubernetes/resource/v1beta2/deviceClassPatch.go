...
func NewDeviceClassPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:DeviceClassPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceClassPatch(ctx *pulumi.Context,
	...
	var resource DeviceClassPatch
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta2:DeviceClassPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
