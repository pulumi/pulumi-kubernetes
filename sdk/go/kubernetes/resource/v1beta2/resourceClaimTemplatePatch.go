...
func NewResourceClaimTemplatePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1:ResourceClaimTemplatePatch"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplatePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceClaimTemplatePatch(ctx *pulumi.Context,
	...
	var resource ResourceClaimTemplatePatch
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplatePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
