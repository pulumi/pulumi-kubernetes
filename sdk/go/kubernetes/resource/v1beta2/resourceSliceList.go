...
func NewResourceSliceList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:ResourceSliceList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceSliceList(ctx *pulumi.Context,
	...
	var resource ResourceSliceList
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta2:ResourceSliceList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
