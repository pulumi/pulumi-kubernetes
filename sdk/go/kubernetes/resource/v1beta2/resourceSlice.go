...
func NewResourceSlice(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1:ResourceSlice"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:ResourceSlice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceSlice(ctx *pulumi.Context,
	...
	var resource ResourceSlice
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta2:ResourceSlice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
