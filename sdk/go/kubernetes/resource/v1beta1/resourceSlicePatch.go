...
func NewResourceSlicePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:ResourceSlicePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceSlicePatch(ctx *pulumi.Context,
	...
	var resource ResourceSlicePatch
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta1:ResourceSlicePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
