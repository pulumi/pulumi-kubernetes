...
func NewResourceClaimTemplatePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplatePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceClaimTemplatePatch(ctx *pulumi.Context,
	...
	var resource ResourceClaimTemplatePatch
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplatePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
