...
func NewDeviceClass(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1beta2:DeviceClass"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DeviceClass
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:DeviceClass", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceClass(ctx *pulumi.Context,
	...
	var resource DeviceClass
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta1:DeviceClass", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
