...
func NewResourceClaim(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:ResourceClaim", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceClaim(ctx *pulumi.Context,
	...
	var resource ResourceClaim
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta1:ResourceClaim", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
