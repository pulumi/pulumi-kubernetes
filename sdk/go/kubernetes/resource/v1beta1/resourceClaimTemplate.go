...
func NewResourceClaimTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceClaimTemplate(ctx *pulumi.Context,
	...
	var resource ResourceClaimTemplate
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
