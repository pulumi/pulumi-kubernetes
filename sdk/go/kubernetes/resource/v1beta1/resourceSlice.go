...
func NewResourceSlice(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:ResourceSlice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceSlice(ctx *pulumi.Context,
	...
	var resource ResourceSlice
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1beta1:ResourceSlice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
