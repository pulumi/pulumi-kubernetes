...
func NewPodSchedulingContext(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1alpha2:PodSchedulingContext"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PodSchedulingContext
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContext", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPodSchedulingContext(ctx *pulumi.Context,
	...
	var resource PodSchedulingContext
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContext", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
