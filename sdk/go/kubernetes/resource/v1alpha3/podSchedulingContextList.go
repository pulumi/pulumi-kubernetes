...
func NewPodSchedulingContextList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContextList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPodSchedulingContextList(ctx *pulumi.Context,
	...
	var resource PodSchedulingContextList
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContextList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
