...
func NewPodSchedulingContextPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1alpha2:PodSchedulingContextPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource PodSchedulingContextPatch
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContextPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPodSchedulingContextPatch(ctx *pulumi.Context,
	...
	var resource PodSchedulingContextPatch
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContextPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
