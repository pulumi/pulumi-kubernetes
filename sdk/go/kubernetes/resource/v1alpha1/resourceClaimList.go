...
func NewResourceClaimList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1alpha1:ResourceClaimList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceClaimList(ctx *pulumi.Context,
	...
	var resource ResourceClaimList
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1alpha1:ResourceClaimList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
