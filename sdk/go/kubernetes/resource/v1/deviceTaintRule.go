...
func NewDeviceTaintRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:DeviceTaintRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceTaintRule(ctx *pulumi.Context,
	...
	var resource DeviceTaintRule
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1:DeviceTaintRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
