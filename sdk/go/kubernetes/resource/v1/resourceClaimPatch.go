...
func NewResourceClaimPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:ResourceClaimPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceClaimPatch(ctx *pulumi.Context,
	...
	var resource ResourceClaimPatch
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1:ResourceClaimPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
