...
func NewDeviceClass(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:DeviceClass", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceClass(ctx *pulumi.Context,
	...
	var resource DeviceClass
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1:DeviceClass", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
