...
func NewDeviceTaintRulePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:resource.k8s.io/v1beta2:DeviceTaintRulePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DeviceTaintRulePatch
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:DeviceTaintRulePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceTaintRulePatch(ctx *pulumi.Context,
	...
	var resource DeviceTaintRulePatch
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1:DeviceTaintRulePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
