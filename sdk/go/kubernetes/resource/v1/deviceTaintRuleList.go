...
func NewDeviceTaintRuleList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:DeviceTaintRuleList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceTaintRuleList(ctx *pulumi.Context,
	...
	var resource DeviceTaintRuleList
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1:DeviceTaintRuleList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
