...
func NewResourceClaimTemplateList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:ResourceClaimTemplateList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceClaimTemplateList(ctx *pulumi.Context,
	...
	var resource ResourceClaimTemplateList
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1:ResourceClaimTemplateList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
