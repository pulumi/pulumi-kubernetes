...
func NewDeviceClassList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:DeviceClassList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceClassList(ctx *pulumi.Context,
	...
	var resource DeviceClassList
	err := ctx.ReadResource("kubernetes:resource.k8s.io/v1:DeviceClassList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
