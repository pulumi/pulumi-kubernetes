...
func NewClusterRoleBinding(ctx *pulumi.Context, name string, args *ClusterRoleBindingArgs, opts ...pulumi.ResourceOption) (*ClusterRoleBinding, error) {
	...
	err := ctx.RegisterResource("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBinding", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterRoleBinding(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*ClusterRoleBinding, error) {
	var resource ClusterRoleBinding
	err := ctx.ReadResource("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBinding", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
