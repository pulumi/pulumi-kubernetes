...
func NewRole(ctx *pulumi.Context, name string, args *RoleArgs, opts ...pulumi.ResourceOption) (*Role, error) {
	...
	var resource Role
	err := ctx.RegisterResource("kubernetes:rbac.authorization.k8s.io/v1alpha1:Role", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRole(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*Role, error) {
	var resource Role
	err := ctx.ReadResource("kubernetes:rbac.authorization.k8s.io/v1alpha1:Role", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
