...
import (
	...
	apiregistrationv1beta1 "github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/apiregistration/v1beta1"
...
type APIService struct {
	...
	Spec apiregistrationv1beta1.APIServiceSpecPtrOutput `pulumi:"spec"`
	// Status contains derived information about an API server
	Status apiregistrationv1beta1.APIServiceStatusPtrOutput `pulumi:"status"`
}
...
type apiserviceState struct {
	...
	// Spec contains information for locating and communicating with a server
	Spec *apiregistrationv1beta1.APIServiceSpec `pulumi:"spec"`
	// Status contains derived information about an API server
	Status *apiregistrationv1beta1.APIServiceStatus `pulumi:"status"`
}
...
type APIServiceState struct {
	...
	// Spec contains information for locating and communicating with a server
	Spec apiregistrationv1beta1.APIServiceSpecPtrInput
	// Status contains derived information about an API server
	Status apiregistrationv1beta1.APIServiceStatusPtrInput
}
