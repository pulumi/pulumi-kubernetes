...
func NewAPIService(ctx *pulumi.Context, name string, args *APIServiceArgs, opts ...pulumi.ResourceOption) (*APIService, error) {
	...
	err := ctx.RegisterResource("kubernetes:apiregistration/v1:APIService", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAPIService(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*APIService, error) {
	var resource APIService
	err := ctx.ReadResource("kubernetes:apiregistration/v1:APIService", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
