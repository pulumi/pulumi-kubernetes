...
func NewAPIServiceList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:apiregistration/v1beta1:APIServiceList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAPIServiceList(ctx *pulumi.Context,
	...
	var resource APIServiceList
	err := ctx.ReadResource("kubernetes:apiregistration/v1beta1:APIServiceList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
