...
func NewAPIService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:apiregistration/v1beta1:APIService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAPIService(ctx *pulumi.Context,
	...
	var resource APIService
	err := ctx.ReadResource("kubernetes:apiregistration/v1beta1:APIService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
