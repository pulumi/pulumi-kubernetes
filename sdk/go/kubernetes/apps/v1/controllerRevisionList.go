...
func NewControllerRevisionList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:apps/v1:ControllerRevisionList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetControllerRevisionList(ctx *pulumi.Context,
	...
	var resource ControllerRevisionList
	err := ctx.ReadResource("kubernetes:apps/v1:ControllerRevisionList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
