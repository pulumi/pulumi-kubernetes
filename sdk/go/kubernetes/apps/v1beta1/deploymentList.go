...
func NewDeploymentList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:apps/v1beta1:DeploymentList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentList(ctx *pulumi.Context,
	...
	var resource DeploymentList
	err := ctx.ReadResource("kubernetes:apps/v1beta1:DeploymentList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o DeploymentListOutput) ApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *DeploymentList) pulumi.StringOutput { return v.ApiVersion }).(pulumi.StringOutput)
}
...
// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
func (o DeploymentListOutput) Kind() pulumi.StringOutput {
	return o.ApplyT(func(v *DeploymentList) pulumi.StringOutput { return v.Kind }).(pulumi.StringOutput)
}

// Standard list metadata.
func (o DeploymentListOutput) Metadata() metav1.ListMetaOutput {
	return o.ApplyT(func(v *DeploymentList) metav1.ListMetaOutput { return v.Metadata }).(metav1.ListMetaOutput)
}
