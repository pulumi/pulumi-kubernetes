...
func NewWorkload(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:scheduling.k8s.io/v1alpha1:Workload"),
		},
		{
			Type: pulumi.String("kubernetes:scheduling.k8s.io/v1alpha2:Workload"),
		},
		{
			Type: pulumi.String("kubernetes:scheduling.k8s.io/v1beta1:Workload"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Workload
	err := ctx.RegisterResource("kubernetes:scheduling.k8s.io/v1alpha3:Workload", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkload(ctx *pulumi.Context,
	...
	var resource Workload
	err := ctx.ReadResource("kubernetes:scheduling.k8s.io/v1alpha3:Workload", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
