...
func NewPriorityClassList(ctx *pulumi.Context, name string, args *PriorityClassListArgs, opts ...pulumi.ResourceOption) (*PriorityClassList, error) {
	...
	err := ctx.RegisterResource("kubernetes:scheduling.k8s.io/v1alpha1:PriorityClassList", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPriorityClassList(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*PriorityClassList, error) {
	var resource PriorityClassList
	err := ctx.ReadResource("kubernetes:scheduling.k8s.io/v1alpha1:PriorityClassList", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
