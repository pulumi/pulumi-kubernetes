...
func NewWorkload(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:scheduling.k8s.io/v1alpha3:Workload"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:scheduling.k8s.io/v1alpha2:Workload", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkload(ctx *pulumi.Context,
	...
	var resource Workload
	err := ctx.ReadResource("kubernetes:scheduling.k8s.io/v1alpha2:Workload", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
