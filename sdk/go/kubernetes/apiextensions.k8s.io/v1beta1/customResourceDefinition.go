...
type CustomResourceDefinition struct {
	...
	Spec apiextensionsv1beta1.CustomResourceDefinitionSpecPtrOutput `pulumi:"spec"`
	// status indicates the actual state of the CustomResourceDefinition
	Status apiextensionsv1beta1.CustomResourceDefinitionStatusPtrOutput `pulumi:"status"`
}
...
type customResourceDefinitionState struct {
	...
	// spec describes how the user wants the resources to appear
	Spec *apiextensionsv1beta1.CustomResourceDefinitionSpec `pulumi:"spec"`
	// status indicates the actual state of the CustomResourceDefinition
	Status *apiextensionsv1beta1.CustomResourceDefinitionStatus `pulumi:"status"`
}
...
type CustomResourceDefinitionState struct {
	...
	// spec describes how the user wants the resources to appear
	Spec apiextensionsv1beta1.CustomResourceDefinitionSpecPtrInput
	// status indicates the actual state of the CustomResourceDefinition
	Status apiextensionsv1beta1.CustomResourceDefinitionStatusPtrInput
}
...
type CustomResourceDefinitionArgs struct {
	...
	Metadata metav1.ObjectMetaPtrInput
	// spec describes how the user wants the resources to appear
	Spec apiextensionsv1beta1.CustomResourceDefinitionSpecInput
}
