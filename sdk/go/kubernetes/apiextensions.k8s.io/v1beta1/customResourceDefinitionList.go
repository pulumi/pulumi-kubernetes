...
type CustomResourceDefinitionList struct {
	...
	Items apiextensionsv1beta1.CustomResourceDefinitionArrayOutput `pulumi:"items"`
...
type customResourceDefinitionListState struct {
	...
	// items list individual CustomResourceDefinition objects
	Items []apiextensionsv1beta1.CustomResourceDefinition `pulumi:"items"`
	// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
...
type CustomResourceDefinitionListState struct {
	...
	// items list individual CustomResourceDefinition objects
	Items apiextensionsv1beta1.CustomResourceDefinitionArrayInput
	// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
