...
func (i *FlowSchema) ToOutput(ctx context.Context) pulumix.Output[*FlowSchema] {
	return pulumix.Output[*FlowSchema]{
		OutputState: i.ToFlowSchemaOutputWithContext(ctx).OutputState,
	}
}
...
func (i FlowSchemaArray) ToOutput(ctx context.Context) pulumix.Output[[]*FlowSchema] {
	return pulumix.Output[[]*FlowSchema]{
		OutputState: i.ToFlowSchemaArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i FlowSchemaMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*FlowSchema] {
	return pulumix.Output[map[string]*FlowSchema]{
		OutputState: i.ToFlowSchemaMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o FlowSchemaOutput) ToOutput(ctx context.Context) pulumix.Output[*FlowSchema] {
	return pulumix.Output[*FlowSchema]{
...
func (o FlowSchemaArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*FlowSchema] {
	return pulumix.Output[[]*FlowSchema]{
		OutputState: o.OutputState,
	}
}
...
func (o FlowSchemaMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*FlowSchema] {
	return pulumix.Output[map[string]*FlowSchema]{
		OutputState: o.OutputState,
	}
}
