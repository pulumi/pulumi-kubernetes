...
func NewPriorityLevelConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:flowcontrol.apiserver.k8s.io/v1:PriorityLevelConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPriorityLevelConfiguration(ctx *pulumi.Context,
	...
	var resource PriorityLevelConfiguration
	err := ctx.ReadResource("kubernetes:flowcontrol.apiserver.k8s.io/v1:PriorityLevelConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type PriorityLevelConfigurationArgs struct {
	...
	// `spec` is the specification of the desired behavior of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
	Spec PriorityLevelConfigurationSpecInput
}
