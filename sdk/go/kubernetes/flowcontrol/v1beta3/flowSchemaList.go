...
func NewFlowSchemaList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:flowcontrol.apiserver.k8s.io/v1beta3:FlowSchemaList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFlowSchemaList(ctx *pulumi.Context,
	...
	var resource FlowSchemaList
	err := ctx.ReadResource("kubernetes:flowcontrol.apiserver.k8s.io/v1beta3:FlowSchemaList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
