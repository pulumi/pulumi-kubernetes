...
func NewLeaseList(ctx *pulumi.Context, name string, args *LeaseListArgs, opts ...pulumi.ResourceOption) (*LeaseList, error) {
	...
	err := ctx.RegisterResource("kubernetes:coordination.k8s.io/v1:LeaseList", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLeaseList(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*LeaseList, error) {
	var resource LeaseList
	err := ctx.ReadResource("kubernetes:coordination.k8s.io/v1:LeaseList", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
