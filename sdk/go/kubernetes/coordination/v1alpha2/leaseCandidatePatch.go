...
func NewLeaseCandidatePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:coordination.k8s.io/v1alpha1:LeaseCandidatePatch"),
		},
		{
			Type: pulumi.String("kubernetes:coordination.k8s.io/v1beta1:LeaseCandidatePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource LeaseCandidatePatch
	err := ctx.RegisterResource("kubernetes:coordination.k8s.io/v1alpha2:LeaseCandidatePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLeaseCandidatePatch(ctx *pulumi.Context,
	...
	var resource LeaseCandidatePatch
	err := ctx.ReadResource("kubernetes:coordination.k8s.io/v1alpha2:LeaseCandidatePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
