...
func NewLeaseCandidate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:coordination.k8s.io/v1beta1:LeaseCandidate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLeaseCandidate(ctx *pulumi.Context,
	...
	var resource LeaseCandidate
	err := ctx.ReadResource("kubernetes:coordination.k8s.io/v1beta1:LeaseCandidate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
