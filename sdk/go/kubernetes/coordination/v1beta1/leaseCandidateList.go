...
func NewLeaseCandidateList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:coordination.k8s.io/v1beta1:LeaseCandidateList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLeaseCandidateList(ctx *pulumi.Context,
	...
	var resource LeaseCandidateList
	err := ctx.ReadResource("kubernetes:coordination.k8s.io/v1beta1:LeaseCandidateList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
