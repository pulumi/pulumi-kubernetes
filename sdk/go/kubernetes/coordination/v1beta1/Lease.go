...
func NewLease(ctx *pulumi.Context, name string, args *LeaseArgs, opts ...pulumi.ResourceOption) (*Lease, error) {
	...
	var resource Lease
	err := ctx.RegisterResource("kubernetes:coordination.k8s.io/v1beta1:Lease", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLease(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*Lease, error) {
	var resource Lease
	err := ctx.ReadResource("kubernetes:coordination.k8s.io/v1beta1:Lease", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
