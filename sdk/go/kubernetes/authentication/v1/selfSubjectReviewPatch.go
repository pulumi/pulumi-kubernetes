...
func NewSelfSubjectReviewPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:authentication.k8s.io/v1:SelfSubjectReviewPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSelfSubjectReviewPatch(ctx *pulumi.Context,
	...
	var resource SelfSubjectReviewPatch
	err := ctx.ReadResource("kubernetes:authentication.k8s.io/v1:SelfSubjectReviewPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
