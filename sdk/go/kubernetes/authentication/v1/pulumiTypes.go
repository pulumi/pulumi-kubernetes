...
func (o TokenRequestOutput) Spec() TokenRequestSpecPtrOutput {
	return o.ApplyT(func (v TokenRequest) *TokenRequestSpec { return v.Spec }).(TokenRequestSpecPtrOutput)
}
...
// Spec holds information about the request being evaluated
func (o TokenReviewOutput) Spec() TokenReviewSpecPtrOutput {
	return o.ApplyT(func (v TokenReview) *TokenReviewSpec { return v.Spec }).(TokenReviewSpecPtrOutput)
}
