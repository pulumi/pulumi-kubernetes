...
func NewSelfSubjectReview(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:authentication.k8s.io/v1:SelfSubjectReview", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSelfSubjectReview(ctx *pulumi.Context,
	...
	var resource SelfSubjectReview
	err := ctx.ReadResource("kubernetes:authentication.k8s.io/v1:SelfSubjectReview", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
func (o SelfSubjectReviewOutput) ApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *SelfSubjectReview) pulumi.StringOutput { return v.ApiVersion }).(pulumi.StringOutput)
}

// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
func (o SelfSubjectReviewOutput) Kind() pulumi.StringOutput {
	return o.ApplyT(func(v *SelfSubjectReview) pulumi.StringOutput { return v.Kind }).(pulumi.StringOutput)
}

// Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
func (o SelfSubjectReviewOutput) Metadata() metav1.ObjectMetaOutput {
	return o.ApplyT(func(v *SelfSubjectReview) metav1.ObjectMetaOutput { return v.Metadata }).(metav1.ObjectMetaOutput)
}
