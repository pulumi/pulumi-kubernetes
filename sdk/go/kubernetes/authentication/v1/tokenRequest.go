...
func (o TokenRequestOutput) ApiVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *TokenRequest) pulumi.StringPtrOutput { return v.ApiVersion }).(pulumi.StringPtrOutput)
}

// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
func (o TokenRequestOutput) Kind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *TokenRequest) pulumi.StringPtrOutput { return v.Kind }).(pulumi.StringPtrOutput)
}

// Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
func (o TokenRequestOutput) Metadata() metav1.ObjectMetaPtrOutput {
	return o.ApplyT(func(v *TokenRequest) metav1.ObjectMetaPtrOutput { return v.Metadata }).(metav1.ObjectMetaPtrOutput)
}

// Spec holds information about the request being evaluated
func (o TokenRequestOutput) Spec() TokenRequestSpecOutput {
	return o.ApplyT(func(v *TokenRequest) TokenRequestSpecOutput { return v.Spec }).(TokenRequestSpecOutput)
}

// Status is filled in by the server and indicates whether the token can be authenticated.
func (o TokenRequestOutput) Status() TokenRequestStatusPtrOutput {
	return o.ApplyT(func(v *TokenRequest) TokenRequestStatusPtrOutput { return v.Status }).(TokenRequestStatusPtrOutput)
}
