...
type CSIDriver struct {
	...
	Spec storagev1beta1.CSIDriverSpecPtrOutput `pulumi:"spec"`
}
...
type csidriverState struct {
	...
	// Specification of the CSI Driver.
	Spec *storagev1beta1.CSIDriverSpec `pulumi:"spec"`
}
...
type CSIDriverState struct {
	...
	// Specification of the CSI Driver.
	Spec storagev1beta1.CSIDriverSpecPtrInput
}
...
type CSIDriverArgs struct {
	...
	Metadata metav1.ObjectMetaPtrInput
	// Specification of the CSI Driver.
	Spec storagev1beta1.CSIDriverSpecInput
}
