...
import (
	...
	storagev1 "github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/storage/v1"
)
...
type VolumeAttachment struct {
	...
	Spec storagev1.VolumeAttachmentSpecPtrOutput `pulumi:"spec"`
	// Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.
	Status storagev1.VolumeAttachmentStatusPtrOutput `pulumi:"status"`
}
...
type volumeAttachmentState struct {
	...
	// Specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.
	Spec *storagev1.VolumeAttachmentSpec `pulumi:"spec"`
	// Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.
	Status *storagev1.VolumeAttachmentStatus `pulumi:"status"`
}
...
type VolumeAttachmentState struct {
	...
	// Specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.
	Spec storagev1.VolumeAttachmentSpecPtrInput
	// Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.
	Status storagev1.VolumeAttachmentStatusPtrInput
}
...
type VolumeAttachmentArgs struct {
	...
	Metadata metav1.ObjectMetaPtrInput
	// Specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.
	Spec storagev1.VolumeAttachmentSpecInput
}
