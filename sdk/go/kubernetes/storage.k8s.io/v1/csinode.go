...
type CSINode struct {
	...
	Spec storagev1.CSINodeSpecPtrOutput `pulumi:"spec"`
}
...
type csinodeState struct {
	...
	// spec is the specification of CSINode
	Spec *storagev1.CSINodeSpec `pulumi:"spec"`
}
...
type CSINodeState struct {
	...
	// spec is the specification of CSINode
	Spec storagev1.CSINodeSpecPtrInput
}
...
type CSINodeArgs struct {
	...
	Metadata metav1.ObjectMetaPtrInput
	// spec is the specification of CSINode
	Spec storagev1.CSINodeSpecInput
}
