...
func RegisterResource(ctx *pulumi.Context, apiVersion, kind, name string, props pulumi.Input,
	...
	case "admissionregistration.k8s.io/v1/MutatingAdmissionPolicy":
		...
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicy", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	case "admissionregistration.k8s.io/v1/MutatingAdmissionPolicyBinding":
		...
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyBinding", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	...
	case "admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicy":
		...
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicy", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	case "admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicyBinding":
		...
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicyBinding", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	...
	case "certificates.k8s.io/v1beta1/PodCertificateRequest":
		...
		err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1beta1:PodCertificateRequest", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	...
	case "resource.k8s.io/v1/ResourceClaim":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:ResourceClaim", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	case "resource.k8s.io/v1/ResourceClaimTemplate":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:ResourceClaimTemplate", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	case "resource.k8s.io/v1/ResourceSlice":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:ResourceSlice", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	...
	case "resource.k8s.io/v1alpha3/ResourcePoolStatusRequest":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1alpha3:ResourcePoolStatusRequest", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	...
	case "resource.k8s.io/v1beta2/DeviceTaintRule":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:DeviceTaintRule", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	...
	case "scheduling.k8s.io/v1alpha2/Workload":
		...
		err := ctx.RegisterResource("kubernetes:scheduling.k8s.io/v1alpha2:Workload", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	...
	case "storage.k8s.io/v1/VolumeAttributesClass":
		...
		err := ctx.RegisterResource("kubernetes:storage.k8s.io/v1:VolumeAttributesClass", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
	...
	case "storagemigration.k8s.io/v1beta1/StorageVersionMigration":
		...
		err := ctx.RegisterResource("kubernetes:storagemigration.k8s.io/v1beta1:StorageVersionMigration", name, props, &res, opts...)
		if err != nil {
			return nil, err
		}
		return &res, nil
