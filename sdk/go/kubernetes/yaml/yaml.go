...
import (
	...
	resourcev1 "github.com/pulumi/pulumi-kubernetes/sdk/v4/go/kubernetes/resource/v1"
...
func parseYamlObject(ctx *pulumi.Context, obj map[string]interface{}, transformations []Transformation,
	...
	case "admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicy":
		...
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1alpha1:MutatingAdmissionPolicy", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicyBinding":
		...
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1alpha1:MutatingAdmissionPolicyBinding", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "admissionregistration.k8s.io/v1alpha1/ValidatingAdmissionPolicy":
		...
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicy", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "admissionregistration.k8s.io/v1alpha1/ValidatingAdmissionPolicyBinding":
		...
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyBinding", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicy":
		var res admissionregistrationv1beta1.MutatingAdmissionPolicy
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicy", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicyBinding":
		var res admissionregistrationv1beta1.MutatingAdmissionPolicyBinding
		err := ctx.RegisterResource("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicyBinding", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "certificates.k8s.io/v1/ClusterTrustBundle":
		...
		err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1:ClusterTrustBundle", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "certificates.k8s.io/v1/PodCertificateRequest":
		...
		err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1:PodCertificateRequest", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "certificates.k8s.io/v1alpha1/ClusterTrustBundle":
		...
		err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1alpha1:ClusterTrustBundle", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "certificates.k8s.io/v1beta1/ClusterTrustBundle":
		...
		err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundle", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "certificates.k8s.io/v1beta1/PodCertificateRequest":
		var res certificatesv1beta1.PodCertificateRequest
		err := ctx.RegisterResource("kubernetes:certificates.k8s.io/v1beta1:PodCertificateRequest", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "coordination.k8s.io/v1alpha2/LeaseCandidate":
		...
		err := ctx.RegisterResource("kubernetes:coordination.k8s.io/v1alpha2:LeaseCandidate", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "coordination.k8s.io/v1beta1/LeaseCandidate":
		...
		err := ctx.RegisterResource("kubernetes:coordination.k8s.io/v1beta1:LeaseCandidate", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "flowcontrol.apiserver.k8s.io/v1beta3/FlowSchema":
		...
		err := ctx.RegisterResource("kubernetes:flowcontrol.apiserver.k8s.io/v1beta3:FlowSchema", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "flowcontrol.apiserver.k8s.io/v1beta3/PriorityLevelConfiguration":
		...
		err := ctx.RegisterResource("kubernetes:flowcontrol.apiserver.k8s.io/v1beta3:PriorityLevelConfiguration", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "lifecycle.k8s.io/v1alpha1/Eviction":
		...
		err := ctx.RegisterResource("kubernetes:lifecycle.k8s.io/v1alpha1:Eviction", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "lifecycle.k8s.io/v1alpha1/EvictionRequest":
		...
		err := ctx.RegisterResource("kubernetes:lifecycle.k8s.io/v1alpha1:EvictionRequest", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "networking.k8s.io/v1/IPAddress":
		...
		err := ctx.RegisterResource("kubernetes:networking.k8s.io/v1:IPAddress", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "networking.k8s.io/v1/ServiceCIDR":
		...
		err := ctx.RegisterResource("kubernetes:networking.k8s.io/v1:ServiceCIDR", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "resource.k8s.io/v1/DeviceClass":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:DeviceClass", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "resource.k8s.io/v1/DeviceTaintRule":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:DeviceTaintRule", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "resource.k8s.io/v1/ResourceClaim":
		var res resourcev1.ResourceClaim
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:ResourceClaim", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "resource.k8s.io/v1/ResourceClaimTemplate":
		var res resourcev1.ResourceClaimTemplate
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:ResourceClaimTemplate", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "resource.k8s.io/v1/ResourceSlice":
		var res resourcev1.ResourceSlice
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1:ResourceSlice", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "resource.k8s.io/v1alpha2/ResourceClaim":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1alpha2:ResourceClaim", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "resource.k8s.io/v1alpha3/DeviceTaintRule":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1alpha3:DeviceTaintRule", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "resource.k8s.io/v1beta1/DeviceClass":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:DeviceClass", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "resource.k8s.io/v1beta1/ResourceClaim":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:ResourceClaim", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "resource.k8s.io/v1beta1/ResourceClaimTemplate":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "resource.k8s.io/v1beta1/ResourceSlice":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta1:ResourceSlice", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "resource.k8s.io/v1beta2/DeviceClass":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:DeviceClass", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "resource.k8s.io/v1beta2/ResourceClaimTemplate":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplate", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "resource.k8s.io/v1beta2/ResourceSlice":
		...
		err := ctx.RegisterResource("kubernetes:resource.k8s.io/v1beta2:ResourceSlice", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "scheduling.k8s.io/v1alpha3/CompositePodGroup":
		...
		err := ctx.RegisterResource("kubernetes:scheduling.k8s.io/v1alpha3:CompositePodGroup", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "scheduling.k8s.io/v1alpha3/PodGroup":
		...
		err := ctx.RegisterResource("kubernetes:scheduling.k8s.io/v1alpha3:PodGroup", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "scheduling.k8s.io/v1alpha3/Workload":
		...
		err := ctx.RegisterResource("kubernetes:scheduling.k8s.io/v1alpha3:Workload", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	case "scheduling.k8s.io/v1beta1/PodGroup":
		...
		err := ctx.RegisterResource("kubernetes:scheduling.k8s.io/v1beta1:PodGroup", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "scheduling.k8s.io/v1beta1/Workload":
		...
		err := ctx.RegisterResource("kubernetes:scheduling.k8s.io/v1beta1:Workload", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "storage.k8s.io/v1/VolumeAttributesClass":
		var res storagev1.VolumeAttributesClass
		err := ctx.RegisterResource("kubernetes:storage.k8s.io/v1:VolumeAttributesClass", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "storagemigration.k8s.io/v1/StorageVersionMigration":
		...
		err := ctx.RegisterResource("kubernetes:storagemigration.k8s.io/v1:StorageVersionMigration", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
	...
	case "storagemigration.k8s.io/v1beta1/StorageVersionMigration":
		var res storagemigrationv1beta1.StorageVersionMigration
		err := ctx.RegisterResource("kubernetes:storagemigration.k8s.io/v1beta1:StorageVersionMigration", metaName, kubernetes.UntypedArgs(obj), &res, opts...)
		if err != nil {
			return nil, err
		}
		return []resourceTuple{{Name: key, Resource: &res}}, nil
