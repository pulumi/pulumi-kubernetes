...
import (
	...
	authorizationv1beta1 "github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/authorization/v1beta1"
...
type SelfSubjectAccessReview struct {
	...
	Spec authorizationv1beta1.SelfSubjectAccessReviewSpecPtrOutput `pulumi:"spec"`
	// Status is filled in by the server and indicates whether the request is allowed or not
	Status authorizationv1beta1.SubjectAccessReviewStatusPtrOutput `pulumi:"status"`
}
...
func NewSelfSubjectAccessReview(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:authorization.k8s.io/v1beta1:SelfSubjectAccessReview", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSelfSubjectAccessReview(ctx *pulumi.Context,
	...
	var resource SelfSubjectAccessReview
	err := ctx.ReadResource("kubernetes:authorization.k8s.io/v1beta1:SelfSubjectAccessReview", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type selfSubjectAccessReviewState struct {
	...
	// Spec holds information about the request being evaluated.  user and groups must be empty
	Spec *authorizationv1beta1.SelfSubjectAccessReviewSpec `pulumi:"spec"`
	// Status is filled in by the server and indicates whether the request is allowed or not
	Status *authorizationv1beta1.SubjectAccessReviewStatus `pulumi:"status"`
}
...
type SelfSubjectAccessReviewState struct {
	...
	// Spec holds information about the request being evaluated.  user and groups must be empty
	Spec authorizationv1beta1.SelfSubjectAccessReviewSpecPtrInput
	// Status is filled in by the server and indicates whether the request is allowed or not
	Status authorizationv1beta1.SubjectAccessReviewStatusPtrInput
}
...
type SelfSubjectAccessReviewArgs struct {
	...
	Metadata metav1.ObjectMetaPtrInput
	// Spec holds information about the request being evaluated.  user and groups must be empty
	Spec authorizationv1beta1.SelfSubjectAccessReviewSpecInput
}
