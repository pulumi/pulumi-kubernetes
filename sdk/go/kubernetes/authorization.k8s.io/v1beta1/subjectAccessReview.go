...
type SubjectAccessReview struct {
	...
	Spec authorizationv1beta1.SubjectAccessReviewSpecPtrOutput `pulumi:"spec"`
...
type subjectAccessReviewState struct {
	...
	// Spec holds information about the request being evaluated
	Spec *authorizationv1beta1.SubjectAccessReviewSpec `pulumi:"spec"`
	// Status is filled in by the server and indicates whether the request is allowed or not
...
type SubjectAccessReviewState struct {
	...
	// Spec holds information about the request being evaluated
	Spec authorizationv1beta1.SubjectAccessReviewSpecPtrInput
	// Status is filled in by the server and indicates whether the request is allowed or not
...
type SubjectAccessReviewArgs struct {
	...
	Metadata metav1.ObjectMetaPtrInput
	// Spec holds information about the request being evaluated
	Spec authorizationv1beta1.SubjectAccessReviewSpecInput
}
