...
func (o NodeOutput) Kind() pulumi.StringOutput {
	return o.ApplyT(func(v *Node) pulumi.StringOutput { return v.Kind }).(pulumi.StringOutput)
}

// Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
func (o NodeOutput) Metadata() metav1.ObjectMetaOutput {
	return o.ApplyT(func(v *Node) metav1.ObjectMetaOutput { return v.Metadata }).(metav1.ObjectMetaOutput)
}

// Spec defines the behavior of a node. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
func (o NodeOutput) Spec() NodeSpecOutput {
	return o.ApplyT(func(v *Node) NodeSpecOutput { return v.Spec }).(NodeSpecOutput)
}
