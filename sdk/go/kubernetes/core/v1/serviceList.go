...
func (o ServiceListOutput) ApiVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ServiceList) pulumi.StringPtrOutput { return v.ApiVersion }).(pulumi.StringPtrOutput)
}
...
func (o ServiceListOutput) Kind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ServiceList) pulumi.StringPtrOutput { return v.Kind }).(pulumi.StringPtrOutput)
}

// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
func (o ServiceListOutput) Metadata() metav1.ListMetaPtrOutput {
	return o.ApplyT(func(v *ServiceList) metav1.ListMetaPtrOutput { return v.Metadata }).(metav1.ListMetaPtrOutput)
}
