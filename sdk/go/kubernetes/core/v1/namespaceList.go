...
func (o NamespaceListOutput) ApiVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NamespaceList) pulumi.StringPtrOutput { return v.ApiVersion }).(pulumi.StringPtrOutput)
}
...
func (o NamespaceListOutput) Kind() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NamespaceList) pulumi.StringPtrOutput { return v.Kind }).(pulumi.StringPtrOutput)
}

// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
func (o NamespaceListOutput) Metadata() metav1.ListMetaPtrOutput {
	return o.ApplyT(func(v *NamespaceList) metav1.ListMetaPtrOutput { return v.Metadata }).(metav1.ListMetaPtrOutput)
}
