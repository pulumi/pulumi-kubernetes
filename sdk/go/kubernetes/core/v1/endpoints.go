...
func (i *Endpoints) ToOutput(ctx context.Context) pulumix.Output[*Endpoints] {
...
func (i EndpointsMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*Endpoints] {
	return pulumix.Output[map[string]*Endpoints]{
		OutputState: i.ToEndpointsMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o EndpointsOutput) ApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *Endpoints) pulumi.StringOutput { return v.ApiVersion }).(pulumi.StringOutput)
}

// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
func (o EndpointsOutput) Kind() pulumi.StringOutput {
	return o.ApplyT(func(v *Endpoints) pulumi.StringOutput { return v.Kind }).(pulumi.StringOutput)
}

// Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
func (o EndpointsOutput) Metadata() metav1.ObjectMetaOutput {
	return o.ApplyT(func(v *Endpoints) metav1.ObjectMetaOutput { return v.Metadata }).(metav1.ObjectMetaOutput)
}
...
func (o EndpointsMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*Endpoints] {
	return pulumix.Output[map[string]*Endpoints]{
		OutputState: o.OutputState,
	}
}
