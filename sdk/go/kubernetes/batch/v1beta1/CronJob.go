...
func NewCronJob(ctx *pulumi.Context, name string, args *CronJobArgs, opts ...pulumi.ResourceOption) (*CronJob, error) {
	...
	err := ctx.RegisterResource("kubernetes:batch/v1beta1:CronJob", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCronJob(ctx *pulumi.Context, name string, id pulumi.IDInput, opts ...pulumi.ResourceOption) (*CronJob, error) {
	var resource CronJob
	err := ctx.ReadResource("kubernetes:batch/v1beta1:CronJob", name, id, nil, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
