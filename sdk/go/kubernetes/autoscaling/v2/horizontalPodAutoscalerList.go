...
func (o HorizontalPodAutoscalerListOutput) ApiVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *HorizontalPodAutoscalerList) pulumi.StringOutput { return v.ApiVersion }).(pulumi.StringOutput)
}
...
func (o HorizontalPodAutoscalerListOutput) Kind() pulumi.StringOutput {
	return o.ApplyT(func(v *HorizontalPodAutoscalerList) pulumi.StringOutput { return v.Kind }).(pulumi.StringOutput)
}

// metadata is the standard list metadata.
func (o HorizontalPodAutoscalerListOutput) Metadata() metav1.ListMetaOutput {
	return o.ApplyT(func(v *HorizontalPodAutoscalerList) metav1.ListMetaOutput { return v.Metadata }).(metav1.ListMetaOutput)
}
