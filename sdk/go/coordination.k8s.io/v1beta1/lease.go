...
import (
	...
	coordinationv1beta1 "github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/coordination/v1beta1"
...
type Lease struct {
	...
	Spec coordinationv1beta1.LeaseSpecPtrOutput `pulumi:"spec"`
}
...
type leaseState struct {
	...
	// Specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
	Spec *coordinationv1beta1.LeaseSpec `pulumi:"spec"`
}
...
type LeaseState struct {
	...
	// Specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
	Spec coordinationv1beta1.LeaseSpecPtrInput
}
