...
type ValidatingWebhookConfigurationList struct {
	...
	Items admissionregistrationv1beta1.ValidatingWebhookConfigurationArrayOutput `pulumi:"items"`
...
type validatingWebhookConfigurationListState struct {
	...
	// List of ValidatingWebhookConfiguration.
	Items []admissionregistrationv1beta1.ValidatingWebhookConfiguration `pulumi:"items"`
	// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
...
type ValidatingWebhookConfigurationListState struct {
	...
	// List of ValidatingWebhookConfiguration.
	Items admissionregistrationv1beta1.ValidatingWebhookConfigurationArrayInput
	// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
