...
type SelfSubjectRulesReview struct {
	...
	Spec authorizationv1beta1.SelfSubjectRulesReviewSpecPtrOutput `pulumi:"spec"`
	// Status is filled in by the server and indicates the set of actions a user can perform.
	Status authorizationv1beta1.SubjectRulesReviewStatusPtrOutput `pulumi:"status"`
}
...
type selfSubjectRulesReviewState struct {
	...
	// Spec holds information about the request being evaluated.
	Spec *authorizationv1beta1.SelfSubjectRulesReviewSpec `pulumi:"spec"`
	// Status is filled in by the server and indicates the set of actions a user can perform.
	Status *authorizationv1beta1.SubjectRulesReviewStatus `pulumi:"status"`
}
...
type SelfSubjectRulesReviewState struct {
	...
	// Spec holds information about the request being evaluated.
	Spec authorizationv1beta1.SelfSubjectRulesReviewSpecPtrInput
	// Status is filled in by the server and indicates the set of actions a user can perform.
	Status authorizationv1beta1.SubjectRulesReviewStatusPtrInput
}
...
type SelfSubjectRulesReviewArgs struct {
	...
	Metadata metav1.ObjectMetaPtrInput
	// Spec holds information about the request being evaluated.
	Spec authorizationv1beta1.SelfSubjectRulesReviewSpecInput
}
