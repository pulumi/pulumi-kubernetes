...
class EventList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['EventArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['EventArgs']]]] items: items is a list of schema objects.
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.Event']]:
        """
