...
class Event(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(deprecated_source, _core.v1.EventSourceArgs):
            ...
            if not isinstance(series, EventSeriesArgs):
                series = series or {}
                def _setter(key, value):
                    series[key] = value
