...
class EventList(pulumi.CustomResource):
    ...
    Items is a list of schema objects.
      ...
      * `deprecated_count` (`float`) - Deprecated field assuring backward compatibility with core.v1 Event type
      * `deprecated_first_timestamp` (`str`) - Deprecated field assuring backward compatibility with core.v1 Event type
      * `deprecated_last_timestamp` (`str`) - Deprecated field assuring backward compatibility with core.v1 Event type
      * `deprecated_source` (`dict`) - Deprecated field assuring backward compatibility with core.v1 Event type
        * `component` (`str`) - Component from which the event is generated.
        * `host` (`str`) - Node name on which the event is generated.

      * `event_time` (`str`) - Required. Time when this Event was first observed.
      ...
      * `regarding` (`dict`) - The object this Event is about. In most cases it's an Object reporting controller implements. E.g. ReplicaSetController implements ReplicaSets and this event is emitted because it acts on some changes in a ReplicaSet object.
        * `api_version` (`str`) - API version of the referent.
      ...
      * `related` (`dict`) - Optional secondary object for more complex actions. E.g. when regarding object triggers a creation or deletion of related object.
      * `reporting_controller` (`str`) - Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.
      ...
      * `series` (`dict`) - Data about the Event series this event represents or nil if it's a singleton Event.
        ...
        * `last_observed_time` (`str`) - Time when last Event from the series was seen before last heartbeat.
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `deprecated_count` (`pulumi.Input[float]`) - Deprecated field assuring backward compatibility with core.v1 Event type
          ...
          * `reporting_controller` (`pulumi.Input[str]`) - Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.
          ...
          * `series` (`pulumi.Input[dict]`) - Data about the Event series this event represents or nil if it's a singleton Event.
            ...
            * `last_observed_time` (`pulumi.Input[str]`) - Time when last Event from the series was seen before last heartbeat.
            * `state` (`pulumi.Input[str]`) - Information whether this series is ongoing or finished. Deprecated. Planned removal for 1.18
