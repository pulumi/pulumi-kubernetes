...
class Event(dict):
    ...
    def __init__(__self__, *,
                 ...
                 deprecated_count: Optional[builtins.int] = None,
                 deprecated_first_timestamp: Optional[builtins.str] = None,
                 deprecated_last_timestamp: Optional[builtins.str] = None,
                 ...
                 reporting_controller: Optional[builtins.str] = None,
                 reporting_instance: Optional[builtins.str] = None,
                 series: Optional['outputs.EventSeries'] = None,
                 type: Optional[builtins.str] = None):
        """
        Event is a report of an event somewhere in the cluster. It generally denotes some state change in the system. Events have a limited retention time and triggers and messages may evolve with time.  Event consumers should not rely on the timing of an event with a given Reason reflecting a consistent underlying trigger, or the continued existence of events with that Reason.  Events should be treated as informative, best-effort, supplemental data.
        :param builtins.str event_time: eventTime is the time when this Event was first observed. It is required.
        :param builtins.str action: action is what action was taken/failed regarding to the regarding object. It is machine-readable. This field cannot be empty for new Events and it can have at most 128 characters.
        :param builtins.str api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param builtins.int deprecated_count: deprecatedCount is the deprecated field assuring backward compatibility with core.v1 Event type.
        :param builtins.str deprecated_first_timestamp: deprecatedFirstTimestamp is the deprecated field assuring backward compatibility with core.v1 Event type.
        :param builtins.str deprecated_last_timestamp: deprecatedLastTimestamp is the deprecated field assuring backward compatibility with core.v1 Event type.
        ...
        :param builtins.str note: note is a human-readable description of the status of this operation. Maximal length of the note is 1kB, but libraries should be prepared to handle values up to 64kB.
        :param builtins.str reason: reason is why the action was taken. It is human-readable. This field cannot be empty for new Events and it can have at most 128 characters.
        ...
        :param builtins.str reporting_controller: reportingController is the name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`. This field cannot be empty for new Events.
        :param builtins.str reporting_instance: reportingInstance is the ID of the controller instance, e.g. `kubelet-xyzf`. This field cannot be empty for new Events and it can have at most 128 characters.
        ...
        :param builtins.str type: type is the type of this event (Normal, Warning), new types could be added in the future. It is machine-readable. This field cannot be empty for new Events.
        """
    ...
    def deprecated_count(self) -> Optional[builtins.int]:
        """
    ...
    def deprecated_first_timestamp(self) -> Optional[builtins.str]:
        """
    ...
    def deprecated_last_timestamp(self) -> Optional[builtins.str]:
        """
    ...
    def reporting_controller(self) -> Optional[builtins.str]:
        """
    ...
    def reporting_instance(self) -> Optional[builtins.str]:
        """
...
class EventSeries(dict):
    ...
    def __init__(__self__, *,
                 count: builtins.int,
                 last_observed_time: builtins.str):
        """
        EventSeries contain information on series of events, i.e. thing that was/is happening continuously for some time. How often to update the EventSeries is up to the event reporters. The default event reporter in "k8s.io/client-go/tools/events/event_broadcaster.go" shows how this struct is updated on heartbeats and can guide customized reporter implementations.
        :param builtins.int count: count is the number of occurrences in this series up to the last heartbeat time.
        :param builtins.str last_observed_time: lastObservedTime is the time when last Event from the series was seen before last heartbeat.
        """
    ...
    def last_observed_time(self) -> builtins.str:
        """
...
class EventSeriesPatch(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_observed_time: Optional[builtins.str] = None):
        """
        EventSeries contain information on series of events, i.e. thing that was/is happening continuously for some time. How often to update the EventSeries is up to the event reporters. The default event reporter in "k8s.io/client-go/tools/events/event_broadcaster.go" shows how this struct is updated on heartbeats and can guide customized reporter implementations.
        :param builtins.int count: count is the number of occurrences in this series up to the last heartbeat time.
        :param builtins.str last_observed_time: lastObservedTime is the time when last Event from the series was seen before last heartbeat.
    ...
    @property
    @pulumi.getter(name="lastObservedTime")
    def last_observed_time(self) -> Optional[builtins.str]:
        """
        lastObservedTime is the time when last Event from the series was seen before last heartbeat.
        """
        return pulumi.get(self, "last_observed_time")
