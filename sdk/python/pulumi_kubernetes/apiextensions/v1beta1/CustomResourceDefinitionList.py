...
__all__ = ['CustomResourceDefinitionList']
...
class CustomResourceDefinitionList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CustomResourceDefinitionArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['CustomResourceDefinitionArgs']]]] items: items list individual CustomResourceDefinition objects
        ...
        if opts.id is None:
            ...
            __props__['api_version'] = 'apiextensions.k8s.io/v1beta1'
            if items is None:
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.CustomResourceDefinition']]:
        """
