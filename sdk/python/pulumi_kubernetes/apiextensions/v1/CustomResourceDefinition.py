...
class CustomResourceDefinitionInitArgs:
    def __init__(__self__, *,
        ...
        """
        CustomResourceDefinitionInitArgs._configure(
...
class CustomResourceDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CustomResourceDefinitionInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(spec, CustomResourceDefinitionSpecArgs):
                spec = spec or {}
                def _setter(key, value):
                    spec[key] = value
