...
class CustomResourceDefinitionListArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['CustomResourceDefinitionList']]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['CustomResourceDefinitionList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['CustomResourceDefinitionList']]]):
...
class CustomResourceDefinitionList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: pulumi.Input[Optional[Literal['apiextensions.k8s.io/v1']]] = None,
                 items: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CustomResourceDefinitionArgs', 'CustomResourceDefinitionArgsDict', 'outputs.CustomResourceDefinition']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['CustomResourceDefinitionList']]] = None,
        ...
        :param pulumi.Input[Literal['apiextensions.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['CustomResourceDefinitionArgs', 'CustomResourceDefinitionArgsDict', 'outputs.CustomResourceDefinition']]]] items: items list individual CustomResourceDefinition objects
        :param pulumi.Input[Literal['CustomResourceDefinitionList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Literal['apiextensions.k8s.io/v1']]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['CustomResourceDefinitionList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
