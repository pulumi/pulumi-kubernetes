...
class CustomResourceDefinitionPatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['CustomResourceDefinitionSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['CustomResourceDefinitionSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['CustomResourceDefinitionSpecPatchArgs']]):
...
class CustomResourceDefinitionPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['CustomResourceDefinitionSpecPatchArgs', 'CustomResourceDefinitionSpecPatchArgsDict', 'outputs.CustomResourceDefinitionSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['CustomResourceDefinitionSpecPatchArgs', 'CustomResourceDefinitionSpecPatchArgsDict', 'outputs.CustomResourceDefinitionSpecPatch']] spec: spec describes how the user wants the resources to appear
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:apiextensions.k8s.io/v1beta1:CustomResourceDefinitionPatch")])
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Optional[Literal['apiextensions.k8s.io/v1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['CustomResourceDefinition']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
