...
class StatusPatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] code: Suggested HTTP return code for this status, 0 if not set.
        ...
        :param pulumi.Input[builtins.str] reason: A machine-readable description of why this operation is in the "Failure" status. If this value is empty there is no information available. A Reason clarifies an HTTP status code but does not override it.
        """
...
class StatusPatch(pulumi.CustomResource):
    ...
    pulumi_type = "kubernetes:meta/v1:StatusPatch"
    ...
    @property
    @pulumi.getter
    def code(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Suggested HTTP return code for this status, 0 if not set.
        """
        return pulumi.get(self, "code")
