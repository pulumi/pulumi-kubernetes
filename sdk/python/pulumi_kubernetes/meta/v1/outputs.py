...
class ConditionPatch(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ConditionPatch. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ConditionPatch.__key_warning(key)
        return super().__getitem__(key)
...
class LabelSelectorPatch(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LabelSelectorPatch. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LabelSelectorPatch.__key_warning(key)
        return super().__getitem__(key)
...
class LabelSelectorRequirement(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        LabelSelectorRequirement._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            key=key,
            operator=operator,
            values=values,
...
@pulumi.output_type
class LabelSelectorRequirementPatch(dict):
    """
    A label selector requirement is a selector that contains values, a key, and an operator that relates the key and values.
    """
    def __init__(__self__, *,
        ...
        :param Sequence[str] values: values is an array of string values. If the operator is In or NotIn, the values array must be non-empty. If the operator is Exists or DoesNotExist, the values array must be empty. This array is replaced during a strategic merge patch.
        """
        LabelSelectorRequirementPatch._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            key=key,
            operator=operator,
            values=values,
...
class ListMetaPatch(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ListMetaPatch. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ListMetaPatch.__key_warning(key)
        return super().__getitem__(key)
...
class ManagedFieldsEntryPatch(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str time: Time is the timestamp of when the ManagedFields entry was added. The timestamp will also be updated if a field is added, the manager changes any of the owned fields value or removes a field. The timestamp does not update when a field is removed from the entry because another manager took it over.
        """
        ManagedFieldsEntryPatch._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            api_version=api_version,
            fields_type=fields_type,
            fields_v1=fields_v1,
...
class OwnerReferencePatch(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str uid: UID of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names#uids
        """
        OwnerReferencePatch._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            api_version=api_version,
            block_owner_deletion=block_owner_deletion,
            controller=controller,
...
class StatusDetailsPatch(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in StatusDetailsPatch. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        StatusDetailsPatch.__key_warning(key)
        return super().__getitem__(key)
