...
class CSINodeList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CSINodeArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['CSINodeArgs']]]] items: items is the list of CSINode
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.CSINode']]:
        """
