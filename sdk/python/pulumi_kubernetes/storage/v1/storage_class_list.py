...
class StorageClassList(pulumi.CustomResource):
    ...
    Items is the list of StorageClasses
      ...
      * `allowed_topologies` (`list`) - Restrict the node topologies where volumes can be dynamically provisioned. Each volume plugin defines its own supported topology specifications. An empty TopologySelectorTerm list means there is no topology restriction. This field is only honored by servers that enable the VolumeScheduling feature.
      ...
      * `mount_options` (`list`) - Dynamically provisioned PersistentVolumes of this storage class are created with these mountOptions, e.g. ["ro", "soft"]. Not validated - mount of the PVs will simply fail if one is invalid.
      * `parameters` (`dict`) - Parameters holds the parameters for the provisioner that should create volumes of this storage class.
      * `provisioner` (`str`) - Provisioner indicates the type of the provisioner.
      * `reclaim_policy` (`str`) - Dynamically provisioned PersistentVolumes of this storage class are created with this reclaimPolicy. Defaults to Delete.
      * `volume_binding_mode` (`str`) - VolumeBindingMode indicates how PersistentVolumeClaims should be provisioned and bound.  When unset, VolumeBindingImmediate is used. This field is only honored by servers that enable the VolumeScheduling feature.
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] items: Items is the list of StorageClasses
        ...
        The **items** object supports the following:
          ...
          * `allow_volume_expansion` (`pulumi.Input[bool]`) - AllowVolumeExpansion shows whether the storage class allow volume expand
          * `allowed_topologies` (`pulumi.Input[list]`) - Restrict the node topologies where volumes can be dynamically provisioned. Each volume plugin defines its own supported topology specifications. An empty TopologySelectorTerm list means there is no topology restriction. This field is only honored by servers that enable the VolumeScheduling feature.
          ...
          * `mount_options` (`pulumi.Input[list]`) - Dynamically provisioned PersistentVolumes of this storage class are created with these mountOptions, e.g. ["ro", "soft"]. Not validated - mount of the PVs will simply fail if one is invalid.
          * `parameters` (`pulumi.Input[dict]`) - Parameters holds the parameters for the provisioner that should create volumes of this storage class.
          * `provisioner` (`pulumi.Input[str]`) - Provisioner indicates the type of the provisioner.
          * `reclaim_policy` (`pulumi.Input[str]`) - Dynamically provisioned PersistentVolumes of this storage class are created with this reclaimPolicy. Defaults to Delete.
          * `volume_binding_mode` (`pulumi.Input[str]`) - VolumeBindingMode indicates how PersistentVolumeClaims should be provisioned and bound.  When unset, VolumeBindingImmediate is used. This field is only honored by servers that enable the VolumeScheduling feature.
        ...
        super(StorageClassList, __self__).__init__(
    ...
    def get(resource_name, id, opts=None):
        ...
        return StorageClassList(resource_name, opts=opts, __props__=__props__)
