...
@pulumi.type_token("kubernetes:storage.k8s.io/v1:VolumeAttributesClassPatch")
class VolumeAttributesClassPatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:storage.k8s.io/v1alpha1:VolumeAttributesClassPatch"), pulumi.Alias(type_="kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClassPatch")])
    ...
    @_builtins.property
    @pulumi.getter(name="driverName")
    def driver_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        driverName is the name of the CSI driver This field is immutable.
        """
        return pulumi.get(self, "driver_name")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['VolumeAttributesClass']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
