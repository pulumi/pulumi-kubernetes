...
class CSIDriverList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CSIDriverArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['CSIDriverArgs']]]] items: items is the list of CSIDriver
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.CSIDriver']]:
        """
