...
class CSIDriverSpec(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "serviceAccountTokenInSecrets":
            suggest = "service_account_token_in_secrets"
    ...
    def service_account_token_in_secrets(self) -> Optional[_builtins.bool]:
        """
