...
class VolumeAttachmentPatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VolumeAttachmentSpecPatchArgs'] spec: spec represents specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.
        """
...
@pulumi.type_token("kubernetes:storage.k8s.io/v1:VolumeAttachmentPatch")
class VolumeAttachmentPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['VolumeAttachmentSpecPatchArgs', 'VolumeAttachmentSpecPatchArgsDict', 'outputs.VolumeAttachmentSpecPatch']] spec: spec represents specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.
        """
        ...
    @overload
    def __init__(__self__,
