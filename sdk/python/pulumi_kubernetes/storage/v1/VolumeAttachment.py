...
@pulumi.type_token("kubernetes:storage.k8s.io/v1:VolumeAttachment")
class VolumeAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['VolumeAttachmentSpecArgs', 'VolumeAttachmentSpecArgsDict', 'outputs.VolumeAttachmentSpec']] spec: spec represents specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['VolumeAttachment']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
