...
class VolumeAttachmentList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VolumeAttachmentArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['VolumeAttachmentArgs']]]] items: Items is the list of VolumeAttachments
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.VolumeAttachment']]:
        """
