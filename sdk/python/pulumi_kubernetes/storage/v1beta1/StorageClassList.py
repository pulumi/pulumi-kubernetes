...
__all__ = ['StorageClassListArgs', 'StorageClassList']

@pulumi.input_type
class StorageClassListArgs:
    def __init__(__self__, *,
                 items: pulumi.Input[Sequence[pulumi.Input['StorageClassArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['StorageClassArgs']]] items: Items is the list of StorageClasses
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", 'StorageClassList')
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)

    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Input[Sequence[pulumi.Input['StorageClassArgs']]]:
        """
    ...
    @items.setter
    def items(self, value: pulumi.Input[Sequence[pulumi.Input['StorageClassArgs']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['StorageClassList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['StorageClassList']]]):
...
@pulumi.type_token("kubernetes:storage.k8s.io/v1beta1:StorageClassList")
class StorageClassList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param StorageClassListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(StorageClassListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = StorageClassListArgs.__new__(StorageClassListArgs)

            __props__.__dict__["api_version"] = 'storage.k8s.io/v1beta1'
            if items is None and not opts.urn:
                raise TypeError("Missing required property 'items'")
            __props__.__dict__["items"] = items
            __props__.__dict__["kind"] = 'StorageClassList'
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'StorageClassList':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence['outputs.StorageClass']]:
        """
        Items is the list of StorageClasses
        """
        return pulumi.get(self, "items")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['StorageClassList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
