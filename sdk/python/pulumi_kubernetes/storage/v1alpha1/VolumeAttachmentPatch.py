...
class VolumeAttachmentPatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['VolumeAttachmentSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['VolumeAttachmentSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['VolumeAttachmentSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:storage.k8s.io/v1alpha1:VolumeAttachmentPatch")
class VolumeAttachmentPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['VolumeAttachmentSpecPatchArgs', 'VolumeAttachmentSpecPatchArgsDict', 'outputs.VolumeAttachmentSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['VolumeAttachmentSpecPatchArgs', 'VolumeAttachmentSpecPatchArgsDict', 'outputs.VolumeAttachmentSpecPatch']] spec: Specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:storage.k8s.io/v1:VolumeAttachmentPatch"), pulumi.Alias(type_="kubernetes:storage.k8s.io/v1beta1:VolumeAttachmentPatch")])
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Optional[Literal['storage.k8s.io/v1alpha1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['VolumeAttachment']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
