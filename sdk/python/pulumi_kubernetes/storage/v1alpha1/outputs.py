...
class VolumeError(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        VolumeError captures an error encountered during a volume operation.
        :param builtins.str message: String detailing the error encountered during Attach or Detach operation. This string maybe logged, so it should not contain sensitive information.
