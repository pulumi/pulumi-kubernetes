...
if not MYPY:
    class DaemonSetSpecPatchArgsDict(TypedDict):
        ...
        """
        template_generation: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DaemonSetSpecPatchArgs:
    def __init__(__self__, *,
                 ...
                 template_generation: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] template_generation: DEPRECATED. A sequence number representing a specific generation of the template. Populated by the system. It can be set only during the creation.
    ...
    def template_generation(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        DEPRECATED. A sequence number representing a specific generation of the template. Populated by the system. It can be set only during the creation.
        """
    ...
    def template_generation(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DaemonSetUpdateStrategyPatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Type of daemon set update. Can be "RollingUpdate" or "OnDelete". Default is OnDelete.
        """
...
class DeploymentSpecPatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] paused: Indicates that the deployment is paused and will not be processed by the deployment controller.
        ...
        :param pulumi.Input[builtins.int] revision_history_limit: The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. This is set to the max value of int32 (i.e. 2147483647) by default, which means "retaining all old RelicaSets".
...
class IPBlockPatchArgs:
    def __init__(__self__, *,
        ...
        """
        DEPRECATED 1.9 - This group version of IPBlock is deprecated by networking/v1/IPBlock. IPBlock describes a particular CIDR (Ex. "192.168.1.1/24") that is allowed to the pods matched by a NetworkPolicySpec's podSelector. The except entry describes CIDRs that should not be included within this rule.
        :param pulumi.Input[builtins.str] cidr: CIDR is a string representing the IP Block Valid examples are "192.168.1.1/24"
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] except_: Except is a slice of CIDRs that should not be included within an IP Block Valid examples are "192.168.1.1/24" Except values will be rejected if they are outside the CIDR range
        """
        if cidr is not None:
...
class NetworkPolicyPortPatchArgs:
    def __init__(__self__, *,
        ...
        """
        DEPRECATED 1.9 - This group version of NetworkPolicyPort is deprecated by networking/v1/NetworkPolicyPort.
        :param pulumi.Input[Union[builtins.int, builtins.str]] port: If specified, the port on the given protocol.  This can either be a numerical or named port on a pod.  If this field is not provided, this matches all port names and numbers. If present, only traffic on the specified protocol AND port will be matched.
        :param pulumi.Input[builtins.str] protocol: Optional.  The protocol (TCP, UDP, or SCTP) which traffic must match. If not specified, this field defaults to TCP.
        """
        if port is not None:
