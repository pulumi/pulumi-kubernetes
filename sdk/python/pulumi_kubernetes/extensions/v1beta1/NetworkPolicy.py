...
class NetworkPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['NetworkPolicySpecArgs', 'NetworkPolicySpecArgsDict', 'outputs.NetworkPolicySpec']] spec: Specification of the desired behavior for this NetworkPolicy.
        """
        ...
    @overload
    def __init__(__self__,
