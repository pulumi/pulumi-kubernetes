...
__all__ = ['DaemonSetInitArgs', 'DaemonSet']

@pulumi.input_type
class DaemonSetInitArgs:
...
@pulumi.type_token("kubernetes:extensions/v1beta1:DaemonSet")
class DaemonSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['DaemonSetSpecArgs', 'DaemonSetSpecArgsDict', 'outputs.DaemonSetSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['DaemonSetSpecArgs', 'DaemonSetSpecArgsDict', 'outputs.DaemonSetSpec']] spec: The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DaemonSetInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        DaemonSet represents the configuration of a daemon set.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DaemonSetInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DaemonSetInitArgs.__new__(DaemonSetInitArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DaemonSet':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['DaemonSet']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.DaemonSetSpec']:
        """
        The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        return pulumi.get(self, "spec")
