...
class DeploymentList(pulumi.CustomResource):
    ...
    Items is the list of Deployments.
      ...
      * `spec` (`dict`) - Specification of the desired behavior of the Deployment.
        ...
        * `revision_history_limit` (`float`) - The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. This is set to the max value of int32 (i.e. 2147483647) by default, which means "retaining all old RelicaSets".
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - Specification of the desired behavior of the Deployment.
            ...
            * `paused` (`pulumi.Input[bool]`) - Indicates that the deployment is paused and will not be processed by the deployment controller.
            ...
            * `revision_history_limit` (`pulumi.Input[float]`) - The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. This is set to the max value of int32 (i.e. 2147483647) by default, which means "retaining all old RelicaSets".
