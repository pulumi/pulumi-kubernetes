...
class DeploymentPatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['DeploymentSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['DeploymentSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['DeploymentSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:extensions/v1beta1:DeploymentPatch")
class DeploymentPatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:apps/v1:DeploymentPatch"), pulumi.Alias(type_="kubernetes:apps/v1beta1:DeploymentPatch"), pulumi.Alias(type_="kubernetes:apps/v1beta2:DeploymentPatch")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['Deployment']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
