...
class ReplicaSetList(pulumi.CustomResource):
    ...
    List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
      ...
      * `metadata` (`dict`) - If the Labels of a ReplicaSet are empty, they are defaulted to be the same as the Pod(s) that the ReplicaSet manages. Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      ...
      * `spec` (`dict`) - Spec defines the specification of the desired behavior of the ReplicaSet. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        ...
        * `template` (`dict`) - Template is the object that describes the pod that will be created if insufficient replicas are detected. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#pod-template
      ...
      * `status` (`dict`) - Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        * `available_replicas` (`float`) - The number of available replicas (ready for at least minReadySeconds) for this replica set.
        * `conditions` (`list`) - Represents the latest available observations of a replica set's current state.
        ...
        * `fully_labeled_replicas` (`float`) - The number of pods that have labels matching the labels of the pod template of the replicaset.
        * `observed_generation` (`float`) - ObservedGeneration reflects the generation of the most recently observed ReplicaSet.
        * `ready_replicas` (`float`) - The number of ready replicas for this replica set.
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] items: List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - Spec defines the specification of the desired behavior of the ReplicaSet. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
            ...
            * `template` (`pulumi.Input[dict]`) - Template is the object that describes the pod that will be created if insufficient replicas are detected. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#pod-template
          ...
          * `status` (`pulumi.Input[dict]`) - Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
            * `available_replicas` (`pulumi.Input[float]`) - The number of available replicas (ready for at least minReadySeconds) for this replica set.
            * `conditions` (`pulumi.Input[list]`) - Represents the latest available observations of a replica set's current state.
              ...
              * `type` (`pulumi.Input[str]`) - Type of replica set condition.

            * `fully_labeled_replicas` (`pulumi.Input[float]`) - The number of pods that have labels matching the labels of the pod template of the replicaset.
            * `observed_generation` (`pulumi.Input[float]`) - ObservedGeneration reflects the generation of the most recently observed ReplicaSet.
            * `ready_replicas` (`pulumi.Input[float]`) - The number of ready replicas for this replica set.
        ...
        super(ReplicaSetList, __self__).__init__(
    ...
    def get(resource_name, id, opts=None):
        ...
        return ReplicaSetList(resource_name, opts=opts, __props__=__props__)
