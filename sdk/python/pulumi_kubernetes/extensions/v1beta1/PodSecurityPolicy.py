...
@pulumi.type_token("kubernetes:extensions/v1beta1:PodSecurityPolicy")
class PodSecurityPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['PodSecurityPolicySpecArgs', 'PodSecurityPolicySpecArgsDict', 'outputs.PodSecurityPolicySpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['PodSecurityPolicySpecArgs', 'PodSecurityPolicySpecArgsDict', 'outputs.PodSecurityPolicySpec']] spec: spec defines the policy enforced.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['PodSecurityPolicy']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.PodSecurityPolicySpec']:
        """
        spec defines the policy enforced.
        """
        return pulumi.get(self, "spec")
