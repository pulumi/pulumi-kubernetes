...
class PodSecurityPolicyList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PodSecurityPolicyArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PodSecurityPolicyArgs']]]] items: items is a list of schema objects.
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.PodSecurityPolicy']]:
        """
