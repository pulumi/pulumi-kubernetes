...
__all__ = ['ReplicaSetListArgs', 'ReplicaSetList']

@pulumi.input_type
class ReplicaSetListArgs:
    def __init__(__self__, *,
                 items: pulumi.Input[Sequence[pulumi.Input['ReplicaSetArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ReplicaSetArgs']]] items: List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", 'ReplicaSetList')
    ...
    @items.setter
    def items(self, value: pulumi.Input[Sequence[pulumi.Input['ReplicaSetArgs']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ReplicaSetList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ReplicaSetList']]]):
...
class ReplicaSetList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Literal['extensions/v1beta1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['ReplicaSetArgs', 'ReplicaSetArgsDict', 'outputs.ReplicaSet']]]] items: List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
        :param pulumi.Input[Literal['ReplicaSetList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ReplicaSetListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ReplicaSetListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ReplicaSetListArgs.__new__(ReplicaSetListArgs)

            __props__.__dict__["api_version"] = 'extensions/v1beta1'
            if items is None and not opts.urn:
                raise TypeError("Missing required property 'items'")
            __props__.__dict__["items"] = items
            __props__.__dict__["kind"] = 'ReplicaSetList'
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ReplicaSetList':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ReplicaSetList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
