...
class ReplicaSetList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ReplicaSetArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ReplicaSetArgs']]]] items: List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.ReplicaSet']]:
        """
