...
class PodSecurityPolicyList(pulumi.CustomResource):
    ...
    items is a list of schema objects.
      ...
      * `spec` (`dict`) - spec defines the policy enforced.
        ...
        * `allowed_csi_drivers` (`list`) - AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes.
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - spec defines the policy enforced.
            ...
            * `allowed_csi_drivers` (`pulumi.Input[list]`) - AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes.
