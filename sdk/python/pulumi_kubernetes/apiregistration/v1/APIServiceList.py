...
__all__ = ['APIServiceListArgs', 'APIServiceList']

@pulumi.input_type
class APIServiceListArgs:
    def __init__(__self__, *,
                 items: pulumi.Input[Sequence[pulumi.Input['APIServiceArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['APIServiceArgs']]] items: Items is the list of APIService
        ...
        :param pulumi.Input[Literal['APIServiceList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", 'APIServiceList')
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)

    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Input[Sequence[pulumi.Input['APIServiceArgs']]]:
        """
    ...
    @items.setter
    def items(self, value: pulumi.Input[Sequence[pulumi.Input['APIServiceArgs']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['APIServiceList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['APIServiceList']]]):
...
class APIServiceList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Literal['apiregistration.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['APIServiceArgs', 'APIServiceArgsDict', 'outputs.APIService']]]] items: Items is the list of APIService
        :param pulumi.Input[Literal['APIServiceList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['APIServiceList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
