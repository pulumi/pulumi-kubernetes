...
class APIServiceList(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - Spec contains information for locating and communicating with a server
          ...
          * `status` (`pulumi.Input[dict]`) - Status contains derived information about an API server
            * `conditions` (`pulumi.Input[list]`) - Current service state of apiService.
              ...
              * `type` (`pulumi.Input[str]`) - Type is the type of the condition.
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:apiregistration/v1:APIServiceList")])
