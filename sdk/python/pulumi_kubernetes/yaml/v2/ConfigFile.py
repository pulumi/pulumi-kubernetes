...
class ConfigFileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] file: Path or URL to a Kubernetes manifest file. File must exist.
        :param pulumi.Input[builtins.str] resource_prefix: A prefix for the auto-generated resource names. Defaults to the name of the ConfigFile. Example: A resource created with resourcePrefix="foo" would produce a resource named "foo-resourceName".
