...
class ConfigGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] files: Set of paths and/or URLs to Kubernetes manifest files. Supports glob patterns.
        :param pulumi.Input[Sequence[Any]] objs: Objects representing Kubernetes resource configurations.
        :param pulumi.Input[builtins.str] resource_prefix: A prefix for the auto-generated resource names. Defaults to the name of the ConfigGroup. Example: A resource created with resourcePrefix="foo" would produce a resource named "foo-resourceName".
        :param pulumi.Input[builtins.bool] skip_await: Indicates that child resources should skip the await logic.
        :param pulumi.Input[builtins.str] yaml: A Kubernetes YAML manifest containing Kubernetes resource configuration(s).
        """
