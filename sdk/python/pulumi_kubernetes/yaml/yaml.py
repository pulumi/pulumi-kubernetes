...
def _parse_yaml_object(
    ...
    if gvk == "admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicy":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.admissionregistration.v1alpha1 import MutatingAdmissionPolicy
        return [identifier.apply(
            lambda x: (f"admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicy:{x}",
                       MutatingAdmissionPolicy(f"{x}", opts, **obj)))]
    if gvk == "admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicyBinding":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.admissionregistration.v1alpha1 import MutatingAdmissionPolicyBinding
        return [identifier.apply(
            lambda x: (f"admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicyBinding:{x}",
                       MutatingAdmissionPolicyBinding(f"{x}", opts, **obj)))]
    if gvk == "admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicyBindingList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.admissionregistration.v1alpha1 import MutatingAdmissionPolicyBindingList
        return [identifier.apply(
            lambda x: (f"admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicyBindingList:{x}",
                       MutatingAdmissionPolicyBindingList(f"{x}", opts, **obj)))]
    if gvk == "admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicyList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.admissionregistration.v1alpha1 import MutatingAdmissionPolicyList
        return [identifier.apply(
            lambda x: (f"admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicyList:{x}",
                       MutatingAdmissionPolicyList(f"{x}", opts, **obj)))]
    ...
    if gvk == "admissionregistration.k8s.io/v1alpha1/ValidatingAdmissionPolicyList":
        ...
        return [identifier.apply(
            lambda x: (f"admissionregistration.k8s.io/v1alpha1/ValidatingAdmissionPolicyList:{x}",
                       ValidatingAdmissionPolicyList(f"{x}", opts, **obj)))]
    if gvk == "admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicy":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.admissionregistration.v1beta1 import MutatingAdmissionPolicy
        return [identifier.apply(
            lambda x: (f"admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicy:{x}",
                       MutatingAdmissionPolicy(f"{x}", opts, **obj)))]
    if gvk == "admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicyBinding":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.admissionregistration.v1beta1 import MutatingAdmissionPolicyBinding
        return [identifier.apply(
            lambda x: (f"admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicyBinding:{x}",
                       MutatingAdmissionPolicyBinding(f"{x}", opts, **obj)))]
    if gvk == "admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicyBindingList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.admissionregistration.v1beta1 import MutatingAdmissionPolicyBindingList
        return [identifier.apply(
            lambda x: (f"admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicyBindingList:{x}",
                       MutatingAdmissionPolicyBindingList(f"{x}", opts, **obj)))]
    if gvk == "admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicyList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.admissionregistration.v1beta1 import MutatingAdmissionPolicyList
        return [identifier.apply(
            lambda x: (f"admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicyList:{x}",
                       MutatingAdmissionPolicyList(f"{x}", opts, **obj)))]
    ...
    if gvk == "certificates.k8s.io/v1/ClusterTrustBundle":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.certificates.v1 import ClusterTrustBundle
        return [identifier.apply(
            lambda x: (f"certificates.k8s.io/v1/ClusterTrustBundle:{x}",
                       ClusterTrustBundle(f"{x}", opts, **obj)))]
    if gvk == "certificates.k8s.io/v1/ClusterTrustBundleList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.certificates.v1 import ClusterTrustBundleList
        return [identifier.apply(
            lambda x: (f"certificates.k8s.io/v1/ClusterTrustBundleList:{x}",
                       ClusterTrustBundleList(f"{x}", opts, **obj)))]
    if gvk == "certificates.k8s.io/v1/PodCertificateRequest":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.certificates.v1 import PodCertificateRequest
        return [identifier.apply(
            lambda x: (f"certificates.k8s.io/v1/PodCertificateRequest:{x}",
                       PodCertificateRequest(f"{x}", opts, **obj)))]
    if gvk == "certificates.k8s.io/v1/PodCertificateRequestList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.certificates.v1 import PodCertificateRequestList
        return [identifier.apply(
            lambda x: (f"certificates.k8s.io/v1/PodCertificateRequestList:{x}",
                       PodCertificateRequestList(f"{x}", opts, **obj)))]
    ...
    if gvk == "certificates.k8s.io/v1beta1/ClusterTrustBundleList":
        ...
        return [identifier.apply(
            lambda x: (f"certificates.k8s.io/v1beta1/ClusterTrustBundleList:{x}",
                       ClusterTrustBundleList(f"{x}", opts, **obj)))]
    if gvk == "certificates.k8s.io/v1beta1/PodCertificateRequest":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.certificates.v1beta1 import PodCertificateRequest
        return [identifier.apply(
            lambda x: (f"certificates.k8s.io/v1beta1/PodCertificateRequest:{x}",
                       PodCertificateRequest(f"{x}", opts, **obj)))]
    if gvk == "certificates.k8s.io/v1beta1/PodCertificateRequestList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.certificates.v1beta1 import PodCertificateRequestList
        return [identifier.apply(
            lambda x: (f"certificates.k8s.io/v1beta1/PodCertificateRequestList:{x}",
                       PodCertificateRequestList(f"{x}", opts, **obj)))]
    ...
    if gvk == "coordination.k8s.io/v1alpha2/LeaseCandidate":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.coordination.v1alpha2 import LeaseCandidate
        return [identifier.apply(
            lambda x: (f"coordination.k8s.io/v1alpha2/LeaseCandidate:{x}",
                       LeaseCandidate(f"{x}", opts, **obj)))]
    if gvk == "coordination.k8s.io/v1alpha2/LeaseCandidateList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.coordination.v1alpha2 import LeaseCandidateList
        return [identifier.apply(
            lambda x: (f"coordination.k8s.io/v1alpha2/LeaseCandidateList:{x}",
                       LeaseCandidateList(f"{x}", opts, **obj)))]
    ...
    if gvk == "flowcontrol.apiserver.k8s.io/v1beta3/PriorityLevelConfigurationList":
        ...
        return [identifier.apply(
            lambda x: (f"flowcontrol.apiserver.k8s.io/v1beta3/PriorityLevelConfigurationList:{x}",
                       PriorityLevelConfigurationList(f"{x}", opts, **obj)))]
    if gvk == "lifecycle.k8s.io/v1alpha1/Eviction":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.lifecycle.v1alpha1 import Eviction
        return [identifier.apply(
            lambda x: (f"lifecycle.k8s.io/v1alpha1/Eviction:{x}",
                       Eviction(f"{x}", opts, **obj)))]
    if gvk == "lifecycle.k8s.io/v1alpha1/EvictionList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.lifecycle.v1alpha1 import EvictionList
        return [identifier.apply(
            lambda x: (f"lifecycle.k8s.io/v1alpha1/EvictionList:{x}",
                       EvictionList(f"{x}", opts, **obj)))]
    if gvk == "lifecycle.k8s.io/v1alpha1/EvictionRequest":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.lifecycle.v1alpha1 import EvictionRequest
        return [identifier.apply(
            lambda x: (f"lifecycle.k8s.io/v1alpha1/EvictionRequest:{x}",
                       EvictionRequest(f"{x}", opts, **obj)))]
    if gvk == "lifecycle.k8s.io/v1alpha1/EvictionRequestList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.lifecycle.v1alpha1 import EvictionRequestList
        return [identifier.apply(
            lambda x: (f"lifecycle.k8s.io/v1alpha1/EvictionRequestList:{x}",
                       EvictionRequestList(f"{x}", opts, **obj)))]
    ...
    if gvk == "rbac.authorization.k8s.io/v1beta1/RoleList":
        ...
        return [identifier.apply(
            lambda x: (f"rbac.authorization.k8s.io/v1beta1/RoleList:{x}",
                       RoleList(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/DeviceClass":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import DeviceClass
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/DeviceClass:{x}",
                       DeviceClass(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/DeviceClassList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import DeviceClassList
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/DeviceClassList:{x}",
                       DeviceClassList(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/DeviceTaintRule":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import DeviceTaintRule
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/DeviceTaintRule:{x}",
                       DeviceTaintRule(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/DeviceTaintRuleList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import DeviceTaintRuleList
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/DeviceTaintRuleList:{x}",
                       DeviceTaintRuleList(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/ResourceClaim":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import ResourceClaim
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/ResourceClaim:{x}",
                       ResourceClaim(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/ResourceClaimList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import ResourceClaimList
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/ResourceClaimList:{x}",
                       ResourceClaimList(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/ResourceClaimTemplate":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import ResourceClaimTemplate
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/ResourceClaimTemplate:{x}",
                       ResourceClaimTemplate(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/ResourceClaimTemplateList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import ResourceClaimTemplateList
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/ResourceClaimTemplateList:{x}",
                       ResourceClaimTemplateList(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/ResourceSlice":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import ResourceSlice
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/ResourceSlice:{x}",
                       ResourceSlice(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1/ResourceSliceList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1 import ResourceSliceList
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1/ResourceSliceList:{x}",
    ...
    if gvk == "resource.k8s.io/v1alpha3/ResourceSlice":
        ...
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1alpha3/ResourceSlice:{x}",
                       ResourceSlice(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1beta1/DeviceClass":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1beta1 import DeviceClass
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1beta1/DeviceClass:{x}",
                       DeviceClass(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1beta1/DeviceClassList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1beta1 import DeviceClassList
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1beta1/DeviceClassList:{x}",
                       DeviceClassList(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1beta1/ResourceClaim":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1beta1 import ResourceClaim
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1beta1/ResourceClaim:{x}",
                       ResourceClaim(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1beta1/ResourceClaimList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1beta1 import ResourceClaimList
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1beta1/ResourceClaimList:{x}",
                       ResourceClaimList(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1beta1/ResourceClaimTemplate":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1beta1 import ResourceClaimTemplate
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1beta1/ResourceClaimTemplate:{x}",
                       ResourceClaimTemplate(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1beta1/ResourceClaimTemplateList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1beta1 import ResourceClaimTemplateList
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1beta1/ResourceClaimTemplateList:{x}",
                       ResourceClaimTemplateList(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1beta1/ResourceSlice":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1beta1 import ResourceSlice
        return [identifier.apply(
            lambda x: (f"resource.k8s.io/v1beta1/ResourceSlice:{x}",
                       ResourceSlice(f"{x}", opts, **obj)))]
    if gvk == "resource.k8s.io/v1beta1/ResourceSliceList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.resource.v1beta1 import ResourceSliceList
        return [identifier.apply(
    ...
    if gvk == "scheduling.k8s.io/v1alpha2/WorkloadList":
        ...
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1alpha2/WorkloadList:{x}",
                       WorkloadList(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1alpha3/CompositePodGroup":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1alpha3 import CompositePodGroup
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1alpha3/CompositePodGroup:{x}",
                       CompositePodGroup(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1alpha3/CompositePodGroupList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1alpha3 import CompositePodGroupList
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1alpha3/CompositePodGroupList:{x}",
                       CompositePodGroupList(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1alpha3/PodGroup":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1alpha3 import PodGroup
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1alpha3/PodGroup:{x}",
                       PodGroup(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1alpha3/PodGroupList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1alpha3 import PodGroupList
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1alpha3/PodGroupList:{x}",
                       PodGroupList(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1alpha3/Workload":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1alpha3 import Workload
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1alpha3/Workload:{x}",
                       Workload(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1alpha3/WorkloadList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1alpha3 import WorkloadList
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1alpha3/WorkloadList:{x}",
                       WorkloadList(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1beta1/PodGroup":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1beta1 import PodGroup
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1beta1/PodGroup:{x}",
                       PodGroup(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1beta1/PodGroupList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1beta1 import PodGroupList
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1beta1/PodGroupList:{x}",
                       PodGroupList(f"{x}", opts, **obj)))]
    ...
    if gvk == "scheduling.k8s.io/v1beta1/PriorityClassList":
        ...
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1beta1/PriorityClassList:{x}",
                       PriorityClassList(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1beta1/Workload":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1beta1 import Workload
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1beta1/Workload:{x}",
                       Workload(f"{x}", opts, **obj)))]
    if gvk == "scheduling.k8s.io/v1beta1/WorkloadList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.scheduling.v1beta1 import WorkloadList
        return [identifier.apply(
            lambda x: (f"scheduling.k8s.io/v1beta1/WorkloadList:{x}",
                       WorkloadList(f"{x}", opts, **obj)))]
    ...
    if gvk == "storage.k8s.io/v1/VolumeAttributesClass":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.storage.v1 import VolumeAttributesClass
        return [identifier.apply(
            lambda x: (f"storage.k8s.io/v1/VolumeAttributesClass:{x}",
                       VolumeAttributesClass(f"{x}", opts, **obj)))]
    if gvk == "storage.k8s.io/v1/VolumeAttributesClassList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.storage.v1 import VolumeAttributesClassList
        return [identifier.apply(
            lambda x: (f"storage.k8s.io/v1/VolumeAttributesClassList:{x}",
    ...
    if gvk == "storage.k8s.io/v1beta1/VolumeAttributesClassList":
        ...
        return [identifier.apply(
            lambda x: (f"storage.k8s.io/v1beta1/VolumeAttributesClassList:{x}",
                       VolumeAttributesClassList(f"{x}", opts, **obj)))]
    if gvk == "storagemigration.k8s.io/v1/StorageVersionMigration":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.storagemigration.v1 import StorageVersionMigration
        return [identifier.apply(
            lambda x: (f"storagemigration.k8s.io/v1/StorageVersionMigration:{x}",
                       StorageVersionMigration(f"{x}", opts, **obj)))]
    if gvk == "storagemigration.k8s.io/v1/StorageVersionMigrationList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.storagemigration.v1 import StorageVersionMigrationList
        return [identifier.apply(
            lambda x: (f"storagemigration.k8s.io/v1/StorageVersionMigrationList:{x}",
    ...
    if gvk == "storagemigration.k8s.io/v1alpha1/StorageVersionMigrationList":
        ...
        return [identifier.apply(
            lambda x: (f"storagemigration.k8s.io/v1alpha1/StorageVersionMigrationList:{x}",
                       StorageVersionMigrationList(f"{x}", opts, **obj)))]
    if gvk == "storagemigration.k8s.io/v1beta1/StorageVersionMigration":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.storagemigration.v1beta1 import StorageVersionMigration
        return [identifier.apply(
            lambda x: (f"storagemigration.k8s.io/v1beta1/StorageVersionMigration:{x}",
                       StorageVersionMigration(f"{x}", opts, **obj)))]
    if gvk == "storagemigration.k8s.io/v1beta1/StorageVersionMigrationList":
        # Import locally to avoid name collisions.
        from pulumi_kubernetes.storagemigration.v1beta1 import StorageVersionMigrationList
        return [identifier.apply(
            lambda x: (f"storagemigration.k8s.io/v1beta1/StorageVersionMigrationList:{x}",
                       StorageVersionMigrationList(f"{x}", opts, **obj)))]
