...
class LocalSubjectAccessReview(pulumi.CustomResource):
    ...
    Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.
      ...
      * `group` (`list`) - Groups is the groups you're testing for.
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, kind=None, metadata=None, spec=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **spec** object supports the following:
          ...
          * `group` (`pulumi.Input[list]`) - Groups is the groups you're testing for.
          ...
          * `user` (`pulumi.Input[str]`) - User is the user you're testing for. If you specify "User" but not "Group", then is it interpreted as "What if User were not a member of any groups
        """
