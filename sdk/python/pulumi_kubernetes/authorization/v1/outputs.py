...
@pulumi.output_type
class NonResourceAttributesPatch(dict):
    """
    NonResourceAttributes includes the authorization attributes available for non-resource requests to the Authorizer interface
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class ResourceAttributesPatch(dict):
    """
    ResourceAttributes includes the authorization attributes available for resource requests to the Authorizer interface
    """
    def __init__(__self__, *,
...
@pulumi.output_type
class SelfSubjectAccessReviewSpecPatch(dict):
    """
    SelfSubjectAccessReviewSpec is a description of the access request.  Exactly one of ResourceAuthorizationAttributes and NonResourceAuthorizationAttributes must be set
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SelfSubjectAccessReviewSpecPatch. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SelfSubjectAccessReviewSpecPatch.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 non_resource_attributes: Optional['outputs.NonResourceAttributesPatch'] = None,
                 resource_attributes: Optional['outputs.ResourceAttributesPatch'] = None):
        """
        SelfSubjectAccessReviewSpec is a description of the access request.  Exactly one of ResourceAuthorizationAttributes and NonResourceAuthorizationAttributes must be set
        :param 'NonResourceAttributesPatchArgs' non_resource_attributes: NonResourceAttributes describes information for a non-resource access request
        :param 'ResourceAttributesPatchArgs' resource_attributes: ResourceAuthorizationAttributes describes information for a resource access request
        """
        if non_resource_attributes is not None:
            pulumi.set(__self__, "non_resource_attributes", non_resource_attributes)
        if resource_attributes is not None:
    ...
    @property
    @pulumi.getter(name="nonResourceAttributes")
    def non_resource_attributes(self) -> Optional['outputs.NonResourceAttributesPatch']:
        """
        NonResourceAttributes describes information for a non-resource access request
        """
        return pulumi.get(self, "non_resource_attributes")
    ...
    @property
    @pulumi.getter(name="resourceAttributes")
    def resource_attributes(self) -> Optional['outputs.ResourceAttributesPatch']:
        """
        ResourceAuthorizationAttributes describes information for a resource access request
        """
        return pulumi.get(self, "resource_attributes")
...
@pulumi.output_type
class SubjectAccessReviewSpecPatch(dict):
    """
    SubjectAccessReviewSpec is a description of the access request.  Exactly one of ResourceAuthorizationAttributes and NonResourceAuthorizationAttributes must be set
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SubjectAccessReviewSpecPatch. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SubjectAccessReviewSpecPatch.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class SubjectAccessReviewStatusPatch(dict):
    """
    SubjectAccessReviewStatus
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SubjectAccessReviewStatusPatch. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SubjectAccessReviewStatusPatch.__key_warning(key)
        return super().__getitem__(key)
