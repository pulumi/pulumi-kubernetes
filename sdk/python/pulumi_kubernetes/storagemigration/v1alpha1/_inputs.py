...
class GroupVersionResourcePatchArgs:
    def __init__(__self__, *,
        ...
        """
        The names of the group, the version, and the resource.
        :param pulumi.Input[builtins.str] group: The name of the group.
        :param pulumi.Input[builtins.str] resource: The name of the resource.
        :param pulumi.Input[builtins.str] version: The name of the version.
        """
...
if not MYPY:
    class StorageVersionMigrationSpecPatchArgsDict(TypedDict):
        ...
        """
        continue_token: NotRequired[pulumi.Input[builtins.str]]
        """
...
class StorageVersionMigrationSpecPatchArgs:
    def __init__(__self__, *,
                 continue_token: Optional[pulumi.Input[builtins.str]] = None,
                 resource: Optional[pulumi.Input['GroupVersionResourcePatchArgs']] = None):
        """
        Spec of the storage version migration.
        :param pulumi.Input[builtins.str] continue_token: The token used in the list options to get the next chunk of objects to migrate. When the .status.conditions indicates the migration is "Running", users can use this token to check the progress of the migration.
    ...
    def continue_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The token used in the list options to get the next chunk of objects to migrate. When the .status.conditions indicates the migration is "Running", users can use this token to check the progress of the migration.
        """
    ...
    def continue_token(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StorageVersionMigrationStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_version: ResourceVersion to compare with the GC cache for performing the migration. This is the current resource version of given group, version and resource when kube-controller-manager first observes this StorageVersionMigration resource.
        """
