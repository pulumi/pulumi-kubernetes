...
class GroupVersionResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The names of the group, the version, and the resource.
        :param builtins.str group: The name of the group.
        :param builtins.str resource: The name of the resource.
        :param builtins.str version: The name of the version.
        """
...
class StorageVersionMigrationSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 continue_token: Optional[builtins.str] = None):
        """
        Spec of the storage version migration.
        ...
        :param builtins.str continue_token: The token used in the list options to get the next chunk of objects to migrate. When the .status.conditions indicates the migration is "Running", users can use this token to check the progress of the migration.
        """
        pulumi.set(__self__, "resource", resource)
    ...
    def continue_token(self) -> Optional[builtins.str]:
        """
...
class StorageVersionMigrationStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str resource_version: ResourceVersion to compare with the GC cache for performing the migration. This is the current resource version of given group, version and resource when kube-controller-manager first observes this StorageVersionMigration resource.
        """
