...
class ClusterRole(dict):
    ...
    def __init__(__self__, *,
                 ...
                 api_version: Optional[Literal['rbac.authorization.k8s.io/v1alpha1']] = None,
                 kind: Optional[Literal['ClusterRole']] = None,
        ...
        :param Literal['rbac.authorization.k8s.io/v1alpha1'] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    ...
    def api_version(self) -> Optional[Literal['rbac.authorization.k8s.io/v1alpha1']]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> Optional[Literal['ClusterRole']]:
        """
...
class ClusterRoleBinding(dict):
    ...
    def __init__(__self__, *,
                 ...
                 api_version: Optional[Literal['rbac.authorization.k8s.io/v1alpha1']] = None,
                 kind: Optional[Literal['ClusterRoleBinding']] = None,
                 metadata: Optional['_meta.v1.outputs.ObjectMeta'] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> Optional[Literal['ClusterRoleBinding']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
...
class PolicyRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] verbs: Verbs is a list of Verbs that apply to ALL the ResourceKinds and AttributeRestrictions contained in this rule.  VerbAll represents all kinds.
        :param Sequence[_builtins.str] api_groups: APIGroups is the name of the APIGroup that contains the resources.  If multiple API groups are specified, any action requested against one of the enumerated resources in any API group will be allowed.
        ...
        :param Sequence[_builtins.str] resources: Resources is a list of resources this rule applies to.  ResourceAll represents all resources.
        """
...
class Role(dict):
    ...
    def __init__(__self__, *,
                 api_version: Optional[Literal['rbac.authorization.k8s.io/v1alpha1']] = None,
                 kind: Optional[Literal['Role']] = None,
                 metadata: Optional['_meta.v1.outputs.ObjectMeta'] = None,
                 rules: Optional[Sequence['outputs.PolicyRule']] = None):
        """
        Role is a namespaced, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 Role, and will no longer be served in v1.20.
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> Optional[Literal['Role']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
...
class RoleBinding(dict):
    ...
    def __init__(__self__, *,
                 role_ref: 'outputs.RoleRef',
                 api_version: Optional[Literal['rbac.authorization.k8s.io/v1alpha1']] = None,
                 kind: Optional[Literal['RoleBinding']] = None,
                 metadata: Optional['_meta.v1.outputs.ObjectMeta'] = None,
                 subjects: Optional[Sequence['outputs.Subject']] = None):
        """
        RoleBinding references a role, but does not contain it.  It can reference a Role in the same namespace or a ClusterRole in the global namespace. It adds who information via Subjects and namespace information by which namespace it exists in.  RoleBindings in a given namespace only have effect in that namespace. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 RoleBinding, and will no longer be served in v1.20.
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> Optional[Literal['RoleBinding']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
...
class Subject(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str api_version: APIVersion holds the API group and version of the referenced subject. Defaults to "v1" for ServiceAccount subjects. Defaults to "rbac.authorization.k8s.io/v1alpha1" for User and Group subjects.
