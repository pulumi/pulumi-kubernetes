...
class ClusterRoleBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, kind=None, metadata=None, role_ref=None, subjects=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] role_ref: RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
