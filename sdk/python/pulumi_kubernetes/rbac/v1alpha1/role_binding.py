...
class RoleBinding(pulumi.CustomResource):
    ...
    Subjects holds references to the objects the role applies to.
      * `api_version` (`str`) - APIVersion holds the API group and version of the referenced subject. Defaults to "v1" for ServiceAccount subjects. Defaults to "rbac.authorization.k8s.io/v1alpha1" for User and Group subjects.
    ...
    """
    def __init__(__self__, resource_name, opts=None, api_version=None, kind=None, metadata=None, role_ref=None, subjects=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[dict] role_ref: RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
        ...
        The **role_ref** object supports the following:

          * `api_group` (`pulumi.Input[str]`) - APIGroup is the group for the resource being referenced
        ...
        The **subjects** object supports the following:
          ...
          * `api_version` (`pulumi.Input[str]`) - APIVersion holds the API group and version of the referenced subject. Defaults to "v1" for ServiceAccount subjects. Defaults to "rbac.authorization.k8s.io/v1alpha1" for User and Group subjects.
          * `kind` (`pulumi.Input[str]`) - Kind of object being referenced. Values defined by this API group are "User", "Group", and "ServiceAccount". If the Authorizer does not recognized the kind value, the Authorizer should report an error.
          * `name` (`pulumi.Input[str]`) - Name of the object being referenced.
          * `namespace` (`pulumi.Input[str]`) - Namespace of the referenced object.  If the object kind is non-namespace, such as "User" or "Group", and this value is not empty the Authorizer should report an error.
        """
