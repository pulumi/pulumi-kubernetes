...
class RoleBindingList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RoleBindingArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['RoleBindingArgs']]]] items: Items is a list of RoleBindings
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.RoleBinding']]:
        """
