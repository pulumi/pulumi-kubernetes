...
__all__ = ['ClusterRoleBindingList']
...
class ClusterRoleBindingList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterRoleBindingArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterRoleBindingArgs']]]] items: Items is a list of ClusterRoleBindings
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.ClusterRoleBinding']]:
        """
