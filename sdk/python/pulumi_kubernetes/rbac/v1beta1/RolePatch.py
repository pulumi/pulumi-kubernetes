...
class RolePatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:rbac.authorization.k8s.io/v1:RolePatch"), pulumi.Alias(type_="kubernetes:rbac.authorization.k8s.io/v1alpha1:RolePatch")])
