...
class RoleList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RoleArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['RoleArgs']]]] items: Items is a list of Roles
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.Role']]:
        """
