...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "kubernetes:rbac.authorization.k8s.io/v1:ClusterRole":
                return ClusterRole(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBinding":
                return ClusterRoleBinding(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBindingList":
                return ClusterRoleBindingList(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleList":
                return ClusterRoleList(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:rbac.authorization.k8s.io/v1:Role":
                return Role(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:rbac.authorization.k8s.io/v1:RoleBinding":
                return RoleBinding(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:rbac.authorization.k8s.io/v1:RoleBindingList":
                return RoleBindingList(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:rbac.authorization.k8s.io/v1:RoleList":
    ...
    pulumi.runtime.register_resource_module("kubernetes", "rbac.authorization.k8s.io/v1", _module_instance)
