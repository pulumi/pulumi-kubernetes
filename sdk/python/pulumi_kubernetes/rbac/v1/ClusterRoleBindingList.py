...
class ClusterRoleBindingListArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['ClusterRoleBindingList']]] = None,
        ...
        :param pulumi.Input[Literal['ClusterRoleBindingList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ClusterRoleBindingList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ClusterRoleBindingList']]]):
...
class ClusterRoleBindingList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: pulumi.Input[Optional[Literal['rbac.authorization.k8s.io/v1']]] = None,
                 items: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ClusterRoleBindingArgs', 'ClusterRoleBindingArgsDict', 'outputs.ClusterRoleBinding']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['ClusterRoleBindingList']]] = None,
        ...
        :param pulumi.Input[Literal['rbac.authorization.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterRoleBindingArgs', 'ClusterRoleBindingArgsDict', 'outputs.ClusterRoleBinding']]]] items: Items is a list of ClusterRoleBindings
        :param pulumi.Input[Literal['ClusterRoleBindingList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ClusterRoleBindingList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
