...
class AggregationRuleArgs:
    def __init__(__self__, *,
                 cluster_role_selectors: pulumi.Input[Optional[Sequence[pulumi.Input['_meta.v1.LabelSelectorArgs']]]] = None):
        """
        AggregationRule describes how to locate ClusterRoles to aggregate into the ClusterRole
    ...
    def cluster_role_selectors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['_meta.v1.LabelSelectorArgs']]]]:
        """
        clusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added
        """
    ...
    def cluster_role_selectors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['_meta.v1.LabelSelectorArgs']]]]):
...
class AggregationRulePatchArgs:
    def __init__(__self__, *,
                 cluster_role_selectors: pulumi.Input[Optional[Sequence[pulumi.Input['_meta.v1.LabelSelectorPatchArgs']]]] = None):
        """
        AggregationRule describes how to locate ClusterRoles to aggregate into the ClusterRole
    ...
    @_builtins.property
    @pulumi.getter(name="clusterRoleSelectors")
    def cluster_role_selectors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['_meta.v1.LabelSelectorPatchArgs']]]]:
        """
        clusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added
        """
        return pulumi.get(self, "cluster_role_selectors")
    ...
    @cluster_role_selectors.setter
    def cluster_role_selectors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['_meta.v1.LabelSelectorPatchArgs']]]]):
        pulumi.set(self, "cluster_role_selectors", value)
...
class ClusterRoleArgsDict(TypedDict):
    ...
    """
    api_version: NotRequired[pulumi.Input[Optional[Literal['rbac.authorization.k8s.io/v1']]]]
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['ClusterRole']]]]
    """
...
class ClusterRoleArgs:
    def __init__(__self__, *,
                 aggregation_rule: pulumi.Input[Optional['AggregationRuleArgs']] = None,
                 api_version: pulumi.Input[Optional[Literal['rbac.authorization.k8s.io/v1']]] = None,
                 kind: pulumi.Input[Optional[Literal['ClusterRole']]] = None,
        ...
        :param pulumi.Input['_meta.v1.ObjectMetaArgs'] metadata: metadata is the standard object's metadata.
    ...
    def aggregation_rule(self) -> pulumi.Input[Optional['AggregationRuleArgs']]:
        """
        aggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.
        """
    ...
    def aggregation_rule(self, value: pulumi.Input[Optional['AggregationRuleArgs']]):
        pulumi.set(self, "aggregation_rule", value)

    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Input[Optional[Literal['rbac.authorization.k8s.io/v1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
    ...
    @api_version.setter
    def api_version(self, value: pulumi.Input[Optional[Literal['rbac.authorization.k8s.io/v1']]]):
        pulumi.set(self, "api_version", value)

    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ClusterRole']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ClusterRole']]]):
...
class ClusterRoleBindingArgsDict(TypedDict):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['ClusterRoleBinding']]]]
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
    metadata: NotRequired[pulumi.Input[Optional['_meta.v1.ObjectMetaArgsDict']]]
...
class ClusterRoleBindingArgs:
    def __init__(__self__, *,
                 ...
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 subjects: pulumi.Input[Optional[Sequence[pulumi.Input['SubjectArgs']]]] = None):
        """
        ClusterRoleBinding references a ClusterRole, but not contain it.  It can reference a ClusterRole in the global namespace, and adds who information via Subject.
    ...
    @_builtins.property
    @pulumi.getter
    def subjects(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SubjectArgs']]]]:
        """
        subjects holds references to the objects the role applies to.
        """
    ...
    @subjects.setter
    def subjects(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SubjectArgs']]]]):
...
class PolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] verbs: verbs is a list of Verbs that apply to ALL the ResourceKinds contained in this rule. '*' represents all verbs.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] api_groups: apiGroups is the name of the APIGroup that contains the resources.  If multiple API groups are specified, any action requested against one of the enumerated resources in any API group will be allowed. "" represents the core API group and "*" represents all API groups.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resources: resources is a list of resources this rule applies to. '*' represents all resources.
        """
...
class RoleArgsDict(TypedDict):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['Role']]]]
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
    metadata: NotRequired[pulumi.Input[Optional['_meta.v1.ObjectMetaArgsDict']]]
...
class RoleArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[Literal['rbac.authorization.k8s.io/v1']]] = None,
                 kind: pulumi.Input[Optional[Literal['Role']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyRuleArgs']]]] = None):
        """
        Role is a namespaced, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding.
        ...
        :param pulumi.Input[Literal['rbac.authorization.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Literal['Role']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        :param pulumi.Input['_meta.v1.ObjectMetaArgs'] metadata: metadata is the standard object's metadata.
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['Role']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['Role']]]):
        pulumi.set(self, "kind", value)
...
class RoleBindingArgsDict(TypedDict):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['RoleBinding']]]]
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
    metadata: NotRequired[pulumi.Input[Optional['_meta.v1.ObjectMetaArgsDict']]]
...
class RoleBindingArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['RoleBinding']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['RoleBinding']]]):
        pulumi.set(self, "kind", value)
