...
class RoleBinding(pulumi.CustomResource):
    ...
    Subjects holds references to the objects the role applies to.
      * `api_group` (`str`) - APIGroup holds the API group of the referenced subject. Defaults to "" for ServiceAccount subjects. Defaults to "rbac.authorization.k8s.io" for User and Group subjects.
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, kind=None, metadata=None, role_ref=None, subjects=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **subjects** object supports the following:
          ...
          * `api_group` (`pulumi.Input[str]`) - APIGroup holds the API group of the referenced subject. Defaults to "" for ServiceAccount subjects. Defaults to "rbac.authorization.k8s.io" for User and Group subjects.
