...
@pulumi.type_token("kubernetes:resource.k8s.io/v1alpha1:ResourceClaimPatch")
class ResourceClaimPatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:ResourceClaimPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:ResourceClaimPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:ResourceClaimPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta2:ResourceClaimPatch")])
