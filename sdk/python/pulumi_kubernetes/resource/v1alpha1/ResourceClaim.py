...
@pulumi.type_token("kubernetes:resource.k8s.io/v1alpha1:ResourceClaim")
class ResourceClaim(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ResourceClaimSpecArgs', 'ResourceClaimSpecArgsDict', 'outputs.ResourceClaimSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ResourceClaimSpecArgs', 'ResourceClaimSpecArgsDict', 'outputs.ResourceClaimSpec']] spec: Spec describes the desired attributes of a resource that then needs to be allocated. It can only be set once when creating the ResourceClaim.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:ResourceClaim"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha2:ResourceClaim"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:ResourceClaim"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:ResourceClaim"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta2:ResourceClaim")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ResourceClaim']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
