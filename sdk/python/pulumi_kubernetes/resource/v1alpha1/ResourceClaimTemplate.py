...
@pulumi.type_token("kubernetes:resource.k8s.io/v1alpha1:ResourceClaimTemplate")
class ResourceClaimTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ResourceClaimTemplateSpecArgs', 'ResourceClaimTemplateSpecArgsDict', 'outputs.ResourceClaimTemplateSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ResourceClaimTemplateSpecArgs', 'ResourceClaimTemplateSpecArgsDict', 'outputs.ResourceClaimTemplateSpec']] spec: Describes the ResourceClaim that is to be generated.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:ResourceClaimTemplate"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplate"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:ResourceClaimTemplate"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplate")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ResourceClaimTemplate']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
