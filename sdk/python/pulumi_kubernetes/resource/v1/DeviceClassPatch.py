...
@pulumi.type_token("kubernetes:resource.k8s.io/v1:DeviceClassPatch")
class DeviceClassPatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:DeviceClassPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:DeviceClassPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta2:DeviceClassPatch")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeviceClassPatch, __self__).__init__(
            'kubernetes:resource.k8s.io/v1:DeviceClassPatch',
            resource_name,
            __props__,
            opts)
