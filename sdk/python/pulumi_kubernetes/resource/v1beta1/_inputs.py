...
class BasicDeviceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] binding_conditions: BindingConditions defines the conditions for proceeding with binding. All of these conditions must be set in the per-device status conditions with a value of True to proceed with binding the pod to the node while scheduling the pod.
               ...
               This is a beta field and requires enabling the DRADeviceBindingConditions and DRAResourceClaimDeviceStatus feature gates.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] binding_failure_conditions: BindingFailureConditions defines the conditions for binding failure. They may be set in the per-device status conditions. If any is true, a binding failure occurred.
...
class DeviceArgsDict(TypedDict):
    ...
    """
    basic: NotRequired[pulumi.Input[Optional['BasicDeviceArgsDict']]]
    """
...
class DeviceClassArgsDict(TypedDict):
    ...
    """
    api_version: NotRequired[pulumi.Input[Optional[Literal['resource.k8s.io/v1beta1']]]]
    """
...
class DeviceClassArgs:
    ...
    def api_version(self) -> pulumi.Input[Optional[Literal['resource.k8s.io/v1beta1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
    ...
    @api_version.setter
    def api_version(self, value: pulumi.Input[Optional[Literal['resource.k8s.io/v1beta1']]]):
...
class DevicePatchArgsDict(TypedDict):
    ...
    Device represents one individual hardware instance that can be selected based on its attributes. Besides the name, exactly one field must be set.
    """
    basic: NotRequired[pulumi.Input[Optional['BasicDevicePatchArgsDict']]]
    """
    Basic defines one device instance.
    """
    name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
