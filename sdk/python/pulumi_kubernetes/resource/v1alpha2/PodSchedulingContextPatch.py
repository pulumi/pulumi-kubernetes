...
class PodSchedulingContextPatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['PodSchedulingContextSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['PodSchedulingContextSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['PodSchedulingContextSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:resource.k8s.io/v1alpha2:PodSchedulingContextPatch")
class PodSchedulingContextPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['PodSchedulingContextSpecPatchArgs', 'PodSchedulingContextSpecPatchArgsDict', 'outputs.PodSchedulingContextSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['PodSchedulingContextSpecPatchArgs', 'PodSchedulingContextSpecPatchArgsDict', 'outputs.PodSchedulingContextSpecPatch']] spec: Spec describes where resources for the Pod are needed.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['PodSchedulingContext']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
