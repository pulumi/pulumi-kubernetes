...
__all__ = ['ResourceClassParametersListArgs', 'ResourceClassParametersList']

@pulumi.input_type
class ResourceClassParametersListArgs:
    def __init__(__self__, *,
                 items: pulumi.Input[Sequence[pulumi.Input['ResourceClassParametersArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ResourceClassParametersArgs']]] items: Items is the list of node resource capacity objects.
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", 'ResourceClassParametersList')
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)

    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Input[Sequence[pulumi.Input['ResourceClassParametersArgs']]]:
        """
    ...
    @items.setter
    def items(self, value: pulumi.Input[Sequence[pulumi.Input['ResourceClassParametersArgs']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ResourceClassParametersList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ResourceClassParametersList']]]):
...
class ResourceClassParametersList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ResourceClassParametersListArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ResourceClassParametersList is a collection of ResourceClassParameters.

        :param str resource_name: The name of the resource.
        :param ResourceClassParametersListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceClassParametersListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceClassParametersListArgs.__new__(ResourceClassParametersListArgs)

            __props__.__dict__["api_version"] = 'resource.k8s.io/v1alpha2'
            if items is None and not opts.urn:
                raise TypeError("Missing required property 'items'")
            __props__.__dict__["items"] = items
            __props__.__dict__["kind"] = 'ResourceClassParametersList'
            __props__.__dict__["metadata"] = metadata
        super(ResourceClassParametersList, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ResourceClassParametersList':
        """
        ...
        return ResourceClassParametersList(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence['outputs.ResourceClassParameters']]:
        """
        Items is the list of node resource capacity objects.
        """
        return pulumi.get(self, "items")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ResourceClassParametersList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
