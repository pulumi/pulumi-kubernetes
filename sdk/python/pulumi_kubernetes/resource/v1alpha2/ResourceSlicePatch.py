...
class ResourceSlicePatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['NamedResourcesResourcesPatchArgs'] named_resources: NamedResources describes available resources using the named resources model.
...
@pulumi.type_token("kubernetes:resource.k8s.io/v1alpha2:ResourceSlicePatch")
class ResourceSlicePatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:ResourceSlicePatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:ResourceSlicePatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:ResourceSlicePatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta2:ResourceSlicePatch")])
    ...
    @_builtins.property
    @pulumi.getter(name="namedResources")
    def named_resources(self) -> pulumi.Output[Optional['outputs.NamedResourcesResourcesPatch']]:
        """
        NamedResources describes available resources using the named resources model.
        """
        return pulumi.get(self, "named_resources")
