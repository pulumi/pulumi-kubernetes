...
@pulumi.type_token("kubernetes:resource.k8s.io/v1beta2:DeviceTaintRule")
class DeviceTaintRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['DeviceTaintRuleSpecArgs', 'DeviceTaintRuleSpecArgsDict', 'outputs.DeviceTaintRuleSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['DeviceTaintRuleSpecArgs', 'DeviceTaintRuleSpecArgsDict', 'outputs.DeviceTaintRuleSpec']] spec: Spec specifies the selector and one taint.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:DeviceTaintRule"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:DeviceTaintRule")])
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Literal['resource.k8s.io/v1beta2']]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['DeviceTaintRule']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
