...
class DeviceClass(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['DeviceClassSpecArgs', 'DeviceClassSpecArgsDict', 'outputs.DeviceClassSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['DeviceClassSpecArgs', 'DeviceClassSpecArgsDict', 'outputs.DeviceClassSpec']] spec: Spec defines what can be allocated and how to configure it.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:DeviceClass"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:DeviceClass"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:DeviceClass")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['DeviceClass']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
