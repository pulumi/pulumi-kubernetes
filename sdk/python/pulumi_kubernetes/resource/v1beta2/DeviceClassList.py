...
class DeviceClassListArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['DeviceClassList']]] = None,
        ...
        :param pulumi.Input[Literal['DeviceClassList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['DeviceClassList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['DeviceClassList']]]):
...
@pulumi.type_token("kubernetes:resource.k8s.io/v1beta2:DeviceClassList")
class DeviceClassList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: pulumi.Input[Optional[Literal['resource.k8s.io/v1beta2']]] = None,
                 items: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DeviceClassArgs', 'DeviceClassArgsDict', 'outputs.DeviceClass']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['DeviceClassList']]] = None,
        ...
        :param pulumi.Input[Literal['resource.k8s.io/v1beta2']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['DeviceClassArgs', 'DeviceClassArgsDict', 'outputs.DeviceClass']]]] items: Items is the list of resource classes.
        :param pulumi.Input[Literal['DeviceClassList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['DeviceClassList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
