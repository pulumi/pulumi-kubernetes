...
@pulumi.type_token("kubernetes:resource.k8s.io/v1beta2:ResourceClaim")
class ResourceClaim(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ResourceClaimSpecArgs', 'ResourceClaimSpecArgsDict', 'outputs.ResourceClaimSpec']] spec: Spec describes what is being requested and how to configure it. The spec is immutable.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:ResourceClaim"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha1:ResourceClaim"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha2:ResourceClaim"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:ResourceClaim"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:ResourceClaim")])
