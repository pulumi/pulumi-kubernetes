...
class ResourceSlicePatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['ResourceSliceSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['ResourceSliceSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['ResourceSliceSpecPatchArgs']]):
...
class ResourceSlicePatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ResourceSliceSpecPatchArgs', 'ResourceSliceSpecPatchArgsDict', 'outputs.ResourceSliceSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ResourceSliceSpecPatchArgs', 'ResourceSliceSpecPatchArgsDict', 'outputs.ResourceSliceSpecPatch']] spec: Contains the information published by the driver.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:ResourceSlicePatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha2:ResourceSlicePatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:ResourceSlicePatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:ResourceSlicePatch")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['ResourceSlice']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
