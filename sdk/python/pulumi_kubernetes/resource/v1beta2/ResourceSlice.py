...
class ResourceSlice(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ResourceSliceSpecArgs', 'ResourceSliceSpecArgsDict', 'outputs.ResourceSliceSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ResourceSliceSpecArgs', 'ResourceSliceSpecArgsDict', 'outputs.ResourceSliceSpec']] spec: Contains the information published by the driver.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:ResourceSlice"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha2:ResourceSlice"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:ResourceSlice"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:ResourceSlice")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ResourceSlice']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
