...
@pulumi.type_token("kubernetes:resource.k8s.io/v1beta2:ResourceClaimPatch")
class ResourceClaimPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ResourceClaimSpecPatchArgs', 'ResourceClaimSpecPatchArgsDict', 'outputs.ResourceClaimSpecPatch']] spec: Spec describes what is being requested and how to configure it. The spec is immutable.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:ResourceClaimPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha1:ResourceClaimPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1alpha3:ResourceClaimPatch"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:ResourceClaimPatch")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['ResourceClaim']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
