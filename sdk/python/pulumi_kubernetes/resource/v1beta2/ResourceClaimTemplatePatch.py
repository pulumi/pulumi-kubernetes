...
class ResourceClaimTemplatePatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['ResourceClaimTemplateSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['ResourceClaimTemplateSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['ResourceClaimTemplateSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplatePatch")
class ResourceClaimTemplatePatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ResourceClaimTemplateSpecPatchArgs', 'ResourceClaimTemplateSpecPatchArgsDict', 'outputs.ResourceClaimTemplateSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ResourceClaimTemplateSpecPatchArgs', 'ResourceClaimTemplateSpecPatchArgsDict', 'outputs.ResourceClaimTemplateSpecPatch']] spec: Describes the ResourceClaim that is to be generated.
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['ResourceClaimTemplate']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
