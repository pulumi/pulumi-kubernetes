...
@pulumi.type_token("kubernetes:resource.k8s.io/v1alpha3:DeviceClass")
class DeviceClass(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:resource.k8s.io/v1:DeviceClass"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta1:DeviceClass"), pulumi.Alias(type_="kubernetes:resource.k8s.io/v1beta2:DeviceClass")])
