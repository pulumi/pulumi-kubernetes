...
class PodDisruptionBudgetSpecPatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] unhealthy_pod_eviction_policy: UnhealthyPodEvictionPolicy defines the criteria for when unhealthy pods should be considered for eviction. Current implementation considers healthy pods, as pods that have status.conditions item with type="Ready",status="True".
    ...
    def unhealthy_pod_eviction_policy(self) -> Optional[pulumi.Input[str]]:
        """
