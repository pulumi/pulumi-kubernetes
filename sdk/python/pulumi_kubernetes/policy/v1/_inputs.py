...
class PodDisruptionBudgetArgsDict(TypedDict):
    ...
    """
    api_version: NotRequired[pulumi.Input[Optional[Literal['policy/v1']]]]
    """
...
class PodDisruptionBudgetStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] observed_generation: Most recent generation observed when updating this PDB status. DisruptionsAllowed and other status information is valid only if observedGeneration equals to PDB's object generation.
        """
