...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "kubernetes:policy/v1:PodDisruptionBudget":
                return PodDisruptionBudget(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:policy/v1:PodDisruptionBudgetList":
    ...
    pulumi.runtime.register_resource_module("kubernetes", "policy/v1", _module_instance)
