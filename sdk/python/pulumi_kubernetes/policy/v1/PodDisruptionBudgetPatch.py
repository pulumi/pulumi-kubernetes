...
class PodDisruptionBudgetPatchArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[Literal['policy/v1']]] = None,
                 ...
                 spec: pulumi.Input[Optional['PodDisruptionBudgetSpecPatchArgs']] = None):
        """
    ...
    def api_version(self) -> pulumi.Input[Optional[Literal['policy/v1']]]:
        """
    ...
    @api_version.setter
    def api_version(self, value: pulumi.Input[Optional[Literal['policy/v1']]]):
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['PodDisruptionBudgetSpecPatchArgs']]):
...
class PodDisruptionBudgetPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['PodDisruptionBudgetSpecPatchArgs', 'PodDisruptionBudgetSpecPatchArgsDict', 'outputs.PodDisruptionBudgetSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['PodDisruptionBudgetSpecPatchArgs', 'PodDisruptionBudgetSpecPatchArgsDict', 'outputs.PodDisruptionBudgetSpecPatch']] spec: spec is the specification of the desired behavior of the PodDisruptionBudget.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Optional[Literal['policy/v1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['PodDisruptionBudget']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
