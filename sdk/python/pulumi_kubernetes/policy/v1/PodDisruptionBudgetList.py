...
class PodDisruptionBudgetListArgs:
    def __init__(__self__, *,
        ...
        """
        PodDisruptionBudgetListArgs._configure(
    ...
    def _configure(
             ...
             items: Optional[pulumi.Input[Sequence[pulumi.Input['PodDisruptionBudgetArgs']]]] = None,
             api_version: Optional[pulumi.Input[str]] = None,
             kind: Optional[pulumi.Input[str]] = None,
             metadata: Optional[pulumi.Input['_meta.v1.ListMetaArgs']] = None,
        ...
        if kind is not None:
            _setter("kind", 'PodDisruptionBudgetList')
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PodDisruptionBudgetListArgs._configure(_setter, **kwargs)
