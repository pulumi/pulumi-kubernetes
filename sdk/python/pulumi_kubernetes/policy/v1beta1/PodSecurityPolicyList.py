...
__all__ = ['PodSecurityPolicyListArgs', 'PodSecurityPolicyList']

@pulumi.input_type
class PodSecurityPolicyListArgs:
    def __init__(__self__, *,
                 items: pulumi.Input[Sequence[pulumi.Input['PodSecurityPolicyArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PodSecurityPolicyArgs']]] items: items is a list of schema objects.
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", 'PodSecurityPolicyList')
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)

    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Input[Sequence[pulumi.Input['PodSecurityPolicyArgs']]]:
        """
    ...
    @items.setter
    def items(self, value: pulumi.Input[Sequence[pulumi.Input['PodSecurityPolicyArgs']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['PodSecurityPolicyList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['PodSecurityPolicyList']]]):
...
class PodSecurityPolicyList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PodSecurityPolicyListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PodSecurityPolicyListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PodSecurityPolicyListArgs.__new__(PodSecurityPolicyListArgs)

            __props__.__dict__["api_version"] = 'policy/v1beta1'
            if items is None and not opts.urn:
                raise TypeError("Missing required property 'items'")
            __props__.__dict__["items"] = items
            __props__.__dict__["kind"] = 'PodSecurityPolicyList'
            __props__.__dict__["metadata"] = metadata
        super(PodSecurityPolicyList, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PodSecurityPolicyList':
        """
        ...
        return PodSecurityPolicyList(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Literal['policy/v1beta1']]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence['outputs.PodSecurityPolicy']]:
        """
        items is a list of schema objects.
        """
        return pulumi.get(self, "items")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['PodSecurityPolicyList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
