...
class PodSecurityPolicyPatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['PodSecurityPolicySpecPatchArgs']] = None):
        """
        ...
        :param pulumi.Input['PodSecurityPolicySpecPatchArgs'] spec: spec defines the policy enforced.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['PodSecurityPolicySpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['PodSecurityPolicySpecPatchArgs']]):
...
class PodSecurityPolicyPatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:extensions/v1beta1:PodSecurityPolicyPatch")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['PodSecurityPolicy']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.PodSecurityPolicySpecPatch']]:
        """
        spec defines the policy enforced.
        """
        return pulumi.get(self, "spec")
