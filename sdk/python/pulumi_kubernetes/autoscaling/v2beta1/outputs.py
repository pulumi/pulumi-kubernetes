...
class HorizontalPodAutoscaler(dict):
    ...
    def __init__(__self__, *,
                 api_version: Optional[Literal['autoscaling/v2beta1']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> Optional[Literal['autoscaling/v2beta1']]:
        """
