...
__all__ = ['HorizontalPodAutoscalerArgs', 'HorizontalPodAutoscaler']
...
class HorizontalPodAutoscaler(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[HorizontalPodAutoscalerArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        HorizontalPodAutoscaler is the configuration for a horizontal pod autoscaler, which automatically manages the replica count of any resource implementing the scale subresource based on the metrics specified.

        :param str resource_name: The name of the resource.
        :param HorizontalPodAutoscalerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(HorizontalPodAutoscalerArgs, pulumi.ResourceOptions, *args, **kwargs)
