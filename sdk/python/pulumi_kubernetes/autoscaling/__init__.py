...
if typing.TYPE_CHECKING:
    import pulumi_kubernetes.autoscaling.v1 as v1
    import pulumi_kubernetes.autoscaling.v2beta1 as v2beta1
    import pulumi_kubernetes.autoscaling.v2beta2 as v2beta2
else:
