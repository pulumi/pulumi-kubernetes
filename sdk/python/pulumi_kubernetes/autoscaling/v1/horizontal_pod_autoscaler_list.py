...
class HorizontalPodAutoscalerList(pulumi.CustomResource):
    ...
    list of horizontal pod autoscaler objects.
      ...
      * `spec` (`dict`) - behaviour of autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.
        * `max_replicas` (`float`) - upper limit for the number of pods that can be set by the autoscaler; cannot be smaller than MinReplicas.
        ...
        * `scale_target_ref` (`dict`) - reference to scaled resource; horizontal pod autoscaler will learn the current resource consumption and will set the desired number of pods by using its Scale subresource.
          * `api_version` (`str`) - API version of the referent
          * `kind` (`str`) - Kind of the referent; More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"
          * `name` (`str`) - Name of the referent; More info: http://kubernetes.io/docs/user-guide/identifiers#names

        * `target_cpu_utilization_percentage` (`float`) - target average CPU utilization (represented as a percentage of requested CPU) over all the pods; if not specified the default autoscaling policy will be used.

      * `status` (`dict`) - current information about the autoscaler.
        * `current_cpu_utilization_percentage` (`float`) - current average CPU utilization over all pods, represented as a percentage of requested CPU, e.g. 70 means that an average pod is using now 70% of its requested CPU.
        * `current_replicas` (`float`) - current number of replicas of pods managed by this autoscaler.
        * `desired_replicas` (`float`) - desired number of replicas of pods managed by this autoscaler.
        * `last_scale_time` (`str`) - last time the HorizontalPodAutoscaler scaled the number of pods; used by the autoscaler to control how often the number of pods is changed.
        * `observed_generation` (`float`) - most recent generation observed by this autoscaler.
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - behaviour of autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.
            * `max_replicas` (`pulumi.Input[float]`) - upper limit for the number of pods that can be set by the autoscaler; cannot be smaller than MinReplicas.
            * `min_replicas` (`pulumi.Input[float]`) - minReplicas is the lower limit for the number of replicas to which the autoscaler can scale down.  It defaults to 1 pod.  minReplicas is allowed to be 0 if the alpha feature gate HPAScaleToZero is enabled and at least one Object or External metric is configured.  Scaling is active as long as at least one metric value is available.
            * `scale_target_ref` (`pulumi.Input[dict]`) - reference to scaled resource; horizontal pod autoscaler will learn the current resource consumption and will set the desired number of pods by using its Scale subresource.
              * `api_version` (`pulumi.Input[str]`) - API version of the referent
              * `kind` (`pulumi.Input[str]`) - Kind of the referent; More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"
              * `name` (`pulumi.Input[str]`) - Name of the referent; More info: http://kubernetes.io/docs/user-guide/identifiers#names

            * `target_cpu_utilization_percentage` (`pulumi.Input[float]`) - target average CPU utilization (represented as a percentage of requested CPU) over all the pods; if not specified the default autoscaling policy will be used.

          * `status` (`pulumi.Input[dict]`) - current information about the autoscaler.
            * `current_cpu_utilization_percentage` (`pulumi.Input[float]`) - current average CPU utilization over all pods, represented as a percentage of requested CPU, e.g. 70 means that an average pod is using now 70% of its requested CPU.
            * `current_replicas` (`pulumi.Input[float]`) - current number of replicas of pods managed by this autoscaler.
            * `desired_replicas` (`pulumi.Input[float]`) - desired number of replicas of pods managed by this autoscaler.
            * `last_scale_time` (`pulumi.Input[str]`) - last time the HorizontalPodAutoscaler scaled the number of pods; used by the autoscaler to control how often the number of pods is changed.
            * `observed_generation` (`pulumi.Input[float]`) - most recent generation observed by this autoscaler.
