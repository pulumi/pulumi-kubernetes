...
class HorizontalPodAutoscaler(dict):
    ...
    def __init__(__self__, *,
                 ...
                 api_version: Optional[Literal['autoscaling/v1']] = None,
                 kind: Optional[Literal['HorizontalPodAutoscaler']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> Optional[Literal['autoscaling/v1']]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> Optional[Literal['HorizontalPodAutoscaler']]:
        """
