...
class HorizontalPodAutoscaler(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['HorizontalPodAutoscalerSpecArgs', 'HorizontalPodAutoscalerSpecArgsDict', 'outputs.HorizontalPodAutoscalerSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['HorizontalPodAutoscalerSpecArgs', 'HorizontalPodAutoscalerSpecArgsDict', 'outputs.HorizontalPodAutoscalerSpec']] spec: spec is the specification for the behaviour of the autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['HorizontalPodAutoscaler']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
