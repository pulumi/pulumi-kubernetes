...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "kubernetes:admissionregistration.k8s.io/v1:MutatingWebhookConfiguration":
                return MutatingWebhookConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:admissionregistration.k8s.io/v1:MutatingWebhookConfigurationList":
                return MutatingWebhookConfigurationList(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:admissionregistration.k8s.io/v1:ValidatingWebhookConfiguration":
                return ValidatingWebhookConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "kubernetes:admissionregistration.k8s.io/v1:ValidatingWebhookConfigurationList":
    ...
    pulumi.runtime.register_resource_module("kubernetes", "admissionregistration.k8s.io/v1", _module_instance)
