...
__all__ = ['ValidatingWebhookConfigurationArgs', 'ValidatingWebhookConfiguration']
...
class ValidatingWebhookConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ValidatingWebhookConfigurationArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ValidatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and object without changing it.

        :param str resource_name: The name of the resource.
        :param ValidatingWebhookConfigurationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ValidatingWebhookConfigurationArgs, pulumi.ResourceOptions, *args, **kwargs)
