...
@pulumi.type_token("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyBinding")
class MutatingAdmissionPolicyBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:admissionregistration.k8s.io/v1alpha1:MutatingAdmissionPolicyBinding"), pulumi.Alias(type_="kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicyBinding")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MutatingAdmissionPolicyBinding, __self__).__init__(
            'kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicyBinding',
            resource_name,
            __props__,
            opts)
