...
class ExpressionWarningArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] field_ref: fieldRef is the path to the field that refers to the expression. For example, the reference to the expression of the first item of validations is "spec.validations[0].expression"
        :param pulumi.Input[_builtins.str] warning: warning contains the content of type checking information in a human-readable form. Each line of the warning contains the type that the expression is checked against, followed by the type check error from the compiler.
        """
...
class MatchResourcesArgs:
    def __init__(__self__, *,
                 exclude_resource_rules: pulumi.Input[Optional[Sequence[pulumi.Input['NamedRuleWithOperationsArgs']]]] = None,
                 ...
                 resource_rules: pulumi.Input[Optional[Sequence[pulumi.Input['NamedRuleWithOperationsArgs']]]] = None):
        """
        MatchResources decides whether to run the admission control policy on an object based on whether it meets the match criteria. The exclude rules take precedence over include rules (if a resource matches both, it is excluded)
    ...
    def exclude_resource_rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['NamedRuleWithOperationsArgs']]]]:
        """
        excludeResourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy should not care about. The exclude rules take precedence over include rules (if a resource matches both, it is excluded)
        """
    ...
    def exclude_resource_rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['NamedRuleWithOperationsArgs']]]]):
    ...
    def resource_rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['NamedRuleWithOperationsArgs']]]]:
        """
        resourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy matches. The policy cares about an operation if it matches _any_ Rule.
        """
    ...
    def resource_rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['NamedRuleWithOperationsArgs']]]]):
...
class MutatingAdmissionPolicyArgsDict(TypedDict):
    ...
    """
    api_version: NotRequired[pulumi.Input[Optional[Literal['admissionregistration.k8s.io/v1']]]]
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['MutatingAdmissionPolicy']]]]
    """
...
class MutatingAdmissionPolicyArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['MutatingAdmissionPolicy']]] = None,
        ...
        :param pulumi.Input[Literal['MutatingAdmissionPolicy']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def api_version(self) -> pulumi.Input[Optional[Literal['admissionregistration.k8s.io/v1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
    ...
    @api_version.setter
    def api_version(self, value: pulumi.Input[Optional[Literal['admissionregistration.k8s.io/v1']]]):
        pulumi.set(self, "api_version", value)

    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['MutatingAdmissionPolicy']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['MutatingAdmissionPolicy']]]):
...
class MutatingAdmissionPolicyBindingArgsDict(TypedDict):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['MutatingAdmissionPolicyBinding']]]]
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
    metadata: NotRequired[pulumi.Input[Optional['_meta.v1.ObjectMetaArgsDict']]]
...
class MutatingAdmissionPolicyBindingArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[Literal['admissionregistration.k8s.io/v1']]] = None,
                 kind: pulumi.Input[Optional[Literal['MutatingAdmissionPolicyBinding']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 spec: pulumi.Input[Optional['MutatingAdmissionPolicyBindingSpecArgs']] = None):
        """
        MutatingAdmissionPolicyBinding binds the MutatingAdmissionPolicy with parametrized resources. MutatingAdmissionPolicyBinding and the optional parameter resource together define how cluster administrators configure policies for clusters.
        ...
        :param pulumi.Input[Literal['admissionregistration.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Literal['MutatingAdmissionPolicyBinding']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        :param pulumi.Input['_meta.v1.ObjectMetaArgs'] metadata: metadata is the standard object metadata; More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata.
        :param pulumi.Input['MutatingAdmissionPolicyBindingSpecArgs'] spec: spec defines the desired behavior of the MutatingAdmissionPolicyBinding.
        """
        if api_version is not None:
            pulumi.set(__self__, "api_version", 'admissionregistration.k8s.io/v1')
        if kind is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['MutatingAdmissionPolicyBinding']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['MutatingAdmissionPolicyBinding']]]):
        pulumi.set(self, "kind", value)
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['MutatingAdmissionPolicyBindingSpecArgs']]:
        """
        spec defines the desired behavior of the MutatingAdmissionPolicyBinding.
        """
        return pulumi.get(self, "spec")
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['MutatingAdmissionPolicyBindingSpecArgs']]):
        pulumi.set(self, "spec", value)
...
class MutatingAdmissionPolicySpecArgs:
    def __init__(__self__, *,
                 ...
                 match_conditions: pulumi.Input[Optional[Sequence[pulumi.Input['MatchConditionArgs']]]] = None,
                 match_constraints: pulumi.Input[Optional['MatchResourcesArgs']] = None,
                 mutations: pulumi.Input[Optional[Sequence[pulumi.Input['MutationArgs']]]] = None,
                 param_kind: pulumi.Input[Optional['ParamKindArgs']] = None,
                 reinvocation_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 variables: pulumi.Input[Optional[Sequence[pulumi.Input['VariableArgs']]]] = None):
        """
        MutatingAdmissionPolicySpec defines the desired behavior of the admission policy.
    ...
    def match_conditions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MatchConditionArgs']]]]:
        """
        matchConditions is a list of conditions that must be met for a request to be validated. Match conditions filter requests that have already been matched by the matchConstraints. An empty list of matchConditions matches all requests. There are a maximum of 64 match conditions allowed.
    ...
    def match_conditions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MatchConditionArgs']]]]):
        pulumi.set(self, "match_conditions", value)

    @_builtins.property
    @pulumi.getter(name="matchConstraints")
    def match_constraints(self) -> pulumi.Input[Optional['MatchResourcesArgs']]:
        """
        matchConstraints specifies what resources this policy is designed to validate. The MutatingAdmissionPolicy cares about a request if it matches _all_ Constraints. However, in order to prevent clusters from being put into an unstable state that cannot be recovered from via the API MutatingAdmissionPolicy cannot match MutatingAdmissionPolicy and MutatingAdmissionPolicyBinding. The CREATE, UPDATE and CONNECT operations are allowed.  The DELETE operation may not be matched. '*' matches CREATE, UPDATE and CONNECT. Required.
        """
    ...
    def match_constraints(self, value: pulumi.Input[Optional['MatchResourcesArgs']]):
        pulumi.set(self, "match_constraints", value)

    @_builtins.property
    @pulumi.getter
    def mutations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MutationArgs']]]]:
        """
        mutations contain operations to perform on matching objects. mutations may not be empty; a minimum of one mutation is required. mutations are evaluated in order, and are reinvoked according to the reinvocationPolicy. The mutations of a policy are invoked for each binding of this policy and reinvocation of mutations occurs on a per binding basis.
        """
    ...
    @mutations.setter
    def mutations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MutationArgs']]]]):
        pulumi.set(self, "mutations", value)

    @_builtins.property
    @pulumi.getter(name="paramKind")
    def param_kind(self) -> pulumi.Input[Optional['ParamKindArgs']]:
        """
        paramKind specifies the kind of resources used to parameterize this policy. If absent, there are no parameters for this policy and the param CEL variable will not be provided to validation expressions. If paramKind refers to a non-existent kind, this policy definition is mis-configured and the FailurePolicy is applied. If paramKind is specified but paramRef is unset in MutatingAdmissionPolicyBinding, the params variable will be null.
        """
    ...
    @param_kind.setter
    def param_kind(self, value: pulumi.Input[Optional['ParamKindArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def variables(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VariableArgs']]]]:
        """
        variables contain definitions of variables that can be used in composition of other expressions. Each variable is defined as a named CEL expression. The variables defined here will be available under `variables` in other expressions of the policy except matchConditions because matchConditions are evaluated before the rest of the policy.
    ...
    @variables.setter
    def variables(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VariableArgs']]]]):
...
class MutatingWebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: name is the name of the admission webhook. Name should be fully qualified, e.g., imagepolicy.kubernetes.io, where "imagepolicy" is the name of the webhook, and kubernetes.io is the name of the organization. Required.
...
class MutatingWebhookConfigurationArgsDict(TypedDict):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['MutatingWebhookConfiguration']]]]
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
    metadata: NotRequired[pulumi.Input[Optional['_meta.v1.ObjectMetaArgsDict']]]
...
class MutatingWebhookConfigurationArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[Literal['admissionregistration.k8s.io/v1']]] = None,
                 kind: pulumi.Input[Optional[Literal['MutatingWebhookConfiguration']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 webhooks: pulumi.Input[Optional[Sequence[pulumi.Input['MutatingWebhookArgs']]]] = None):
        """
        MutatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and may change the object.

        :param pulumi.Input[Literal['admissionregistration.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Literal['MutatingWebhookConfiguration']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        :param pulumi.Input['_meta.v1.ObjectMetaArgs'] metadata: metadata is the standard object metadata; More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata.
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['MutatingWebhookConfiguration']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['MutatingWebhookConfiguration']]]):
        pulumi.set(self, "kind", value)
    ...
    @_builtins.property
    @pulumi.getter
    def webhooks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MutatingWebhookArgs']]]]:
        """
        webhooks is a list of webhooks and the affected resources and operations.
        """
    ...
    @webhooks.setter
    def webhooks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MutatingWebhookArgs']]]]):
...
class MutatingWebhookPatchArgs:
    def __init__(__self__, *,
                 ...
                 object_selector: pulumi.Input[Optional['_meta.v1.LabelSelectorPatchArgs']] = None,
                 reinvocation_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['RuleWithOperationsPatchArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RuleWithOperationsPatchArgs']]]]:
        """
        rules describes what operations on what resources/subresources the webhook cares about. The webhook cares about an operation if it matches _any_ Rule. However, in order to prevent ValidatingAdmissionWebhooks and MutatingAdmissionWebhooks from putting the cluster in a state which cannot be recovered from without completely disabling the plugin, ValidatingAdmissionWebhooks and MutatingAdmissionWebhooks are never called on admission requests for ValidatingWebhookConfiguration and MutatingWebhookConfiguration objects.
        """
        return pulumi.get(self, "rules")
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RuleWithOperationsPatchArgs']]]]):
        pulumi.set(self, "rules", value)
...
class MutationPatchArgsDict(TypedDict):
    ...
    jsonPatch defines a [JSON patch](https://jsonpatch.com/) operation to perform a mutation to the object. A CEL expression is used to create the JSON patch.
    """
    patch_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    patchType indicates the patch strategy used. Allowed values are "ApplyConfiguration" and "JSONPatch". Required.
    """
...
class MutationPatchArgs:
    def __init__(__self__, *,
                 apply_configuration: pulumi.Input[Optional['ApplyConfigurationPatchArgs']] = None,
                 json_patch: pulumi.Input[Optional['JSONPatchPatchArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="applyConfiguration")
    def apply_configuration(self) -> pulumi.Input[Optional['ApplyConfigurationPatchArgs']]:
        """
        applyConfiguration defines the desired configuration values of an object. The configuration is applied to the admission object using [structured merge diff](https://github.com/kubernetes-sigs/structured-merge-diff). A CEL expression is used to create apply configuration.
        """
        return pulumi.get(self, "apply_configuration")
    ...
    @apply_configuration.setter
    def apply_configuration(self, value: pulumi.Input[Optional['ApplyConfigurationPatchArgs']]):
        pulumi.set(self, "apply_configuration", value)

    @_builtins.property
    @pulumi.getter(name="jsonPatch")
    def json_patch(self) -> pulumi.Input[Optional['JSONPatchPatchArgs']]:
        """
        jsonPatch defines a [JSON patch](https://jsonpatch.com/) operation to perform a mutation to the object. A CEL expression is used to create the JSON patch.
        """
        return pulumi.get(self, "json_patch")
    ...
    @json_patch.setter
    def json_patch(self, value: pulumi.Input[Optional['JSONPatchPatchArgs']]):
        pulumi.set(self, "json_patch", value)
...
class ServiceReferenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] port: port is the port on the service that hosts the webhook. Default to 443 for backward compatibility. `port` should be a valid port number (1-65535, inclusive).
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "namespace", namespace)
        if path is not None:
...
class TypeCheckingArgs:
    def __init__(__self__, *,
                 expression_warnings: pulumi.Input[Optional[Sequence[pulumi.Input['ExpressionWarningArgs']]]] = None):
        """
        TypeChecking contains results of type checking the expressions in the ValidatingAdmissionPolicy

        :param pulumi.Input[Sequence[pulumi.Input['ExpressionWarningArgs']]] expression_warnings: expressionWarnings contains the type checking warnings for each expression.
        """
    ...
    def expression_warnings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ExpressionWarningArgs']]]]:
        """
        expressionWarnings contains the type checking warnings for each expression.
        """
    ...
    def expression_warnings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ExpressionWarningArgs']]]]):
...
class ValidatingAdmissionPolicyArgsDict(TypedDict):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['ValidatingAdmissionPolicy']]]]
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
    metadata: NotRequired[pulumi.Input[Optional['_meta.v1.ObjectMetaArgsDict']]]
...
class ValidatingAdmissionPolicyArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[Literal['admissionregistration.k8s.io/v1']]] = None,
                 kind: pulumi.Input[Optional[Literal['ValidatingAdmissionPolicy']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
        ...
        :param pulumi.Input[Literal['admissionregistration.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Literal['ValidatingAdmissionPolicy']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        :param pulumi.Input['_meta.v1.ObjectMetaArgs'] metadata: metadata is the standard object metadata; More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata.
        :param pulumi.Input['ValidatingAdmissionPolicySpecArgs'] spec: spec defines the desired behavior of the ValidatingAdmissionPolicy.
        :param pulumi.Input['ValidatingAdmissionPolicyStatusArgs'] status: status represents the current status of the ValidatingAdmissionPolicy, including warnings that are useful to determine if the policy behaves in the expected way. Populated by the system. Read-only.
        """
        if api_version is not None:
            pulumi.set(__self__, "api_version", 'admissionregistration.k8s.io/v1')
        if kind is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ValidatingAdmissionPolicy']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ValidatingAdmissionPolicy']]]):
        pulumi.set(self, "kind", value)
...
class ValidatingAdmissionPolicyBindingArgsDict(TypedDict):
    ...
    """
    spec: pulumi.Input['ValidatingAdmissionPolicyBindingSpecArgsDict']
    """
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['ValidatingAdmissionPolicyBinding']]]]
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
    metadata: NotRequired[pulumi.Input[Optional['_meta.v1.ObjectMetaArgsDict']]]
...
class ValidatingAdmissionPolicyBindingArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ValidatingAdmissionPolicyBinding']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ValidatingAdmissionPolicyBinding']]]):
        pulumi.set(self, "kind", value)
...
class ValidatingAdmissionPolicyBindingSpecArgsDict(TypedDict):
    ...
    """
    validation_actions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
    """
...
class ValidatingAdmissionPolicyBindingSpecArgs:
    ...
    def validation_actions(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        validationActions declares how Validations of the referenced ValidatingAdmissionPolicy are enforced. If a validation evaluates to false it is always enforced according to these actions.
    ...
    def validation_actions(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ValidatingAdmissionPolicySpecArgs:
    def __init__(__self__, *,
                 audit_annotations: pulumi.Input[Optional[Sequence[pulumi.Input['AuditAnnotationArgs']]]] = None,
                 failure_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 match_conditions: pulumi.Input[Optional[Sequence[pulumi.Input['MatchConditionArgs']]]] = None,
                 match_constraints: pulumi.Input[Optional['MatchResourcesArgs']] = None,
                 param_kind: pulumi.Input[Optional['ParamKindArgs']] = None,
                 validations: pulumi.Input[Optional[Sequence[pulumi.Input['ValidationArgs']]]] = None,
                 variables: pulumi.Input[Optional[Sequence[pulumi.Input['VariableArgs']]]] = None):
        """
        ValidatingAdmissionPolicySpec is the specification of the desired behavior of the AdmissionPolicy.
    ...
    def audit_annotations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AuditAnnotationArgs']]]]:
        """
        auditAnnotations contains CEL expressions which are used to produce audit annotations for the audit event of the API request. validations and auditAnnotations may not both be empty; a least one of validations or auditAnnotations is required.
        """
    ...
    def audit_annotations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AuditAnnotationArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def validations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ValidationArgs']]]]:
        """
        validations contain CEL expressions which is used to apply the validation. Validations and AuditAnnotations may not both be empty; a minimum of one Validations or AuditAnnotations is required.
        """
    ...
    @validations.setter
    def validations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ValidationArgs']]]]):
...
class ValidatingAdmissionPolicyStatusArgs:
    def __init__(__self__, *,
                 ...
                 type_checking: pulumi.Input[Optional['TypeCheckingArgs']] = None):
        """
        ValidatingAdmissionPolicyStatus represents the status of an admission validation policy.

        :param pulumi.Input[Sequence[pulumi.Input['_meta.v1.ConditionArgs']]] conditions: conditions represent the latest available observations of a policy's current state.
        :param pulumi.Input[_builtins.int] observed_generation: observedGeneration is the generation observed by the controller.
        :param pulumi.Input['TypeCheckingArgs'] type_checking: typeChecking contains the results of type checking for each expression. Presence of this field indicates the completion of the type checking.
        """
    ...
    def type_checking(self) -> pulumi.Input[Optional['TypeCheckingArgs']]:
        """
        typeChecking contains the results of type checking for each expression. Presence of this field indicates the completion of the type checking.
        """
    ...
    def type_checking(self, value: pulumi.Input[Optional['TypeCheckingArgs']]):
...
class ValidatingWebhookConfigurationArgsDict(TypedDict):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['ValidatingWebhookConfiguration']]]]
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
    metadata: NotRequired[pulumi.Input[Optional['_meta.v1.ObjectMetaArgsDict']]]
...
class ValidatingWebhookConfigurationArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[Literal['admissionregistration.k8s.io/v1']]] = None,
                 kind: pulumi.Input[Optional[Literal['ValidatingWebhookConfiguration']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 webhooks: pulumi.Input[Optional[Sequence[pulumi.Input['ValidatingWebhookArgs']]]] = None):
        """
        ValidatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and object without changing it.

        :param pulumi.Input[Literal['admissionregistration.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Literal['ValidatingWebhookConfiguration']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        :param pulumi.Input['_meta.v1.ObjectMetaArgs'] metadata: metadata is the standard object metadata; More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata.
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ValidatingWebhookConfiguration']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ValidatingWebhookConfiguration']]]):
        pulumi.set(self, "kind", value)
    ...
    @_builtins.property
    @pulumi.getter
    def webhooks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ValidatingWebhookArgs']]]]:
        """
        webhooks is a list of webhooks and the affected resources and operations.
        """
        return pulumi.get(self, "webhooks")
    ...
    @webhooks.setter
    def webhooks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ValidatingWebhookArgs']]]]):
        pulumi.set(self, "webhooks", value)
