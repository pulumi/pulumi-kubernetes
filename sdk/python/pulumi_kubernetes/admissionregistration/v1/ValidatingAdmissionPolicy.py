...
class ValidatingAdmissionPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ValidatingAdmissionPolicySpecArgs', 'ValidatingAdmissionPolicySpecArgsDict', 'outputs.ValidatingAdmissionPolicySpec']] spec: spec defines the desired behavior of the ValidatingAdmissionPolicy.
        """
        ...
    @overload
    def __init__(__self__,
