...
class ValidatingAdmissionPolicyBindingPatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ValidatingAdmissionPolicyBindingSpecPatchArgs'] spec: spec defines the desired behavior of the ValidatingAdmissionPolicyBinding.
        """
...
class ValidatingAdmissionPolicyBindingPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ValidatingAdmissionPolicyBindingSpecPatchArgs', 'ValidatingAdmissionPolicyBindingSpecPatchArgsDict', 'outputs.ValidatingAdmissionPolicyBindingSpecPatch']] spec: spec defines the desired behavior of the ValidatingAdmissionPolicyBinding.
        """
        ...
    @overload
    def __init__(__self__,
