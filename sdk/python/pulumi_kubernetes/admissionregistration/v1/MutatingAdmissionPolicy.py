...
@pulumi.type_token("kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicy")
class MutatingAdmissionPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:admissionregistration.k8s.io/v1alpha1:MutatingAdmissionPolicy"), pulumi.Alias(type_="kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MutatingAdmissionPolicy, __self__).__init__(
            'kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicy',
            resource_name,
            __props__,
            opts)
