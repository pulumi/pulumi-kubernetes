...
class MutatingAdmissionPolicyListArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['MutatingAdmissionPolicyList']]] = None,
        ...
        :param pulumi.Input[Literal['MutatingAdmissionPolicyList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['MutatingAdmissionPolicyList']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['MutatingAdmissionPolicyList']]]):
...
@pulumi.type_token("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicyList")
class MutatingAdmissionPolicyList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: pulumi.Input[Optional[Literal['admissionregistration.k8s.io/v1beta1']]] = None,
                 items: pulumi.Input[Optional[Sequence[pulumi.Input[Union['MutatingAdmissionPolicyArgs', 'MutatingAdmissionPolicyArgsDict', 'outputs.MutatingAdmissionPolicy']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['MutatingAdmissionPolicyList']]] = None,
        ...
        :param pulumi.Input[Literal['admissionregistration.k8s.io/v1beta1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['MutatingAdmissionPolicyArgs', 'MutatingAdmissionPolicyArgsDict', 'outputs.MutatingAdmissionPolicy']]]] items: List of ValidatingAdmissionPolicy.
        :param pulumi.Input[Literal['MutatingAdmissionPolicyList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['MutatingAdmissionPolicyList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
