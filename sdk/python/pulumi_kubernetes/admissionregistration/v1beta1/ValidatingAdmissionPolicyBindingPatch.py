...
class ValidatingAdmissionPolicyBindingPatchArgs:
    def __init__(__self__, *,
        ...
        """
        ValidatingAdmissionPolicyBindingPatchArgs._configure(
...
class ValidatingAdmissionPolicyBindingPatch(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ValidatingAdmissionPolicyBindingPatchArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if spec is not None and not isinstance(spec, ValidatingAdmissionPolicyBindingSpecPatchArgs):
                spec = spec or {}
                def _setter(key, value):
                    spec[key] = value
                ValidatingAdmissionPolicyBindingSpecPatchArgs._configure(_setter, **spec)
            __props__.__dict__["spec"] = spec
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyBindingPatch")])
