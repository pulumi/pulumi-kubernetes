...
@pulumi.type_token("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicy")
class MutatingAdmissionPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['MutatingAdmissionPolicySpecArgs', 'MutatingAdmissionPolicySpecArgsDict', 'outputs.MutatingAdmissionPolicySpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['MutatingAdmissionPolicySpecArgs', 'MutatingAdmissionPolicySpecArgsDict', 'outputs.MutatingAdmissionPolicySpec']] spec: spec defines the desired behavior of the MutatingAdmissionPolicy.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:admissionregistration.k8s.io/v1:MutatingAdmissionPolicy"), pulumi.Alias(type_="kubernetes:admissionregistration.k8s.io/v1alpha1:MutatingAdmissionPolicy")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['MutatingAdmissionPolicy']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
