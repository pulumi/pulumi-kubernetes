...
class MutatingWebhookConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 webhooks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['MutatingWebhookArgs', 'MutatingWebhookArgsDict', 'outputs.MutatingWebhook']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['MutatingWebhookArgs', 'MutatingWebhookArgsDict', 'outputs.MutatingWebhook']]]] webhooks: Webhooks is a list of webhooks and the affected resources and operations.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['MutatingWebhookConfiguration']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
