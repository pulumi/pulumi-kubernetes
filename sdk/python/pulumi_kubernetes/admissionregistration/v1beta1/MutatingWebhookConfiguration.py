...
__all__ = ['MutatingWebhookConfigurationArgs', 'MutatingWebhookConfiguration']
...
class MutatingWebhookConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[MutatingWebhookConfigurationArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        MutatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and may change the object. Deprecated in v1.16, planned for removal in v1.19. Use admissionregistration.k8s.io/v1 MutatingWebhookConfiguration instead.

        :param str resource_name: The name of the resource.
        :param MutatingWebhookConfigurationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MutatingWebhookConfigurationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MutatingWebhookConfigurationArgs.__new__(MutatingWebhookConfigurationArgs)
