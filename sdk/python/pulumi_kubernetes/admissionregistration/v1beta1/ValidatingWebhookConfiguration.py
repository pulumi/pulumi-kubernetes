...
class ValidatingWebhookConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 webhooks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ValidatingWebhookArgs', 'ValidatingWebhookArgsDict', 'outputs.ValidatingWebhook']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ValidatingWebhookArgs', 'ValidatingWebhookArgsDict', 'outputs.ValidatingWebhook']]]] webhooks: Webhooks is a list of webhooks and the affected resources and operations.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ValidatingWebhookConfiguration']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
