...
class ValidatingAdmissionPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ValidatingAdmissionPolicySpecArgs', 'ValidatingAdmissionPolicySpecArgsDict', 'outputs.ValidatingAdmissionPolicySpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ValidatingAdmissionPolicySpecArgs', 'ValidatingAdmissionPolicySpecArgsDict', 'outputs.ValidatingAdmissionPolicySpec']] spec: Specification of the desired behavior of the ValidatingAdmissionPolicy.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicy"), pulumi.Alias(type_="kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicy")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ValidatingAdmissionPolicy']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
