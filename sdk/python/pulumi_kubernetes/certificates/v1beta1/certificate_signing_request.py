...
class CertificateSigningRequest(pulumi.CustomResource):
    ...
    The certificate request itself and any additional information.
      * `extra` (`dict`) - Extra information about the requesting user. See user.Info interface for details.
      * `groups` (`list`) - Group information about the requesting user. See user.Info interface for details.
      * `request` (`str`) - Base64-encoded PKCS#10 CSR data
      * `signer_name` (`str`) - Requested signer for the request. It is a qualified name in the form: `scope-hostname.io/name`. If empty, it will be defaulted:
      ...
      * `usages` (`list`) - allowedUsages specifies a set of usage contexts the key will be valid for. See: https://tools.ietf.org/html/rfc5280#section-4.2.1.3
    ...
    Derived information about the request.
      ...
      * `conditions` (`list`) - Conditions applied to the request, such as approval or denial.
