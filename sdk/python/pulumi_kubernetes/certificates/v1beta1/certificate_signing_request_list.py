...
class CertificateSigningRequestList(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - The certificate request itself and any additional information.
            * `extra` (`pulumi.Input[dict]`) - Extra information about the requesting user. See user.Info interface for details.
            * `groups` (`pulumi.Input[list]`) - Group information about the requesting user. See user.Info interface for details.
            * `request` (`pulumi.Input[str]`) - Base64-encoded PKCS#10 CSR data
            * `signer_name` (`pulumi.Input[str]`) - Requested signer for the request. It is a qualified name in the form: `scope-hostname.io/name`. If empty, it will be defaulted:
            ...
            * `uid` (`pulumi.Input[str]`) - UID information about the requesting user. See user.Info interface for details.
            * `usages` (`pulumi.Input[list]`) - allowedUsages specifies a set of usage contexts the key will be valid for. See: https://tools.ietf.org/html/rfc5280#section-4.2.1.3
                   https://tools.ietf.org/html/rfc5280#section-4.2.1.12
            * `username` (`pulumi.Input[str]`) - Information about the requesting user. See user.Info interface for details.

          * `status` (`pulumi.Input[dict]`) - Derived information about the request.
            * `certificate` (`pulumi.Input[str]`) - If request was approved, the controller will place the issued certificate here.
            * `conditions` (`pulumi.Input[list]`) - Conditions applied to the request, such as approval or denial.
              * `lastUpdateTime` (`pulumi.Input[str]`) - timestamp for the last update to this condition
              * `message` (`pulumi.Input[str]`) - human readable message with details about the request state
              * `reason` (`pulumi.Input[str]`) - brief reason for the request state
              * `type` (`pulumi.Input[str]`) - request approval state, currently Approved or Denied.
