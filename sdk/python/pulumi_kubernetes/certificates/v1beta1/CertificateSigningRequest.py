...
class CertificateSigningRequestInitArgs:
    def __init__(__self__, *,
        ...
        """
        CertificateSigningRequestInitArgs._configure(
...
class CertificateSigningRequest(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CertificateSigningRequestInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(spec, CertificateSigningRequestSpecArgs):
                spec = spec or {}
                def _setter(key, value):
                    spec[key] = value
