...
class PodCertificateRequestSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str pkix_public_key: The PKIX-serialized public key the signer will issue the certificate to.
        ...
        :param _builtins.str proof_of_possession: A proof that the requesting kubelet holds the private key corresponding to pkixPublicKey.
