...
class ClusterTrustBundleListArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['ClusterTrustBundleList']]] = None,
        ...
        :param pulumi.Input[Literal['ClusterTrustBundleList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def api_version(self) -> pulumi.Input[Optional[Literal['certificates.k8s.io/v1alpha1']]]:
        """
    ...
    @api_version.setter
    def api_version(self, value: pulumi.Input[Optional[Literal['certificates.k8s.io/v1alpha1']]]):
        pulumi.set(self, "api_version", value)

    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ClusterTrustBundleList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ClusterTrustBundleList']]]):
...
@pulumi.type_token("kubernetes:certificates.k8s.io/v1alpha1:ClusterTrustBundleList")
class ClusterTrustBundleList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: pulumi.Input[Optional[Literal['certificates.k8s.io/v1alpha1']]] = None,
                 items: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ClusterTrustBundleArgs', 'ClusterTrustBundleArgsDict', 'outputs.ClusterTrustBundle']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['ClusterTrustBundleList']]] = None,
        ...
        :param pulumi.Input[Literal['certificates.k8s.io/v1alpha1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterTrustBundleArgs', 'ClusterTrustBundleArgsDict', 'outputs.ClusterTrustBundle']]]] items: items is a collection of ClusterTrustBundle objects
        :param pulumi.Input[Literal['ClusterTrustBundleList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Literal['certificates.k8s.io/v1alpha1']]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ClusterTrustBundleList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
