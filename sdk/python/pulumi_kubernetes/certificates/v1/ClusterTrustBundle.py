...
@pulumi.type_token("kubernetes:certificates.k8s.io/v1:ClusterTrustBundle")
class ClusterTrustBundle(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:certificates.k8s.io/v1alpha1:ClusterTrustBundle"), pulumi.Alias(type_="kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundle")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ClusterTrustBundle, __self__).__init__(
            'kubernetes:certificates.k8s.io/v1:ClusterTrustBundle',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ClusterTrustBundle']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
