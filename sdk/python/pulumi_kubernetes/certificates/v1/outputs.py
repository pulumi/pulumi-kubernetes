...
class CertificateSigningRequestCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CertificateSigningRequestCondition describes a condition of a CertificateSigningRequest object
        :param builtins.str status: status of the condition, one of True, False, Unknown. Approved, Denied, and Failed conditions may not be "False" or "Unknown".
        :param builtins.str type: type of the condition. Known conditions are "Approved", "Denied", and "Failed".
        ...
        :param builtins.str last_update_time: lastUpdateTime is the time of the last update to this condition
        :param builtins.str message: message contains a human readable message with details about the request state
        :param builtins.str reason: reason indicates a brief reason for the request state
        """
        pulumi.set(__self__, "status", status)
...
class CertificateSigningRequestSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CertificateSigningRequestSpec contains the certificate request.
        :param builtins.str request: request contains an x509 certificate signing request encoded in a "CERTIFICATE REQUEST" PEM block. When serialized as JSON or YAML, the data is additionally base64-encoded.
        :param builtins.str signer_name: signerName indicates the requested signer, and is a qualified name.
        ...
        :param builtins.int expiration_seconds: expirationSeconds is the requested duration of validity of the issued certificate. The certificate signer may issue a certificate with a different validity duration so a client must check the delta between the notBefore and and notAfter fields in the issued certificate to determine the actual duration.
        ...
        :param Mapping[str, Sequence[builtins.str]] extra: extra contains extra attributes of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable.
        :param Sequence[builtins.str] groups: groups contains group membership of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable.
        :param builtins.str uid: uid contains the uid of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable.
        :param Sequence[builtins.str] usages: usages specifies a set of key usages requested in the issued certificate.
        ...
        :param builtins.str username: username contains the name of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable.
        """
...
class CertificateSigningRequestStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CertificateSigningRequestStatus contains conditions used to indicate approved/denied/failed status of the request, and the issued certificate.
        :param builtins.str certificate: certificate is populated with an issued certificate by the signer after an Approved condition is present. This field is set via the /status subresource. Once populated, this field is immutable.
