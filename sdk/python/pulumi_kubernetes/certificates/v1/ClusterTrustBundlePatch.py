...
class ClusterTrustBundlePatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['ClusterTrustBundleSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['ClusterTrustBundleSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['ClusterTrustBundleSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch")
class ClusterTrustBundlePatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ClusterTrustBundleSpecPatchArgs', 'ClusterTrustBundleSpecPatchArgsDict', 'outputs.ClusterTrustBundleSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ClusterTrustBundleSpecPatchArgs', 'ClusterTrustBundleSpecPatchArgsDict', 'outputs.ClusterTrustBundleSpecPatch']] spec: spec contains the signer (if any) and trust anchors.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:certificates.k8s.io/v1alpha1:ClusterTrustBundlePatch"), pulumi.Alias(type_="kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundlePatch")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ClusterTrustBundlePatch, __self__).__init__(
            'kubernetes:certificates.k8s.io/v1:ClusterTrustBundlePatch',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['ClusterTrustBundle']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
