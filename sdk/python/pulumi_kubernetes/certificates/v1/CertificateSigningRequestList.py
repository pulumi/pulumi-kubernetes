...
class CertificateSigningRequestList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CertificateSigningRequestArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['CertificateSigningRequestArgs']]]] items: items is a collection of CertificateSigningRequest objects
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.CertificateSigningRequest']]:
        """
