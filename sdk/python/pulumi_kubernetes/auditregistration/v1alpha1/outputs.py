...
class Policy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Policy defines the configuration of how audit events are logged
        :param builtins.str level: The Level that all requests are recorded at. available options: None, Metadata, Request, RequestResponse required
        :param Sequence[builtins.str] stages: Stages is a list of stages for which events are created.
        """
...
class WebhookThrottleConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        WebhookThrottleConfig holds the configuration for throttling events
        :param builtins.int burst: ThrottleBurst is the maximum number of events sent at the same moment default 15 QPS
        :param builtins.int qps: ThrottleQPS maximum number of batches per second default 10 QPS
        """
