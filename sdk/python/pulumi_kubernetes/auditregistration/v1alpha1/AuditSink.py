...
class AuditSink(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AuditSinkInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if spec is not None and not isinstance(spec, AuditSinkSpecArgs):
                spec = spec or {}
                def _setter(key, value):
                    spec[key] = value
                AuditSinkSpecArgs._configure(_setter, **spec)
