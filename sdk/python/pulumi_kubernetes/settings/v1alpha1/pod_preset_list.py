...
class PodPresetList(pulumi.CustomResource):
    ...
    Items is a list of schema objects.
      ...
      * `spec` (`dict`)
        * `env` (`list`) - Env defines the collection of EnvVar to inject into containers.
        ...
        * `env_from` (`list`) - EnvFrom defines the collection of EnvFromSource to inject into containers.
        ...
        * `selector` (`dict`) - Selector is a label query over a set of resources, in this case pods. Required.
        ...
        * `volume_mounts` (`list`) - VolumeMounts defines the collection of VolumeMount to inject into containers.
        ...
        * `volumes` (`list`) - Volumes defines the collection of Volume to inject into the pod.
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`)
            * `env` (`pulumi.Input[list]`) - Env defines the collection of EnvVar to inject into containers.
            ...
            * `env_from` (`pulumi.Input[list]`) - EnvFrom defines the collection of EnvFromSource to inject into containers.
            ...
            * `selector` (`pulumi.Input[dict]`) - Selector is a label query over a set of resources, in this case pods. Required.
            ...
            * `volume_mounts` (`pulumi.Input[list]`) - VolumeMounts defines the collection of VolumeMount to inject into containers.
            ...
            * `volumes` (`pulumi.Input[list]`) - Volumes defines the collection of Volume to inject into the pod.
    ...
    def get(resource_name, id, opts=None):
        ...
        return PodPresetList(resource_name, opts=opts, __props__=__props__)
