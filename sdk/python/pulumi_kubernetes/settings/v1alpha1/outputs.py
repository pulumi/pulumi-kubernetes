...
class PodPreset(dict):
    ...
    def __init__(__self__, *,
                 api_version: Optional[Literal['settings.k8s.io/v1alpha1']] = None,
                 kind: Optional[Literal['PodPreset']] = None,
                 metadata: Optional['_meta.v1.outputs.ObjectMeta'] = None,
                 spec: Optional['outputs.PodPresetSpec'] = None):
        """
        PodPreset is a policy resource that defines additional runtime requirements for a Pod.

        :param Literal['settings.k8s.io/v1alpha1'] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param Literal['PodPreset'] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
    ...
    def api_version(self) -> Optional[Literal['settings.k8s.io/v1alpha1']]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> Optional[Literal['PodPreset']]:
        """
