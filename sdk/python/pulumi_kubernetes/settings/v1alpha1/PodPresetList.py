...
class PodPresetList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PodPresetArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PodPresetArgs']]]] items: Items is a list of schema objects.
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.PodPreset']]:
        """
