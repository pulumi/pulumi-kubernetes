...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 enable_secret_mutable: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_server_side_apply: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 render_yaml_to_directory: Optional[pulumi.Input[builtins.str]] = None,
                 skip_update_unreachable: Optional[pulumi.Input[builtins.bool]] = None,
                 suppress_deprecation_warnings: Optional[pulumi.Input[builtins.bool]] = None,
                 suppress_helm_hook_warnings: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.str] cluster: If present, the name of the kubeconfig cluster to use.
        :param pulumi.Input[builtins.str] cluster_identifier: If present, this value will control the provider's replacement behavior. In particular, the provider will _only_ be replaced when `clusterIdentifier` changes; all other changes to provider configuration will be treated as updates.
        ...
        :param pulumi.Input[builtins.str] context: If present, the name of the kubeconfig context to use.
        :param pulumi.Input[builtins.bool] delete_unreachable: If present and set to true, the provider will delete resources associated with an unreachable Kubernetes cluster from Pulumi state
        :param pulumi.Input[builtins.bool] enable_config_map_mutable: BETA FEATURE - If present and set to true, allow ConfigMaps to be mutated.
               This feature is in developer preview, and is disabled by default.
               
               This config can be specified in the following ways using this precedence:
               1. This `enableConfigMapMutable` parameter.
               2. The `PULUMI_K8S_ENABLE_CONFIGMAP_MUTABLE` environment variable.
        :param pulumi.Input[builtins.bool] enable_secret_mutable: BETA FEATURE - If present and set to true, allow Secrets to be mutated.
               This feature is in developer preview, and is disabled by default.
               
               This config can be specified in the following ways using this precedence:
               1. This `enableSecretMutable` parameter.
               2. The `PULUMI_K8S_ENABLE_SECRET_MUTABLE` environment variable.
        :param pulumi.Input[builtins.bool] enable_server_side_apply: If present and set to false, disable Server-Side Apply mode.
        ...
        :param pulumi.Input[builtins.str] render_yaml_to_directory: BETA FEATURE - If present, render resource manifests to this directory. In this mode, resources will not
        ...
        :param pulumi.Input[builtins.bool] skip_update_unreachable: If present and set to true, the provider will skip resources update associated with an unreachable Kubernetes cluster from Pulumi state
        :param pulumi.Input[builtins.bool] suppress_deprecation_warnings: If present and set to true, suppress apiVersion deprecation warnings from the CLI.
        :param pulumi.Input[builtins.bool] suppress_helm_hook_warnings: If present and set to true, suppress unsupported Helm hook warnings from the CLI.
        """
    ...
    def enable_secret_mutable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_secret_mutable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_secret_mutable", value)

    @property
    @pulumi.getter(name="enableServerSideApply")
    def enable_server_side_apply(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_server_side_apply(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def render_yaml_to_directory(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def render_yaml_to_directory(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "render_yaml_to_directory", value)

    @property
    @pulumi.getter(name="skipUpdateUnreachable")
    def skip_update_unreachable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def skip_update_unreachable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "skip_update_unreachable", value)

    @property
    @pulumi.getter(name="suppressDeprecationWarnings")
    def suppress_deprecation_warnings(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def suppress_deprecation_warnings(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "suppress_deprecation_warnings", value)

    @property
    @pulumi.getter(name="suppressHelmHookWarnings")
    def suppress_helm_hook_warnings(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def suppress_helm_hook_warnings(self, value: Optional[pulumi.Input[builtins.bool]]):
