...
class RuntimeClassPatchArgs:
    ...
    def api_version(self) -> pulumi.Input[Optional[Literal['node.k8s.io/v1alpha1']]]:
        """
    ...
    @api_version.setter
    def api_version(self, value: pulumi.Input[Optional[Literal['node.k8s.io/v1alpha1']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['RuntimeClassSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['RuntimeClassSpecPatchArgs']]):
...
class RuntimeClassPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['RuntimeClassSpecPatchArgs', 'RuntimeClassSpecPatchArgsDict', 'outputs.RuntimeClassSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['RuntimeClassSpecPatchArgs', 'RuntimeClassSpecPatchArgsDict', 'outputs.RuntimeClassSpecPatch']] spec: Specification of the RuntimeClass More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Optional[Literal['node.k8s.io/v1alpha1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.RuntimeClassSpecPatch']]:
        """
        Specification of the RuntimeClass More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        return pulumi.get(self, "spec")
