...
class RuntimeClass(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 overhead: pulumi.Input[Optional[Union['OverheadArgs', 'OverheadArgsDict', 'outputs.Overhead']]] = None,
                 scheduling: pulumi.Input[Optional[Union['SchedulingArgs', 'SchedulingArgsDict', 'outputs.Scheduling']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['OverheadArgs', 'OverheadArgsDict', 'outputs.Overhead']] overhead: Overhead represents the resource overhead associated with running a pod for a given RuntimeClass. For more details, see https://git.k8s.io/enhancements/keps/sig-node/20190226-pod-overhead.md This field is alpha-level as of Kubernetes v1.15, and is only honored by servers that enable the PodOverhead feature.
        :param pulumi.Input[Union['SchedulingArgs', 'SchedulingArgsDict', 'outputs.Scheduling']] scheduling: Scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Literal['node.k8s.io/v1beta1']]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['RuntimeClass']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
