...
class CronJobArgsDict(TypedDict):
    ...
    """
    api_version: NotRequired[pulumi.Input[Optional[Literal['batch/v1beta1']]]]
    """
...
class CronJobSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] successful_jobs_history_limit: The number of successful finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified. Defaults to 3.
