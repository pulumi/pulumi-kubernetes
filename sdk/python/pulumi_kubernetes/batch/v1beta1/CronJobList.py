...
class CronJobList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CronJobArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['CronJobArgs']]]] items: items is the list of CronJobs.
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.CronJob']]:
        """
