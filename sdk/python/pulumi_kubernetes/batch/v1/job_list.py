...
class JobList(pulumi.CustomResource):
    ...
    items is the list of Jobs.
      ...
      * `spec` (`dict`) - Specification of the desired behavior of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      ...
      * `status` (`dict`) - Current status of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        * `active` (`float`) - The number of actively running pods.
        * `completion_time` (`str`) - Represents time when the job was completed. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.
        * `conditions` (`list`) - The latest available observations of an object's current state. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/
        ...
        * `failed` (`float`) - The number of pods which reached phase Failed.
        * `start_time` (`str`) - Represents time when the job was acknowledged by the job controller. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.
        * `succeeded` (`float`) - The number of pods which reached phase Succeeded.
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] items: items is the list of Jobs.
        ...
        The **items** object supports the following:
          ...
          * `status` (`pulumi.Input[dict]`) - Current status of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
            * `active` (`pulumi.Input[float]`) - The number of actively running pods.
            * `completion_time` (`pulumi.Input[str]`) - Represents time when the job was completed. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.
            * `conditions` (`pulumi.Input[list]`) - The latest available observations of an object's current state. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/
              * `lastProbeTime` (`pulumi.Input[str]`) - Last time the condition was checked.
              * `lastTransitionTime` (`pulumi.Input[str]`) - Last time the condition transit from one status to another.
              * `message` (`pulumi.Input[str]`) - Human readable message indicating details about last transition.
              * `reason` (`pulumi.Input[str]`) - (brief) reason for the condition's last transition.
              * `status` (`pulumi.Input[str]`) - Status of the condition, one of True, False, Unknown.
              * `type` (`pulumi.Input[str]`) - Type of job condition, Complete or Failed.

            * `failed` (`pulumi.Input[float]`) - The number of pods which reached phase Failed.
            * `start_time` (`pulumi.Input[str]`) - Represents time when the job was acknowledged by the job controller. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.
            * `succeeded` (`pulumi.Input[float]`) - The number of pods which reached phase Succeeded.
        ...
        super(JobList, __self__).__init__(
    ...
    def get(resource_name, id, opts=None):
        ...
        return JobList(resource_name, opts=opts, __props__=__props__)
