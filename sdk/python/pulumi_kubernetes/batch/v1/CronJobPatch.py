...
class CronJobPatchArgs:
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input['CronJobSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: Optional[pulumi.Input['CronJobSpecPatchArgs']]):
...
class CronJobPatch(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CronJobPatchArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if spec is not None and not isinstance(spec, CronJobSpecPatchArgs):
                spec = spec or {}
                def _setter(key, value):
                    spec[key] = value
                CronJobSpecPatchArgs._configure(_setter, **spec)
