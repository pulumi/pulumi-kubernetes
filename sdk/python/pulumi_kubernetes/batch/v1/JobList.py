...
class JobList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['JobArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['JobArgs']]]] items: items is the list of Jobs.
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.Job']]:
        """
