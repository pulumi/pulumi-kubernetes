...
class CronJobArgsDict(TypedDict):
    ...
    """
    api_version: NotRequired[pulumi.Input[Optional[Literal['batch/v2alpha1']]]]
    """
...
class CronJobArgs:
    ...
    def api_version(self) -> pulumi.Input[Optional[Literal['batch/v2alpha1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
    ...
    @api_version.setter
    def api_version(self, value: pulumi.Input[Optional[Literal['batch/v2alpha1']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['CronJobSpecArgs']]:
        """
        Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['CronJobSpecArgs']]):
...
class CronJobSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] failed_jobs_history_limit: The number of failed finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified.
        ...
        :param pulumi.Input[_builtins.int] successful_jobs_history_limit: The number of successful finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified.
...
class JobTemplateSpecArgs:
    def __init__(__self__, *,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 spec: pulumi.Input[Optional['_batch.v1.JobSpecArgs']] = None):
        """
        JobTemplateSpec describes the data a Job should have when created from a template
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['_batch.v1.JobSpecArgs']]:
        """
        Specification of the desired behavior of the job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        return pulumi.get(self, "spec")
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['_batch.v1.JobSpecArgs']]):
        pulumi.set(self, "spec", value)
...
class JobTemplateSpecPatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['_batch.v1.JobSpecPatchArgs']] = None):
        """
        JobTemplateSpec describes the data a Job should have when created from a template
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['_batch.v1.JobSpecPatchArgs']]:
        """
        Specification of the desired behavior of the job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        return pulumi.get(self, "spec")
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['_batch.v1.JobSpecPatchArgs']]):
        pulumi.set(self, "spec", value)
