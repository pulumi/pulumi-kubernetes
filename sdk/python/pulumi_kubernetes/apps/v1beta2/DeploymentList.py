...
class DeploymentList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['DeploymentArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['DeploymentArgs']]]] items: Items is the list of Deployments.
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.Deployment']]:
        """
