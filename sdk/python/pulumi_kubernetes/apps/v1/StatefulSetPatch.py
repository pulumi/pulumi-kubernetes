...
@pulumi.type_token("kubernetes:apps/v1:StatefulSetPatch")
class StatefulSetPatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:apps/v1beta1:StatefulSetPatch"), pulumi.Alias(type_="kubernetes:apps/v1beta2:StatefulSetPatch")])
