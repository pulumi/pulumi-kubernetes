...
__all__ = ['DeploymentInitArgs', 'Deployment']
...
class Deployment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['DeploymentSpecArgs', 'DeploymentSpecArgsDict', 'outputs.DeploymentSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['DeploymentSpecArgs', 'DeploymentSpecArgsDict', 'outputs.DeploymentSpec']] spec: Specification of the desired behavior of the Deployment.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DeploymentInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DeploymentInitArgs.__new__(DeploymentInitArgs)
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['Deployment']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.DeploymentSpec']:
        """
        Specification of the desired behavior of the Deployment.
        """
        return pulumi.get(self, "spec")
