...
class ControllerRevisionList(pulumi.CustomResource):
    ...
    Items is the list of ControllerRevisions
      ...
      * `data` (`dict`) - Data is the serialized representation of the state.
      ...
      * `revision` (`float`) - Revision indicates the revision of the state represented by Data.
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] items: Items is the list of ControllerRevisions
        ...
        The **items** object supports the following:
          ...
          * `revision` (`pulumi.Input[float]`) - Revision indicates the revision of the state represented by Data.
