...
__all__ = ['StatefulSetListArgs', 'StatefulSetList']

@pulumi.input_type
class StatefulSetListArgs:
    def __init__(__self__, *,
                 items: pulumi.Input[Sequence[pulumi.Input['StatefulSetArgs']]],
    ...
    @items.setter
    def items(self, value: pulumi.Input[Sequence[pulumi.Input['StatefulSetArgs']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['StatefulSetList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['StatefulSetList']]]):
...
class StatefulSetList(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(StatefulSetListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = StatefulSetListArgs.__new__(StatefulSetListArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'StatefulSetList':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['StatefulSetList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
