...
class StatefulSet(pulumi.CustomResource):
    ...
    Spec defines the desired identities of pods in this set.
      ...
      * `selector` (`dict`) - selector is a label query over pods that should match the replica count. If empty, defaulted to labels on the pod template. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
      ...
      * `update_strategy` (`dict`) - updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template.
        * `rolling_update` (`dict`) - RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType.
          * `partition` (`float`) - Partition indicates the ordinal at which the StatefulSet should be partitioned.
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, kind=None, metadata=None, spec=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **spec** object supports the following:
          ...
          * `selector` (`pulumi.Input[dict]`) - selector is a label query over pods that should match the replica count. If empty, defaulted to labels on the pod template. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
          ...
          * `update_strategy` (`pulumi.Input[dict]`) - updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template.
            * `rolling_update` (`pulumi.Input[dict]`) - RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType.
              * `partition` (`pulumi.Input[float]`) - Partition indicates the ordinal at which the StatefulSet should be partitioned.

            * `type` (`pulumi.Input[str]`) - Type indicates the type of the StatefulSetUpdateStrategy.
