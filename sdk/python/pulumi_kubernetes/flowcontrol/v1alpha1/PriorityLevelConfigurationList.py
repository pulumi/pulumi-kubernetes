...
class PriorityLevelConfigurationList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PriorityLevelConfigurationArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PriorityLevelConfigurationArgs']]]] items: `items` is a list of request-priorities.
        ...
        if opts.id is None:
            ...
            __props__['kind'] = 'PriorityLevelConfigurationList'
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.PriorityLevelConfiguration']]:
        """
