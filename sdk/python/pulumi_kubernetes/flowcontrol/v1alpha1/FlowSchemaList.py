...
class FlowSchemaList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['FlowSchemaArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['FlowSchemaArgs']]]] items: `items` is a list of FlowSchemas.
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.FlowSchema']]:
        """
