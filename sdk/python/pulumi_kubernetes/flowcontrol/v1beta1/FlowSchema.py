...
__all__ = ['FlowSchemaArgs', 'FlowSchema']
...
class FlowSchema(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FlowSchemaArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        FlowSchema defines the schema of a group of flows. Note that a flow is made up of a set of inbound API requests with similar attributes and is identified by a pair of strings: the name of the FlowSchema and a "flow distinguisher".

        :param str resource_name: The name of the resource.
        :param FlowSchemaArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FlowSchemaArgs, pulumi.ResourceOptions, *args, **kwargs)
