...
__all__ = ['PriorityLevelConfigurationArgs', 'PriorityLevelConfiguration']
...
class PriorityLevelConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[PriorityLevelConfigurationArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        PriorityLevelConfiguration represents the configuration of a priority level.

        :param str resource_name: The name of the resource.
        :param PriorityLevelConfigurationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PriorityLevelConfigurationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PriorityLevelConfigurationArgs.__new__(PriorityLevelConfigurationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfiguration")])
