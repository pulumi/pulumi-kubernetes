...
class LeaseList(pulumi.CustomResource):
    ...
    Items is a list of schema objects.
      ...
      * `spec` (`dict`) - Specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        * `acquire_time` (`str`) - acquireTime is a time when the current lease was acquired.
        * `holder_identity` (`str`) - holderIdentity contains the identity of the holder of a current lease.
        * `lease_duration_seconds` (`float`) - leaseDurationSeconds is a duration that candidates for a lease need to wait to force acquire it. This is measure against time of last observed RenewTime.
        * `lease_transitions` (`float`) - leaseTransitions is the number of transitions of a lease between holders.
        * `renew_time` (`str`) - renewTime is a time when the current holder of a lease has last updated the lease.
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - Specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
            * `acquire_time` (`pulumi.Input[str]`) - acquireTime is a time when the current lease was acquired.
            * `holder_identity` (`pulumi.Input[str]`) - holderIdentity contains the identity of the holder of a current lease.
            * `lease_duration_seconds` (`pulumi.Input[float]`) - leaseDurationSeconds is a duration that candidates for a lease need to wait to force acquire it. This is measure against time of last observed RenewTime.
            * `lease_transitions` (`pulumi.Input[float]`) - leaseTransitions is the number of transitions of a lease between holders.
            * `renew_time` (`pulumi.Input[str]`) - renewTime is a time when the current holder of a lease has last updated the lease.
