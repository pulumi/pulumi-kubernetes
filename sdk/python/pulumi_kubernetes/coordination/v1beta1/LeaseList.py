...
class LeaseList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['LeaseArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['LeaseArgs']]]] items: Items is a list of schema objects.
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.Lease']]:
        """
