...
class LeaseArgsDict(TypedDict):
    ...
    """
    api_version: NotRequired[pulumi.Input[Optional[Literal['coordination.k8s.io/v1beta1']]]]
    """
...
class LeaseCandidateArgsDict(TypedDict):
    ...
    """
    spec: pulumi.Input['LeaseCandidateSpecArgsDict']
    """
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: NotRequired[pulumi.Input[Optional[Literal['LeaseCandidate']]]]
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    """
    metadata: NotRequired[pulumi.Input[Optional['_meta.v1.ObjectMetaArgsDict']]]
...
class LeaseCandidateArgs:
    def __init__(__self__, *,
                 spec: pulumi.Input['LeaseCandidateSpecArgs'],
                 api_version: pulumi.Input[Optional[Literal['coordination.k8s.io/v1beta1']]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input['LeaseCandidateSpecArgs']:
        """
        spec contains the specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        return pulumi.get(self, "spec")
    ...
    @spec.setter
    def spec(self, value: pulumi.Input['LeaseCandidateSpecArgs']):
        pulumi.set(self, "spec", value)
