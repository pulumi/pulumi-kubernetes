...
@pulumi.type_token("kubernetes:coordination.k8s.io/v1beta1:LeaseCandidate")
class LeaseCandidate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['LeaseCandidateSpecArgs', 'LeaseCandidateSpecArgsDict', 'outputs.LeaseCandidateSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['LeaseCandidateSpecArgs', 'LeaseCandidateSpecArgsDict', 'outputs.LeaseCandidateSpec']] spec: spec contains the specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: LeaseCandidateInitArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        LeaseCandidate defines a candidate for a Lease object. Candidates are created such that coordinated leader election will pick the best leader from the list of candidates.
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['LeaseCandidate']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
