...
class Lease(dict):
    ...
    def __init__(__self__, *,
                 api_version: Optional[Literal['coordination.k8s.io/v1']] = None,
    ...
    def api_version(self) -> Optional[Literal['coordination.k8s.io/v1']]:
        """
...
class LeaseSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 preferred_holder: Optional[_builtins.str] = None,
