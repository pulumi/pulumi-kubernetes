...
if not MYPY:
    class LeaseSpecPatchArgsDict(TypedDict):
        ...
        """
        preferred_holder: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LeaseSpecPatchArgs:
    def __init__(__self__, *,
                 ...
                 preferred_holder: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] holder_identity: holderIdentity contains the identity of the holder of a current lease. If Coordinated Leader Election is used, the holder identity must be equal to the elected LeaseCandidate.metadata.name field.
        :param pulumi.Input[builtins.int] lease_duration_seconds: leaseDurationSeconds is a duration that candidates for a lease need to wait to force acquire it. This is measured against the time of last observed renewTime.
        ...
        :param pulumi.Input[builtins.str] preferred_holder: PreferredHolder signals to a lease holder that the lease has a more optimal holder and should be given up. This field can only be set if Strategy is also set.
        ...
        :param pulumi.Input[builtins.str] strategy: Strategy indicates the strategy for picking the leader for coordinated leader election. If the field is not specified, there is no active coordination for this lease. (Alpha) Using this field requires the CoordinatedLeaderElection feature gate to be enabled.
        """
    ...
    def preferred_holder(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        PreferredHolder signals to a lease holder that the lease has a more optimal holder and should be given up. This field can only be set if Strategy is also set.
        """
    ...
    def preferred_holder(self, value: Optional[pulumi.Input[builtins.str]]):
