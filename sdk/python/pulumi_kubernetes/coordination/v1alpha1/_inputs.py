...
if not MYPY:
    class LeaseCandidateSpecPatchArgsDict(TypedDict):
        ...
        """
        preferred_strategies: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class LeaseCandidateSpecPatchArgs:
    def __init__(__self__, *,
                 ...
                 preferred_strategies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 renew_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        LeaseCandidateSpec is a specification of a Lease.
        :param pulumi.Input[builtins.str] binary_version: BinaryVersion is the binary version. It must be in a semver format without leading `v`. This field is required when strategy is "OldestEmulationVersion"
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] preferred_strategies: PreferredStrategies indicates the list of strategies for picking the leader for coordinated leader election. The list is ordered, and the first strategy supersedes all other strategies. The list is used by coordinated leader election to make a decision about the final election strategy. This follows as - If all clients have strategy X as the first element in this list, strategy X will be used. - If a candidate has strategy [X] and another candidate has strategy [Y, X], Y supersedes X and strategy Y
                 will be used.
               - If a candidate has strategy [X, Y] and another candidate has strategy [Y, X], this is a user error and leader
                 election will not operate the Lease until resolved.
               (Alpha) Using this field requires the CoordinatedLeaderElection feature gate to be enabled.
    ...
    def preferred_strategies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        PreferredStrategies indicates the list of strategies for picking the leader for coordinated leader election. The list is ordered, and the first strategy supersedes all other strategies. The list is used by coordinated leader election to make a decision about the final election strategy. This follows as - If all clients have strategy X as the first element in this list, strategy X will be used. - If a candidate has strategy [X] and another candidate has strategy [Y, X], Y supersedes X and strategy Y
          will be used.
        - If a candidate has strategy [X, Y] and another candidate has strategy [Y, X], this is a user error and leader
    ...
    def preferred_strategies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class LeaseCandidateSpecArgsDict(TypedDict):
        ...
        LeaseName is the name of the lease for which this candidate is contending. This field is immutable.
        """
        preferred_strategies: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        PreferredStrategies indicates the list of strategies for picking the leader for coordinated leader election. The list is ordered, and the first strategy supersedes all other strategies. The list is used by coordinated leader election to make a decision about the final election strategy. This follows as - If all clients have strategy X as the first element in this list, strategy X will be used. - If a candidate has strategy [X] and another candidate has strategy [Y, X], Y supersedes X and strategy Y
          will be used.
        - If a candidate has strategy [X, Y] and another candidate has strategy [Y, X], this is a user error and leader
...
class LeaseCandidateSpecArgs:
    ...
    @property
    @pulumi.getter(name="preferredStrategies")
    def preferred_strategies(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        PreferredStrategies indicates the list of strategies for picking the leader for coordinated leader election. The list is ordered, and the first strategy supersedes all other strategies. The list is used by coordinated leader election to make a decision about the final election strategy. This follows as - If all clients have strategy X as the first element in this list, strategy X will be used. - If a candidate has strategy [X] and another candidate has strategy [Y, X], Y supersedes X and strategy Y
          will be used.
        - If a candidate has strategy [X, Y] and another candidate has strategy [Y, X], this is a user error and leader
    ...
    @preferred_strategies.setter
    def preferred_strategies(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "preferred_strategies", value)
