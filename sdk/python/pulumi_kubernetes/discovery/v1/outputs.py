...
class EndpointSlice(dict):
    ...
    def __init__(__self__, *,
                 ...
                 api_version: Optional[Literal['discovery.k8s.io/v1']] = None,
    ...
    def api_version(self) -> Optional[Literal['discovery.k8s.io/v1']]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> Optional[Sequence['outputs.Endpoint']]:
        """
