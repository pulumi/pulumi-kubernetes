...
class EndpointSlicePatchArgs:
    def __init__(__self__, *,
                 ...
                 api_version: pulumi.Input[Optional[Literal['discovery.k8s.io/v1']]] = None,
    ...
    def api_version(self) -> pulumi.Input[Optional[Literal['discovery.k8s.io/v1']]]:
        """
    ...
    @api_version.setter
    def api_version(self, value: pulumi.Input[Optional[Literal['discovery.k8s.io/v1']]]):
...
@pulumi.type_token("kubernetes:discovery.k8s.io/v1:EndpointSlicePatch")
class EndpointSlicePatch(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Optional[Literal['discovery.k8s.io/v1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
