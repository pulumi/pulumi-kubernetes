...
class EndpointPort(dict):
    ...
    def __init__(__self__, *,
        ...
        :param float port: The port number of the endpoint. If this is not specified, ports are not restricted and must be interpreted in the context of the specific consumer.
