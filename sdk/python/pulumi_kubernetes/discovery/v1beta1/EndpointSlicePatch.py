...
class EndpointSlicePatchArgs:
    def __init__(__self__, *,
                 ...
                 endpoints: pulumi.Input[Optional[Sequence[pulumi.Input['EndpointPatchArgs']]]] = None,
                 kind: pulumi.Input[Optional[Literal['EndpointSlice']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaPatchArgs']] = None,
                 ports: pulumi.Input[Optional[Sequence[pulumi.Input['EndpointPortPatchArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Literal['EndpointSlice']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EndpointPatchArgs']]]]:
        """
    ...
    @endpoints.setter
    def endpoints(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EndpointPatchArgs']]]]):
        pulumi.set(self, "endpoints", value)

    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['EndpointSlice']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['EndpointSlice']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def ports(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EndpointPortPatchArgs']]]]:
        """
    ...
    @ports.setter
    def ports(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EndpointPortPatchArgs']]]]):
...
class EndpointSlicePatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 address_type: pulumi.Input[Optional[_builtins.str]] = None,
                 api_version: pulumi.Input[Optional[Literal['discovery.k8s.io/v1beta1']]] = None,
                 endpoints: pulumi.Input[Optional[Sequence[pulumi.Input[Union['EndpointPatchArgs', 'EndpointPatchArgsDict', 'outputs.EndpointPatch']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['EndpointSlice']]] = None,
                 ...
                 ports: pulumi.Input[Optional[Sequence[pulumi.Input[Union['EndpointPortPatchArgs', 'EndpointPortPatchArgsDict', 'outputs.EndpointPortPatch']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] address_type: addressType specifies the type of address carried by this EndpointSlice. All addresses in this slice must be the same type. This field is immutable after creation. The following address types are currently supported: * IPv4: Represents an IPv4 Address. * IPv6: Represents an IPv6 Address. * FQDN: Represents a Fully Qualified Domain Name.
        :param pulumi.Input[Literal['discovery.k8s.io/v1beta1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['EndpointPatchArgs', 'EndpointPatchArgsDict', 'outputs.EndpointPatch']]]] endpoints: endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints.
        :param pulumi.Input[Literal['EndpointSlice']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['EndpointPortPatchArgs', 'EndpointPortPatchArgsDict', 'outputs.EndpointPortPatch']]]] ports: ports specifies the list of network ports exposed by each endpoint in this slice. Each port must have a unique name. When ports is empty, it indicates that there are no defined ports. When a port is defined with a nil port value, it indicates "all ports". Each slice may include a maximum of 100 ports.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter(name="apiVersion")
    def api_version(self) -> pulumi.Output[Optional[Literal['discovery.k8s.io/v1beta1']]]:
        """
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        """
        return pulumi.get(self, "api_version")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['EndpointSlice']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
