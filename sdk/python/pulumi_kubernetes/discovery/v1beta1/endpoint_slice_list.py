...
class EndpointSliceList(pulumi.CustomResource):
    ...
    List of endpoint slices
      ...
      * `endpoints` (`list`) - endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints.
        * `addresses` (`list`) - addresses of this endpoint. The contents of this field are interpreted according to the corresponding EndpointSlice addressType field. Consumers must handle different types of addresses in the context of their own capabilities. This must contain at least one address but no more than 100.
        * `conditions` (`dict`) - conditions contains information about the current status of the endpoint.
        ...
        * `targetRef` (`dict`) - targetRef is a reference to a Kubernetes object that represents this endpoint.
        ...
        * `topology` (`dict`) - topology contains arbitrary topology information associated with the endpoint. These key/value pairs must conform with the label format. https://kubernetes.io/docs/concepts/overview/working-with-objects/labels Topology may include a maximum of 16 key/value pairs. This includes, but is not limited to the following well known keys: * kubernetes.io/hostname: the value indicates the hostname of the node
      ...
      * `ports` (`list`) - ports specifies the list of network ports exposed by each endpoint in this slice. Each port must have a unique name. When ports is empty, it indicates that there are no defined ports. When a port is defined with a nil port value, it indicates "all ports". Each slice may include a maximum of 100 ports.
        ...
        * `port` (`float`) - The port number of the endpoint. If this is not specified, ports are not restricted and must be interpreted in the context of the specific consumer.
        * `protocol` (`str`) - The IP protocol for this port. Must be UDP, TCP, or SCTP. Default is TCP.
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `endpoints` (`pulumi.Input[list]`) - endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints.
            ...
            * `conditions` (`pulumi.Input[dict]`) - conditions contains information about the current status of the endpoint.
              * `ready` (`pulumi.Input[bool]`) - ready indicates that this endpoint is prepared to receive traffic, according to whatever system is managing the endpoint. A nil value indicates an unknown state. In most cases consumers should interpret this unknown state as ready.

            * `hostname` (`pulumi.Input[str]`) - hostname of this endpoint. This field may be used by consumers of endpoints to distinguish endpoints from each other (e.g. in DNS names). Multiple endpoints which use the same hostname should be considered fungible (e.g. multiple A values in DNS). Must pass DNS Label (RFC 1123) validation.
            * `targetRef` (`pulumi.Input[dict]`) - targetRef is a reference to a Kubernetes object that represents this endpoint.
            ...
            * `topology` (`pulumi.Input[dict]`) - topology contains arbitrary topology information associated with the endpoint. These key/value pairs must conform with the label format. https://kubernetes.io/docs/concepts/overview/working-with-objects/labels Topology may include a maximum of 16 key/value pairs. This includes, but is not limited to the following well known keys: * kubernetes.io/hostname: the value indicates the hostname of the node
                where the endpoint is located. This should match the corresponding
                node label.
              * topology.kubernetes.io/zone: the value indicates the zone where the
                endpoint is located. This should match the corresponding node label.
          ...
          * `ports` (`pulumi.Input[list]`) - ports specifies the list of network ports exposed by each endpoint in this slice. Each port must have a unique name. When ports is empty, it indicates that there are no defined ports. When a port is defined with a nil port value, it indicates "all ports". Each slice may include a maximum of 100 ports.
            ...
            * `port` (`pulumi.Input[float]`) - The port number of the endpoint. If this is not specified, ports are not restricted and must be interpreted in the context of the specific consumer.
            * `protocol` (`pulumi.Input[str]`) - The IP protocol for this port. Must be UDP, TCP, or SCTP. Default is TCP.
        ...
        super(EndpointSliceList, __self__).__init__(
    ...
    def get(resource_name, id, opts=None):
        ...
        return EndpointSliceList(resource_name, opts=opts, __props__=__props__)
