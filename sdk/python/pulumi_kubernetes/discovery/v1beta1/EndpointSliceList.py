...
class EndpointSliceList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['EndpointSliceArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['EndpointSliceArgs']]]] items: List of endpoint slices
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.EndpointSlice']]:
        """
