...
class NetworkPolicyListArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['NetworkPolicyList']]] = None,
        ...
        :param pulumi.Input[Literal['NetworkPolicyList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['NetworkPolicyList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['NetworkPolicyList']]]):
...
class NetworkPolicyList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: pulumi.Input[Optional[Literal['networking.k8s.io/v1']]] = None,
                 items: pulumi.Input[Optional[Sequence[pulumi.Input[Union['NetworkPolicyArgs', 'NetworkPolicyArgsDict', 'outputs.NetworkPolicy']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['NetworkPolicyList']]] = None,
        ...
        :param pulumi.Input[Literal['networking.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['NetworkPolicyArgs', 'NetworkPolicyArgsDict', 'outputs.NetworkPolicy']]]] items: items is a list of schema objects.
        :param pulumi.Input[Literal['NetworkPolicyList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NetworkPolicyListArgs.__new__(NetworkPolicyListArgs)

            __props__.__dict__["api_version"] = 'networking.k8s.io/v1'
            if items is None and not opts.urn:
                raise TypeError("Missing required property 'items'")
            __props__.__dict__["items"] = items
            __props__.__dict__["kind"] = 'NetworkPolicyList'
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['NetworkPolicyList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
