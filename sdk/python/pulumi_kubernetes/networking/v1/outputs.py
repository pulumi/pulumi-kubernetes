...
class NetworkPolicyPort(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        NetworkPolicyPort describes a port to allow traffic on
        :param int end_port: If set, indicates that the range of ports from port to endPort, inclusive, should be allowed by the policy. This field cannot be defined if the port field is not defined or if the port field is defined as a named (string) port. The endPort must be equal or greater than port.
