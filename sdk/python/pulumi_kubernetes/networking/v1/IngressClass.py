...
@pulumi.type_token("kubernetes:networking.k8s.io/v1:IngressClass")
class IngressClass(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['IngressClassSpecArgs', 'IngressClassSpecArgsDict', 'outputs.IngressClassSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['IngressClassSpecArgs', 'IngressClassSpecArgsDict', 'outputs.IngressClassSpec']] spec: spec is the desired state of the IngressClass. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['IngressClass']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
