...
@pulumi.type_token("kubernetes:networking.k8s.io/v1:ServiceCIDR")
class ServiceCIDR(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ServiceCIDRSpecArgs', 'ServiceCIDRSpecArgsDict', 'outputs.ServiceCIDRSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ServiceCIDRSpecArgs', 'ServiceCIDRSpecArgsDict', 'outputs.ServiceCIDRSpec']] spec: spec is the desired state of the ServiceCIDR. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:networking.k8s.io/v1alpha1:ServiceCIDR"), pulumi.Alias(type_="kubernetes:networking.k8s.io/v1beta1:ServiceCIDR")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ServiceCIDR']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
