...
class ServiceCIDRPatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['ServiceCIDRSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['ServiceCIDRSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['ServiceCIDRSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:networking.k8s.io/v1:ServiceCIDRPatch")
class ServiceCIDRPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ServiceCIDRSpecPatchArgs', 'ServiceCIDRSpecPatchArgsDict', 'outputs.ServiceCIDRSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ServiceCIDRSpecPatchArgs', 'ServiceCIDRSpecPatchArgsDict', 'outputs.ServiceCIDRSpecPatch']] spec: spec is the desired state of the ServiceCIDR. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:networking.k8s.io/v1alpha1:ServiceCIDRPatch"), pulumi.Alias(type_="kubernetes:networking.k8s.io/v1beta1:ServiceCIDRPatch")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['ServiceCIDR']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
