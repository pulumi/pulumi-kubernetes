...
class IPAddressPatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['IPAddressSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['IPAddressSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['IPAddressSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:networking.k8s.io/v1:IPAddressPatch")
class IPAddressPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['IPAddressSpecPatchArgs', 'IPAddressSpecPatchArgsDict', 'outputs.IPAddressSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['IPAddressSpecPatchArgs', 'IPAddressSpecPatchArgsDict', 'outputs.IPAddressSpecPatch']] spec: spec is the desired state of the IPAddress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['IPAddress']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
