...
class ServiceCIDRListArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['ServiceCIDRList']]] = None,
        ...
        :param pulumi.Input[Literal['ServiceCIDRList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ServiceCIDRList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ServiceCIDRList']]]):
...
@pulumi.type_token("kubernetes:networking.k8s.io/v1alpha1:ServiceCIDRList")
class ServiceCIDRList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: pulumi.Input[Optional[Literal['networking.k8s.io/v1alpha1']]] = None,
                 items: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServiceCIDRArgs', 'ServiceCIDRArgsDict', 'outputs.ServiceCIDR']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['ServiceCIDRList']]] = None,
        ...
        :param pulumi.Input[Literal['networking.k8s.io/v1alpha1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['ServiceCIDRArgs', 'ServiceCIDRArgsDict', 'outputs.ServiceCIDR']]]] items: items is the list of ServiceCIDRs.
        :param pulumi.Input[Literal['ServiceCIDRList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ServiceCIDRList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
