...
class EventPatchArgs:
    def __init__(__self__, *,
                 ...
                 involved_object: pulumi.Input[Optional['ObjectReferencePatchArgs']] = None,
                 ...
                 related: pulumi.Input[Optional['ObjectReferencePatchArgs']] = None,
                 ...
                 source: pulumi.Input[Optional['EventSourcePatchArgs']] = None,
    ...
    def first_timestamp(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def first_timestamp(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "first_timestamp", value)

    @_builtins.property
    @pulumi.getter(name="involvedObject")
    def involved_object(self) -> pulumi.Input[Optional['ObjectReferencePatchArgs']]:
        """
    ...
    def involved_object(self, value: pulumi.Input[Optional['ObjectReferencePatchArgs']]):
    ...
    def last_timestamp(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def last_timestamp(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def related(self) -> pulumi.Input[Optional['ObjectReferencePatchArgs']]:
        """
    ...
    @related.setter
    def related(self, value: pulumi.Input[Optional['ObjectReferencePatchArgs']]):
        pulumi.set(self, "related", value)

    @_builtins.property
    @pulumi.getter(name="reportingComponent")
    def reporting_component(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def reporting_component(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def source(self) -> pulumi.Input[Optional['EventSourcePatchArgs']]:
        """
    ...
    @source.setter
    def source(self, value: pulumi.Input[Optional['EventSourcePatchArgs']]):
...
@pulumi.type_token("kubernetes:core/v1:EventPatch")
class EventPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 event_time: pulumi.Input[Optional[_builtins.str]] = None,
                 first_timestamp: pulumi.Input[Optional[_builtins.str]] = None,
                 involved_object: pulumi.Input[Optional[Union['ObjectReferencePatchArgs', 'ObjectReferencePatchArgsDict', 'outputs.ObjectReferencePatch']]] = None,
                 kind: pulumi.Input[Optional[Literal['Event']]] = None,
                 last_timestamp: pulumi.Input[Optional[_builtins.str]] = None,
                 message: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 reason: pulumi.Input[Optional[_builtins.str]] = None,
                 related: pulumi.Input[Optional[Union['ObjectReferencePatchArgs', 'ObjectReferencePatchArgsDict', 'outputs.ObjectReferencePatch']]] = None,
                 reporting_component: pulumi.Input[Optional[_builtins.str]] = None,
                 reporting_instance: pulumi.Input[Optional[_builtins.str]] = None,
                 series: pulumi.Input[Optional[Union['EventSeriesPatchArgs', 'EventSeriesPatchArgsDict', 'outputs.EventSeriesPatch']]] = None,
                 source: pulumi.Input[Optional[Union['EventSourcePatchArgs', 'EventSourcePatchArgsDict', 'outputs.EventSourcePatch']]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] event_time: Time when this Event was first observed.
        :param pulumi.Input[_builtins.str] first_timestamp: The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)
        :param pulumi.Input[Union['ObjectReferencePatchArgs', 'ObjectReferencePatchArgsDict', 'outputs.ObjectReferencePatch']] involved_object: The object that this event is about.
        :param pulumi.Input[Literal['Event']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        :param pulumi.Input[_builtins.str] last_timestamp: The time at which the most recent occurrence of this event was recorded.
        :param pulumi.Input[_builtins.str] message: A human-readable description of the status of this operation.
        ...
        :param pulumi.Input[_builtins.str] reason: This should be a short, machine understandable string that gives the reason for the transition into the object's current status.
        :param pulumi.Input[Union['ObjectReferencePatchArgs', 'ObjectReferencePatchArgsDict', 'outputs.ObjectReferencePatch']] related: Optional secondary object for more complex actions.
        :param pulumi.Input[_builtins.str] reporting_component: Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.
        :param pulumi.Input[_builtins.str] reporting_instance: ID of the controller instance, e.g. `kubelet-xyzf`.
        ...
        :param pulumi.Input[Union['EventSourcePatchArgs', 'EventSourcePatchArgsDict', 'outputs.EventSourcePatch']] source: The component reporting this event. Should be a short machine understandable string.
        :param pulumi.Input[_builtins.str] type: Type of this event (Normal, Warning), new types could be added in the future
        """
        ...
    @overload
    ...
    @_builtins.property
    @pulumi.getter(name="firstTimestamp")
    def first_timestamp(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)
        """
        return pulumi.get(self, "first_timestamp")
    ...
    @_builtins.property
    @pulumi.getter(name="lastTimestamp")
    def last_timestamp(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The time at which the most recent occurrence of this event was recorded.
        """
        return pulumi.get(self, "last_timestamp")
    ...
    @_builtins.property
    @pulumi.getter(name="reportingComponent")
    def reporting_component(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.
        """
        return pulumi.get(self, "reporting_component")
