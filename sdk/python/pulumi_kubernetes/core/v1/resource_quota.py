...
class ResourceQuota(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, kind=None, metadata=None, spec=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[dict] spec: Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        ...
        super(ResourceQuota, __self__).__init__(
    ...
    def get(resource_name, id, opts=None):
        ...
        return ResourceQuota(resource_name, opts=opts, __props__=__props__)
