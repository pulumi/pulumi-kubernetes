...
class ComponentStatusList(pulumi.CustomResource):
    ...
    List of ComponentStatus objects.
      ...
      * `conditions` (`list`) - List of component conditions observed
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **items** object supports the following:
          ...
          * `conditions` (`pulumi.Input[list]`) - List of component conditions observed
            * `error` (`pulumi.Input[str]`) - Condition error code for a component. For example, a health check error code.
            * `message` (`pulumi.Input[str]`) - Message about the condition for a component. For example, information about a health check.
            * `status` (`pulumi.Input[str]`) - Status of the condition for a component. Valid values for "Healthy": "True", "False", or "Unknown".
            * `type` (`pulumi.Input[str]`) - Type of condition for a component. Valid value: "Healthy"
