...
class PersistentVolumeList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PersistentVolumeArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PersistentVolumeArgs']]]] items: List of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.PersistentVolume']]:
        """
