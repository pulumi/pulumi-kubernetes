...
class BindingPatchArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['Binding']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaPatchArgs']] = None,
                 target: pulumi.Input[Optional['ObjectReferencePatchArgs']] = None):
        """
        ...
        :param pulumi.Input[Literal['Binding']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        ...
        :param pulumi.Input['ObjectReferencePatchArgs'] target: The target object that you want to bind to the standard object.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['Binding']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['Binding']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def target(self) -> pulumi.Input[Optional['ObjectReferencePatchArgs']]:
        """
    ...
    @target.setter
    def target(self, value: pulumi.Input[Optional['ObjectReferencePatchArgs']]):
...
class BindingPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 target: pulumi.Input[Optional[Union['ObjectReferencePatchArgs', 'ObjectReferencePatchArgsDict', 'outputs.ObjectReferencePatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ObjectReferencePatchArgs', 'ObjectReferencePatchArgsDict', 'outputs.ObjectReferencePatch']] target: The target object that you want to bind to the standard object.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['Binding']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def target(self) -> pulumi.Output[Optional['outputs.ObjectReferencePatch']]:
        """
        The target object that you want to bind to the standard object.
        """
        return pulumi.get(self, "target")
