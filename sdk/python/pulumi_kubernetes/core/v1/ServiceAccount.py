...
class ServiceAccount(pulumi.CustomResource):
    ...
    """
    def __init__(self, __name__, __opts__=None, automountServiceAccountToken=None, imagePullSecrets=None, metadata=None, secrets=None):
        if not __name__:
        ...
        if automountServiceAccountToken and not isinstance(automountServiceAccountToken, boolean):
        ...
        """
        __props__['automountServiceAccountToken'] = automountServiceAccountToken

        if imagePullSecrets and not isinstance(imagePullSecrets, list):
        ...
        """
        __props__['imagePullSecrets'] = imagePullSecrets
