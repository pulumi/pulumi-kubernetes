...
class ServiceAccountInitArgs:
    def __init__(__self__, *,
                 ...
                 image_pull_secrets: pulumi.Input[Optional[Sequence[pulumi.Input['LocalObjectReferenceArgs']]]] = None,
                 kind: pulumi.Input[Optional[Literal['ServiceAccount']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 secrets: pulumi.Input[Optional[Sequence[pulumi.Input['ObjectReferenceArgs']]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.bool] automount_service_account_token: AutomountServiceAccountToken indicates whether pods running as this service account should have an API token automatically mounted. Can be overridden at the pod level.
        ...
        :param pulumi.Input[Literal['ServiceAccount']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def image_pull_secrets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LocalObjectReferenceArgs']]]]:
        """
    ...
    def image_pull_secrets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LocalObjectReferenceArgs']]]]):
        pulumi.set(self, "image_pull_secrets", value)

    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['ServiceAccount']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['ServiceAccount']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def secrets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ObjectReferenceArgs']]]]:
        """
    ...
    @secrets.setter
    def secrets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ObjectReferenceArgs']]]]):
        pulumi.set(self, "secrets", value)


@pulumi.type_token("kubernetes:core/v1:ServiceAccount")
class ServiceAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: pulumi.Input[Optional[Literal['v1']]] = None,
                 automount_service_account_token: pulumi.Input[Optional[_builtins.bool]] = None,
                 image_pull_secrets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LocalObjectReferenceArgs', 'LocalObjectReferenceArgsDict', 'outputs.LocalObjectReference']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['ServiceAccount']]] = None,
                 ...
                 secrets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ObjectReferenceArgs', 'ObjectReferenceArgsDict', 'outputs.ObjectReference']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Literal['v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[_builtins.bool] automount_service_account_token: AutomountServiceAccountToken indicates whether pods running as this service account should have an API token automatically mounted. Can be overridden at the pod level.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LocalObjectReferenceArgs', 'LocalObjectReferenceArgsDict', 'outputs.LocalObjectReference']]]] image_pull_secrets: ImagePullSecrets is a list of references to secrets in the same namespace to use for pulling any images in pods that reference this ServiceAccount. ImagePullSecrets are distinct from Secrets because Secrets can be mounted in the pod, but ImagePullSecrets are only accessed by the kubelet. More info: https://kubernetes.io/docs/concepts/containers/images/#specifying-imagepullsecrets-on-a-pod
        :param pulumi.Input[Literal['ServiceAccount']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter(name="automountServiceAccountToken")
    def automount_service_account_token(self) -> pulumi.Output[_builtins.bool]:
        """
        AutomountServiceAccountToken indicates whether pods running as this service account should have an API token automatically mounted. Can be overridden at the pod level.
        """
        return pulumi.get(self, "automount_service_account_token")
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['ServiceAccount']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
