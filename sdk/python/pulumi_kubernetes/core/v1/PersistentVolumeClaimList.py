...
class PersistentVolumeClaimList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PersistentVolumeClaimArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PersistentVolumeClaimArgs']]]] items: A list of persistent volume claims. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.PersistentVolumeClaim']]:
        """
