...
class LimitRangeList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['LimitRangeArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['LimitRangeArgs']]]] items: Items is a list of LimitRange objects. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.LimitRange']]:
        """
