...
class EventList(pulumi.CustomResource):
    ...
    List of events
      ...
      * `count` (`float`) - The number of times this event has occurred.
      * `event_time` (`str`) - Time when this Event was first observed.
      * `first_timestamp` (`str`) - The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)
      * `involved_object` (`dict`) - The object that this event is about.
      ...
      * `last_timestamp` (`str`) - The time at which the most recent occurrence of this event was recorded.
      ...
      * `related` (`dict`) - Optional secondary object for more complex actions.
      * `reporting_component` (`str`) - Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.
      * `reporting_instance` (`str`) - ID of the controller instance, e.g. `kubelet-xyzf`.
      * `series` (`dict`) - Data about the Event series this event represents or nil if it's a singleton Event.
        * `count` (`float`) - Number of occurrences in this series up to the last heartbeat time
        * `last_observed_time` (`str`) - Time of the last occurrence observed
        * `state` (`str`) - State of this Series: Ongoing or Finished Deprecated. Planned removal for 1.18

      * `source` (`dict`) - The component reporting this event. Should be a short machine understandable string.
        * `component` (`str`) - Component from which the event is generated.
        * `host` (`str`) - Node name on which the event is generated.

      * `type` (`str`) - Type of this event (Normal, Warning), new types could be added in the future
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] items: List of events
        ...
        The **items** object supports the following:
          ...
          * `count` (`pulumi.Input[float]`) - The number of times this event has occurred.
          * `event_time` (`pulumi.Input[str]`) - Time when this Event was first observed.
          * `first_timestamp` (`pulumi.Input[str]`) - The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)
          * `involved_object` (`pulumi.Input[dict]`) - The object that this event is about.
          ...
          * `last_timestamp` (`pulumi.Input[str]`) - The time at which the most recent occurrence of this event was recorded.
          ...
          * `reason` (`pulumi.Input[str]`) - This should be a short, machine understandable string that gives the reason for the transition into the object's current status.
          * `related` (`pulumi.Input[dict]`) - Optional secondary object for more complex actions.
          * `reporting_component` (`pulumi.Input[str]`) - Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.
          * `reporting_instance` (`pulumi.Input[str]`) - ID of the controller instance, e.g. `kubelet-xyzf`.
          * `series` (`pulumi.Input[dict]`) - Data about the Event series this event represents or nil if it's a singleton Event.
            * `count` (`pulumi.Input[float]`) - Number of occurrences in this series up to the last heartbeat time
            * `last_observed_time` (`pulumi.Input[str]`) - Time of the last occurrence observed
            * `state` (`pulumi.Input[str]`) - State of this Series: Ongoing or Finished Deprecated. Planned removal for 1.18

          * `source` (`pulumi.Input[dict]`) - The component reporting this event. Should be a short machine understandable string.
            * `component` (`pulumi.Input[str]`) - Component from which the event is generated.
            * `host` (`pulumi.Input[str]`) - Node name on which the event is generated.
        ...
        super(EventList, __self__).__init__(
    ...
    def get(resource_name, id, opts=None):
        ...
        return EventList(resource_name, opts=opts, __props__=__props__)
