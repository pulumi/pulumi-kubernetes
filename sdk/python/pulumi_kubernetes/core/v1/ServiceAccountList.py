...
class ServiceAccountList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceAccountArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceAccountArgs']]]] items: List of ServiceAccounts. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.ServiceAccount']]:
        """
