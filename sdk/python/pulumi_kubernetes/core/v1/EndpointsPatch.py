...
class EndpointsPatchArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['Endpoints']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaPatchArgs']] = None,
                 subsets: pulumi.Input[Optional[Sequence[pulumi.Input['EndpointSubsetPatchArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['Endpoints']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['Endpoints']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def subsets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EndpointSubsetPatchArgs']]]]:
        """
    ...
    @subsets.setter
    def subsets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EndpointSubsetPatchArgs']]]]):
        pulumi.set(self, "subsets", value)


@pulumi.type_token("kubernetes:core/v1:EndpointsPatch")
class EndpointsPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 subsets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['EndpointSubsetPatchArgs', 'EndpointSubsetPatchArgsDict', 'outputs.EndpointSubsetPatch']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['EndpointSubsetPatchArgs', 'EndpointSubsetPatchArgsDict', 'outputs.EndpointSubsetPatch']]]] subsets: The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to the IPs they share. A single address with multiple ports, some of which are ready and some of which are not (because they come from different containers) will result in the address being displayed in different subsets for the different ports. No address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['Endpoints']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
