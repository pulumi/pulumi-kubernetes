...
class ServiceList(pulumi.CustomResource):
    ...
    List of services
      ...
      * `spec` (`dict`) - Spec defines the behavior of a service. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      ...
      * `status` (`dict`) - Most recently observed status of the service. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] items: List of services
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - Spec defines the behavior of a service. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
          ...
          * `status` (`pulumi.Input[dict]`) - Most recently observed status of the service. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
            * `load_balancer` (`pulumi.Input[dict]`) - LoadBalancer contains the current status of the load-balancer, if one is present.
        ...
        super(ServiceList, __self__).__init__(
    ...
    def get(resource_name, id, opts=None):
        ...
        return ServiceList(resource_name, opts=opts, __props__=__props__)
