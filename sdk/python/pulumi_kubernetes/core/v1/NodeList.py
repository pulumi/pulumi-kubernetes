...
class NodeList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['NodeArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['NodeArgs']]]] items: List of nodes
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.Node']]:
        """
        List of nodes
        """
