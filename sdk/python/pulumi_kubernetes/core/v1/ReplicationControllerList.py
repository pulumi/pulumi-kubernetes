...
class ReplicationControllerList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ReplicationControllerArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ReplicationControllerArgs']]]] items: List of replication controllers. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.ReplicationController']]:
        """
