...
class LimitRangeList(pulumi.CustomResource):
    ...
    Items is a list of LimitRange objects. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/
      ...
      * `spec` (`dict`) - Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        * `limits` (`list`) - Limits is the list of LimitRangeItem objects that are enforced.
          * `default` (`dict`) - Default resource requirement limit value by resource name if resource limit is omitted.
          * `defaultRequest` (`dict`) - DefaultRequest is the default resource requirement request value by resource name if resource request is omitted.
          * `max` (`dict`) - Max usage constraints on this kind by resource name.
          * `maxLimitRequestRatio` (`dict`) - MaxLimitRequestRatio if specified, the named resource must have a request and limit that are both non-zero where limit divided by request is less than or equal to the enumerated value; this represents the max burst for the named resource.
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] items: Items is a list of LimitRange objects. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
            * `limits` (`pulumi.Input[list]`) - Limits is the list of LimitRangeItem objects that are enforced.
              * `default` (`pulumi.Input[dict]`) - Default resource requirement limit value by resource name if resource limit is omitted.
              * `defaultRequest` (`pulumi.Input[dict]`) - DefaultRequest is the default resource requirement request value by resource name if resource request is omitted.
              * `max` (`pulumi.Input[dict]`) - Max usage constraints on this kind by resource name.
              * `maxLimitRequestRatio` (`pulumi.Input[dict]`) - MaxLimitRequestRatio if specified, the named resource must have a request and limit that are both non-zero where limit divided by request is less than or equal to the enumerated value; this represents the max burst for the named resource.
              * `min` (`pulumi.Input[dict]`) - Min usage constraints on this kind by resource name.
              * `type` (`pulumi.Input[str]`) - Type of resource that this limit applies to.
