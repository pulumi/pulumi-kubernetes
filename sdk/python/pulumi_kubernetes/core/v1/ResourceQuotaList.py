...
class ResourceQuotaList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ResourceQuotaArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ResourceQuotaArgs']]]] items: Items is a list of ResourceQuota objects. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.ResourceQuota']]:
        """
