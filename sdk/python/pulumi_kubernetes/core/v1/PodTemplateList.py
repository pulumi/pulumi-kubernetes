...
class PodTemplateList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PodTemplateArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PodTemplateArgs']]]] items: List of pod templates
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.PodTemplate']]:
        """
