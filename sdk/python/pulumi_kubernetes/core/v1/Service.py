...
class ServiceInitArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['ServiceSpecArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['ServiceSpecArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['ServiceSpecArgs']]):
...
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ServiceSpecArgs', 'ServiceSpecArgsDict', 'outputs.ServiceSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ServiceSpecArgs', 'ServiceSpecArgsDict', 'outputs.ServiceSpec']] spec: Spec defines the behavior of a service. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['Service']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
