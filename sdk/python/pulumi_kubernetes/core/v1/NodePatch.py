...
class NodePatchArgs:
    def __init__(__self__, *,
                 ...
                 spec: Optional[pulumi.Input['NodeSpecPatchArgs']] = None):
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input['NodeSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: Optional[pulumi.Input['NodeSpecPatchArgs']]):
...
class NodePatch(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            NodePatchArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if spec is not None and not isinstance(spec, NodeSpecPatchArgs):
                spec = spec or {}
                def _setter(key, value):
                    spec[key] = value
                NodeSpecPatchArgs._configure(_setter, **spec)
