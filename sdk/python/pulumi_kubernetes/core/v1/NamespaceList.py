...
class NamespaceList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['NamespaceArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['NamespaceArgs']]]] items: Items is the list of Namespace objects in the list. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.Namespace']]:
        """
