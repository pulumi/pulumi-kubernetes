...
__all__ = ['LimitRangeArgs', 'LimitRange']
...
class LimitRange(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[LimitRangeArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        LimitRange sets resource usage limits for each kind of resource in a Namespace.

        :param str resource_name: The name of the resource.
        :param LimitRangeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LimitRangeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LimitRangeArgs.__new__(LimitRangeArgs)
