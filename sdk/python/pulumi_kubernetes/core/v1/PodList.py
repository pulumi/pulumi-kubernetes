...
class PodList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PodArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PodArgs']]]] items: List of pods. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.Pod']]:
        """
