...
__all__ = ['PersistentVolumeInitArgs', 'PersistentVolume']

@pulumi.input_type
class PersistentVolumeInitArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['PersistentVolumeSpecArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['PersistentVolumeSpecArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['PersistentVolumeSpecArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:core/v1:PersistentVolume")
class PersistentVolume(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['PersistentVolumeSpecArgs', 'PersistentVolumeSpecArgsDict', 'outputs.PersistentVolumeSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['PersistentVolumeSpecArgs', 'PersistentVolumeSpecArgsDict', 'outputs.PersistentVolumeSpec']] spec: spec defines a specification of a persistent volume owned by the cluster. Provisioned by an administrator. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PersistentVolumeInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PersistentVolumeInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PersistentVolumeInitArgs.__new__(PersistentVolumeInitArgs)
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['PersistentVolume']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.PersistentVolumeSpec']:
        """
        spec defines a specification of a persistent volume owned by the cluster. Provisioned by an administrator. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
        """
        return pulumi.get(self, "spec")
