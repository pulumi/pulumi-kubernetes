...
class PodTemplateInitArgs:
    def __init__(__self__, *,
                 ...
                 template: pulumi.Input[Optional['PodTemplateSpecArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['PodTemplate']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['PodTemplate']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def template(self) -> pulumi.Input[Optional['PodTemplateSpecArgs']]:
        """
    ...
    @template.setter
    def template(self, value: pulumi.Input[Optional['PodTemplateSpecArgs']]):
        pulumi.set(self, "template", value)


@pulumi.type_token("kubernetes:core/v1:PodTemplate")
class PodTemplate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['PodTemplate']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def template(self) -> pulumi.Output['outputs.PodTemplateSpec']:
        """
        Template defines the pods that will be created from this pod template. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        return pulumi.get(self, "template")
