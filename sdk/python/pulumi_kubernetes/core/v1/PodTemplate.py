...
class PodTemplateInitArgs:
    def __init__(__self__, *,
        ...
        """
        PodTemplateInitArgs._configure(
...
class PodTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PodTemplateInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if template is not None and not isinstance(template, PodTemplateSpecArgs):
                template = template or {}
                def _setter(key, value):
                    template[key] = value
                PodTemplateSpecArgs._configure(_setter, **template)
