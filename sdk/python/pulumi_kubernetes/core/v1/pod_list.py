...
class PodList(pulumi.CustomResource):
    ...
    List of pods. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
      ...
      * `status` (`dict`) - Most recently observed status of the pod. This data may not be up to date. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        * `conditions` (`list`) - Current service state of pod. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions
        ...
        * `container_statuses` (`list`) - The list has one entry per container in the manifest. Each entry is currently the output of `docker inspect`. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status
          ...
          * `lastState` (`dict`) - Details about the container's last termination condition.
            * `running` (`dict`) - Details about a running container
              * `startedAt` (`str`) - Time at which the container was last (re-)started

            * `terminated` (`dict`) - Details about a terminated container
              * `containerID` (`str`) - Container's ID in the format 'docker://<container_id>'
              * `exitCode` (`float`) - Exit status from the last termination of the container
              ...
              * `signal` (`float`) - Signal from the last termination of the container
              * `startedAt` (`str`) - Time at which previous execution of the container started

            * `waiting` (`dict`) - Details about a waiting container
          ...
          * `restartCount` (`float`) - The number of times the container has been restarted, currently based on the number of dead containers that have not yet been removed. Note that this is calculated from dead containers. But those containers are subject to garbage collection. This value will get capped at 5 by GC.
          ...
          * `state` (`dict`) - Details about the container's current condition.

        * `ephemeral_container_statuses` (`list`) - Status for any ephemeral containers that have run in this pod. This field is alpha-level and is only populated by servers that enable the EphemeralContainers feature.
        * `host_ip` (`str`) - IP address of the host to which the pod is assigned. Empty if not yet scheduled.
        * `init_container_statuses` (`list`) - The list has one entry per init container in the manifest. The most recent successful init container will have ready = true, the most recently started container will have startTime set. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status
        ...
        * `pod_ip` (`str`) - IP address allocated to the pod. Routable at least within the cluster. Empty if not yet allocated.
        * `pod_i_ps` (`list`) - podIPs holds the IP addresses allocated to the pod. If this field is specified, the 0th entry must match the podIP field. Pods may be allocated at most 1 value for each of IPv4 and IPv6. This list is empty if no IPs have been allocated yet.
          * `ip` (`str`) - ip is an IP address (IPv4 or IPv6) assigned to the pod

        * `qos_class` (`str`) - The Quality of Service (QOS) classification assigned to the pod based on resource requirements See PodQOSClass type for available QOS classes More info: https://git.k8s.io/community/contributors/design-proposals/node/resource-qos.md
        * `reason` (`str`) - A brief CamelCase message indicating details about why the pod is in this state. e.g. 'Evicted'
        * `start_time` (`str`) - RFC 3339 date and time at which the object was acknowledged by the Kubelet. This is before the Kubelet pulled the container image(s) for the pod.
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] items: List of pods. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        ...
        The **items** object supports the following:
          ...
          * `status` (`pulumi.Input[dict]`) - Most recently observed status of the pod. This data may not be up to date. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
            * `conditions` (`pulumi.Input[list]`) - Current service state of pod. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions
              ...
              * `reason` (`pulumi.Input[str]`) - Unique, one-word, CamelCase reason for the condition's last transition.
              * `status` (`pulumi.Input[str]`) - Status is the status of the condition. Can be True, False, Unknown. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions
              * `type` (`pulumi.Input[str]`) - Type is the type of the condition. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions

            * `container_statuses` (`pulumi.Input[list]`) - The list has one entry per container in the manifest. Each entry is currently the output of `docker inspect`. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status
              * `containerID` (`pulumi.Input[str]`) - Container's ID in the format 'docker://<container_id>'.
              * `image` (`pulumi.Input[str]`) - The image the container is running. More info: https://kubernetes.io/docs/concepts/containers/images
              * `imageID` (`pulumi.Input[str]`) - ImageID of the container's image.
              * `lastState` (`pulumi.Input[dict]`) - Details about the container's last termination condition.
                * `running` (`pulumi.Input[dict]`) - Details about a running container
                  * `startedAt` (`pulumi.Input[str]`) - Time at which the container was last (re-)started

                * `terminated` (`pulumi.Input[dict]`) - Details about a terminated container
                  * `containerID` (`pulumi.Input[str]`) - Container's ID in the format 'docker://<container_id>'
                  * `exitCode` (`pulumi.Input[float]`) - Exit status from the last termination of the container
                  * `finishedAt` (`pulumi.Input[str]`) - Time at which the container last terminated
                  * `message` (`pulumi.Input[str]`) - Message regarding the last termination of the container
                  * `reason` (`pulumi.Input[str]`) - (brief) reason from the last termination of the container
                  * `signal` (`pulumi.Input[float]`) - Signal from the last termination of the container
                  * `startedAt` (`pulumi.Input[str]`) - Time at which previous execution of the container started

                * `waiting` (`pulumi.Input[dict]`) - Details about a waiting container
                  * `message` (`pulumi.Input[str]`) - Message regarding why the container is not yet running.
                  * `reason` (`pulumi.Input[str]`) - (brief) reason the container is not yet running.

              * `name` (`pulumi.Input[str]`) - This must be a DNS_LABEL. Each container in a pod must have a unique name. Cannot be updated.
              * `ready` (`pulumi.Input[bool]`) - Specifies whether the container has passed its readiness probe.
              * `restartCount` (`pulumi.Input[float]`) - The number of times the container has been restarted, currently based on the number of dead containers that have not yet been removed. Note that this is calculated from dead containers. But those containers are subject to garbage collection. This value will get capped at 5 by GC.
              * `started` (`pulumi.Input[bool]`) - Specifies whether the container has passed its startup probe. Initialized as false, becomes true after startupProbe is considered successful. Resets to false when the container is restarted, or if kubelet loses state temporarily. Is always true when no startupProbe is defined.
              * `state` (`pulumi.Input[dict]`) - Details about the container's current condition.

            * `ephemeral_container_statuses` (`pulumi.Input[list]`) - Status for any ephemeral containers that have run in this pod. This field is alpha-level and is only populated by servers that enable the EphemeralContainers feature.
            * `host_ip` (`pulumi.Input[str]`) - IP address of the host to which the pod is assigned. Empty if not yet scheduled.
            * `init_container_statuses` (`pulumi.Input[list]`) - The list has one entry per init container in the manifest. The most recent successful init container will have ready = true, the most recently started container will have startTime set. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status
            * `message` (`pulumi.Input[str]`) - A human readable message indicating details about why the pod is in this condition.
            * `nominated_node_name` (`pulumi.Input[str]`) - nominatedNodeName is set only when this pod preempts other pods on the node, but it cannot be scheduled right away as preemption victims receive their graceful termination periods. This field does not guarantee that the pod will be scheduled on this node. Scheduler may decide to place the pod elsewhere if other nodes become available sooner. Scheduler may also decide to give the resources on this node to a higher priority pod that is created after preemption. As a result, this field may be different than PodSpec.nodeName when the pod is scheduled.
            * `phase` (`pulumi.Input[str]`) - The phase of a Pod is a simple, high-level summary of where the Pod is in its lifecycle. The conditions array, the reason and message fields, and the individual container status arrays contain more detail about the pod's status. There are five possible phase values:
              
              Pending: The pod has been accepted by the Kubernetes system, but one or more of the container images has not been created. This includes time before being scheduled as well as time spent downloading images over the network, which could take a while. Running: The pod has been bound to a node, and all of the containers have been created. At least one container is still running, or is in the process of starting or restarting. Succeeded: All containers in the pod have terminated in success, and will not be restarted. Failed: All containers in the pod have terminated, and at least one container has terminated in failure. The container either exited with non-zero status or was terminated by the system. Unknown: For some reason the state of the pod could not be obtained, typically due to an error in communicating with the host of the pod.
              
              More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-phase
            * `pod_ip` (`pulumi.Input[str]`) - IP address allocated to the pod. Routable at least within the cluster. Empty if not yet allocated.
            * `pod_i_ps` (`pulumi.Input[list]`) - podIPs holds the IP addresses allocated to the pod. If this field is specified, the 0th entry must match the podIP field. Pods may be allocated at most 1 value for each of IPv4 and IPv6. This list is empty if no IPs have been allocated yet.
              * `ip` (`pulumi.Input[str]`) - ip is an IP address (IPv4 or IPv6) assigned to the pod

            * `qos_class` (`pulumi.Input[str]`) - The Quality of Service (QOS) classification assigned to the pod based on resource requirements See PodQOSClass type for available QOS classes More info: https://git.k8s.io/community/contributors/design-proposals/node/resource-qos.md
            * `reason` (`pulumi.Input[str]`) - A brief CamelCase message indicating details about why the pod is in this state. e.g. 'Evicted'
            * `start_time` (`pulumi.Input[str]`) - RFC 3339 date and time at which the object was acknowledged by the Kubelet. This is before the Kubelet pulled the container image(s) for the pod.
        ...
        super(PodList, __self__).__init__(
    ...
    def get(resource_name, id, opts=None):
        ...
        return PodList(resource_name, opts=opts, __props__=__props__)
