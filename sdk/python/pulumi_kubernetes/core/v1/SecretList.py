...
class SecretList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['SecretArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['SecretArgs']]]] items: Items is a list of secret objects. More info: https://kubernetes.io/docs/concepts/configuration/secret
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.Secret']]:
        """
