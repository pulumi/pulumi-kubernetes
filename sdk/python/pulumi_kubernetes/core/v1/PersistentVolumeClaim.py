...
class PersistentVolumeClaimInitArgs:
    def __init__(__self__, *,
        ...
        """
        PersistentVolumeClaimInitArgs._configure(
...
class PersistentVolumeClaim(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PersistentVolumeClaimInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if spec is not None and not isinstance(spec, PersistentVolumeClaimSpecArgs):
                spec = spec or {}
                def _setter(key, value):
                    spec[key] = value
                PersistentVolumeClaimSpecArgs._configure(_setter, **spec)
