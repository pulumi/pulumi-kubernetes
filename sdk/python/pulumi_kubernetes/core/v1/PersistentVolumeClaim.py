...
class PersistentVolumeClaimInitArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['PersistentVolumeClaim']]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 spec: pulumi.Input[Optional['PersistentVolumeClaimSpecArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['PersistentVolumeClaim']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['PersistentVolumeClaim']]]):
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['PersistentVolumeClaimSpecArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['PersistentVolumeClaimSpecArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:core/v1:PersistentVolumeClaim")
class PersistentVolumeClaim(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['PersistentVolumeClaimSpecArgs', 'PersistentVolumeClaimSpecArgsDict', 'outputs.PersistentVolumeClaimSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['PersistentVolumeClaimSpecArgs', 'PersistentVolumeClaimSpecArgsDict', 'outputs.PersistentVolumeClaimSpec']] spec: spec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['PersistentVolumeClaim']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.PersistentVolumeClaimSpec']:
        """
        spec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
        """
        return pulumi.get(self, "spec")
