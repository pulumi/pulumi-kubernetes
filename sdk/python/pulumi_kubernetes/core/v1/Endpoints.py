...
class EndpointsInitArgs:
    def __init__(__self__, *,
                 ...
                 subsets: pulumi.Input[Optional[Sequence[pulumi.Input['EndpointSubsetArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def subsets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EndpointSubsetArgs']]]]:
        """
    ...
    @subsets.setter
    def subsets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EndpointSubsetArgs']]]]):
...
class Endpoints(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 subsets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['EndpointSubsetArgs', 'EndpointSubsetArgsDict', 'outputs.EndpointSubset']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['EndpointSubsetArgs', 'EndpointSubsetArgsDict', 'outputs.EndpointSubset']]]] subsets: The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to the IPs they share. A single address with multiple ports, some of which are ready and some of which are not (because they come from different containers) will result in the address being displayed in different subsets for the different ports. No address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['Endpoints']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def subsets(self) -> pulumi.Output[Sequence['outputs.EndpointSubset']]:
        """
        The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to the IPs they share. A single address with multiple ports, some of which are ready and some of which are not (because they come from different containers) will result in the address being displayed in different subsets for the different ports. No address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.
        """
        return pulumi.get(self, "subsets")
