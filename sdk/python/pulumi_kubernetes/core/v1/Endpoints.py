...
class Endpoints(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 subsets: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['EndpointSubsetArgs']]]]] = None,
                 __props__=None,
                 __name__=None,
                 __opts__=None):
        """
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['EndpointSubsetArgs']]]] subsets: The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to the IPs they share. A single address with multiple ports, some of which are ready and some of which are not (because they come from different containers) will result in the address being displayed in different subsets for the different ports. No address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.
        """
    ...
    @property
    @pulumi.getter
    def subsets(self) -> pulumi.Output[Optional[List['outputs.EndpointSubset']]]:
        """
