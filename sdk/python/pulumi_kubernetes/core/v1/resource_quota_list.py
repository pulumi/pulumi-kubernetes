...
class ResourceQuotaList(pulumi.CustomResource):
    ...
    Items is a list of ResourceQuota objects. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/
      ...
      * `spec` (`dict`) - Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        ...
        * `scope_selector` (`dict`) - scopeSelector is also a collection of filters like scopes that must match each object tracked by a quota but expressed using ScopeSelectorOperator in combination with possible values. For a resource to match, both scopes AND scopeSelector (if specified in spec), must be matched.
          * `match_expressions` (`list`) - A list of scope selector requirements by scope of the resources.
            ...
            * `values` (`list`) - An array of string values. If the operator is In or NotIn, the values array must be non-empty. If the operator is Exists or DoesNotExist, the values array must be empty. This array is replaced during a strategic merge patch.

        * `scopes` (`list`) - A collection of filters that must match each object tracked by a quota. If not specified, the quota matches all objects.

      * `status` (`dict`) - Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        * `hard` (`dict`) - Hard is the set of enforced hard limits for each named resource. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/
        * `used` (`dict`) - Used is the current observed total usage of the resource in the namespace.
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] items: Items is a list of ResourceQuota objects. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/
        ...
        The **items** object supports the following:
          ...
          * `spec` (`pulumi.Input[dict]`) - Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
            * `hard` (`pulumi.Input[dict]`) - hard is the set of desired hard limits for each named resource. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/
            * `scope_selector` (`pulumi.Input[dict]`) - scopeSelector is also a collection of filters like scopes that must match each object tracked by a quota but expressed using ScopeSelectorOperator in combination with possible values. For a resource to match, both scopes AND scopeSelector (if specified in spec), must be matched.
              * `match_expressions` (`pulumi.Input[list]`) - A list of scope selector requirements by scope of the resources.
                * `operator` (`pulumi.Input[str]`) - Represents a scope's relationship to a set of values. Valid operators are In, NotIn, Exists, DoesNotExist.
                * `scopeName` (`pulumi.Input[str]`) - The name of the scope that the selector applies to.
                * `values` (`pulumi.Input[list]`) - An array of string values. If the operator is In or NotIn, the values array must be non-empty. If the operator is Exists or DoesNotExist, the values array must be empty. This array is replaced during a strategic merge patch.

            * `scopes` (`pulumi.Input[list]`) - A collection of filters that must match each object tracked by a quota. If not specified, the quota matches all objects.

          * `status` (`pulumi.Input[dict]`) - Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
            * `hard` (`pulumi.Input[dict]`) - Hard is the set of enforced hard limits for each named resource. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/
            * `used` (`pulumi.Input[dict]`) - Used is the current observed total usage of the resource in the namespace.
        ...
        super(ResourceQuotaList, __self__).__init__(
    ...
    def get(resource_name, id, opts=None):
        ...
        return ResourceQuotaList(resource_name, opts=opts, __props__=__props__)
