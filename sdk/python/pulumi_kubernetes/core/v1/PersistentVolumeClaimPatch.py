...
class PersistentVolumeClaimPatchInitArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['PersistentVolumeClaimSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['PersistentVolumeClaimSpecPatchArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['PersistentVolumeClaimSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:core/v1:PersistentVolumeClaimPatch")
class PersistentVolumeClaimPatch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['PersistentVolumeClaimSpecPatchArgs', 'PersistentVolumeClaimSpecPatchArgsDict', 'outputs.PersistentVolumeClaimSpecPatch']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['PersistentVolumeClaimSpecPatchArgs', 'PersistentVolumeClaimSpecPatchArgsDict', 'outputs.PersistentVolumeClaimSpecPatch']] spec: spec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Optional[Literal['PersistentVolumeClaim']]]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
