...
class ConfigMapList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ConfigMapArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ConfigMapArgs']]]] items: Items is the list of ConfigMaps.
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.ConfigMap']]:
        """
