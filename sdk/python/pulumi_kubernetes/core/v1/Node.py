...
class NodeInitArgs:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['NodeSpecArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['NodeSpecArgs']]:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['NodeSpecArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:core/v1:Node")
class Node(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['NodeSpecArgs', 'NodeSpecArgsDict', 'outputs.NodeSpec']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['NodeSpecArgs', 'NodeSpecArgsDict', 'outputs.NodeSpec']] spec: Spec defines the behavior of a node. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[NodeInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Node is a worker node in Kubernetes. Each node will have a unique identifier in the cache (i.e. in etcd).
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['Node']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.NodeSpec']:
        """
        Spec defines the behavior of a node. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        """
        return pulumi.get(self, "spec")
