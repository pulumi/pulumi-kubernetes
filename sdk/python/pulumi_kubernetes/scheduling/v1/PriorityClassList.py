...
class PriorityClassListArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Optional[Literal['PriorityClassList']]] = None,
        ...
        :param pulumi.Input[Literal['PriorityClassList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", 'PriorityClassList')
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Literal['PriorityClassList']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Literal['PriorityClassList']]]):
...
@pulumi.type_token("kubernetes:scheduling.k8s.io/v1:PriorityClassList")
class PriorityClassList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: pulumi.Input[Optional[Literal['scheduling.k8s.io/v1']]] = None,
                 items: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PriorityClassArgs', 'PriorityClassArgsDict', 'outputs.PriorityClass']]]]] = None,
                 kind: pulumi.Input[Optional[Literal['PriorityClassList']]] = None,
        ...
        :param pulumi.Input[Literal['scheduling.k8s.io/v1']] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['PriorityClassArgs', 'PriorityClassArgsDict', 'outputs.PriorityClass']]]] items: items is the list of PriorityClasses
        :param pulumi.Input[Literal['PriorityClassList']] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['PriorityClassList']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
