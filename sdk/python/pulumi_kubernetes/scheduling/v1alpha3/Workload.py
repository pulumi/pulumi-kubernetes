...
@pulumi.type_token("kubernetes:scheduling.k8s.io/v1alpha3:Workload")
class Workload(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:scheduling.k8s.io/v1alpha1:Workload"), pulumi.Alias(type_="kubernetes:scheduling.k8s.io/v1alpha2:Workload"), pulumi.Alias(type_="kubernetes:scheduling.k8s.io/v1beta1:Workload")])
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Output[Literal['Workload']]:
        """
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        """
        return pulumi.get(self, "kind")
