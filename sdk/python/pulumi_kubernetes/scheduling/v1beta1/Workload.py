...
@pulumi.type_token("kubernetes:scheduling.k8s.io/v1beta1:Workload")
class Workload(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:scheduling.k8s.io/v1alpha1:Workload"), pulumi.Alias(type_="kubernetes:scheduling.k8s.io/v1alpha2:Workload"), pulumi.Alias(type_="kubernetes:scheduling.k8s.io/v1alpha3:Workload")])
