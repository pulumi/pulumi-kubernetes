...
class PriorityClassList(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PriorityClassArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PriorityClassArgs']]]] items: items is the list of PriorityClasses
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[List['outputs.PriorityClass']]:
        """
