...
func FailedStateRefreshFunc() StateRefreshFunc {
	return func() (*unstructured.Unstructured, string, error) {
...
func SuccessfulStateRefreshFunc() StateRefreshFunc {
	return func() (*unstructured.Unstructured, string, error) {
		return &unstructured.Unstructured{}, "running", nil
	}
}
...
func InconsistentStateRefreshFunc() StateRefreshFunc {
	...
	return func() (*unstructured.Unstructured, string, error) {
		...
		return makeStateIndexObj(idx), s, nil
	}
}
...
func makeStateIndexObj(idx int) *unstructured.Unstructured {
	return &unstructured.Unstructured{Object: map[string]interface{}{"state": idx}}
}

func stateIndex(obj *unstructured.Unstructured) int {
	return obj.Object["state"].(int)
}
...
func TestWaitForState_failureEmpty(t *testing.T) {
	conf := &StateChangeConf{
		...
		NotFoundChecks: 1,
		Refresh: func() (*unstructured.Unstructured, string, error) {
			return makeStateIndexObj(42), "pending", nil
		},
		PollInterval: 10 * time.Millisecond,
